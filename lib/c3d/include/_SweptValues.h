...
class _SweptValues : public Napi::ObjectWrap<_SweptValues>
{
  public:
...
{
  public:
    _SweptValues_CheckSelfInt_AsyncWorker(SweptValues *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    _SweptValues_SetCheckSelfInt_AsyncWorker(SweptValues *_underlying, Napi::Promise::Deferred const &d, bool c);
