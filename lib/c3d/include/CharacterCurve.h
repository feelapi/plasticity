...
class CharacterCurve : public Napi::ObjectWrap<CharacterCurve>
{
  public:
...
{
  public:
    CharacterCurve_Inverse_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    CharacterCurve_Trimmed_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d, double t1,
                                       double t2, int sense);
...
{
  public:
    CharacterCurve_IsStraight_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    CharacterCurve_IsClosed_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CharacterCurve_IsBounded_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CharacterCurve_GetTMax_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CharacterCurve_GetTMin_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CharacterCurve_GetPeriod_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CharacterCurve_GetWeightCentre_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CharacterCurve_GetLimitPoint_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d,
                                             ptrdiff_t number);
...
{
  public:
    CharacterCurve_PointOn_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CharacterCurve__PointOn_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CharacterCurve_Explore_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d, double &t,
                                       bool ext);
...
{
  public:
    CharacterCurve_FirstDer_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CharacterCurve__FirstDer_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CharacterCurve_SecondDer_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CharacterCurve__SecondDer_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CharacterCurve_Tangent_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CharacterCurve__Tangent_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CharacterCurve_Normal_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CharacterCurve__Normal_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CharacterCurve_PointRelative_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    CharacterCurve_PointLocation_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d,
                                             const MbCartPoint &pnt, double eps);
...
{
  public:
    CharacterCurve_IsA_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CharacterCurve_Type_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CharacterCurve_Family_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CharacterCurve_Move_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d, const MbVector &to,
                                    MbRegTransform *iReg = NULL);
...
{
  public:
    CharacterCurve_Transform_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    CharacterCurve_Duplicate_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    CharacterCurve_AddYourGabaritTo_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d,
                                                MbRect &rect);
...
{
  public:
    CharacterCurve_GetUseCount_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CharacterCurve_AddRef_AsyncWorker(MbCharacterCurve *_underlying, Napi::Promise::Deferred const &d);
