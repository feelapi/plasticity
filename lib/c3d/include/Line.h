...
{
  public:
    Line_Inverse_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, MbRegTransform *iReg = NULL);
...
{
  public:
    Line_Trimmed_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, double t1, double t2, int sense);
...
{
  public:
    Line_IsStraight_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, bool ignoreParams = false);
...
{
  public:
    Line_IsClosed_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line_IsBounded_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line_GetTMax_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line_GetTMin_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line_GetPeriod_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line_GetWeightCentre_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line_GetLimitPoint_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, ptrdiff_t number);
...
{
  public:
    Line_PointOn_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line__PointOn_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line_Explore_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, double &t, bool ext);
...
{
  public:
    Line_FirstDer_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line__FirstDer_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line_SecondDer_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line__SecondDer_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line_Tangent_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line__Tangent_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line_Normal_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line__Normal_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line_PointRelative_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, const MbCartPoint &pnt,
                                   double eps);
...
{
  public:
    Line_PointLocation_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, const MbCartPoint &pnt,
                                   double eps);
...
{
  public:
    Line_IsA_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line_Type_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line_Family_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line_Move_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, const MbVector &to,
                          MbRegTransform *iReg = NULL);
...
{
  public:
    Line_Transform_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, const MbMatrix &matr,
...
{
  public:
    Line_Duplicate_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, MbRegDuplicate *dup = NULL);
...
{
  public:
    Line_AddYourGabaritTo_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d, MbRect &rect);
...
{
  public:
    Line_GetUseCount_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line_AddRef_AsyncWorker(MbLine *_underlying, Napi::Promise::Deferred const &d);
