...
class _SolidPool : public
  Napi::ObjectWrap<_SolidPool>
{
  public:
...
SolidPool * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
SolidPool * _underlying;                         size_t  n;
