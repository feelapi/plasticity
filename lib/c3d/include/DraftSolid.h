...
class DraftSolid : public Napi::ObjectWrap<DraftSolid>
{
  public:
...
{
  public:
    DraftSolid_IsA_AsyncWorker(MbDraftSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DraftSolid_Type_AsyncWorker(MbDraftSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DraftSolid_GetBasisPoints_AsyncWorker(MbDraftSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DraftSolid_SetBasisPoints_AsyncWorker(MbDraftSolid *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    DraftSolid_GetBasisItems_AsyncWorker(MbDraftSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DraftSolid_GetCreatorsCount_AsyncWorker(MbDraftSolid *_underlying, Napi::Promise::Deferred const &d,
                                            MbeCreatorType ct);
...
{
  public:
    DraftSolid_GetYourNameMaker_AsyncWorker(MbDraftSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DraftSolid_GetStatus_AsyncWorker(MbDraftSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DraftSolid_SetStatus_AsyncWorker(MbDraftSolid *_underlying, Napi::Promise::Deferred const &d, MbeProcessState l);
...
{
  public:
    DraftSolid_CreateShell_AsyncWorker(MbDraftSolid *_underlying, Napi::Promise::Deferred const &d, MbFaceShell *shell,
...
{
  public:
    DraftSolid_GetMainName_AsyncWorker(MbDraftSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DraftSolid_GetUseCount_AsyncWorker(MbDraftSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DraftSolid_AddRef_AsyncWorker(MbDraftSolid *_underlying, Napi::Promise::Deferred const &d);
