...
class Polygon3D : public Napi::ObjectWrap<Polygon3D>
{
  public:
...
{
  public:
    Polygon3D_SetItem_AsyncWorker(MbPolygon3D *_underlying, Napi::Promise::Deferred const &d, const MbRefItem *g);
...
{
  public:
    Polygon3D_SetPrimitiveName_AsyncWorker(MbPolygon3D *_underlying, Napi::Promise::Deferred const &d, SimpleName n);
...
{
  public:
    Polygon3D_SetPrimitiveType_AsyncWorker(MbPolygon3D *_underlying, Napi::Promise::Deferred const &d, MbeRefType t);
...
{
  public:
    Polygon3D_GetUseCount_AsyncWorker(MbPolygon3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polygon3D_AddRef_AsyncWorker(MbPolygon3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polygon3D_SetStyle_AsyncWorker(MbPolygon3D *_underlying, Napi::Promise::Deferred const &d, int s);
...
{
  public:
    Polygon3D_GetStyle_AsyncWorker(MbPolygon3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polygon3D_SetColor_AsyncWorker(MbPolygon3D *_underlying, Napi::Promise::Deferred const &d, uint32 c);
...
{
  public:
    Polygon3D_GetColor_AsyncWorker(MbPolygon3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polygon3D_AttributesConvert_AsyncWorker(MbPolygon3D *_underlying, Napi::Promise::Deferred const &d, MbGrid &other);
