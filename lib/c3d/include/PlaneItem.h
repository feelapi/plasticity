...
class PlaneItem : public
  Napi::ObjectWrap<PlaneItem>
{
  public:
...
MbPlaneItem * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPlaneItem * _underlying;                        const MbVector & to;
                         MbRegTransform * iReg= NULL;
  ...
  class PlaneItem_Transform_AsyncWorker : public PromiseWorker {
      public:
          PlaneItem_Transform_AsyncWorker(
MbPlaneItem * _underlying,            Napi::Promise::Deferred const &d,
                                const MbMatrix & matr,
                                 MbRegTransform * iReg = NULL,
      ...
      private:
MbPlaneItem * _underlying;                        const MbMatrix & matr;
                         MbRegTransform * iReg= NULL;
                        const MbSurface * newSurface= NULL;
  ...
  class PlaneItem_Duplicate_AsyncWorker : public PromiseWorker {
      public:
          PlaneItem_Duplicate_AsyncWorker(
MbPlaneItem * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPlaneItem * _underlying;                         MbRegDuplicate * dup= NULL;
  ...
  class PlaneItem_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          PlaneItem_AddYourGabaritTo_AsyncWorker(
MbPlaneItem * _underlying,            Napi::Promise::Deferred const &d,
                                 MbRect & rect);
      ...
      private:
MbPlaneItem * _underlying;                         MbRect & rect;
  ...
  class PlaneItem_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          PlaneItem_GetUseCount_AsyncWorker(
MbPlaneItem * _underlying,            Napi::Promise::Deferred const &d);
