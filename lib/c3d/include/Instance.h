...
MbInstance * _underlying;
  ...
  class Instance_CreateMesh_AsyncWorker : public PromiseWorker {
      public:
          Instance_CreateMesh_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbInstance * _underlying;                        const MbStepData & stepData;
                        const MbFormNote & note;
                         MbRegDuplicate * iReg= NULL;
  ...
  class Instance_CalculateMesh_AsyncWorker : public PromiseWorker {
      public:
          Instance_CalculateMesh_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
                                const MbStepData & stepData,
                                const MbFormNote & note);
...
MbInstance * _underlying;                        const MbStepData & stepData;
  ...
  class Instance_GetItemName_AsyncWorker : public PromiseWorker {
      public:
          Instance_GetItemName_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d);
...
MbInstance * _underlying;
  ...
  class Instance_SetItemName_AsyncWorker : public PromiseWorker {
      public:
          Instance_SetItemName_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
                                 SimpleName  name);
      ...
      private:
MbInstance * _underlying;                         SimpleName  name;
  ...
  class Instance_RebuildItem_AsyncWorker : public PromiseWorker {
      public:
          Instance_RebuildItem_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbInstance * _underlying;                         MbeCopyMode  sameShell;
                         ProgressIndicator * progInd= NULL;
  ...
  class Instance_GetItemByPath_AsyncWorker : public PromiseWorker {
      public:
          Instance_GetItemByPath_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
                                const MbPath & path,
                                 size_t  ind,
                                 MbMatrix3D & from,
      ...
      private:
MbInstance * _underlying;                        const MbPath & path;
                         size_t  ind;
                         MbMatrix3D & from;
                         size_t  currInd= 0;
...
MbInstance * _underlying;
  ...
  class Instance_Transform_AsyncWorker : public PromiseWorker {
      public:
          Instance_Transform_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbInstance * _underlying;                        const MbMatrix3D & mat;
                         MbRegTransform * iReg= NULL;
...
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbInstance * _underlying;                        const MbVector3D & v;
                         MbRegTransform * iReg= NULL;
...
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbInstance * _underlying;                        const MbAxis3D & axis;
                         double  angle;
                         MbRegTransform * iReg= NULL;
...
MbInstance * _underlying;
  ...
  class Instance_Duplicate_AsyncWorker : public PromiseWorker {
      public:
          Instance_Duplicate_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
                                 MbRegDuplicate * iReg = NULL);
      ...
      private:
MbInstance * _underlying;                         MbRegDuplicate * iReg= NULL;
  ...
  class Instance_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          Instance_AddYourGabaritTo_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
                                 MbCube & cube);
      ...
      private:
MbInstance * _underlying;                         MbCube & cube;
  ...
  class Instance_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          Instance_GetUseCount_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d);
...
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbInstance * _underlying;                         uint32  c;
...
MbInstance * _underlying;
  ...
  class Instance_AttributesConvert_AsyncWorker : public PromiseWorker {
      public:
          Instance_AttributesConvert_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
                                 MbGrid & other);
      ...
      private:
MbInstance * _underlying;                         MbGrid & other;
  ...
  class Instance_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          Instance_GetCreatorsCount_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d);
...
MbInstance * _underlying;
  ...
  class Instance_GetCreator_AsyncWorker : public PromiseWorker {
      public:
          Instance_GetCreator_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
      ...
      private:
MbInstance * _underlying;                         size_t  ind;
  ...
  class Instance_SetCreator_AsyncWorker : public PromiseWorker {
      public:
          Instance_SetCreator_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
...
MbInstance * _underlying;                         size_t  ind;
  ...
  class Instance_DetachCreator_AsyncWorker : public PromiseWorker {
      public:
          Instance_DetachCreator_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
...
MbInstance * _underlying;                         size_t  ind;
  ...
  class Instance_AddCreator_AsyncWorker : public PromiseWorker {
      public:
          Instance_AddCreator_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbInstance * _underlying;                        const MbCreator * creator;
                         bool  addSame= false;
  ...
  class Instance_GetCreators_AsyncWorker : public PromiseWorker {
      public:
          Instance_GetCreators_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d);
...
MbInstance * _underlying;
  ...
  class Instance_DeleteCreator_AsyncWorker : public PromiseWorker {
      public:
          Instance_DeleteCreator_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
...
MbInstance * _underlying;                         size_t  ind;
  ...
  class Instance_GetActiveCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          Instance_GetActiveCreatorsCount_AsyncWorker(
MbInstance * _underlying,            Napi::Promise::Deferred const &d);
