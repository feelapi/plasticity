...
{
  public:
    Item_CreateMesh_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, const MbStepData &stepData,
...
{
  public:
    Item_CalculateMesh_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, const MbStepData &stepData,
                                   const MbFormNote &note);
...
{
  public:
    Item_GetItemName_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Item_SetItemName_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, SimpleName name);
...
{
  public:
    Item_RebuildItem_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, MbeCopyMode sameShell,
...
{
  public:
    Item_GetItemByPath_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, const MbPath &path,
...
{
  public:
    Item_IsA_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Item_Type_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Item_Family_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Item_Transform_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, const MbMatrix3D &mat,
...
{
  public:
    Item_Move_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, const MbVector3D &v,
                          MbRegTransform *iReg = NULL);
...
{
  public:
    Item_Rotate_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, const MbAxis3D &axis, double angle,
                            MbRegTransform *iReg = NULL);
...
{
  public:
    Item_Refresh_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Item_Duplicate_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, MbRegDuplicate *iReg = NULL);
...
{
  public:
    Item_AddYourGabaritTo_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, MbCube &cube);
...
{
  public:
    Item_GetUseCount_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Item_AddRef_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Item_SetStyle_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, int s);
...
{
  public:
    Item_GetStyle_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Item_SetColor_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, uint32 c);
...
{
  public:
    Item_GetColor_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Item_AttributesConvert_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, MbGrid &other);
...
{
  public:
    Item_GetCreatorsCount_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Item_GetCreator_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    Item_SetCreator_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    Item_DetachCreator_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    Item_AddCreator_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, const MbCreator *creator,
                                bool addSame = false);
...
{
  public:
    Item_GetCreators_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Item_DeleteCreator_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    Item_GetActiveCreatorsCount_AsyncWorker(MbItem *_underlying, Napi::Promise::Deferred const &d);
