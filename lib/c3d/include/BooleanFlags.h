...
class BooleanFlags : public Napi::ObjectWrap<BooleanFlags>
{
  public:
...
{
  public:
    BooleanFlags_InitBoolean_AsyncWorker(MbBooleanFlags *_underlying, Napi::Promise::Deferred const &d, bool _closed,
...
{
  public:
    BooleanFlags_InitCutting_AsyncWorker(MbBooleanFlags *_underlying, Napi::Promise::Deferred const &d, bool _closed,
                                         bool _allowNonIntersecting = false);
...
{
  public:
    BooleanFlags_SetMergingFaces_AsyncWorker(MbBooleanFlags *_underlying, Napi::Promise::Deferred const &d, bool s);
...
{
  public:
    BooleanFlags_SetMergingEdges_AsyncWorker(MbBooleanFlags *_underlying, Napi::Promise::Deferred const &d, bool s);
