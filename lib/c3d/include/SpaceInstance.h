...
class SpaceInstance : public Napi::ObjectWrap<SpaceInstance>
{
  public:
...
{
  public:
    SpaceInstance_GetSpaceItem_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SpaceInstance_GetBasisPoints_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SpaceInstance_SetBasisPoints_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    SpaceInstance_CreateMesh_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    SpaceInstance_CalculateMesh_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d,
                                            const MbStepData &stepData, const MbFormNote &note);
...
{
  public:
    SpaceInstance_GetItemName_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SpaceInstance_SetItemName_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d,
                                          SimpleName name);
...
{
  public:
    SpaceInstance_RebuildItem_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    SpaceInstance_GetItemByPath_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    SpaceInstance_IsA_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SpaceInstance_Type_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SpaceInstance_Family_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SpaceInstance_Transform_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    SpaceInstance_Move_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d, const MbVector3D &v,
                                   MbRegTransform *iReg = NULL);
...
{
  public:
    SpaceInstance_Rotate_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    SpaceInstance_Refresh_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SpaceInstance_Duplicate_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d,
                                        MbRegDuplicate *iReg = NULL);
...
{
  public:
    SpaceInstance_AddYourGabaritTo_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d,
                                               MbCube &cube);
...
{
  public:
    SpaceInstance_GetUseCount_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SpaceInstance_AddRef_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SpaceInstance_SetStyle_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d, int s);
...
{
  public:
    SpaceInstance_GetStyle_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SpaceInstance_SetColor_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d, uint32 c);
...
{
  public:
    SpaceInstance_GetColor_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SpaceInstance_AttributesConvert_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d,
                                                MbGrid &other);
...
{
  public:
    SpaceInstance_GetCreatorsCount_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SpaceInstance_GetCreator_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    SpaceInstance_SetCreator_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    SpaceInstance_DetachCreator_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    SpaceInstance_AddCreator_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    SpaceInstance_GetCreators_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SpaceInstance_DeleteCreator_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    SpaceInstance_GetActiveCreatorsCount_AsyncWorker(MbSpaceInstance *_underlying, Napi::Promise::Deferred const &d);
