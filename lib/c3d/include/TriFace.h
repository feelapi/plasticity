...
class TriFace : public Napi::ObjectWrap<TriFace>
{
  public:
...
{
  public:
    TriFace_CalculateGrid_AsyncWorker(Napi::Promise::Deferred const &d, const MbFace &face, const MbStepData &stepData,
                                      MbGrid &grid, bool dualSeams = true, bool quad = false, bool fair = false);
