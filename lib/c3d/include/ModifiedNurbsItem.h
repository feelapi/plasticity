...
class ModifiedNurbsItem : public
  Napi::ObjectWrap<ModifiedNurbsItem>
{
  public:
  ...
  class ModifiedNurbsItem_IsA_AsyncWorker : public PromiseWorker {
      public:
          ModifiedNurbsItem_IsA_AsyncWorker(
...
MbModifiedNurbsItem * _underlying;
  ...
  class ModifiedNurbsItem_Type_AsyncWorker : public PromiseWorker {
      public:
          ModifiedNurbsItem_Type_AsyncWorker(
MbModifiedNurbsItem * _underlying,            Napi::Promise::Deferred const &d);
...
MbModifiedNurbsItem * _underlying;
  ...
  class ModifiedNurbsItem_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          ModifiedNurbsItem_GetBasisPoints_AsyncWorker(
MbModifiedNurbsItem * _underlying,            Napi::Promise::Deferred const &d);
...
MbModifiedNurbsItem * _underlying;
  ...
  class ModifiedNurbsItem_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          ModifiedNurbsItem_SetBasisPoints_AsyncWorker(
MbModifiedNurbsItem * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbModifiedNurbsItem * _underlying;                        const MbControlData3D & cd;
  ...
  class ModifiedNurbsItem_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          ModifiedNurbsItem_GetBasisItems_AsyncWorker(
MbModifiedNurbsItem * _underlying,            Napi::Promise::Deferred const &d);
...
MbModifiedNurbsItem * _underlying;
  ...
  class ModifiedNurbsItem_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          ModifiedNurbsItem_GetCreatorsCount_AsyncWorker(
MbModifiedNurbsItem * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbModifiedNurbsItem * _underlying;                         MbeCreatorType  ct;
  ...
  class ModifiedNurbsItem_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          ModifiedNurbsItem_GetYourNameMaker_AsyncWorker(
MbModifiedNurbsItem * _underlying,            Napi::Promise::Deferred const &d);
...
MbModifiedNurbsItem * _underlying;
  ...
  class ModifiedNurbsItem_GetStatus_AsyncWorker : public PromiseWorker {
      public:
          ModifiedNurbsItem_GetStatus_AsyncWorker(
MbModifiedNurbsItem * _underlying,            Napi::Promise::Deferred const &d);
...
MbModifiedNurbsItem * _underlying;
  ...
  class ModifiedNurbsItem_SetStatus_AsyncWorker : public PromiseWorker {
      public:
          ModifiedNurbsItem_SetStatus_AsyncWorker(
MbModifiedNurbsItem * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeProcessState  l);
      ...
      private:
MbModifiedNurbsItem * _underlying;                         MbeProcessState  l;
  ...
  class ModifiedNurbsItem_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          ModifiedNurbsItem_CreateShell_AsyncWorker(
MbModifiedNurbsItem * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbModifiedNurbsItem * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class ModifiedNurbsItem_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          ModifiedNurbsItem_GetMainName_AsyncWorker(
MbModifiedNurbsItem * _underlying,            Napi::Promise::Deferred const &d);
...
MbModifiedNurbsItem * _underlying;
  ...
  class ModifiedNurbsItem_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          ModifiedNurbsItem_GetUseCount_AsyncWorker(
MbModifiedNurbsItem * _underlying,            Napi::Promise::Deferred const &d);
...
MbModifiedNurbsItem * _underlying;
  ...
  class ModifiedNurbsItem_AddRef_AsyncWorker : public PromiseWorker {
      public:
          ModifiedNurbsItem_AddRef_AsyncWorker(
MbModifiedNurbsItem * _underlying,            Napi::Promise::Deferred const &d);
