...
class Placement3D : public
  Napi::ObjectWrap<Placement3D>
{
  public:
  ...
  class Placement3D_InitYZ_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_InitYZ_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPlacement3D * _underlying;                        const MbCartPoint3D & p;
                        const MbVector3D & axisY;
                        const MbVector3D & axisZ;
...
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPlacement3D * _underlying;                        const MbVector3D & to;
  ...
  class Placement3D_Rotate_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_Rotate_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d,
                                const MbAxis3D & axis,
                                 double  angle);
      ...
      private:
MbPlacement3D * _underlying;                        const MbAxis3D & axis;
                         double  angle;
...
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPlacement3D * _underlying;                         double  sx;
                         double  sy;
                         double  sz;
  ...
  class Placement3D_SetAxisX_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_SetAxisX_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d,
                                const MbVector3D & a);
      ...
      private:
MbPlacement3D * _underlying;                        const MbVector3D & a;
  ...
  class Placement3D_SetAxisY_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_SetAxisY_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d,
                                const MbVector3D & a);
...
MbPlacement3D * _underlying;                        const MbVector3D & a;
  ...
  class Placement3D_SetAxisZ_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_SetAxisZ_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d,
                                const MbVector3D & a);
...
MbPlacement3D * _underlying;                        const MbVector3D & a;
  ...
  class Placement3D_GetOrigin_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_GetOrigin_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbPlacement3D * _underlying;
  ...
  class Placement3D_SetOrigin_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_SetOrigin_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPlacement3D * _underlying;                        const MbCartPoint3D & o;
  ...
  class Placement3D_GetAxisZ_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_GetAxisZ_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbPlacement3D * _underlying;
  ...
  class Placement3D_GetAxisY_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_GetAxisY_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbPlacement3D * _underlying;
  ...
  class Placement3D_GetAxisX_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_GetAxisX_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbPlacement3D * _underlying;
  ...
  class Placement3D_Normalize_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_Normalize_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbPlacement3D * _underlying;
  ...
  class Placement3D_Invert_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_Invert_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbPlacement3D * _underlying;
  ...
  class Placement3D_GetXEpsilon_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_GetXEpsilon_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbPlacement3D * _underlying;
  ...
  class Placement3D_GetYEpsilon_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_GetYEpsilon_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbPlacement3D * _underlying;
  ...
  class Placement3D_PointProjection_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_PointProjection_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d,
                                const MbCartPoint3D & p);
...
MbPlacement3D * _underlying;                        const MbCartPoint3D & p;
  ...
  class Placement3D_PointRelative_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_PointRelative_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPlacement3D * _underlying;                        const MbCartPoint3D & pnt;
                         double  eps= Math::angleRegion;
  ...
  class Placement3D_GetMatrixToPlace_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_GetMatrixToPlace_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPlacement3D * _underlying;                        const MbPlacement3D & p;
                         double  eps= Math::angleRegion;
  ...
  class Placement3D_GetVectorFrom_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_GetVectorFrom_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d,
                                 double  x1,
                                 double  y1,
                                 double  z1,
      ...
      private:
MbPlacement3D * _underlying;                         double  x1;
                         double  y1;
                         double  z1;
                         MbeLocalSystemType3D  type= ls_CartesianSystem;
  ...
  class Placement3D_GetPointFrom_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_GetPointFrom_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d,
                                 double  x1,
                                 double  y1,
                                 double  z1,
...
MbPlacement3D * _underlying;                         double  x1;
  ...
  class Placement3D_GetPointInto_AsyncWorker : public PromiseWorker {
      public:
          Placement3D_GetPointInto_AsyncWorker(
MbPlacement3D * _underlying,            Napi::Promise::Deferred const &d,
                                 MbCartPoint3D & p,
                                 MbeLocalSystemType3D  type = ls_CartesianSystem);
      ...
      private:
MbPlacement3D * _underlying;                         MbCartPoint3D & p;
                         MbeLocalSystemType3D  type= ls_CartesianSystem;
