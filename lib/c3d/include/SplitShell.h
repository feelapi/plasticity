...
class SplitShell : public Napi::ObjectWrap<SplitShell>
{
  public:
...
{
  public:
    SplitShell_IsA_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SplitShell_Type_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SplitShell_GetBasisPoints_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SplitShell_SetBasisPoints_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    SplitShell_GetBasisItems_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SplitShell_GetCreatorsCount_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d,
                                            MbeCreatorType ct);
...
{
  public:
    SplitShell_GetYourNameMaker_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SplitShell_GetStatus_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SplitShell_SetStatus_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d, MbeProcessState l);
...
{
  public:
    SplitShell_CreateShell_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d, MbFaceShell *shell,
...
{
  public:
    SplitShell_GetMainName_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SplitShell_GetUseCount_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    SplitShell_AddRef_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d);
