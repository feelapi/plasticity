...
class Spiral : public Napi::ObjectWrap<Spiral>
{
  public:
...
{
  public:
    Spiral_GetPlaneCurve_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d, bool saveParams,
...
{
  public:
    Spiral_IsPlanar_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Spiral_IsClosed_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_IsTouch_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_GetTMax_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_GetTMin_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_GetPeriod_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_IsPeriodic_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_IsStraight_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d, bool ignoreParams = false);
...
{
  public:
    Spiral_Trimmed_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d, double t1, double t2,
                               int sense);
...
{
  public:
    Spiral_Normal_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Spiral_Tangent_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Spiral_BNormal_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Spiral_GetCentre_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_GetLimitPoint_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d, ptrdiff_t number);
...
{
  public:
    Spiral_PointOn_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Spiral__PointOn_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Spiral_NearPointProjection_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Spiral_GetSurfaceCurve_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Spiral_GetWeightCentre_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_GetBasisCurve_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_GetBasisPoints_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_SetBasisPoints_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Spiral_Inverse_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_GetProjection_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Spiral_GetCircleAxis_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_IsA_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_Type_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_Family_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_Transform_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d, const MbMatrix3D &mat,
...
{
  public:
    Spiral_Move_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d, const MbVector3D &v,
                            MbRegTransform *iReg = NULL);
...
{
  public:
    Spiral_Rotate_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d, const MbAxis3D &axis,
...
{
  public:
    Spiral_Refresh_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_Duplicate_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d, MbRegDuplicate *iReg = NULL);
...
{
  public:
    Spiral_AddYourGabaritTo_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d, MbCube &cube);
...
{
  public:
    Spiral_GetUseCount_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Spiral_AddRef_AsyncWorker(MbSpiral *_underlying, Napi::Promise::Deferred const &d);
