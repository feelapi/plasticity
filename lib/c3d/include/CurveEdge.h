...
class CurveEdge : public Napi::ObjectWrap<CurveEdge>
{
  public:
...
{
  public:
    CurveEdge_EdgeNormal_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d, double t);
...
{
  public:
    CurveEdge_GetIntersectionCurve_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_GetFacePlus_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_GetFaceMinus_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_IsSplit_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d, bool strict = false);
...
{
  public:
    CurveEdge_GetSpaceCurve_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_MakeCurve_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_IsSmooth_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_IsSeam_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_IsPole_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_FaceNormal_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d, double t, bool plus);
...
{
  public:
    CurveEdge_VertexNormal_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d, bool begin);
...
{
  public:
    CurveEdge_GetProlongEdges_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_FindOrientedEdge_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d, bool orient);
...
{
  public:
    CurveEdge_FindOrientedEdgePlus_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_FindOrientedEdgeMinus_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_Point_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d, double t);
...
{
  public:
    CurveEdge_GetBegPoint_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_GetEndPoint_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_PointProjection_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    CurveEdge_Reverse_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_Tangent_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d, double t);
...
{
  public:
    CurveEdge_GetBegTangent_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_GetEndTangent_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_IsA_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_GetName_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_GetMainName_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_GetFirstName_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_GetNameHash_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_AddYourGabaritTo_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d, MbCube &cube);
...
{
  public:
    CurveEdge_CalculateMesh_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    CurveEdge_GetOwnChanged_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_GetUseCount_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_AddRef_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_SetStyle_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d, int s);
...
{
  public:
    CurveEdge_GetStyle_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_SetColor_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d, uint32 c);
...
{
  public:
    CurveEdge_GetColor_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CurveEdge_AttributesConvert_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d, MbGrid &other);
