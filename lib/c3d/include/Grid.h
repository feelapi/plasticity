...
MbGrid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbGrid * _underlying;                        const MbStepData & stData;
  ...
  class Grid_IsSearchTreeReady_AsyncWorker : public PromiseWorker {
      public:
          Grid_IsSearchTreeReady_AsyncWorker(
MbGrid * _underlying,            Napi::Promise::Deferred const &d);
...
MbGrid * _underlying;
  ...
  class Grid_CreateSearchTree_AsyncWorker : public PromiseWorker {
      public:
          Grid_CreateSearchTree_AsyncWorker(
MbGrid * _underlying,            Napi::Promise::Deferred const &d);
...
MbGrid * _underlying;
  ...
  class Grid_DeleteSearchTree_AsyncWorker : public PromiseWorker {
      public:
          Grid_DeleteSearchTree_AsyncWorker(
MbGrid * _underlying,            Napi::Promise::Deferred const &d);
...
MbGrid * _underlying;
  ...
  class Grid_CreateGridTopology_AsyncWorker : public PromiseWorker {
      public:
          Grid_CreateGridTopology_AsyncWorker(
MbGrid * _underlying,            Napi::Promise::Deferred const &d,
                                 bool  keepExisting);
      ...
      private:
MbGrid * _underlying;                         bool  keepExisting;
  ...
  class Grid_IsGridTopologyReady_AsyncWorker : public PromiseWorker {
      public:
          Grid_IsGridTopologyReady_AsyncWorker(
MbGrid * _underlying,            Napi::Promise::Deferred const &d);
...
MbGrid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbGrid * _underlying;                        const MbRefItem * g;
  ...
  class Grid_SetPrimitiveName_AsyncWorker : public PromiseWorker {
      public:
          Grid_SetPrimitiveName_AsyncWorker(
MbGrid * _underlying,            Napi::Promise::Deferred const &d,
                                 SimpleName  n);
      ...
      private:
MbGrid * _underlying;                         SimpleName  n;
  ...
  class Grid_SetPrimitiveType_AsyncWorker : public PromiseWorker {
      public:
          Grid_SetPrimitiveType_AsyncWorker(
MbGrid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeRefType  t);
      ...
      private:
MbGrid * _underlying;                         MbeRefType  t;
...
MbGrid * _underlying;
  ...
  class Grid_AttributesConvert_AsyncWorker : public PromiseWorker {
      public:
          Grid_AttributesConvert_AsyncWorker(
MbGrid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbGrid & other);
      ...
      private:
MbGrid * _underlying;                         MbGrid & other;
