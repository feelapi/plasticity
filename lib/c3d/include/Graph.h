...
{
  public:
    Graph_GetLoopsCount_AsyncWorker(MpGraph *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Graph_GetUsedCurves_AsyncWorker(MpGraph *_underlying, Napi::Promise::Deferred const &d,
