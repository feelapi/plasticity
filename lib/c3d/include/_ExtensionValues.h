...
class _ExtensionValues : public
  Napi::ObjectWrap<_ExtensionValues>
{
  public:
  ...
  class _ExtensionValues_InitByDistance_AsyncWorker : public PromiseWorker {
      public:
          _ExtensionValues_InitByDistance_AsyncWorker(
ExtensionValues * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
ExtensionValues * _underlying;                         ExtensionValues::ExtensionType  t;
                         ExtensionValues::LateralKind  k;
                        const MbVector3D & v;
                         double  dist;
  ...
  class _ExtensionValues_InitByVertex_AsyncWorker : public PromiseWorker {
      public:
          _ExtensionValues_InitByVertex_AsyncWorker(
ExtensionValues * _underlying,            Napi::Promise::Deferred const &d,
                                 ExtensionValues::ExtensionType  t,
                                 ExtensionValues::LateralKind  k,
...
ExtensionValues * _underlying;                         ExtensionValues::ExtensionType  t;
  ...
  class _ExtensionValues_InitByShell_AsyncWorker : public PromiseWorker {
      public:
          _ExtensionValues_InitByShell_AsyncWorker(
ExtensionValues * _underlying,            Napi::Promise::Deferred const &d,
                                 ExtensionValues::ExtensionType  t,
                                 ExtensionValues::LateralKind  k,
                                const MbFace * f,
