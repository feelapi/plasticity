...
class RegDuplicate : public Napi::ObjectWrap<RegDuplicate>
{
  public:
...
{
  public:
    RegDuplicate_IsReg_AsyncWorker(MbRegDuplicate *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    RegDuplicate_SetReg_AsyncWorker(MbRegDuplicate *_underlying, Napi::Promise::Deferred const &d,
