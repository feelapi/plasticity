...
{
  public:
    Polyline_GetPointsCount_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polyline_GetPoint_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, ptrdiff_t index);
...
{
  public:
    Polyline_AddPoint_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, const MbCartPoint &pnt);
...
{
  public:
    Polyline_Inverse_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Polyline_Trimmed_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, double t1, double t2,
                                 int sense);
...
{
  public:
    Polyline_IsStraight_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Polyline_IsClosed_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polyline_IsBounded_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polyline_GetTMax_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polyline_GetTMin_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polyline_GetPeriod_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polyline_GetWeightCentre_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polyline_GetLimitPoint_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, ptrdiff_t number);
...
{
  public:
    Polyline_PointOn_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Polyline__PointOn_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Polyline_Explore_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, double &t, bool ext);
...
{
  public:
    Polyline_FirstDer_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Polyline__FirstDer_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Polyline_SecondDer_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Polyline__SecondDer_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Polyline_Tangent_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Polyline__Tangent_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Polyline_Normal_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Polyline__Normal_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Polyline_PointRelative_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Polyline_PointLocation_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d,
                                       const MbCartPoint &pnt, double eps);
...
{
  public:
    Polyline_IsA_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polyline_Type_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polyline_Family_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polyline_Move_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, const MbVector &to,
                              MbRegTransform *iReg = NULL);
...
{
  public:
    Polyline_Transform_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, const MbMatrix &matr,
...
{
  public:
    Polyline_Duplicate_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Polyline_AddYourGabaritTo_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d, MbRect &rect);
...
{
  public:
    Polyline_GetUseCount_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Polyline_AddRef_AsyncWorker(MbPolyline *_underlying, Napi::Promise::Deferred const &d);
