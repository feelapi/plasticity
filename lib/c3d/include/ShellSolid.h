...
class ShellSolid : public
  Napi::ObjectWrap<ShellSolid>
{
  public:
...
MbShellSolid * _underlying;
  ...
  class ShellSolid_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          ShellSolid_GetBasisPoints_AsyncWorker(
MbShellSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbShellSolid * _underlying;
  ...
  class ShellSolid_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          ShellSolid_SetBasisPoints_AsyncWorker(
MbShellSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbShellSolid * _underlying;                        const MbControlData3D & cd;
  ...
  class ShellSolid_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          ShellSolid_GetBasisItems_AsyncWorker(
MbShellSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbShellSolid * _underlying;
  ...
  class ShellSolid_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          ShellSolid_GetCreatorsCount_AsyncWorker(
MbShellSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbShellSolid * _underlying;                         MbeCreatorType  ct;
  ...
  class ShellSolid_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          ShellSolid_GetYourNameMaker_AsyncWorker(
MbShellSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbShellSolid * _underlying;
  ...
  class ShellSolid_GetStatus_AsyncWorker : public PromiseWorker {
      public:
          ShellSolid_GetStatus_AsyncWorker(
MbShellSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbShellSolid * _underlying;
  ...
  class ShellSolid_SetStatus_AsyncWorker : public PromiseWorker {
      public:
          ShellSolid_SetStatus_AsyncWorker(
MbShellSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeProcessState  l);
      ...
      private:
MbShellSolid * _underlying;                         MbeProcessState  l;
  ...
  class ShellSolid_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          ShellSolid_CreateShell_AsyncWorker(
MbShellSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbShellSolid * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class ShellSolid_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          ShellSolid_GetMainName_AsyncWorker(
MbShellSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbShellSolid * _underlying;
  ...
  class ShellSolid_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          ShellSolid_GetUseCount_AsyncWorker(
MbShellSolid * _underlying,            Napi::Promise::Deferred const &d);
