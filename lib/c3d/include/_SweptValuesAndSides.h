...
class _SweptValuesAndSides : public
  Napi::ObjectWrap<_SweptValuesAndSides>
{
  public:
  ...
  class _SweptValuesAndSides_CheckSelfInt_AsyncWorker : public PromiseWorker {
      public:
          _SweptValuesAndSides_CheckSelfInt_AsyncWorker(
...
SweptValuesAndSides  _underlying;
  ...
  class _SweptValuesAndSides_SetCheckSelfInt_AsyncWorker : public PromiseWorker {
      public:
          _SweptValuesAndSides_SetCheckSelfInt_AsyncWorker(
SweptValuesAndSides  _underlying,            Napi::Promise::Deferred const &d,
                                 bool  c);
      ...
      private:
SweptValuesAndSides  _underlying;                         bool  c;
