  ...
  Napi::ObjectWrap<Arc3D>
{
  ...
  class Arc3D_SetLimitPoint_AsyncWorker : public PromiseWorker {
      public:
          Arc3D_SetLimitPoint_AsyncWorker(
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbArc3D * _underlying;                         ptrdiff_t  number;
                        const MbCartPoint3D & pnt;
...
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbArc3D * _underlying;                         double  ang;
...
MbArc3D * _underlying;
  ...
  class Arc3D_GetPlaneCurve_AsyncWorker : public PromiseWorker {
      public:
          Arc3D_GetPlaneCurve_AsyncWorker(
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
                                 bool  saveParams,
      ...
      private:
MbArc3D * _underlying;                         bool  saveParams;
                         PlanarCheckParams  params= PlanarCheckParams();
...
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbArc3D * _underlying;                         double  accuracy= METRIC_EPSILON;
...
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbArc3D * _underlying;                         bool  ignoreParams= false;
...
MbArc3D * _underlying;
  ...
  class Arc3D_GetLimitPoint_AsyncWorker : public PromiseWorker {
      public:
          Arc3D_GetLimitPoint_AsyncWorker(
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
                                 ptrdiff_t  number);
...
MbArc3D * _underlying;                         double & t;
  ...
  class Arc3D_NearPointProjection_AsyncWorker : public PromiseWorker {
      public:
          Arc3D_NearPointProjection_AsyncWorker(
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
                                const MbCartPoint3D & pnt,
                                 bool  ext,
      ...
      private:
MbArc3D * _underlying;                        const MbCartPoint3D & pnt;
                         bool  ext;
                         MbRect1D * tRange= NULL;
  ...
  class Arc3D_GetSurfaceCurve_AsyncWorker : public PromiseWorker {
      public:
          Arc3D_GetSurfaceCurve_AsyncWorker(
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbArc3D * _underlying;                         VERSION  version= Math::DefaultMathVersion();
  ...
  class Arc3D_GetWeightCentre_AsyncWorker : public PromiseWorker {
      public:
          Arc3D_GetWeightCentre_AsyncWorker(
MbArc3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbArc3D * _underlying;
  ...
  class Arc3D_GetBasisCurve_AsyncWorker : public PromiseWorker {
      public:
          Arc3D_GetBasisCurve_AsyncWorker(
MbArc3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbArc3D * _underlying;
  ...
  class Arc3D_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          Arc3D_GetBasisPoints_AsyncWorker(
MbArc3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbArc3D * _underlying;
  ...
  class Arc3D_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          Arc3D_SetBasisPoints_AsyncWorker(
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbArc3D * _underlying;                        const MbControlData3D & cd;
...
MbArc3D * _underlying;
  ...
  class Arc3D_GetProjection_AsyncWorker : public PromiseWorker {
      public:
          Arc3D_GetProjection_AsyncWorker(
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbArc3D * _underlying;                        const MbPlacement3D & place;
                         VERSION  version= Math::DefaultMathVersion();
  ...
  class Arc3D_GetCircleAxis_AsyncWorker : public PromiseWorker {
      public:
          Arc3D_GetCircleAxis_AsyncWorker(
MbArc3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbArc3D * _underlying;                        const MbMatrix3D & mat;
                         MbRegTransform * iReg= NULL;
...
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbArc3D * _underlying;                        const MbVector3D & v;
                         MbRegTransform * iReg= NULL;
...
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbArc3D * _underlying;                        const MbAxis3D & axis;
                         double  angle;
                         MbRegTransform * iReg= NULL;
...
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbArc3D * _underlying;                         MbRegDuplicate * iReg= NULL;
  ...
  class Arc3D_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          Arc3D_AddYourGabaritTo_AsyncWorker(
MbArc3D * _underlying,            Napi::Promise::Deferred const &d,
                                 MbCube & cube);
      ...
      private:
MbArc3D * _underlying;                         MbCube & cube;
