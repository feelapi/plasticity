...
MbCurve * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbCurve * _underlying;                         MbRegTransform * iReg= NULL;
...
MbCurve * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbCurve * _underlying;                         bool  ignoreParams= false;
...
MbCurve * _underlying;
  ...
  class Curve_GetWeightCentre_AsyncWorker : public PromiseWorker {
      public:
          Curve_GetWeightCentre_AsyncWorker(
MbCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurve * _underlying;
  ...
  class Curve_GetLimitPoint_AsyncWorker : public PromiseWorker {
      public:
          Curve_GetLimitPoint_AsyncWorker(
MbCurve * _underlying,            Napi::Promise::Deferred const &d,
                                 ptrdiff_t  number);
      ...
      private:
MbCurve * _underlying;                         ptrdiff_t  number;
...
MbCurve * _underlying;                         double & t;
  ...
  class Curve_PointRelative_AsyncWorker : public PromiseWorker {
      public:
          Curve_PointRelative_AsyncWorker(
MbCurve * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbCurve * _underlying;                        const MbCartPoint & pnt;
                         double  eps;
  ...
  class Curve_PointLocation_AsyncWorker : public PromiseWorker {
      public:
          Curve_PointLocation_AsyncWorker(
MbCurve * _underlying,            Napi::Promise::Deferred const &d,
                                const MbCartPoint & pnt,
                                 double  eps);
...
MbCurve * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbCurve * _underlying;                        const MbVector & to;
                         MbRegTransform * iReg= NULL;
...
MbCurve * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbCurve * _underlying;                        const MbMatrix & matr;
                         MbRegTransform * iReg= NULL;
                        const MbSurface * newSurface= NULL;
...
MbCurve * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbCurve * _underlying;                         MbRegDuplicate * dup= NULL;
  ...
  class Curve_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          Curve_AddYourGabaritTo_AsyncWorker(
MbCurve * _underlying,            Napi::Promise::Deferred const &d,
                                 MbRect & rect);
      ...
      private:
MbCurve * _underlying;                         MbRect & rect;
