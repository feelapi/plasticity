...
class ShellHistory : public
  Napi::ObjectWrap<ShellHistory>
{
  public:
  ...
  class ShellHistory_InitOrigins_AsyncWorker : public PromiseWorker {
      public:
          ShellHistory_InitOrigins_AsyncWorker(
MbShellHistory * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbShellHistory * _underlying;                        const RPArray<MbFace> & origin;
  ...
  class ShellHistory_SetOrigins_AsyncWorker : public PromiseWorker {
      public:
          ShellHistory_SetOrigins_AsyncWorker(
MbShellHistory * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell & shell);
      ...
      private:
MbShellHistory * _underlying;                         MbFaceShell & shell;
  ...
  class ShellHistory_SetOriginFaces_AsyncWorker : public PromiseWorker {
      public:
          ShellHistory_SetOriginFaces_AsyncWorker(
MbShellHistory * _underlying,            Napi::Promise::Deferred const &d);
...
MbShellHistory * _underlying;
  ...
  class ShellHistory_SetCopyFaces_AsyncWorker : public PromiseWorker {
      public:
          ShellHistory_SetCopyFaces_AsyncWorker(
MbShellHistory * _underlying,            Napi::Promise::Deferred const &d);
