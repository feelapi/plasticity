...
class ExtensionShell : public
  Napi::ObjectWrap<ExtensionShell>
{
  public:
  ...
  class ExtensionShell_IsA_AsyncWorker : public PromiseWorker {
      public:
          ExtensionShell_IsA_AsyncWorker(
...
MbExtensionShell * _underlying;
  ...
  class ExtensionShell_Type_AsyncWorker : public PromiseWorker {
      public:
          ExtensionShell_Type_AsyncWorker(
MbExtensionShell * _underlying,            Napi::Promise::Deferred const &d);
...
MbExtensionShell * _underlying;
  ...
  class ExtensionShell_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          ExtensionShell_GetBasisPoints_AsyncWorker(
MbExtensionShell * _underlying,            Napi::Promise::Deferred const &d);
...
MbExtensionShell * _underlying;
  ...
  class ExtensionShell_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          ExtensionShell_SetBasisPoints_AsyncWorker(
MbExtensionShell * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbExtensionShell * _underlying;                        const MbControlData3D & cd;
  ...
  class ExtensionShell_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          ExtensionShell_GetBasisItems_AsyncWorker(
MbExtensionShell * _underlying,            Napi::Promise::Deferred const &d);
...
MbExtensionShell * _underlying;
  ...
  class ExtensionShell_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          ExtensionShell_GetCreatorsCount_AsyncWorker(
MbExtensionShell * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbExtensionShell * _underlying;                         MbeCreatorType  ct;
  ...
  class ExtensionShell_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          ExtensionShell_GetYourNameMaker_AsyncWorker(
MbExtensionShell * _underlying,            Napi::Promise::Deferred const &d);
...
MbExtensionShell * _underlying;
  ...
  class ExtensionShell_GetStatus_AsyncWorker : public PromiseWorker {
      public:
          ExtensionShell_GetStatus_AsyncWorker(
MbExtensionShell * _underlying,            Napi::Promise::Deferred const &d);
...
MbExtensionShell * _underlying;
  ...
  class ExtensionShell_SetStatus_AsyncWorker : public PromiseWorker {
      public:
          ExtensionShell_SetStatus_AsyncWorker(
MbExtensionShell * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeProcessState  l);
      ...
      private:
MbExtensionShell * _underlying;                         MbeProcessState  l;
  ...
  class ExtensionShell_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          ExtensionShell_CreateShell_AsyncWorker(
MbExtensionShell * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbExtensionShell * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class ExtensionShell_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          ExtensionShell_GetMainName_AsyncWorker(
MbExtensionShell * _underlying,            Napi::Promise::Deferred const &d);
...
MbExtensionShell * _underlying;
  ...
  class ExtensionShell_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          ExtensionShell_GetUseCount_AsyncWorker(
MbExtensionShell * _underlying,            Napi::Promise::Deferred const &d);
...
MbExtensionShell * _underlying;
  ...
  class ExtensionShell_AddRef_AsyncWorker : public PromiseWorker {
      public:
          ExtensionShell_AddRef_AsyncWorker(
MbExtensionShell * _underlying,            Napi::Promise::Deferred const &d);
