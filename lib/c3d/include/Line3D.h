...
class Line3D : public Napi::ObjectWrap<Line3D>
{
  public:
...
{
  public:
    Line3D_GetPlaneCurve_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d, bool saveParams,
...
{
  public:
    Line3D_IsPlanar_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Line3D_IsClosed_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_IsTouch_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_GetTMax_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_GetTMin_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_GetPeriod_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_IsPeriodic_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_IsStraight_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d, bool ignoreParams = false);
...
{
  public:
    Line3D_Trimmed_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d, double t1, double t2,
                               int sense);
...
{
  public:
    Line3D_Normal_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line3D_Tangent_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line3D_BNormal_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line3D_GetCentre_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_GetLimitPoint_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d, ptrdiff_t number);
...
{
  public:
    Line3D_PointOn_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line3D__PointOn_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Line3D_NearPointProjection_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Line3D_GetSurfaceCurve_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Line3D_GetWeightCentre_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_GetBasisCurve_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_GetBasisPoints_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_SetBasisPoints_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Line3D_Inverse_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_GetProjection_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Line3D_GetCircleAxis_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_IsA_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_Type_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_Family_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_Transform_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d, const MbMatrix3D &mat,
...
{
  public:
    Line3D_Move_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d, const MbVector3D &v,
                            MbRegTransform *iReg = NULL);
...
{
  public:
    Line3D_Rotate_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d, const MbAxis3D &axis,
...
{
  public:
    Line3D_Refresh_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_Duplicate_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d, MbRegDuplicate *iReg = NULL);
...
{
  public:
    Line3D_AddYourGabaritTo_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d, MbCube &cube);
...
{
  public:
    Line3D_GetUseCount_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Line3D_AddRef_AsyncWorker(MbLine3D *_underlying, Napi::Promise::Deferred const &d);
