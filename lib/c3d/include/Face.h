  ...
  Napi::ObjectWrap<Face>
{
  ...
  class Face_GetAnyPointOn_AsyncWorker : public PromiseWorker {
      public:
          Face_GetAnyPointOn_AsyncWorker(
...
MbFace * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFace * _underlying;                         double  faceU;
                         double  faceV;
...
MbFace * _underlying;
  ...
  class Face_GetPlanePlacement_AsyncWorker : public PromiseWorker {
      public:
          Face_GetPlanePlacement_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d);
...
MbFace * _underlying;
  ...
  class Face_GetControlPlacement_AsyncWorker : public PromiseWorker {
      public:
          Face_GetControlPlacement_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d);
...
MbFace * _underlying;
  ...
  class Face_GetSurfacePlacement_AsyncWorker : public PromiseWorker {
      public:
          Face_GetSurfacePlacement_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d);
...
MbFace * _underlying;
  ...
  class Face_OrientPlacement_AsyncWorker : public PromiseWorker {
      public:
          Face_OrientPlacement_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d,
                                 MbPlacement3D & result);
      ...
      private:
MbFace * _underlying;                         MbPlacement3D & result;
  ...
  class Face_NearPointProjection_AsyncWorker : public PromiseWorker {
      public:
          Face_NearPointProjection_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFace * _underlying;                        const MbCartPoint3D & point;
...
MbFace * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFace * _underlying;                        const double  surfaceU;
                        const double  surfaceV;
  ...
  class Face_GetSurfaceParam_AsyncWorker : public PromiseWorker {
      public:
          Face_GetSurfaceParam_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d,
                                const double  faceU,
                                const double  faceV);
      ...
      private:
MbFace * _underlying;                        const double  faceU;
                        const double  faceV;
  ...
  class Face_GetOuterEdges_AsyncWorker : public PromiseWorker {
      public:
          Face_GetOuterEdges_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFace * _underlying;                         size_t  mapThreshold= 50;
...
MbFace * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFace * _underlying;                        const MbTopologyItem & other;
                         double  accuracy;
  ...
  class Face_GetNeighborFaces_AsyncWorker : public PromiseWorker {
      public:
          Face_GetNeighborFaces_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d);
...
MbFace * _underlying;
  ...
  class Face_GetBoundaryEdges_AsyncWorker : public PromiseWorker {
      public:
          Face_GetBoundaryEdges_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d);
...
MbFace * _underlying;
  ...
  class Face_GetSurfaceCurvesData_AsyncWorker : public PromiseWorker {
      public:
          Face_GetSurfaceCurvesData_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d);
...
MbFace * _underlying;
  ...
  class Face_HasNeighborFace_AsyncWorker : public PromiseWorker {
      public:
          Face_HasNeighborFace_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d);
...
MbFace * _underlying;
  ...
  class Face_GetLoopsCount_AsyncWorker : public PromiseWorker {
      public:
          Face_GetLoopsCount_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d);
...
MbFace * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFace * _underlying;                         size_t  index;
...
MbFace * _underlying;
  ...
  class Face_DataDuplicate_AsyncWorker : public PromiseWorker {
      public:
          Face_DataDuplicate_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFace * _underlying;                         MbRegDuplicate * dup= NULL;
...
MbFace * _underlying;
  ...
  class Face_GetCylinderAxis_AsyncWorker : public PromiseWorker {
      public:
          Face_GetCylinderAxis_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d);
...
MbFace * _underlying;
  ...
  class Face_UpdateSurfaceBounds_AsyncWorker : public PromiseWorker {
      public:
          Face_UpdateSurfaceBounds_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFace * _underlying;                         bool  curveBoundedOnly= true;
  ...
  class Face_IsOwnChangedItem_AsyncWorker : public PromiseWorker {
      public:
          Face_IsOwnChangedItem_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFace * _underlying;                         bool  checkVertices= false;
...
MbFace * _underlying;
  ...
  class Face_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          Face_AddYourGabaritTo_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d,
                                 MbCube & cube);
      ...
      private:
MbFace * _underlying;                         MbCube & cube;
  ...
  class Face_CalculateMesh_AsyncWorker : public PromiseWorker {
      public:
          Face_CalculateMesh_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFace * _underlying;                        const MbStepData & stepData;
                        const MbFormNote & note;
  ...
  class Face_GetOwnChanged_AsyncWorker : public PromiseWorker {
      public:
          Face_GetOwnChanged_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d);
...
MbFace * _underlying;
  ...
  class Face_AttributesConvert_AsyncWorker : public PromiseWorker {
      public:
          Face_AttributesConvert_AsyncWorker(
MbFace * _underlying,            Napi::Promise::Deferred const &d,
                                 MbGrid & other);
      ...
      private:
MbFace * _underlying;                         MbGrid & other;
