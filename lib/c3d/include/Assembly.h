...
MbAssembly * _underlying;
  ...
  class Assembly_CreateMesh_AsyncWorker : public PromiseWorker {
      public:
          Assembly_CreateMesh_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbAssembly * _underlying;                        const MbStepData & stepData;
                        const MbFormNote & note;
                         MbRegDuplicate * iReg= NULL;
  ...
  class Assembly_CalculateMesh_AsyncWorker : public PromiseWorker {
      public:
          Assembly_CalculateMesh_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
                                const MbStepData & stepData,
                                const MbFormNote & note);
...
MbAssembly * _underlying;                        const MbStepData & stepData;
  ...
  class Assembly_GetItemName_AsyncWorker : public PromiseWorker {
      public:
          Assembly_GetItemName_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d);
...
MbAssembly * _underlying;
  ...
  class Assembly_SetItemName_AsyncWorker : public PromiseWorker {
      public:
          Assembly_SetItemName_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
                                 SimpleName  name);
      ...
      private:
MbAssembly * _underlying;                         SimpleName  name;
  ...
  class Assembly_RebuildItem_AsyncWorker : public PromiseWorker {
      public:
          Assembly_RebuildItem_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbAssembly * _underlying;                         MbeCopyMode  sameShell;
                         ProgressIndicator * progInd= NULL;
  ...
  class Assembly_GetItemByPath_AsyncWorker : public PromiseWorker {
      public:
          Assembly_GetItemByPath_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
                                const MbPath & path,
                                 size_t  ind,
                                 MbMatrix3D & from,
      ...
      private:
MbAssembly * _underlying;                        const MbPath & path;
                         size_t  ind;
                         MbMatrix3D & from;
                         size_t  currInd= 0;
...
MbAssembly * _underlying;
  ...
  class Assembly_Transform_AsyncWorker : public PromiseWorker {
      public:
          Assembly_Transform_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbAssembly * _underlying;                        const MbMatrix3D & mat;
                         MbRegTransform * iReg= NULL;
...
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbAssembly * _underlying;                        const MbVector3D & v;
                         MbRegTransform * iReg= NULL;
...
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbAssembly * _underlying;                        const MbAxis3D & axis;
                         double  angle;
                         MbRegTransform * iReg= NULL;
...
MbAssembly * _underlying;
  ...
  class Assembly_Duplicate_AsyncWorker : public PromiseWorker {
      public:
          Assembly_Duplicate_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
                                 MbRegDuplicate * iReg = NULL);
      ...
      private:
MbAssembly * _underlying;                         MbRegDuplicate * iReg= NULL;
  ...
  class Assembly_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          Assembly_AddYourGabaritTo_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
                                 MbCube & cube);
      ...
      private:
MbAssembly * _underlying;                         MbCube & cube;
  ...
  class Assembly_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          Assembly_GetUseCount_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d);
...
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbAssembly * _underlying;                         uint32  c;
...
MbAssembly * _underlying;
  ...
  class Assembly_AttributesConvert_AsyncWorker : public PromiseWorker {
      public:
          Assembly_AttributesConvert_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
                                 MbGrid & other);
      ...
      private:
MbAssembly * _underlying;                         MbGrid & other;
  ...
  class Assembly_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          Assembly_GetCreatorsCount_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d);
...
MbAssembly * _underlying;
  ...
  class Assembly_GetCreator_AsyncWorker : public PromiseWorker {
      public:
          Assembly_GetCreator_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
      ...
      private:
MbAssembly * _underlying;                         size_t  ind;
  ...
  class Assembly_SetCreator_AsyncWorker : public PromiseWorker {
      public:
          Assembly_SetCreator_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
...
MbAssembly * _underlying;                         size_t  ind;
  ...
  class Assembly_DetachCreator_AsyncWorker : public PromiseWorker {
      public:
          Assembly_DetachCreator_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
...
MbAssembly * _underlying;                         size_t  ind;
  ...
  class Assembly_AddCreator_AsyncWorker : public PromiseWorker {
      public:
          Assembly_AddCreator_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbAssembly * _underlying;                        const MbCreator * creator;
                         bool  addSame= false;
  ...
  class Assembly_GetCreators_AsyncWorker : public PromiseWorker {
      public:
          Assembly_GetCreators_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d);
...
MbAssembly * _underlying;
  ...
  class Assembly_DeleteCreator_AsyncWorker : public PromiseWorker {
      public:
          Assembly_DeleteCreator_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
...
MbAssembly * _underlying;                         size_t  ind;
  ...
  class Assembly_GetActiveCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          Assembly_GetActiveCreatorsCount_AsyncWorker(
MbAssembly * _underlying,            Napi::Promise::Deferred const &d);
