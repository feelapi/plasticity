...
MbVertex * _underlying;
  ...
  class Vertex_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          Vertex_GetMainName_AsyncWorker(
MbVertex * _underlying,            Napi::Promise::Deferred const &d);
...
MbVertex * _underlying;
  ...
  class Vertex_GetFirstName_AsyncWorker : public PromiseWorker {
      public:
          Vertex_GetFirstName_AsyncWorker(
MbVertex * _underlying,            Napi::Promise::Deferred const &d);
...
MbVertex * _underlying;
  ...
  class Vertex_GetNameHash_AsyncWorker : public PromiseWorker {
      public:
          Vertex_GetNameHash_AsyncWorker(
MbVertex * _underlying,            Napi::Promise::Deferred const &d);
...
MbVertex * _underlying;
  ...
  class Vertex_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          Vertex_AddYourGabaritTo_AsyncWorker(
MbVertex * _underlying,            Napi::Promise::Deferred const &d,
                                 MbCube & cube);
      ...
      private:
MbVertex * _underlying;                         MbCube & cube;
  ...
  class Vertex_CalculateMesh_AsyncWorker : public PromiseWorker {
      public:
          Vertex_CalculateMesh_AsyncWorker(
MbVertex * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbVertex * _underlying;                        const MbStepData & stepData;
                        const MbFormNote & note;
  ...
  class Vertex_GetOwnChanged_AsyncWorker : public PromiseWorker {
      public:
          Vertex_GetOwnChanged_AsyncWorker(
MbVertex * _underlying,            Napi::Promise::Deferred const &d);
...
MbVertex * _underlying;
  ...
  class Vertex_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          Vertex_GetUseCount_AsyncWorker(
MbVertex * _underlying,            Napi::Promise::Deferred const &d);
...
MbVertex * _underlying;
  ...
  class Vertex_AttributesConvert_AsyncWorker : public PromiseWorker {
      public:
          Vertex_AttributesConvert_AsyncWorker(
MbVertex * _underlying,            Napi::Promise::Deferred const &d,
                                 MbGrid & other);
      ...
      private:
MbVertex * _underlying;                         MbGrid & other;
