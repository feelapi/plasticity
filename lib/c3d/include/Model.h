...
{
  public:
    Model_AddItem_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, MbItem &item,
...
{
  public:
    Model_ItemsCount_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Model_GetItems_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Model_DetachItem_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, MbItem *item,
                                 bool resetName = true);
...
{
  public:
    Model_DeleteItem_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, MbItem *item,
                                 bool resetName = true);
...
{
  public:
    Model_GetItemByName_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, SimpleName n);
...
{
  public:
    Model_NearestMesh_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, MbeSpaceType sType,
...
{
  public:
    Model_GetUseCount_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Model_AddRef_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Model_SetStyle_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, int s);
...
{
  public:
    Model_GetStyle_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Model_SetColor_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, uint32 c);
...
{
  public:
    Model_GetColor_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Model_AttributesConvert_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, MbGrid &other);
...
{
  public:
    Model_GetCreatorsCount_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Model_GetCreator_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    Model_SetCreator_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    Model_DetachCreator_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    Model_AddCreator_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, const MbCreator *creator,
                                 bool addSame = false);
...
{
  public:
    Model_GetCreators_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Model_DeleteCreator_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    Model_GetActiveCreatorsCount_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d);
