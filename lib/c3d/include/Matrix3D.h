...
class Matrix3D : public Napi::ObjectWrap<Matrix3D>
{
  public:
...
{
  public:
    Matrix3D_Scale_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d, double sx, double sy,
                               double sz);
...
{
  public:
    Matrix3D_Rotate_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d, const MbAxis3D &axis,
                                double angle);
...
{
  public:
    Matrix3D_Symmetry_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Matrix3D_GetRow_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d, size_t i);
...
{
  public:
    Matrix3D_GetColumn_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d, size_t i);
...
{
  public:
    Matrix3D_SetRow_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d, size_t i, MbHomogeneous3D h);
...
{
  public:
    Matrix3D_SetColumn_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d, size_t i,
                                   MbHomogeneous3D h);
...
{
  public:
    Matrix3D_GetAxisX_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Matrix3D_GetAxisY_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Matrix3D_GetAxisZ_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Matrix3D_GetOrigin_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Matrix3D_El_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d, size_t i, size_t j);
...
{
  public:
    Matrix3D_GetOffset_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Matrix3D_Div_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d, MbMatrix3D &from);
...
{
  public:
    Matrix3D_Adj_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Matrix3D_SetOffset_AsyncWorker(MbMatrix3D *_underlying, Napi::Promise::Deferred const &d, const MbCartPoint3D &p);
