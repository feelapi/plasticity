...
class Arc : public Napi::ObjectWrap<Arc>
{
  public:
...
{
  public:
    Arc_Inverse_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, MbRegTransform *iReg = NULL);
...
{
  public:
    Arc_Trimmed_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, double t1, double t2, int sense);
...
{
  public:
    Arc_IsStraight_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, bool ignoreParams = false);
...
{
  public:
    Arc_IsClosed_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Arc_IsBounded_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Arc_GetTMax_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Arc_GetTMin_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Arc_GetPeriod_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Arc_GetWeightCentre_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Arc_GetLimitPoint_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, ptrdiff_t number);
...
{
  public:
    Arc_PointOn_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Arc__PointOn_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Arc_Explore_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, double &t, bool ext);
...
{
  public:
    Arc_FirstDer_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Arc__FirstDer_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Arc_SecondDer_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Arc__SecondDer_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Arc_Tangent_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Arc__Tangent_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Arc_Normal_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Arc__Normal_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    Arc_PointRelative_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, const MbCartPoint &pnt,
                                  double eps);
...
{
  public:
    Arc_PointLocation_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, const MbCartPoint &pnt,
                                  double eps);
...
{
  public:
    Arc_IsA_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Arc_Type_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Arc_Family_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Arc_Move_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, const MbVector &to,
                         MbRegTransform *iReg = NULL);
...
{
  public:
    Arc_Transform_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, const MbMatrix &matr,
...
{
  public:
    Arc_Duplicate_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, MbRegDuplicate *dup = NULL);
...
{
  public:
    Arc_AddYourGabaritTo_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d, MbRect &rect);
...
{
  public:
    Arc_GetUseCount_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Arc_AddRef_AsyncWorker(MbArc *_underlying, Napi::Promise::Deferred const &d);
