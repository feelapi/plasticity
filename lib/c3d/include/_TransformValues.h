...
class _TransformValues : public
  Napi::ObjectWrap<_TransformValues>
{
  public:
  ...
  class _TransformValues_Move_AsyncWorker : public PromiseWorker {
      public:
          _TransformValues_Move_AsyncWorker(
TransformValues * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
TransformValues * _underlying;                        const MbVector3D & to;
  ...
  class _TransformValues_Rotate_AsyncWorker : public PromiseWorker {
      public:
          _TransformValues_Rotate_AsyncWorker(
TransformValues * _underlying,            Napi::Promise::Deferred const &d,
                                const MbAxis3D & axis,
                                 double  ang);
      ...
      private:
TransformValues * _underlying;                        const MbAxis3D & axis;
                         double  ang;
  ...
  class _TransformValues_GetMatrix_AsyncWorker : public PromiseWorker {
      public:
          _TransformValues_GetMatrix_AsyncWorker(
TransformValues * _underlying,            Napi::Promise::Deferred const &d);
...
TransformValues * _underlying;
  ...
  class _TransformValues_SetFixed_AsyncWorker : public PromiseWorker {
      public:
          _TransformValues_SetFixed_AsyncWorker(
TransformValues * _underlying,            Napi::Promise::Deferred const &d,
                                 bool  b);
      ...
      private:
TransformValues * _underlying;                         bool  b;
  ...
  class _TransformValues_SetFixedPoint_AsyncWorker : public PromiseWorker {
      public:
          _TransformValues_SetFixedPoint_AsyncWorker(
TransformValues * _underlying,            Napi::Promise::Deferred const &d);
