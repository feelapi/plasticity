...
{
  public:
    Matrix_Scale_AsyncWorker(MbMatrix *_underlying, Napi::Promise::Deferred const &d, double s);
...
{
  public:
    Matrix_ScaleX_AsyncWorker(MbMatrix *_underlying, Napi::Promise::Deferred const &d, double s);
...
{
  public:
    Matrix_ScaleY_AsyncWorker(MbMatrix *_underlying, Napi::Promise::Deferred const &d, double s);
