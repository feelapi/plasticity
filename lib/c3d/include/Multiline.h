...
class Multiline : public
  Napi::ObjectWrap<Multiline>
{
  public:
  ...
  class Multiline_GetBegTipCurve_AsyncWorker : public PromiseWorker {
      public:
          Multiline_GetBegTipCurve_AsyncWorker(
...
MbMultiline * _underlying;
  ...
  class Multiline_GetEndTipCurve_AsyncWorker : public PromiseWorker {
      public:
          Multiline_GetEndTipCurve_AsyncWorker(
MbMultiline * _underlying,            Napi::Promise::Deferred const &d);
...
MbMultiline * _underlying;
  ...
  class Multiline_GetCurvesCount_AsyncWorker : public PromiseWorker {
      public:
          Multiline_GetCurvesCount_AsyncWorker(
MbMultiline * _underlying,            Napi::Promise::Deferred const &d);
...
MbMultiline * _underlying;
  ...
  class Multiline_GetCurve_AsyncWorker : public PromiseWorker {
      public:
          Multiline_GetCurve_AsyncWorker(
MbMultiline * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  i);
      ...
      private:
MbMultiline * _underlying;                         size_t  i;
...
MbMultiline * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbMultiline * _underlying;                        const MbVector & to;
                         MbRegTransform * iReg= NULL;
  ...
  class Multiline_Transform_AsyncWorker : public PromiseWorker {
      public:
          Multiline_Transform_AsyncWorker(
MbMultiline * _underlying,            Napi::Promise::Deferred const &d,
                                const MbMatrix & matr,
                                 MbRegTransform * iReg = NULL,
      ...
      private:
MbMultiline * _underlying;                        const MbMatrix & matr;
                         MbRegTransform * iReg= NULL;
                        const MbSurface * newSurface= NULL;
  ...
  class Multiline_Duplicate_AsyncWorker : public PromiseWorker {
      public:
          Multiline_Duplicate_AsyncWorker(
MbMultiline * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbMultiline * _underlying;                         MbRegDuplicate * dup= NULL;
  ...
  class Multiline_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          Multiline_AddYourGabaritTo_AsyncWorker(
MbMultiline * _underlying,            Napi::Promise::Deferred const &d,
                                 MbRect & rect);
      ...
      private:
MbMultiline * _underlying;                         MbRect & rect;
  ...
  class Multiline_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          Multiline_GetUseCount_AsyncWorker(
MbMultiline * _underlying,            Napi::Promise::Deferred const &d);
