...
class _ExtrusionValues : public Napi::ObjectWrap<_ExtrusionValues>
{
  public:
...
{
  public:
    _ExtrusionValues_CheckSelfInt_AsyncWorker(ExtrusionValues _underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    _ExtrusionValues_SetCheckSelfInt_AsyncWorker(ExtrusionValues _underlying, Napi::Promise::Deferred const &d, bool c);
