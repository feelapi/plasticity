...
MbCreator * _underlying;
  ...
  class Creator_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          Creator_GetBasisPoints_AsyncWorker(
MbCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbCreator * _underlying;
  ...
  class Creator_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          Creator_SetBasisPoints_AsyncWorker(
MbCreator * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbCreator * _underlying;                        const MbControlData3D & cd;
  ...
  class Creator_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          Creator_GetBasisItems_AsyncWorker(
MbCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbCreator * _underlying;
  ...
  class Creator_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          Creator_GetCreatorsCount_AsyncWorker(
MbCreator * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbCreator * _underlying;                         MbeCreatorType  ct;
  ...
  class Creator_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          Creator_GetYourNameMaker_AsyncWorker(
MbCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbCreator * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbCreator * _underlying;                         MbeProcessState  l;
  ...
  class Creator_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          Creator_CreateShell_AsyncWorker(
MbCreator * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbCreator * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class Creator_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          Creator_GetMainName_AsyncWorker(
MbCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbCreator * _underlying;
  ...
  class Creator_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          Creator_GetUseCount_AsyncWorker(
MbCreator * _underlying,            Napi::Promise::Deferred const &d);
