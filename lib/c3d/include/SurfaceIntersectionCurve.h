...
class SurfaceIntersectionCurve : public
  Napi::ObjectWrap<SurfaceIntersectionCurve>
{
  public:
  ...
  class SurfaceIntersectionCurve_GetSurfaceOne_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetSurfaceOne_AsyncWorker(
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetSurfaceTwo_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetSurfaceTwo_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetPCurveOne_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetPCurveOne_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetPCurveTwo_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetPCurveTwo_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetSCurveOne_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetSCurveOne_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetSCurveTwo_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetSCurveTwo_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetSpaceCurve_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetSpaceCurve_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetCurveOneSurface_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetCurveOneSurface_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetCurveTwoSurface_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetCurveTwoSurface_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetPlaneCurve_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetPlaneCurve_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
                                 bool  saveParams,
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                         bool  saveParams;
                         PlanarCheckParams  params= PlanarCheckParams();
  ...
  class SurfaceIntersectionCurve_IsPlanar_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_IsPlanar_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                         double  accuracy= METRIC_EPSILON;
  ...
  class SurfaceIntersectionCurve_IsClosed_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_IsClosed_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_IsTouch_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_IsTouch_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetTMax_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetTMax_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetTMin_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetTMin_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetPeriod_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetPeriod_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_IsPeriodic_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_IsPeriodic_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_IsStraight_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_IsStraight_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                         bool  ignoreParams= false;
  ...
  class SurfaceIntersectionCurve_Trimmed_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_Trimmed_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
                                 double  t1,
                                 double  t2,
                                 int  sense);
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                         double  t1;
                         double  t2;
                         int  sense;
  ...
  class SurfaceIntersectionCurve_Normal_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_Normal_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
                                 double & t);
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                         double & t;
  ...
  class SurfaceIntersectionCurve_Tangent_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_Tangent_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
                                 double & t);
...
MbSurfaceIntersectionCurve * _underlying;                         double & t;
  ...
  class SurfaceIntersectionCurve_BNormal_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_BNormal_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
                                 double & t);
...
MbSurfaceIntersectionCurve * _underlying;                         double & t;
  ...
  class SurfaceIntersectionCurve_GetCentre_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetCentre_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetLimitPoint_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetLimitPoint_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
                                 ptrdiff_t  number);
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                         ptrdiff_t  number;
  ...
  class SurfaceIntersectionCurve_PointOn_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_PointOn_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
                                 double & t);
...
MbSurfaceIntersectionCurve * _underlying;                         double & t;
  ...
  class SurfaceIntersectionCurve__PointOn_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve__PointOn_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
                                 double & t);
...
MbSurfaceIntersectionCurve * _underlying;                         double & t;
  ...
  class SurfaceIntersectionCurve_NearPointProjection_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_NearPointProjection_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                        const MbCartPoint3D & pnt;
                         bool  ext;
                         MbRect1D * tRange= NULL;
  ...
  class SurfaceIntersectionCurve_GetSurfaceCurve_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetSurfaceCurve_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                         VERSION  version= Math::DefaultMathVersion();
  ...
  class SurfaceIntersectionCurve_GetWeightCentre_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetWeightCentre_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetBasisCurve_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetBasisCurve_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetBasisPoints_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_SetBasisPoints_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                        const MbControlData3D & cd;
  ...
  class SurfaceIntersectionCurve_Inverse_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_Inverse_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_GetProjection_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetProjection_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                        const MbPlacement3D & place;
                         VERSION  version= Math::DefaultMathVersion();
  ...
  class SurfaceIntersectionCurve_GetCircleAxis_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetCircleAxis_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_IsA_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_IsA_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_Type_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_Type_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_Family_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_Family_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_Transform_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_Transform_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                        const MbMatrix3D & mat;
                         MbRegTransform * iReg= NULL;
  ...
  class SurfaceIntersectionCurve_Move_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_Move_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
                                const MbVector3D & v,
                                 MbRegTransform * iReg = NULL);
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                        const MbVector3D & v;
                         MbRegTransform * iReg= NULL;
  ...
  class SurfaceIntersectionCurve_Rotate_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_Rotate_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
                                const MbAxis3D & axis,
                                 double  angle,
                                 MbRegTransform * iReg = NULL);
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                        const MbAxis3D & axis;
                         double  angle;
                         MbRegTransform * iReg= NULL;
  ...
  class SurfaceIntersectionCurve_Refresh_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_Refresh_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_Duplicate_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_Duplicate_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                         MbRegDuplicate * iReg= NULL;
  ...
  class SurfaceIntersectionCurve_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_AddYourGabaritTo_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d,
                                 MbCube & cube);
      ...
      private:
MbSurfaceIntersectionCurve * _underlying;                         MbCube & cube;
  ...
  class SurfaceIntersectionCurve_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_GetUseCount_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
...
MbSurfaceIntersectionCurve * _underlying;
  ...
  class SurfaceIntersectionCurve_AddRef_AsyncWorker : public PromiseWorker {
      public:
          SurfaceIntersectionCurve_AddRef_AsyncWorker(
MbSurfaceIntersectionCurve * _underlying,            Napi::Promise::Deferred const &d);
