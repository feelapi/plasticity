...
MbMesh * _underlying;
  ...
  class Mesh_ConvertAllToTriangles_AsyncWorker : public PromiseWorker {
      public:
          Mesh_ConvertAllToTriangles_AsyncWorker(
MbMesh * _underlying,            Napi::Promise::Deferred const &d);
...
MbMesh * _underlying;
  ...
  class Mesh_AddExistingGrid_AsyncWorker : public PromiseWorker {
      public:
          Mesh_AddExistingGrid_AsyncWorker(
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
                                 MbGrid & gr);
...
MbMesh * _underlying;
  ...
  class Mesh_CreateGridSearchTrees_AsyncWorker : public PromiseWorker {
      public:
          Mesh_CreateGridSearchTrees_AsyncWorker(
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbMesh * _underlying;                         bool  forcedNew= false;
  ...
  class Mesh_LineIntersection_AsyncWorker : public PromiseWorker {
      public:
          Mesh_LineIntersection_AsyncWorker(
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbMesh * _underlying;                        const MbFloatAxis3D & line;
...
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbMesh * _underlying;                         MbeSpaceType  sType;
                         MbeTopologyType  tType;
                         MbePlaneType  pType;
                        const MbAxis3D & axis;
                         double  maxDistance;
...
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbMesh * _underlying;                        const MbStepData & stepData;
                        const MbFormNote & note;
                         MbRegDuplicate * iReg= NULL;
  ...
  class Mesh_CalculateMesh_AsyncWorker : public PromiseWorker {
      public:
          Mesh_CalculateMesh_AsyncWorker(
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
                                const MbStepData & stepData,
                                const MbFormNote & note);
...
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbMesh * _underlying;                         SimpleName  name;
...
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbMesh * _underlying;                         MbeCopyMode  sameShell;
                         ProgressIndicator * progInd= NULL;
  ...
  class Mesh_GetItemByPath_AsyncWorker : public PromiseWorker {
      public:
          Mesh_GetItemByPath_AsyncWorker(
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
                                const MbPath & path,
                                 size_t  ind,
                                 MbMatrix3D & from,
      ...
      private:
MbMesh * _underlying;                        const MbPath & path;
                         size_t  ind;
                         MbMatrix3D & from;
                         size_t  currInd= 0;
...
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbMesh * _underlying;                        const MbMatrix3D & mat;
                         MbRegTransform * iReg= NULL;
...
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbMesh * _underlying;                        const MbVector3D & v;
                         MbRegTransform * iReg= NULL;
...
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbMesh * _underlying;                        const MbAxis3D & axis;
                         double  angle;
                         MbRegTransform * iReg= NULL;
...
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbMesh * _underlying;                         MbRegDuplicate * iReg= NULL;
  ...
  class Mesh_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          Mesh_AddYourGabaritTo_AsyncWorker(
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
                                 MbCube & cube);
      ...
      private:
MbMesh * _underlying;                         MbCube & cube;
...
MbMesh * _underlying;
  ...
  class Mesh_AttributesConvert_AsyncWorker : public PromiseWorker {
      public:
          Mesh_AttributesConvert_AsyncWorker(
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
                                 MbGrid & other);
      ...
      private:
MbMesh * _underlying;                         MbGrid & other;
  ...
  class Mesh_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          Mesh_GetCreatorsCount_AsyncWorker(
MbMesh * _underlying,            Napi::Promise::Deferred const &d);
...
MbMesh * _underlying;                         size_t  ind;
  ...
  class Mesh_DetachCreator_AsyncWorker : public PromiseWorker {
      public:
          Mesh_DetachCreator_AsyncWorker(
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
...
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbMesh * _underlying;                        const MbCreator * creator;
                         bool  addSame= false;
...
MbMesh * _underlying;
  ...
  class Mesh_DeleteCreator_AsyncWorker : public PromiseWorker {
      public:
          Mesh_DeleteCreator_AsyncWorker(
MbMesh * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
...
MbMesh * _underlying;                         size_t  ind;
  ...
  class Mesh_GetActiveCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          Mesh_GetActiveCreatorsCount_AsyncWorker(
MbMesh * _underlying,            Napi::Promise::Deferred const &d);
