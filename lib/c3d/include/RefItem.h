...
class RefItem : public Napi::ObjectWrap<RefItem>
{
  public:
...
{
  public:
    RefItem_GetUseCount_AsyncWorker(MbRefItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    RefItem_AddRef_AsyncWorker(MbRefItem *_underlying, Napi::Promise::Deferred const &d);
