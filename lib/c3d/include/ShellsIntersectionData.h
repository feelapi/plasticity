...
class ShellsIntersectionData : public Napi::ObjectWrap<ShellsIntersectionData>
{
  public:
...
{
  public:
    ShellsIntersectionData_IsSolid_AsyncWorker(MbShellsIntersectionData *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ShellsIntersectionData_IsSurface_AsyncWorker(MbShellsIntersectionData *_underlying,
