...
class ActionSurfaceCurve : public Napi::ObjectWrap<ActionSurfaceCurve>
{
  public:
...
{
  public:
    ActionSurfaceCurve_CreateContourFillets_AsyncWorker(Napi::Promise::Deferred const &d, const MbContour3D &contour,
                                                        SArray<double> &radiuses, const MbeConnectingType type);
...
{
  public:
    ActionSurfaceCurve_OffsetPlaneCurve_AsyncWorker(Napi::Promise::Deferred const &d, const MbCurve3D &curve,
                                                    double dist);
...
{
  public:
    ActionSurfaceCurve_OffsetSurfaceCurve_AsyncWorker(Napi::Promise::Deferred const &d, const MbCurve3D &curve,
...
{
  public:
    ActionSurfaceCurve_OffsetCurve_AsyncWorker(Napi::Promise::Deferred const &d, const MbCurve3D &initCurve,
...
{
  public:
    ActionSurfaceCurve_FilletCurve_AsyncWorker(Napi::Promise::Deferred const &d, const MbCurve3D &curve1, double &t1,
                                               const MbCurve3D &curve2, double &t2, double &radius, bool sense,
                                               const MbeConnectingType type, const MbSNameMaker &names);
...
{
  public:
    ActionSurfaceCurve_BridgeCurve_AsyncWorker(Napi::Promise::Deferred const &d, const MbCurve3D &curve1, double t1,
                                               bool sense1, const MbCurve3D &curve2, double t2, bool sense2,
                                               const MbSNameMaker &names);
...
{
  public:
    ActionSurfaceCurve_ConnectingSpline_AsyncWorker(Napi::Promise::Deferred const &d, const MbCurve3D &curve1,
                                                    double t1, MbeMatingType mating1, const MbCurve3D &curve2,
                                                    double t2, MbeMatingType mating2, double tension1, double tension2,
                                                    const MbSNameMaker &names);
...
{
  public:
    ActionSurfaceCurve_CurveProjection_AsyncWorker(Napi::Promise::Deferred const &d, const MbSurface &surface,
                                                   const MbCurve3D &curve, MbVector3D *direction, bool createExact,
                                                   bool truncateByBounds, VERSION version = Math::DefaultMathVersion());
