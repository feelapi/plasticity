...
{
  public:
    Name_Hash_AsyncWorker(MbName *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Name_GetFirstName_AsyncWorker(MbName *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Name_GetMainName_AsyncWorker(MbName *_underlying, Napi::Promise::Deferred const &d);
