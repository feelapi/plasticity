...
MbPrimitive * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPrimitive * _underlying;                        const MbRefItem * g;
  ...
  class Primitive_SetPrimitiveName_AsyncWorker : public PromiseWorker {
      public:
          Primitive_SetPrimitiveName_AsyncWorker(
MbPrimitive * _underlying,            Napi::Promise::Deferred const &d,
                                 SimpleName  n);
      ...
      private:
MbPrimitive * _underlying;                         SimpleName  n;
  ...
  class Primitive_SetPrimitiveType_AsyncWorker : public PromiseWorker {
      public:
          Primitive_SetPrimitiveType_AsyncWorker(
MbPrimitive * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeRefType  t);
      ...
      private:
MbPrimitive * _underlying;                         MbeRefType  t;
  ...
  class Primitive_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          Primitive_GetUseCount_AsyncWorker(
MbPrimitive * _underlying,            Napi::Promise::Deferred const &d);
...
MbPrimitive * _underlying;
  ...
  class Primitive_SetStyle_AsyncWorker : public PromiseWorker {
      public:
          Primitive_SetStyle_AsyncWorker(
MbPrimitive * _underlying,            Napi::Promise::Deferred const &d,
                                 int  s);
...
MbPrimitive * _underlying;                         int  s;
  ...
  class Primitive_GetStyle_AsyncWorker : public PromiseWorker {
      public:
          Primitive_GetStyle_AsyncWorker(
MbPrimitive * _underlying,            Napi::Promise::Deferred const &d);
...
MbPrimitive * _underlying;
  ...
  class Primitive_SetColor_AsyncWorker : public PromiseWorker {
      public:
          Primitive_SetColor_AsyncWorker(
MbPrimitive * _underlying,            Napi::Promise::Deferred const &d,
                                 uint32  c);
      ...
      private:
MbPrimitive * _underlying;                         uint32  c;
  ...
  class Primitive_GetColor_AsyncWorker : public PromiseWorker {
      public:
          Primitive_GetColor_AsyncWorker(
MbPrimitive * _underlying,            Napi::Promise::Deferred const &d);
...
MbPrimitive * _underlying;
  ...
  class Primitive_AttributesConvert_AsyncWorker : public PromiseWorker {
      public:
          Primitive_AttributesConvert_AsyncWorker(
MbPrimitive * _underlying,            Napi::Promise::Deferred const &d,
                                 MbGrid & other);
      ...
      private:
MbPrimitive * _underlying;                         MbGrid & other;
