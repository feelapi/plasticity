...
class _LoftedValues : public Napi::ObjectWrap<_LoftedValues>
{
  public:
...
{
  public:
    _LoftedValues_CheckSelfInt_AsyncWorker(LoftedValues *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    _LoftedValues_SetCheckSelfInt_AsyncWorker(LoftedValues *_underlying, Napi::Promise::Deferred const &d, bool c);
