...
class ContourOnSurface : public Napi::ObjectWrap<ContourOnSurface>
{
  public:
...
{
  public:
    ContourOnSurface_GetContour_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_GetSurface_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_GetSegment_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d,
                                            size_t index);
...
{
  public:
    ContourOnSurface_GetSegmentsCount_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_GetPlaneCurve_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ContourOnSurface_IsPlanar_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ContourOnSurface_IsClosed_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_IsTouch_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_GetTMax_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_GetTMin_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_GetPeriod_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_IsPeriodic_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_IsStraight_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ContourOnSurface_Trimmed_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d, double t1,
                                         double t2, int sense);
...
{
  public:
    ContourOnSurface_Normal_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    ContourOnSurface_Tangent_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    ContourOnSurface_BNormal_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    ContourOnSurface_GetCentre_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_GetLimitPoint_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d,
                                               ptrdiff_t number);
...
{
  public:
    ContourOnSurface_PointOn_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    ContourOnSurface__PointOn_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    ContourOnSurface_NearPointProjection_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ContourOnSurface_GetSurfaceCurve_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ContourOnSurface_GetWeightCentre_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_GetBasisCurve_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_GetBasisPoints_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_SetBasisPoints_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ContourOnSurface_Inverse_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_GetProjection_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ContourOnSurface_GetCircleAxis_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_IsA_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_Type_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_Family_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_Transform_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ContourOnSurface_Move_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ContourOnSurface_Rotate_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ContourOnSurface_Refresh_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_Duplicate_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ContourOnSurface_AddYourGabaritTo_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d,
                                                  MbCube &cube);
...
{
  public:
    ContourOnSurface_GetUseCount_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ContourOnSurface_AddRef_AsyncWorker(MbContourOnSurface *_underlying, Napi::Promise::Deferred const &d);
