...
class ReverseCreator : public
  Napi::ObjectWrap<ReverseCreator>
{
  public:
  ...
  class ReverseCreator_IsA_AsyncWorker : public PromiseWorker {
      public:
          ReverseCreator_IsA_AsyncWorker(
...
MbReverseCreator * _underlying;
  ...
  class ReverseCreator_Type_AsyncWorker : public PromiseWorker {
      public:
          ReverseCreator_Type_AsyncWorker(
MbReverseCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbReverseCreator * _underlying;
  ...
  class ReverseCreator_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          ReverseCreator_GetBasisPoints_AsyncWorker(
MbReverseCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbReverseCreator * _underlying;
  ...
  class ReverseCreator_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          ReverseCreator_SetBasisPoints_AsyncWorker(
MbReverseCreator * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbReverseCreator * _underlying;                        const MbControlData3D & cd;
  ...
  class ReverseCreator_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          ReverseCreator_GetBasisItems_AsyncWorker(
MbReverseCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbReverseCreator * _underlying;
  ...
  class ReverseCreator_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          ReverseCreator_GetCreatorsCount_AsyncWorker(
MbReverseCreator * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbReverseCreator * _underlying;                         MbeCreatorType  ct;
  ...
  class ReverseCreator_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          ReverseCreator_GetYourNameMaker_AsyncWorker(
MbReverseCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbReverseCreator * _underlying;
  ...
  class ReverseCreator_GetStatus_AsyncWorker : public PromiseWorker {
      public:
          ReverseCreator_GetStatus_AsyncWorker(
MbReverseCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbReverseCreator * _underlying;
  ...
  class ReverseCreator_SetStatus_AsyncWorker : public PromiseWorker {
      public:
          ReverseCreator_SetStatus_AsyncWorker(
MbReverseCreator * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeProcessState  l);
      ...
      private:
MbReverseCreator * _underlying;                         MbeProcessState  l;
  ...
  class ReverseCreator_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          ReverseCreator_CreateShell_AsyncWorker(
MbReverseCreator * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbReverseCreator * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class ReverseCreator_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          ReverseCreator_GetMainName_AsyncWorker(
MbReverseCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbReverseCreator * _underlying;
  ...
  class ReverseCreator_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          ReverseCreator_GetUseCount_AsyncWorker(
MbReverseCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbReverseCreator * _underlying;
  ...
  class ReverseCreator_AddRef_AsyncWorker : public PromiseWorker {
      public:
          ReverseCreator_AddRef_AsyncWorker(
MbReverseCreator * _underlying,            Napi::Promise::Deferred const &d);
