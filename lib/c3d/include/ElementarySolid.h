...
class ElementarySolid : public Napi::ObjectWrap<ElementarySolid>
{
  public:
...
{
  public:
    ElementarySolid_IsA_AsyncWorker(MbElementarySolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySolid_Type_AsyncWorker(MbElementarySolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySolid_GetBasisPoints_AsyncWorker(MbElementarySolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySolid_SetBasisPoints_AsyncWorker(MbElementarySolid *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ElementarySolid_GetBasisItems_AsyncWorker(MbElementarySolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySolid_GetCreatorsCount_AsyncWorker(MbElementarySolid *_underlying, Napi::Promise::Deferred const &d,
                                                 MbeCreatorType ct);
...
{
  public:
    ElementarySolid_GetYourNameMaker_AsyncWorker(MbElementarySolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySolid_GetStatus_AsyncWorker(MbElementarySolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySolid_SetStatus_AsyncWorker(MbElementarySolid *_underlying, Napi::Promise::Deferred const &d,
                                          MbeProcessState l);
...
{
  public:
    ElementarySolid_CreateShell_AsyncWorker(MbElementarySolid *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ElementarySolid_GetMainName_AsyncWorker(MbElementarySolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySolid_GetUseCount_AsyncWorker(MbElementarySolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySolid_AddRef_AsyncWorker(MbElementarySolid *_underlying, Napi::Promise::Deferred const &d);
