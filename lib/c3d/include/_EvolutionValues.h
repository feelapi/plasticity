...
class _EvolutionValues : public
  Napi::ObjectWrap<_EvolutionValues>
{
  public:
  ...
  class _EvolutionValues_SetParallel_AsyncWorker : public PromiseWorker {
      public:
          _EvolutionValues_SetParallel_AsyncWorker(
...
EvolutionValues * _underlying;
  ...
  class _EvolutionValues_SetKeepingAngle_AsyncWorker : public PromiseWorker {
      public:
          _EvolutionValues_SetKeepingAngle_AsyncWorker(
EvolutionValues * _underlying,            Napi::Promise::Deferred const &d);
...
EvolutionValues * _underlying;
  ...
  class _EvolutionValues_SetOrthogonal_AsyncWorker : public PromiseWorker {
      public:
          _EvolutionValues_SetOrthogonal_AsyncWorker(
EvolutionValues * _underlying,            Napi::Promise::Deferred const &d);
...
EvolutionValues * _underlying;
  ...
  class _EvolutionValues_CheckSelfInt_AsyncWorker : public PromiseWorker {
      public:
          _EvolutionValues_CheckSelfInt_AsyncWorker(
EvolutionValues * _underlying,            Napi::Promise::Deferred const &d);
...
EvolutionValues * _underlying;
  ...
  class _EvolutionValues_SetCheckSelfInt_AsyncWorker : public PromiseWorker {
      public:
          _EvolutionValues_SetCheckSelfInt_AsyncWorker(
EvolutionValues * _underlying,            Napi::Promise::Deferred const &d,
                                 bool  c);
      ...
      private:
EvolutionValues * _underlying;                         bool  c;
