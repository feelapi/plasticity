...
class FaceModifiedSolid : public
  Napi::ObjectWrap<FaceModifiedSolid>
{
  public:
  ...
  class FaceModifiedSolid_IsA_AsyncWorker : public PromiseWorker {
      public:
          FaceModifiedSolid_IsA_AsyncWorker(
...
MbFaceModifiedSolid * _underlying;
  ...
  class FaceModifiedSolid_Type_AsyncWorker : public PromiseWorker {
      public:
          FaceModifiedSolid_Type_AsyncWorker(
MbFaceModifiedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbFaceModifiedSolid * _underlying;
  ...
  class FaceModifiedSolid_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          FaceModifiedSolid_GetBasisPoints_AsyncWorker(
MbFaceModifiedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbFaceModifiedSolid * _underlying;
  ...
  class FaceModifiedSolid_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          FaceModifiedSolid_SetBasisPoints_AsyncWorker(
MbFaceModifiedSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFaceModifiedSolid * _underlying;                        const MbControlData3D & cd;
  ...
  class FaceModifiedSolid_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          FaceModifiedSolid_GetBasisItems_AsyncWorker(
MbFaceModifiedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbFaceModifiedSolid * _underlying;
  ...
  class FaceModifiedSolid_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          FaceModifiedSolid_GetCreatorsCount_AsyncWorker(
MbFaceModifiedSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbFaceModifiedSolid * _underlying;                         MbeCreatorType  ct;
  ...
  class FaceModifiedSolid_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          FaceModifiedSolid_GetYourNameMaker_AsyncWorker(
MbFaceModifiedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbFaceModifiedSolid * _underlying;
  ...
  class FaceModifiedSolid_GetStatus_AsyncWorker : public PromiseWorker {
      public:
          FaceModifiedSolid_GetStatus_AsyncWorker(
MbFaceModifiedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbFaceModifiedSolid * _underlying;
  ...
  class FaceModifiedSolid_SetStatus_AsyncWorker : public PromiseWorker {
      public:
          FaceModifiedSolid_SetStatus_AsyncWorker(
MbFaceModifiedSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeProcessState  l);
      ...
      private:
MbFaceModifiedSolid * _underlying;                         MbeProcessState  l;
  ...
  class FaceModifiedSolid_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          FaceModifiedSolid_CreateShell_AsyncWorker(
MbFaceModifiedSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbFaceModifiedSolid * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class FaceModifiedSolid_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          FaceModifiedSolid_GetMainName_AsyncWorker(
MbFaceModifiedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbFaceModifiedSolid * _underlying;
  ...
  class FaceModifiedSolid_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          FaceModifiedSolid_GetUseCount_AsyncWorker(
MbFaceModifiedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbFaceModifiedSolid * _underlying;
  ...
  class FaceModifiedSolid_AddRef_AsyncWorker : public PromiseWorker {
      public:
          FaceModifiedSolid_AddRef_AsyncWorker(
MbFaceModifiedSolid * _underlying,            Napi::Promise::Deferred const &d);
