...
class _SlotValues : public
  Napi::ObjectWrap<_SlotValues>
{
  public:
  ...
  class _SlotValues_SetSurface_AsyncWorker : public PromiseWorker {
      public:
          _SlotValues_SetSurface_AsyncWorker(
SlotValues * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
SlotValues * _underlying;                         MbSurface * s;
  ...
  class _SlotValues_SetPhantom_AsyncWorker : public PromiseWorker {
      public:
          _SlotValues_SetPhantom_AsyncWorker(
SlotValues * _underlying,            Napi::Promise::Deferred const &d,
                                 bool  s);
