...
{
  public:
    Transactions_GetCreatorsCount_AsyncWorker(MbTransactions *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Transactions_GetCreator_AsyncWorker(MbTransactions *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    Transactions_SetCreator_AsyncWorker(MbTransactions *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    Transactions_DetachCreator_AsyncWorker(MbTransactions *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    Transactions_AddCreator_AsyncWorker(MbTransactions *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Transactions_GetCreators_AsyncWorker(MbTransactions *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Transactions_DeleteCreator_AsyncWorker(MbTransactions *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    Transactions_GetActiveCreatorsCount_AsyncWorker(MbTransactions *_underlying, Napi::Promise::Deferred const &d);
