...
class FaceShell : public
  Napi::ObjectWrap<FaceShell>
{
  public:
  ...
  class FaceShell_GetBoundaryEdges_AsyncWorker : public PromiseWorker {
      public:
          FaceShell_GetBoundaryEdges_AsyncWorker(
...
MbFaceShell * _underlying;
  ...
  class FaceShell_GetFaces_AsyncWorker : public PromiseWorker {
      public:
          FaceShell_GetFaces_AsyncWorker(
MbFaceShell * _underlying,            Napi::Promise::Deferred const &d);
...
MbFaceShell * _underlying;
  ...
  class FaceShell_FindFacesIndexByEdges_AsyncWorker : public PromiseWorker {
      public:
          FaceShell_FindFacesIndexByEdges_AsyncWorker(
MbFaceShell * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFaceShell * _underlying;                        const SArray<MbEdgeFunction> & init;
  ...
  class FaceShell_FindEdgesByFacesIndex_AsyncWorker : public PromiseWorker {
      public:
          FaceShell_FindEdgesByFacesIndex_AsyncWorker(
MbFaceShell * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFaceShell * _underlying;                        const SArray<MbEdgeFacesIndexes> & indexes;
                         RPArray<MbFunction> & initFunctions;
                         RPArray<MbCurve3D> & initSlideways;
...
MbFaceShell * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFaceShell * _underlying;                         MbeCopyMode  sameShell;
                         MbShellHistory * history= NULL;
                         MbRegDuplicate * iReg= NULL;
...
MbFaceShell * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbFaceShell * _underlying;                         size_t  index;
  ...
  class FaceShell_SetOwnChangedThrough_AsyncWorker : public PromiseWorker {
      public:
          FaceShell_SetOwnChangedThrough_AsyncWorker(
MbFaceShell * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeChangedType  n);
      ...
      private:
MbFaceShell * _underlying;                         MbeChangedType  n;
  ...
  class FaceShell_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          FaceShell_GetUseCount_AsyncWorker(
MbFaceShell * _underlying,            Napi::Promise::Deferred const &d);
