...
{
  public:
    Plane_GetSurface_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_GetUEpsilon_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_GetVEpsilon_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_GetUMid_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_GetVMid_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_GetUMin_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_GetUMax_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_GetVMin_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_GetVMax_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_GetUParamToUnit_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_GetVParamToUnit_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_GetRadius_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_Normal_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d, double &u, double &v);
...
{
  public:
    Plane_NearDirectPointProjection_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Plane_IsA_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_Type_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_Family_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_Transform_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d, const MbMatrix3D &mat,
...
{
  public:
    Plane_Move_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d, const MbVector3D &v,
                           MbRegTransform *iReg = NULL);
...
{
  public:
    Plane_Rotate_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d, const MbAxis3D &axis, double angle,
                             MbRegTransform *iReg = NULL);
...
{
  public:
    Plane_Refresh_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_Duplicate_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d, MbRegDuplicate *iReg = NULL);
...
{
  public:
    Plane_AddYourGabaritTo_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d, MbCube &cube);
...
{
  public:
    Plane_GetUseCount_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Plane_AddRef_AsyncWorker(MbPlane *_underlying, Napi::Promise::Deferred const &d);
