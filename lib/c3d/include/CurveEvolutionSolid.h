...
class CurveEvolutionSolid : public
  Napi::ObjectWrap<CurveEvolutionSolid>
{
  public:
  ...
  class CurveEvolutionSolid_IsA_AsyncWorker : public PromiseWorker {
      public:
          CurveEvolutionSolid_IsA_AsyncWorker(
...
MbCurveEvolutionSolid * _underlying;
  ...
  class CurveEvolutionSolid_Type_AsyncWorker : public PromiseWorker {
      public:
          CurveEvolutionSolid_Type_AsyncWorker(
MbCurveEvolutionSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurveEvolutionSolid * _underlying;
  ...
  class CurveEvolutionSolid_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          CurveEvolutionSolid_GetBasisPoints_AsyncWorker(
MbCurveEvolutionSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurveEvolutionSolid * _underlying;
  ...
  class CurveEvolutionSolid_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          CurveEvolutionSolid_SetBasisPoints_AsyncWorker(
MbCurveEvolutionSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbCurveEvolutionSolid * _underlying;                        const MbControlData3D & cd;
  ...
  class CurveEvolutionSolid_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          CurveEvolutionSolid_GetBasisItems_AsyncWorker(
MbCurveEvolutionSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurveEvolutionSolid * _underlying;
  ...
  class CurveEvolutionSolid_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          CurveEvolutionSolid_GetCreatorsCount_AsyncWorker(
MbCurveEvolutionSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbCurveEvolutionSolid * _underlying;                         MbeCreatorType  ct;
  ...
  class CurveEvolutionSolid_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          CurveEvolutionSolid_GetYourNameMaker_AsyncWorker(
MbCurveEvolutionSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurveEvolutionSolid * _underlying;
  ...
  class CurveEvolutionSolid_GetStatus_AsyncWorker : public PromiseWorker {
      public:
          CurveEvolutionSolid_GetStatus_AsyncWorker(
MbCurveEvolutionSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurveEvolutionSolid * _underlying;
  ...
  class CurveEvolutionSolid_SetStatus_AsyncWorker : public PromiseWorker {
      public:
          CurveEvolutionSolid_SetStatus_AsyncWorker(
MbCurveEvolutionSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeProcessState  l);
      ...
      private:
MbCurveEvolutionSolid * _underlying;                         MbeProcessState  l;
  ...
  class CurveEvolutionSolid_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          CurveEvolutionSolid_CreateShell_AsyncWorker(
MbCurveEvolutionSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbCurveEvolutionSolid * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class CurveEvolutionSolid_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          CurveEvolutionSolid_GetMainName_AsyncWorker(
MbCurveEvolutionSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurveEvolutionSolid * _underlying;
  ...
  class CurveEvolutionSolid_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          CurveEvolutionSolid_GetUseCount_AsyncWorker(
MbCurveEvolutionSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurveEvolutionSolid * _underlying;
  ...
  class CurveEvolutionSolid_AddRef_AsyncWorker : public PromiseWorker {
      public:
          CurveEvolutionSolid_AddRef_AsyncWorker(
MbCurveEvolutionSolid * _underlying,            Napi::Promise::Deferred const &d);
