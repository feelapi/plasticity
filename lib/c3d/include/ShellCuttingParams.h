...
class ShellCuttingParams : public Napi::ObjectWrap<ShellCuttingParams>
{
  public:
...
{
  public:
    ShellCuttingParams_SetSurfaceProlongType_AsyncWorker(MbShellCuttingParams *_underlying,
                                                         Napi::Promise::Deferred const &d, MbeSurfaceProlongType pt);
...
{
  public:
    ShellCuttingParams_AddSurfaceProlongType_AsyncWorker(MbShellCuttingParams *_underlying,
                                                         Napi::Promise::Deferred const &d, MbeSurfaceProlongType pt);
