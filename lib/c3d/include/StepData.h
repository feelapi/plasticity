...
class StepData : public
  Napi::ObjectWrap<StepData>
{
  public:
...
MbStepData * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbStepData * _underlying;                         double  s;
...
MbStepData * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbStepData * _underlying;                         double  a;
  ...
  class StepData_SetLength_AsyncWorker : public PromiseWorker {
      public:
          StepData_SetLength_AsyncWorker(
MbStepData * _underlying,            Napi::Promise::Deferred const &d,
                                 double  l);
      ...
      private:
MbStepData * _underlying;                         double  l;
  ...
  class StepData_SetMaxCount_AsyncWorker : public PromiseWorker {
      public:
          StepData_SetMaxCount_AsyncWorker(
MbStepData * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  c);
      ...
      private:
MbStepData * _underlying;                         size_t  c;
...
MbStepData * _underlying;
  ...
  class StepData_GetLength_AsyncWorker : public PromiseWorker {
      public:
          StepData_GetLength_AsyncWorker(
MbStepData * _underlying,            Napi::Promise::Deferred const &d);
...
MbStepData * _underlying;
  ...
  class StepData_SetStepType_AsyncWorker : public PromiseWorker {
      public:
          StepData_SetStepType_AsyncWorker(
MbStepData * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeStepType  t,
                                 bool  add = true);
      ...
      private:
MbStepData * _underlying;                         MbeStepType  t;
                         bool  add= true;
