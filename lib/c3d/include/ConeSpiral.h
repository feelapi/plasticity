...
class ConeSpiral : public Napi::ObjectWrap<ConeSpiral>
{
  public:
...
{
  public:
    ConeSpiral_GetPlaneCurve_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d, bool saveParams,
...
{
  public:
    ConeSpiral_IsPlanar_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ConeSpiral_IsClosed_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_IsTouch_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_GetTMax_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_GetTMin_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_GetPeriod_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_IsPeriodic_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_IsStraight_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ConeSpiral_Trimmed_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d, double t1, double t2,
                                   int sense);
...
{
  public:
    ConeSpiral_Normal_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    ConeSpiral_Tangent_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    ConeSpiral_BNormal_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    ConeSpiral_GetCentre_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_GetLimitPoint_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d, ptrdiff_t number);
...
{
  public:
    ConeSpiral_PointOn_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    ConeSpiral__PointOn_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    ConeSpiral_NearPointProjection_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ConeSpiral_GetSurfaceCurve_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ConeSpiral_GetWeightCentre_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_GetBasisCurve_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_GetBasisPoints_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_SetBasisPoints_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ConeSpiral_Inverse_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_GetProjection_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ConeSpiral_GetCircleAxis_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_IsA_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_Type_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_Family_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_Transform_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d, const MbMatrix3D &mat,
...
{
  public:
    ConeSpiral_Move_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d, const MbVector3D &v,
                                MbRegTransform *iReg = NULL);
...
{
  public:
    ConeSpiral_Rotate_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d, const MbAxis3D &axis,
...
{
  public:
    ConeSpiral_Refresh_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_Duplicate_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ConeSpiral_AddYourGabaritTo_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d, MbCube &cube);
...
{
  public:
    ConeSpiral_GetUseCount_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ConeSpiral_AddRef_AsyncWorker(MbConeSpiral *_underlying, Napi::Promise::Deferred const &d);
