...
{
  public:
    Surface_GetSurface_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_GetUEpsilon_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_GetVEpsilon_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_GetUMid_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_GetVMid_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_GetUMin_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_GetUMax_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_GetVMin_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_GetVMax_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_GetUParamToUnit_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_GetVParamToUnit_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_GetRadius_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_PointOn_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d, MbCartPoint &uv);
...
{
  public:
    Surface_Normal_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d, double &u, double &v);
...
{
  public:
    Surface_GetPlacement_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d, bool exact = false);
...
{
  public:
    Surface_NearDirectPointProjection_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Surface_IsA_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_Type_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_Family_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_Transform_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d, const MbMatrix3D &mat,
...
{
  public:
    Surface_Move_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d, const MbVector3D &v,
                             MbRegTransform *iReg = NULL);
...
{
  public:
    Surface_Rotate_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d, const MbAxis3D &axis,
...
{
  public:
    Surface_Refresh_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_Duplicate_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    Surface_AddYourGabaritTo_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d, MbCube &cube);
...
{
  public:
    Surface_GetUseCount_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Surface_AddRef_AsyncWorker(MbSurface *_underlying, Napi::Promise::Deferred const &d);
