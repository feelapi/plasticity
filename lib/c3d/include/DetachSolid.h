...
class DetachSolid : public Napi::ObjectWrap<DetachSolid>
{
  public:
...
{
  public:
    DetachSolid_IsA_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DetachSolid_Type_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DetachSolid_GetBasisPoints_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DetachSolid_SetBasisPoints_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    DetachSolid_GetBasisItems_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DetachSolid_GetCreatorsCount_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d,
                                             MbeCreatorType ct);
...
{
  public:
    DetachSolid_GetYourNameMaker_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DetachSolid_GetStatus_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DetachSolid_SetStatus_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d, MbeProcessState l);
...
{
  public:
    DetachSolid_CreateShell_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    DetachSolid_GetMainName_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DetachSolid_GetUseCount_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    DetachSolid_AddRef_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d);
