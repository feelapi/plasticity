...
class HoleSolid : public Napi::ObjectWrap<HoleSolid>
{
  public:
...
{
  public:
    HoleSolid_IsA_AsyncWorker(MbHoleSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    HoleSolid_Type_AsyncWorker(MbHoleSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    HoleSolid_GetBasisPoints_AsyncWorker(MbHoleSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    HoleSolid_SetBasisPoints_AsyncWorker(MbHoleSolid *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    HoleSolid_GetBasisItems_AsyncWorker(MbHoleSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    HoleSolid_GetCreatorsCount_AsyncWorker(MbHoleSolid *_underlying, Napi::Promise::Deferred const &d,
                                           MbeCreatorType ct);
...
{
  public:
    HoleSolid_GetYourNameMaker_AsyncWorker(MbHoleSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    HoleSolid_GetStatus_AsyncWorker(MbHoleSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    HoleSolid_SetStatus_AsyncWorker(MbHoleSolid *_underlying, Napi::Promise::Deferred const &d, MbeProcessState l);
...
{
  public:
    HoleSolid_CreateShell_AsyncWorker(MbHoleSolid *_underlying, Napi::Promise::Deferred const &d, MbFaceShell *shell,
...
{
  public:
    HoleSolid_GetMainName_AsyncWorker(MbHoleSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    HoleSolid_GetUseCount_AsyncWorker(MbHoleSolid *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    HoleSolid_AddRef_AsyncWorker(MbHoleSolid *_underlying, Napi::Promise::Deferred const &d);
