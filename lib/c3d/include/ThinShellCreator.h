...
class ThinShellCreator : public
  Napi::ObjectWrap<ThinShellCreator>
{
  public:
  ...
  class ThinShellCreator_IsA_AsyncWorker : public PromiseWorker {
      public:
          ThinShellCreator_IsA_AsyncWorker(
...
MbThinShellCreator * _underlying;
  ...
  class ThinShellCreator_Type_AsyncWorker : public PromiseWorker {
      public:
          ThinShellCreator_Type_AsyncWorker(
MbThinShellCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbThinShellCreator * _underlying;
  ...
  class ThinShellCreator_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          ThinShellCreator_GetBasisPoints_AsyncWorker(
MbThinShellCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbThinShellCreator * _underlying;
  ...
  class ThinShellCreator_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          ThinShellCreator_SetBasisPoints_AsyncWorker(
MbThinShellCreator * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbThinShellCreator * _underlying;                        const MbControlData3D & cd;
  ...
  class ThinShellCreator_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          ThinShellCreator_GetBasisItems_AsyncWorker(
MbThinShellCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbThinShellCreator * _underlying;
  ...
  class ThinShellCreator_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          ThinShellCreator_GetCreatorsCount_AsyncWorker(
MbThinShellCreator * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbThinShellCreator * _underlying;                         MbeCreatorType  ct;
  ...
  class ThinShellCreator_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          ThinShellCreator_GetYourNameMaker_AsyncWorker(
MbThinShellCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbThinShellCreator * _underlying;
  ...
  class ThinShellCreator_GetStatus_AsyncWorker : public PromiseWorker {
      public:
          ThinShellCreator_GetStatus_AsyncWorker(
MbThinShellCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbThinShellCreator * _underlying;
  ...
  class ThinShellCreator_SetStatus_AsyncWorker : public PromiseWorker {
      public:
          ThinShellCreator_SetStatus_AsyncWorker(
MbThinShellCreator * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeProcessState  l);
      ...
      private:
MbThinShellCreator * _underlying;                         MbeProcessState  l;
  ...
  class ThinShellCreator_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          ThinShellCreator_CreateShell_AsyncWorker(
MbThinShellCreator * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbThinShellCreator * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class ThinShellCreator_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          ThinShellCreator_GetMainName_AsyncWorker(
MbThinShellCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbThinShellCreator * _underlying;
  ...
  class ThinShellCreator_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          ThinShellCreator_GetUseCount_AsyncWorker(
MbThinShellCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbThinShellCreator * _underlying;
  ...
  class ThinShellCreator_AddRef_AsyncWorker : public PromiseWorker {
      public:
          ThinShellCreator_AddRef_AsyncWorker(
MbThinShellCreator * _underlying,            Napi::Promise::Deferred const &d);
