...
class _HoleValues : public Napi::ObjectWrap<_HoleValues>
{
  public:
...
{
  public:
    _HoleValues_SetSurface_AsyncWorker(HoleValues *_underlying, Napi::Promise::Deferred const &d, MbSurface *s);
...
{
  public:
    _HoleValues_SetPhantom_AsyncWorker(HoleValues *_underlying, Napi::Promise::Deferred const &d, bool s);
