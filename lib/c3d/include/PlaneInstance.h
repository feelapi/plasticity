...
class PlaneInstance : public Napi::ObjectWrap<PlaneInstance>
{
  public:
...
{
  public:
    PlaneInstance_GetPlacement_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    PlaneInstance_PlaneItemsCount_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    PlaneInstance_GetPlaneItem_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d,
                                           size_t ind = 0);
...
{
  public:
    PlaneInstance_CreateMesh_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    PlaneInstance_CalculateMesh_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d,
                                            const MbStepData &stepData, const MbFormNote &note);
...
{
  public:
    PlaneInstance_GetItemName_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    PlaneInstance_SetItemName_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d,
                                          SimpleName name);
...
{
  public:
    PlaneInstance_RebuildItem_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    PlaneInstance_GetItemByPath_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    PlaneInstance_IsA_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    PlaneInstance_Type_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    PlaneInstance_Family_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    PlaneInstance_Transform_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    PlaneInstance_Move_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d, const MbVector3D &v,
                                   MbRegTransform *iReg = NULL);
...
{
  public:
    PlaneInstance_Rotate_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    PlaneInstance_Refresh_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    PlaneInstance_Duplicate_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d,
                                        MbRegDuplicate *iReg = NULL);
...
{
  public:
    PlaneInstance_AddYourGabaritTo_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d,
                                               MbCube &cube);
...
{
  public:
    PlaneInstance_GetUseCount_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    PlaneInstance_AddRef_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    PlaneInstance_SetStyle_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d, int s);
...
{
  public:
    PlaneInstance_GetStyle_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    PlaneInstance_SetColor_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d, uint32 c);
...
{
  public:
    PlaneInstance_GetColor_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    PlaneInstance_AttributesConvert_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d,
                                                MbGrid &other);
...
{
  public:
    PlaneInstance_GetCreatorsCount_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    PlaneInstance_GetCreator_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    PlaneInstance_SetCreator_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    PlaneInstance_DetachCreator_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    PlaneInstance_AddCreator_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    PlaneInstance_GetCreators_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    PlaneInstance_DeleteCreator_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d, size_t ind);
...
{
  public:
    PlaneInstance_GetActiveCreatorsCount_AsyncWorker(MbPlaneInstance *_underlying, Napi::Promise::Deferred const &d);
