...
class ActionPoint : public Napi::ObjectWrap<ActionPoint>
{
  public:
...
{
  public:
    ActionPoint_LineLineNearestPoints_AsyncWorker(Napi::Promise::Deferred const &d, const MbLine3D &line1,
                                                  const MbLine3D &line2, MbCartPoint3D &p1, MbCartPoint3D &p2);
...
{
  public:
    ActionPoint_CurveCurveIntersection2D_AsyncWorker(Napi::Promise::Deferred const &d, const MbCurve &curve1,
                                                     const MbCurve &curve2, double xEpsilon, double yEpsilon,
...
{
  public:
    ActionPoint_CurveCurveIntersection3D_AsyncWorker(Napi::Promise::Deferred const &d, const MbCurve3D &curve1,
                                                     const MbCurve3D &curve2, double mEps);
...
{
  public:
    ActionPoint_CurveCurveCrossing_AsyncWorker(Napi::Promise::Deferred const &d, const MbCurve3D &curve1,
                                               const MbCurve3D &curve2, double mEps = Math::metricRegion);
