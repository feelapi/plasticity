  ...
  Napi::ObjectWrap<Bezier>
{
  ...
  class Bezier_GetPointsCount_AsyncWorker : public PromiseWorker {
      public:
          Bezier_GetPointsCount_AsyncWorker(
...
MbBezier * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier * _underlying;                         ptrdiff_t  index;
...
MbBezier * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier * _underlying;                        const MbCartPoint & pnt;
...
MbBezier * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier * _underlying;                         MbRegTransform * iReg= NULL;
...
MbBezier * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier * _underlying;                         double  t1;
                         double  t2;
                         int  sense;
...
MbBezier * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier * _underlying;                         bool  ignoreParams= false;
...
MbBezier * _underlying;
  ...
  class Bezier_GetWeightCentre_AsyncWorker : public PromiseWorker {
      public:
          Bezier_GetWeightCentre_AsyncWorker(
MbBezier * _underlying,            Napi::Promise::Deferred const &d);
...
MbBezier * _underlying;
  ...
  class Bezier_GetLimitPoint_AsyncWorker : public PromiseWorker {
      public:
          Bezier_GetLimitPoint_AsyncWorker(
MbBezier * _underlying,            Napi::Promise::Deferred const &d,
                                 ptrdiff_t  number);
      ...
      private:
MbBezier * _underlying;                         ptrdiff_t  number;
...
MbBezier * _underlying;                         double & t;
  ...
  class Bezier_PointRelative_AsyncWorker : public PromiseWorker {
      public:
          Bezier_PointRelative_AsyncWorker(
MbBezier * _underlying,            Napi::Promise::Deferred const &d,
                                const MbCartPoint & pnt,
                                 double  eps);
...
MbBezier * _underlying;                        const MbCartPoint & pnt;
  ...
  class Bezier_PointLocation_AsyncWorker : public PromiseWorker {
      public:
          Bezier_PointLocation_AsyncWorker(
MbBezier * _underlying,            Napi::Promise::Deferred const &d,
                                const MbCartPoint & pnt,
                                 double  eps);
...
MbBezier * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier * _underlying;                        const MbVector & to;
                         MbRegTransform * iReg= NULL;
...
MbBezier * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier * _underlying;                        const MbMatrix & matr;
                         MbRegTransform * iReg= NULL;
                        const MbSurface * newSurface= NULL;
...
MbBezier * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier * _underlying;                         MbRegDuplicate * dup= NULL;
  ...
  class Bezier_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          Bezier_AddYourGabaritTo_AsyncWorker(
MbBezier * _underlying,            Napi::Promise::Deferred const &d,
                                 MbRect & rect);
      ...
      private:
MbBezier * _underlying;                         MbRect & rect;
  ...
  class Bezier_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          Bezier_GetUseCount_AsyncWorker(
MbBezier * _underlying,            Napi::Promise::Deferred const &d);
