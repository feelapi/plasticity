...
class MergingFlags : public
  Napi::ObjectWrap<MergingFlags>
{
  public:
  ...
  class MergingFlags_SetMergingFaces_AsyncWorker : public PromiseWorker {
      public:
          MergingFlags_SetMergingFaces_AsyncWorker(
MbMergingFlags * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbMergingFlags * _underlying;                         bool  s;
  ...
  class MergingFlags_SetMergingEdges_AsyncWorker : public PromiseWorker {
      public:
          MergingFlags_SetMergingEdges_AsyncWorker(
MbMergingFlags * _underlying,            Napi::Promise::Deferred const &d,
                                 bool  s);
