...
class SimpleCreator : public
  Napi::ObjectWrap<SimpleCreator>
{
  public:
  ...
  class SimpleCreator_IsA_AsyncWorker : public PromiseWorker {
      public:
          SimpleCreator_IsA_AsyncWorker(
MbSimpleCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbSimpleCreator * _underlying;
  ...
  class SimpleCreator_Type_AsyncWorker : public PromiseWorker {
      public:
          SimpleCreator_Type_AsyncWorker(
MbSimpleCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbSimpleCreator * _underlying;
  ...
  class SimpleCreator_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          SimpleCreator_GetBasisPoints_AsyncWorker(
MbSimpleCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbSimpleCreator * _underlying;
  ...
  class SimpleCreator_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          SimpleCreator_SetBasisPoints_AsyncWorker(
MbSimpleCreator * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSimpleCreator * _underlying;                        const MbControlData3D & cd;
  ...
  class SimpleCreator_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          SimpleCreator_GetBasisItems_AsyncWorker(
MbSimpleCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbSimpleCreator * _underlying;
  ...
  class SimpleCreator_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          SimpleCreator_GetCreatorsCount_AsyncWorker(
MbSimpleCreator * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbSimpleCreator * _underlying;                         MbeCreatorType  ct;
  ...
  class SimpleCreator_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          SimpleCreator_GetYourNameMaker_AsyncWorker(
MbSimpleCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbSimpleCreator * _underlying;
  ...
  class SimpleCreator_GetStatus_AsyncWorker : public PromiseWorker {
      public:
          SimpleCreator_GetStatus_AsyncWorker(
MbSimpleCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbSimpleCreator * _underlying;
  ...
  class SimpleCreator_SetStatus_AsyncWorker : public PromiseWorker {
      public:
          SimpleCreator_SetStatus_AsyncWorker(
MbSimpleCreator * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeProcessState  l);
      ...
      private:
MbSimpleCreator * _underlying;                         MbeProcessState  l;
  ...
  class SimpleCreator_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          SimpleCreator_CreateShell_AsyncWorker(
MbSimpleCreator * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbSimpleCreator * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class SimpleCreator_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          SimpleCreator_GetMainName_AsyncWorker(
MbSimpleCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbSimpleCreator * _underlying;
  ...
  class SimpleCreator_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          SimpleCreator_GetUseCount_AsyncWorker(
MbSimpleCreator * _underlying,            Napi::Promise::Deferred const &d);
...
MbSimpleCreator * _underlying;
  ...
  class SimpleCreator_AddRef_AsyncWorker : public PromiseWorker {
      public:
          SimpleCreator_AddRef_AsyncWorker(
MbSimpleCreator * _underlying,            Napi::Promise::Deferred const &d);
