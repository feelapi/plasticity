...
class TransformedSolid : public
  Napi::ObjectWrap<TransformedSolid>
{
  public:
  ...
  class TransformedSolid_IsA_AsyncWorker : public PromiseWorker {
      public:
          TransformedSolid_IsA_AsyncWorker(
...
MbTransformedSolid * _underlying;
  ...
  class TransformedSolid_Type_AsyncWorker : public PromiseWorker {
      public:
          TransformedSolid_Type_AsyncWorker(
MbTransformedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbTransformedSolid * _underlying;
  ...
  class TransformedSolid_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          TransformedSolid_GetBasisPoints_AsyncWorker(
MbTransformedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbTransformedSolid * _underlying;
  ...
  class TransformedSolid_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          TransformedSolid_SetBasisPoints_AsyncWorker(
MbTransformedSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbTransformedSolid * _underlying;                        const MbControlData3D & cd;
  ...
  class TransformedSolid_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          TransformedSolid_GetBasisItems_AsyncWorker(
MbTransformedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbTransformedSolid * _underlying;
  ...
  class TransformedSolid_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          TransformedSolid_GetCreatorsCount_AsyncWorker(
MbTransformedSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbTransformedSolid * _underlying;                         MbeCreatorType  ct;
  ...
  class TransformedSolid_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          TransformedSolid_GetYourNameMaker_AsyncWorker(
MbTransformedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbTransformedSolid * _underlying;
  ...
  class TransformedSolid_GetStatus_AsyncWorker : public PromiseWorker {
      public:
          TransformedSolid_GetStatus_AsyncWorker(
MbTransformedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbTransformedSolid * _underlying;
  ...
  class TransformedSolid_SetStatus_AsyncWorker : public PromiseWorker {
      public:
          TransformedSolid_SetStatus_AsyncWorker(
MbTransformedSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeProcessState  l);
      ...
      private:
MbTransformedSolid * _underlying;                         MbeProcessState  l;
  ...
  class TransformedSolid_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          TransformedSolid_CreateShell_AsyncWorker(
MbTransformedSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbTransformedSolid * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class TransformedSolid_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          TransformedSolid_GetMainName_AsyncWorker(
MbTransformedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbTransformedSolid * _underlying;
  ...
  class TransformedSolid_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          TransformedSolid_GetUseCount_AsyncWorker(
MbTransformedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbTransformedSolid * _underlying;
  ...
  class TransformedSolid_AddRef_AsyncWorker : public PromiseWorker {
      public:
          TransformedSolid_AddRef_AsyncWorker(
MbTransformedSolid * _underlying,            Napi::Promise::Deferred const &d);
