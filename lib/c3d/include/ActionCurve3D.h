...
class ActionCurve3D : public Napi::ObjectWrap<ActionCurve3D>
{
  public:
...
{
  public:
    ActionCurve3D_Arc_AsyncWorker(Napi::Promise::Deferred const &d, const MbCartPoint3D &centre,
                                  const SArray<MbCartPoint3D> &points, bool curveClosed, double angle, double &a,
                                  double &b);
...
{
  public:
    ActionCurve3D_Segment_AsyncWorker(Napi::Promise::Deferred const &d, const MbCartPoint3D &point1,
...
{
  public:
    ActionCurve3D_SplineCurve_AsyncWorker(Napi::Promise::Deferred const &d, const SArray<MbCartPoint3D> &points,
...
{
  public:
    ActionCurve3D_CreateContour_AsyncWorker(Napi::Promise::Deferred const &d, MbCurve3D &curve);
...
{
  public:
    ActionCurve3D_AddCurveToContour_AsyncWorker(Napi::Promise::Deferred const &d, MbCurve3D &curve, MbCurve3D &contour,
                                                bool toEnd);
...
{
  public:
    ActionCurve3D_RegularPolygon_AsyncWorker(Napi::Promise::Deferred const &d, const MbCartPoint3D &centre,
                                             const MbCartPoint3D &point, const MbVector3D &axisZ, size_t vertexCount,
                                             bool describe);
...
{
  public:
    ActionCurve3D_SpiralCurve_AsyncWorker(Napi::Promise::Deferred const &d, const MbCartPoint3D &point0,
                                          const MbCartPoint3D &point1, const MbCartPoint3D &point2, double radius,
                                          double step, double angle, MbCurve *lawCurve, bool spiralAxis);
...
{
  public:
    ActionCurve3D_CreateContours_AsyncWorker(Napi::Promise::Deferred const &d, RPArray<MbCurve3D> &curves,
                                             double metricEps, bool onlySmoothConnected = false,
...
{
  public:
    ActionCurve3D_PlaneCurve_AsyncWorker(Napi::Promise::Deferred const &d, const MbPlacement3D &place,
                                         const MbCurve &curve);
...
{
  public:
    ActionCurve3D_DuplicateCurve_AsyncWorker(Napi::Promise::Deferred const &d, const MbCurve3D &curve,
                                             VERSION version = Math::DefaultMathVersion());
...
{
  public:
    ActionCurve3D_NurbsCopy_AsyncWorker(Napi::Promise::Deferred const &d, const MbCurve3D &curve);
