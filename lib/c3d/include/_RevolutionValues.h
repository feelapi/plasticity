...
class _RevolutionValues : public
  Napi::ObjectWrap<_RevolutionValues>
{
  public:
  ...
  class _RevolutionValues_CheckSelfInt_AsyncWorker : public PromiseWorker {
      public:
          _RevolutionValues_CheckSelfInt_AsyncWorker(
...
RevolutionValues * _underlying;
  ...
  class _RevolutionValues_SetCheckSelfInt_AsyncWorker : public PromiseWorker {
      public:
          _RevolutionValues_SetCheckSelfInt_AsyncWorker(
RevolutionValues * _underlying,            Napi::Promise::Deferred const &d,
                                 bool  c);
      ...
      private:
RevolutionValues * _underlying;                         bool  c;
