...
class NameMaker : public
  Napi::ObjectWrap<NameMaker>
{
  public:
...
MbNameMaker * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbNameMaker * _underlying;                        const MbTopologyItem & t;
  ...
  class NameMaker_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          NameMaker_GetMainName_AsyncWorker(
MbNameMaker * _underlying,            Napi::Promise::Deferred const &d);
...
MbNameMaker * _underlying;
  ...
  class NameMaker_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          NameMaker_GetUseCount_AsyncWorker(
MbNameMaker * _underlying,            Napi::Promise::Deferred const &d);
