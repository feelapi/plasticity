...
class SpaceItem : public
  Napi::ObjectWrap<SpaceItem>
{
  public:
  ...
  class SpaceItem_IsA_AsyncWorker : public PromiseWorker {
      public:
          SpaceItem_IsA_AsyncWorker(
MbSpaceItem * _underlying,            Napi::Promise::Deferred const &d);
...
MbSpaceItem * _underlying;
  ...
  class SpaceItem_Transform_AsyncWorker : public PromiseWorker {
      public:
          SpaceItem_Transform_AsyncWorker(
MbSpaceItem * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSpaceItem * _underlying;                        const MbMatrix3D & mat;
                         MbRegTransform * iReg= NULL;
...
MbSpaceItem * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSpaceItem * _underlying;                        const MbVector3D & v;
                         MbRegTransform * iReg= NULL;
...
MbSpaceItem * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSpaceItem * _underlying;                        const MbAxis3D & axis;
                         double  angle;
                         MbRegTransform * iReg= NULL;
...
MbSpaceItem * _underlying;
  ...
  class SpaceItem_Duplicate_AsyncWorker : public PromiseWorker {
      public:
          SpaceItem_Duplicate_AsyncWorker(
MbSpaceItem * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSpaceItem * _underlying;                         MbRegDuplicate * iReg= NULL;
  ...
  class SpaceItem_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          SpaceItem_AddYourGabaritTo_AsyncWorker(
MbSpaceItem * _underlying,            Napi::Promise::Deferred const &d,
                                 MbCube & cube);
      ...
      private:
MbSpaceItem * _underlying;                         MbCube & cube;
  ...
  class SpaceItem_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          SpaceItem_GetUseCount_AsyncWorker(
MbSpaceItem * _underlying,            Napi::Promise::Deferred const &d);
