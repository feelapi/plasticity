...
class TopologyItem : public Napi::ObjectWrap<TopologyItem>
{
  public:
...
{
  public:
    TopologyItem_IsA_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TopologyItem_GetName_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TopologyItem_GetMainName_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TopologyItem_GetFirstName_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TopologyItem_GetNameHash_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TopologyItem_AddYourGabaritTo_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d,
                                              MbCube &cube);
...
{
  public:
    TopologyItem_CalculateMesh_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    TopologyItem_GetOwnChanged_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TopologyItem_GetUseCount_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TopologyItem_AddRef_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TopologyItem_SetStyle_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d, int s);
...
{
  public:
    TopologyItem_GetStyle_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TopologyItem_SetColor_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d, uint32 c);
...
{
  public:
    TopologyItem_GetColor_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TopologyItem_AttributesConvert_AsyncWorker(MbTopologyItem *_underlying, Napi::Promise::Deferred const &d,
                                               MbGrid &other);
