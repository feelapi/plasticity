...
class Bezier3D : public
  Napi::ObjectWrap<Bezier3D>
{
  public:
  ...
  class Bezier3D_GetPoints_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_GetPoints_AsyncWorker(
...
MbBezier3D * _underlying;
  ...
  class Bezier3D_ChangePoint_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_ChangePoint_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
                                 ptrdiff_t  index,
      ...
      private:
MbBezier3D * _underlying;                         ptrdiff_t  index;
                        const MbCartPoint3D & pnt;
  ...
  class Bezier3D_RemovePoint_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_RemovePoint_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
                                 ptrdiff_t  index);
...
MbBezier3D * _underlying;
  ...
  class Bezier3D_GetPlaneCurve_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_GetPlaneCurve_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
                                 bool  saveParams,
      ...
      private:
MbBezier3D * _underlying;                         bool  saveParams;
                         PlanarCheckParams  params= PlanarCheckParams();
...
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier3D * _underlying;                         double  accuracy= METRIC_EPSILON;
...
MbBezier3D * _underlying;
  ...
  class Bezier3D_GetPeriod_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_GetPeriod_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbBezier3D * _underlying;
  ...
  class Bezier3D_IsPeriodic_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_IsPeriodic_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbBezier3D * _underlying;
  ...
  class Bezier3D_IsStraight_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_IsStraight_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier3D * _underlying;                         bool  ignoreParams= false;
...
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier3D * _underlying;                         double  t1;
                         double  t2;
                         int  sense;
...
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier3D * _underlying;                         double & t;
...
MbBezier3D * _underlying;                         double & t;
  ...
  class Bezier3D_GetCentre_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_GetCentre_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbBezier3D * _underlying;
  ...
  class Bezier3D_GetLimitPoint_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_GetLimitPoint_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
                                 ptrdiff_t  number);
      ...
      private:
MbBezier3D * _underlying;                         ptrdiff_t  number;
...
MbBezier3D * _underlying;                         double & t;
  ...
  class Bezier3D_NearPointProjection_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_NearPointProjection_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
                                const MbCartPoint3D & pnt,
                                 bool  ext,
      ...
      private:
MbBezier3D * _underlying;                        const MbCartPoint3D & pnt;
                         bool  ext;
                         MbRect1D * tRange= NULL;
  ...
  class Bezier3D_GetSurfaceCurve_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_GetSurfaceCurve_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier3D * _underlying;                         VERSION  version= Math::DefaultMathVersion();
  ...
  class Bezier3D_GetWeightCentre_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_GetWeightCentre_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbBezier3D * _underlying;
  ...
  class Bezier3D_GetBasisCurve_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_GetBasisCurve_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbBezier3D * _underlying;
  ...
  class Bezier3D_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_GetBasisPoints_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbBezier3D * _underlying;
  ...
  class Bezier3D_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_SetBasisPoints_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier3D * _underlying;                        const MbControlData3D & cd;
...
MbBezier3D * _underlying;
  ...
  class Bezier3D_GetProjection_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_GetProjection_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier3D * _underlying;                        const MbPlacement3D & place;
                         VERSION  version= Math::DefaultMathVersion();
  ...
  class Bezier3D_GetCircleAxis_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_GetCircleAxis_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d);
...
MbBezier3D * _underlying;
  ...
  class Bezier3D_Transform_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_Transform_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier3D * _underlying;                        const MbMatrix3D & mat;
                         MbRegTransform * iReg= NULL;
...
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier3D * _underlying;                        const MbVector3D & v;
                         MbRegTransform * iReg= NULL;
...
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier3D * _underlying;                        const MbAxis3D & axis;
                         double  angle;
                         MbRegTransform * iReg= NULL;
...
MbBezier3D * _underlying;
  ...
  class Bezier3D_Duplicate_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_Duplicate_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbBezier3D * _underlying;                         MbRegDuplicate * iReg= NULL;
  ...
  class Bezier3D_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_AddYourGabaritTo_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d,
                                 MbCube & cube);
      ...
      private:
MbBezier3D * _underlying;                         MbCube & cube;
  ...
  class Bezier3D_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          Bezier3D_GetUseCount_AsyncWorker(
MbBezier3D * _underlying,            Napi::Promise::Deferred const &d);
