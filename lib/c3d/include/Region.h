...
class Region : public Napi::ObjectWrap<Region>
{
  public:
...
{
  public:
    Region_DetachContours_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Region_GetContoursCount_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Region_SetContour_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d, size_t k);
...
{
  public:
    Region_GetContour_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d, size_t k);
...
{
  public:
    Region_GetOutContour_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Region_SetCorrect_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Region_IsA_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Region_Type_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Region_Family_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Region_Move_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d, const MbVector &to,
...
{
  public:
    Region_Transform_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d, const MbMatrix &matr,
...
{
  public:
    Region_Duplicate_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d, MbRegDuplicate *dup = NULL);
...
{
  public:
    Region_AddYourGabaritTo_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d, MbRect &rect);
...
{
  public:
    Region_GetUseCount_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Region_AddRef_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d);
