...
class TrimmedCurve : public Napi::ObjectWrap<TrimmedCurve>
{
  public:
...
{
  public:
    TrimmedCurve_Inverse_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    TrimmedCurve_Trimmed_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d, double t1,
                                     double t2, int sense);
...
{
  public:
    TrimmedCurve_IsStraight_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    TrimmedCurve_IsClosed_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TrimmedCurve_IsBounded_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TrimmedCurve_GetTMax_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TrimmedCurve_GetTMin_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TrimmedCurve_GetPeriod_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TrimmedCurve_GetWeightCentre_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TrimmedCurve_GetLimitPoint_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d,
                                           ptrdiff_t number);
...
{
  public:
    TrimmedCurve_PointOn_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    TrimmedCurve__PointOn_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    TrimmedCurve_Explore_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d, double &t,
                                     bool ext);
...
{
  public:
    TrimmedCurve_FirstDer_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    TrimmedCurve__FirstDer_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    TrimmedCurve_SecondDer_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    TrimmedCurve__SecondDer_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    TrimmedCurve_Tangent_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    TrimmedCurve__Tangent_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    TrimmedCurve_Normal_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    TrimmedCurve__Normal_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    TrimmedCurve_PointRelative_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    TrimmedCurve_PointLocation_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d,
                                           const MbCartPoint &pnt, double eps);
...
{
  public:
    TrimmedCurve_IsA_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TrimmedCurve_Type_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TrimmedCurve_Family_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TrimmedCurve_Move_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d, const MbVector &to,
                                  MbRegTransform *iReg = NULL);
...
{
  public:
    TrimmedCurve_Transform_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    TrimmedCurve_Duplicate_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    TrimmedCurve_AddYourGabaritTo_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d,
                                              MbRect &rect);
...
{
  public:
    TrimmedCurve_GetUseCount_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TrimmedCurve_AddRef_AsyncWorker(MbTrimmedCurve *_underlying, Napi::Promise::Deferred const &d);
