...
class UnionSolid : public
  Napi::ObjectWrap<UnionSolid>
{
  public:
  ...
  class UnionSolid_IsA_AsyncWorker : public PromiseWorker {
      public:
          UnionSolid_IsA_AsyncWorker(
MbUnionSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbUnionSolid * _underlying;
  ...
  class UnionSolid_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          UnionSolid_GetBasisPoints_AsyncWorker(
MbUnionSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbUnionSolid * _underlying;
  ...
  class UnionSolid_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          UnionSolid_SetBasisPoints_AsyncWorker(
MbUnionSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbUnionSolid * _underlying;                        const MbControlData3D & cd;
  ...
  class UnionSolid_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          UnionSolid_GetBasisItems_AsyncWorker(
MbUnionSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbUnionSolid * _underlying;
  ...
  class UnionSolid_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          UnionSolid_GetCreatorsCount_AsyncWorker(
MbUnionSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbUnionSolid * _underlying;                         MbeCreatorType  ct;
  ...
  class UnionSolid_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          UnionSolid_GetYourNameMaker_AsyncWorker(
MbUnionSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbUnionSolid * _underlying;
  ...
  class UnionSolid_GetStatus_AsyncWorker : public PromiseWorker {
      public:
          UnionSolid_GetStatus_AsyncWorker(
MbUnionSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbUnionSolid * _underlying;
  ...
  class UnionSolid_SetStatus_AsyncWorker : public PromiseWorker {
      public:
          UnionSolid_SetStatus_AsyncWorker(
MbUnionSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeProcessState  l);
      ...
      private:
MbUnionSolid * _underlying;                         MbeProcessState  l;
  ...
  class UnionSolid_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          UnionSolid_CreateShell_AsyncWorker(
MbUnionSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbUnionSolid * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class UnionSolid_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          UnionSolid_GetMainName_AsyncWorker(
MbUnionSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbUnionSolid * _underlying;
  ...
  class UnionSolid_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          UnionSolid_GetUseCount_AsyncWorker(
MbUnionSolid * _underlying,            Napi::Promise::Deferred const &d);
