  ...
  Napi::ObjectWrap<Nurbs>
{
  ...
  class Nurbs_GetPointsCount_AsyncWorker : public PromiseWorker {
      public:
          Nurbs_GetPointsCount_AsyncWorker(
...
MbNurbs * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbNurbs * _underlying;                         ptrdiff_t  index;
...
MbNurbs * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbNurbs * _underlying;                        const MbCartPoint & pnt;
...
MbNurbs * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbNurbs * _underlying;                         MbRegTransform * iReg= NULL;
...
MbNurbs * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbNurbs * _underlying;                         bool  ignoreParams= false;
...
MbNurbs * _underlying;
  ...
  class Nurbs_GetWeightCentre_AsyncWorker : public PromiseWorker {
      public:
          Nurbs_GetWeightCentre_AsyncWorker(
MbNurbs * _underlying,            Napi::Promise::Deferred const &d);
...
MbNurbs * _underlying;
  ...
  class Nurbs_GetLimitPoint_AsyncWorker : public PromiseWorker {
      public:
          Nurbs_GetLimitPoint_AsyncWorker(
MbNurbs * _underlying,            Napi::Promise::Deferred const &d,
                                 ptrdiff_t  number);
      ...
      private:
MbNurbs * _underlying;                         ptrdiff_t  number;
...
MbNurbs * _underlying;                         double & t;
  ...
  class Nurbs_PointRelative_AsyncWorker : public PromiseWorker {
      public:
          Nurbs_PointRelative_AsyncWorker(
MbNurbs * _underlying,            Napi::Promise::Deferred const &d,
                                const MbCartPoint & pnt,
                                 double  eps);
...
MbNurbs * _underlying;                        const MbCartPoint & pnt;
  ...
  class Nurbs_PointLocation_AsyncWorker : public PromiseWorker {
      public:
          Nurbs_PointLocation_AsyncWorker(
MbNurbs * _underlying,            Napi::Promise::Deferred const &d,
                                const MbCartPoint & pnt,
                                 double  eps);
...
MbNurbs * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbNurbs * _underlying;                        const MbVector & to;
                         MbRegTransform * iReg= NULL;
...
MbNurbs * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbNurbs * _underlying;                        const MbMatrix & matr;
                         MbRegTransform * iReg= NULL;
                        const MbSurface * newSurface= NULL;
...
MbNurbs * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbNurbs * _underlying;                         MbRegDuplicate * dup= NULL;
  ...
  class Nurbs_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          Nurbs_AddYourGabaritTo_AsyncWorker(
MbNurbs * _underlying,            Napi::Promise::Deferred const &d,
                                 MbRect & rect);
      ...
      private:
MbNurbs * _underlying;                         MbRect & rect;
