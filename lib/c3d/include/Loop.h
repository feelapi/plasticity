...
{
  public:
    Loop_MakeContourOnSurface_AsyncWorker(MbLoop *_underlying, Napi::Promise::Deferred const &d, const MbSurface &surf,
                                          bool faceSense, bool doExact);
...
{
  public:
    Loop_GetEdgesCount_AsyncWorker(MbLoop *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Loop_GetOrientedEdge_AsyncWorker(MbLoop *_underlying, Napi::Promise::Deferred const &d, size_t index);
...
{
  public:
    Loop_GetEdges_AsyncWorker(MbLoop *_underlying, Napi::Promise::Deferred const &d, bool findSame = true);
...
{
  public:
    Loop_GetUseCount_AsyncWorker(MbLoop *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Loop_AddRef_AsyncWorker(MbLoop *_underlying, Napi::Promise::Deferred const &d);
