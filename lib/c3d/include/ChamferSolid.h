...
class ChamferSolid : public
  Napi::ObjectWrap<ChamferSolid>
{
  public:
  ...
  class ChamferSolid_GetParameters_AsyncWorker : public PromiseWorker {
      public:
          ChamferSolid_GetParameters_AsyncWorker(
...
MbChamferSolid * _underlying;
  ...
  class ChamferSolid_SetParameters_AsyncWorker : public PromiseWorker {
      public:
          ChamferSolid_SetParameters_AsyncWorker(
MbChamferSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbChamferSolid * _underlying;                        const SmoothValues & params;
...
MbChamferSolid * _underlying;
  ...
  class ChamferSolid_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          ChamferSolid_GetBasisPoints_AsyncWorker(
MbChamferSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbChamferSolid * _underlying;
  ...
  class ChamferSolid_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          ChamferSolid_SetBasisPoints_AsyncWorker(
MbChamferSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbChamferSolid * _underlying;                        const MbControlData3D & cd;
  ...
  class ChamferSolid_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          ChamferSolid_GetBasisItems_AsyncWorker(
MbChamferSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbChamferSolid * _underlying;
  ...
  class ChamferSolid_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          ChamferSolid_GetCreatorsCount_AsyncWorker(
MbChamferSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbChamferSolid * _underlying;                         MbeCreatorType  ct;
  ...
  class ChamferSolid_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          ChamferSolid_GetYourNameMaker_AsyncWorker(
MbChamferSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbChamferSolid * _underlying;
  ...
  class ChamferSolid_GetStatus_AsyncWorker : public PromiseWorker {
      public:
          ChamferSolid_GetStatus_AsyncWorker(
MbChamferSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbChamferSolid * _underlying;
  ...
  class ChamferSolid_SetStatus_AsyncWorker : public PromiseWorker {
      public:
          ChamferSolid_SetStatus_AsyncWorker(
MbChamferSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeProcessState  l);
      ...
      private:
MbChamferSolid * _underlying;                         MbeProcessState  l;
  ...
  class ChamferSolid_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          ChamferSolid_CreateShell_AsyncWorker(
MbChamferSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbChamferSolid * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class ChamferSolid_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          ChamferSolid_GetMainName_AsyncWorker(
MbChamferSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbChamferSolid * _underlying;
  ...
  class ChamferSolid_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          ChamferSolid_GetUseCount_AsyncWorker(
MbChamferSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbChamferSolid * _underlying;
  ...
  class ChamferSolid_AddRef_AsyncWorker : public PromiseWorker {
      public:
          ChamferSolid_AddRef_AsyncWorker(
MbChamferSolid * _underlying,            Napi::Promise::Deferred const &d);
