...
class CurveLoftedSolid : public
  Napi::ObjectWrap<CurveLoftedSolid>
{
  public:
  ...
  class CurveLoftedSolid_IsA_AsyncWorker : public PromiseWorker {
      public:
          CurveLoftedSolid_IsA_AsyncWorker(
...
MbCurveLoftedSolid * _underlying;
  ...
  class CurveLoftedSolid_Type_AsyncWorker : public PromiseWorker {
      public:
          CurveLoftedSolid_Type_AsyncWorker(
MbCurveLoftedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurveLoftedSolid * _underlying;
  ...
  class CurveLoftedSolid_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          CurveLoftedSolid_GetBasisPoints_AsyncWorker(
MbCurveLoftedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurveLoftedSolid * _underlying;
  ...
  class CurveLoftedSolid_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          CurveLoftedSolid_SetBasisPoints_AsyncWorker(
MbCurveLoftedSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbCurveLoftedSolid * _underlying;                        const MbControlData3D & cd;
  ...
  class CurveLoftedSolid_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          CurveLoftedSolid_GetBasisItems_AsyncWorker(
MbCurveLoftedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurveLoftedSolid * _underlying;
  ...
  class CurveLoftedSolid_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          CurveLoftedSolid_GetCreatorsCount_AsyncWorker(
MbCurveLoftedSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbCurveLoftedSolid * _underlying;                         MbeCreatorType  ct;
  ...
  class CurveLoftedSolid_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          CurveLoftedSolid_GetYourNameMaker_AsyncWorker(
MbCurveLoftedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurveLoftedSolid * _underlying;
  ...
  class CurveLoftedSolid_GetStatus_AsyncWorker : public PromiseWorker {
      public:
          CurveLoftedSolid_GetStatus_AsyncWorker(
MbCurveLoftedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurveLoftedSolid * _underlying;
  ...
  class CurveLoftedSolid_SetStatus_AsyncWorker : public PromiseWorker {
      public:
          CurveLoftedSolid_SetStatus_AsyncWorker(
MbCurveLoftedSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeProcessState  l);
      ...
      private:
MbCurveLoftedSolid * _underlying;                         MbeProcessState  l;
  ...
  class CurveLoftedSolid_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          CurveLoftedSolid_CreateShell_AsyncWorker(
MbCurveLoftedSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbCurveLoftedSolid * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class CurveLoftedSolid_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          CurveLoftedSolid_GetMainName_AsyncWorker(
MbCurveLoftedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurveLoftedSolid * _underlying;
  ...
  class CurveLoftedSolid_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          CurveLoftedSolid_GetUseCount_AsyncWorker(
MbCurveLoftedSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbCurveLoftedSolid * _underlying;
  ...
  class CurveLoftedSolid_AddRef_AsyncWorker : public PromiseWorker {
      public:
          CurveLoftedSolid_AddRef_AsyncWorker(
MbCurveLoftedSolid * _underlying,            Napi::Promise::Deferred const &d);
