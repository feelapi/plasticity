...
class TransformationMaker : public Napi::ObjectWrap<TransformationMaker>
{
  public:
...
{
  public:
    TransformationMaker_IsA_AsyncWorker(MbTransformationMaker *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TransformationMaker_Type_AsyncWorker(MbTransformationMaker *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TransformationMaker_GetBasisPoints_AsyncWorker(MbTransformationMaker *_underlying,
...
{
  public:
    TransformationMaker_SetBasisPoints_AsyncWorker(MbTransformationMaker *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    TransformationMaker_GetBasisItems_AsyncWorker(MbTransformationMaker *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TransformationMaker_GetCreatorsCount_AsyncWorker(MbTransformationMaker *_underlying,
...
{
  public:
    TransformationMaker_GetYourNameMaker_AsyncWorker(MbTransformationMaker *_underlying,
                                                     Napi::Promise::Deferred const &d);
...
{
  public:
    TransformationMaker_GetStatus_AsyncWorker(MbTransformationMaker *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TransformationMaker_SetStatus_AsyncWorker(MbTransformationMaker *_underlying, Napi::Promise::Deferred const &d,
                                              MbeProcessState l);
...
{
  public:
    TransformationMaker_CreateShell_AsyncWorker(MbTransformationMaker *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    TransformationMaker_GetMainName_AsyncWorker(MbTransformationMaker *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TransformationMaker_GetUseCount_AsyncWorker(MbTransformationMaker *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    TransformationMaker_AddRef_AsyncWorker(MbTransformationMaker *_underlying, Napi::Promise::Deferred const &d);
