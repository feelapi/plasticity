...
class AttributeContainer : public Napi::ObjectWrap<AttributeContainer>
{
  public:
...
{
  public:
    AttributeContainer_SetStyle_AsyncWorker(MbAttributeContainer *_underlying, Napi::Promise::Deferred const &d, int s);
...
{
  public:
    AttributeContainer_GetStyle_AsyncWorker(MbAttributeContainer *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    AttributeContainer_SetColor_AsyncWorker(MbAttributeContainer *_underlying, Napi::Promise::Deferred const &d,
                                            uint32 c);
...
{
  public:
    AttributeContainer_GetColor_AsyncWorker(MbAttributeContainer *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    AttributeContainer_AttributesConvert_AsyncWorker(MbAttributeContainer *_underlying,
