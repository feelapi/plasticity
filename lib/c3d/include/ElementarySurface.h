...
class ElementarySurface : public Napi::ObjectWrap<ElementarySurface>
{
  public:
...
{
  public:
    ElementarySurface_GetSurface_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_GetUEpsilon_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_GetVEpsilon_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_GetUMid_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_GetVMid_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_GetUMin_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_GetUMax_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_GetVMin_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_GetVMax_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_GetUParamToUnit_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_GetVParamToUnit_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_GetRadius_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_Normal_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d, double &u,
                                         double &v);
...
{
  public:
    ElementarySurface_NearDirectPointProjection_AsyncWorker(MbElementarySurface *_underlying,
                                                            Napi::Promise::Deferred const &d, const MbCartPoint3D &pnt,
                                                            const MbVector3D &vect, bool ext,
...
{
  public:
    ElementarySurface_IsA_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_Type_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_Family_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_Transform_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ElementarySurface_Move_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ElementarySurface_Rotate_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ElementarySurface_Refresh_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_Duplicate_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    ElementarySurface_AddYourGabaritTo_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d,
                                                   MbCube &cube);
...
{
  public:
    ElementarySurface_GetUseCount_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    ElementarySurface_AddRef_AsyncWorker(MbElementarySurface *_underlying, Napi::Promise::Deferred const &d);
