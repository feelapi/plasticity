  ...
  Napi::ObjectWrap<Contour>
{
  ...
  class Contour_InitClosed_AsyncWorker : public PromiseWorker {
      public:
          Contour_InitClosed_AsyncWorker(
...
MbContour * _underlying;                         bool  c;
  ...
  class Contour_CheckClosed_AsyncWorker : public PromiseWorker {
      public:
          Contour_CheckClosed_AsyncWorker(
MbContour * _underlying,            Napi::Promise::Deferred const &d,
                                 double  closedEps);
      ...
      private:
MbContour * _underlying;                         double  closedEps;
...
MbContour * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbContour * _underlying;                         double  sag= 1;
  ...
  class Contour_GetSegmentsCount_AsyncWorker : public PromiseWorker {
      public:
          Contour_GetSegmentsCount_AsyncWorker(
MbContour * _underlying,            Napi::Promise::Deferred const &d);
...
MbContour * _underlying;
  ...
  class Contour_GetSegment_AsyncWorker : public PromiseWorker {
      public:
          Contour_GetSegment_AsyncWorker(
MbContour * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  i);
      ...
      private:
MbContour * _underlying;                         size_t  i;
  ...
  class Contour_AddCurveWithRuledCheck_AsyncWorker : public PromiseWorker {
      public:
          Contour_AddCurveWithRuledCheck_AsyncWorker(
MbContour * _underlying,            Napi::Promise::Deferred const &d,
                                 MbCurve & newCur,
                                 double  absEps,
      ...
      private:
MbContour * _underlying;                         MbCurve & newCur;
                         double  absEps;
                         bool  toEndOnly= false;
                         bool  checkSame= true;
                         VERSION  version= Math::DefaultMathVersion();
  ...
  class Contour_GetCornerParams_AsyncWorker : public PromiseWorker {
      public:
          Contour_GetCornerParams_AsyncWorker(
MbContour * _underlying,            Napi::Promise::Deferred const &d);
...
MbContour * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbContour * _underlying;                         MbRegTransform * iReg= NULL;
...
MbContour * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbContour * _underlying;                         double  t1;
                         double  t2;
                         int  sense;
  ...
  class Contour_IsStraight_AsyncWorker : public PromiseWorker {
      public:
          Contour_IsStraight_AsyncWorker(
MbContour * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbContour * _underlying;                         bool  ignoreParams= false;
...
MbContour * _underlying;
  ...
  class Contour_GetWeightCentre_AsyncWorker : public PromiseWorker {
      public:
          Contour_GetWeightCentre_AsyncWorker(
MbContour * _underlying,            Napi::Promise::Deferred const &d);
...
MbContour * _underlying;
  ...
  class Contour_GetLimitPoint_AsyncWorker : public PromiseWorker {
      public:
          Contour_GetLimitPoint_AsyncWorker(
MbContour * _underlying,            Napi::Promise::Deferred const &d,
                                 ptrdiff_t  number);
      ...
      private:
MbContour * _underlying;                         ptrdiff_t  number;
...
MbContour * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbContour * _underlying;                         double & t;
...
MbContour * _underlying;                         double & t;
  ...
  class Contour__SecondDer_AsyncWorker : public PromiseWorker {
      public:
          Contour__SecondDer_AsyncWorker(
MbContour * _underlying,            Napi::Promise::Deferred const &d,
                                 double & t);
...
MbContour * _underlying;                         double & t;
  ...
  class Contour_PointRelative_AsyncWorker : public PromiseWorker {
      public:
          Contour_PointRelative_AsyncWorker(
MbContour * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbContour * _underlying;                        const MbCartPoint & pnt;
                         double  eps;
  ...
  class Contour_PointLocation_AsyncWorker : public PromiseWorker {
      public:
          Contour_PointLocation_AsyncWorker(
MbContour * _underlying,            Napi::Promise::Deferred const &d,
                                const MbCartPoint & pnt,
                                 double  eps);
...
MbContour * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbContour * _underlying;                        const MbVector & to;
                         MbRegTransform * iReg= NULL;
...
MbContour * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbContour * _underlying;                        const MbMatrix & matr;
                         MbRegTransform * iReg= NULL;
                        const MbSurface * newSurface= NULL;
...
MbContour * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbContour * _underlying;                         MbRegDuplicate * dup= NULL;
  ...
  class Contour_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          Contour_AddYourGabaritTo_AsyncWorker(
MbContour * _underlying,            Napi::Promise::Deferred const &d,
                                 MbRect & rect);
      ...
      private:
MbContour * _underlying;                         MbRect & rect;
  ...
  class Contour_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          Contour_GetUseCount_AsyncWorker(
MbContour * _underlying,            Napi::Promise::Deferred const &d);
