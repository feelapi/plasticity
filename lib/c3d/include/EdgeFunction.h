...
class EdgeFunction : public Napi::ObjectWrap<EdgeFunction>
{
  public:
...
{
  public:
    EdgeFunction_Edge_AsyncWorker(MbEdgeFunction *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    EdgeFunction_Function_AsyncWorker(MbEdgeFunction *_underlying, Napi::Promise::Deferred const &d);
