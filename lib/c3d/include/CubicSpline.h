...
class CubicSpline : public Napi::ObjectWrap<CubicSpline>
{
  public:
...
{
  public:
    CubicSpline_GetPointsCount_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CubicSpline_GetPoint_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d, ptrdiff_t index);
...
{
  public:
    CubicSpline_AddPoint_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    CubicSpline_Inverse_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    CubicSpline_Trimmed_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d, double t1, double t2,
                                    int sense);
...
{
  public:
    CubicSpline_IsStraight_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    CubicSpline_IsClosed_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CubicSpline_IsBounded_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CubicSpline_GetTMax_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CubicSpline_GetTMin_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CubicSpline_GetPeriod_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CubicSpline_GetWeightCentre_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CubicSpline_GetLimitPoint_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d,
                                          ptrdiff_t number);
...
{
  public:
    CubicSpline_PointOn_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CubicSpline__PointOn_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CubicSpline_Explore_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d, double &t, bool ext);
...
{
  public:
    CubicSpline_FirstDer_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CubicSpline__FirstDer_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CubicSpline_SecondDer_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CubicSpline__SecondDer_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CubicSpline_Tangent_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CubicSpline__Tangent_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CubicSpline_Normal_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CubicSpline__Normal_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d, double &t);
...
{
  public:
    CubicSpline_PointRelative_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    CubicSpline_PointLocation_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d,
                                          const MbCartPoint &pnt, double eps);
...
{
  public:
    CubicSpline_IsA_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CubicSpline_Type_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CubicSpline_Family_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CubicSpline_Move_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d, const MbVector &to,
                                 MbRegTransform *iReg = NULL);
...
{
  public:
    CubicSpline_Transform_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    CubicSpline_Duplicate_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d,
...
{
  public:
    CubicSpline_AddYourGabaritTo_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d,
                                             MbRect &rect);
...
{
  public:
    CubicSpline_GetUseCount_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    CubicSpline_AddRef_AsyncWorker(MbCubicSpline *_underlying, Napi::Promise::Deferred const &d);
