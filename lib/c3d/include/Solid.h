...
MbSolid * _underlying;
  ...
  class Solid_FindFaceByName_AsyncWorker : public PromiseWorker {
      public:
          Solid_FindFaceByName_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
                                const MbName & name);
      ...
      private:
MbSolid * _underlying;                        const MbName & name;
  ...
  class Solid_FindFaceByHash_AsyncWorker : public PromiseWorker {
      public:
          Solid_FindFaceByHash_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
                                const SimpleName  h);
      ...
      private:
MbSolid * _underlying;                        const SimpleName  h;
...
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSolid * _underlying;                         size_t  index;
...
MbSolid * _underlying;                         size_t  index;
  ...
  class Solid_FindEdgeByName_AsyncWorker : public PromiseWorker {
      public:
          Solid_FindEdgeByName_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
                                const MbName & name);
...
MbSolid * _underlying;
  ...
  class Solid_GetFaceIndex_AsyncWorker : public PromiseWorker {
      public:
          Solid_GetFaceIndex_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
                                const MbFace & face);
      ...
      private:
MbSolid * _underlying;                        const MbFace & face;
  ...
  class Solid_GetEdgeIndex_AsyncWorker : public PromiseWorker {
      public:
          Solid_GetEdgeIndex_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSolid * _underlying;                        const MbCurveEdge & edge;
  ...
  class Solid_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          Solid_GetBasisPoints_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbSolid * _underlying;
  ...
  class Solid_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          Solid_SetBasisPoints_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSolid * _underlying;                        const MbControlData3D & cd;
...
MbSolid * _underlying;
  ...
  class Solid_SetOwnChangedThrough_AsyncWorker : public PromiseWorker {
      public:
          Solid_SetOwnChangedThrough_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeChangedType  type);
      ...
      private:
MbSolid * _underlying;                         MbeChangedType  type;
...
MbSolid * _underlying;
  ...
  class Solid_SolidClassification_AsyncWorker : public PromiseWorker {
      public:
          Solid_SolidClassification_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
                                const MbSolid & solid,
      ...
      private:
MbSolid * _underlying;                        const MbSolid & solid;
                         double  epsilon= Math::metricRegion;
...
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSolid * _underlying;                        const MbStepData & stepData;
                        const MbFormNote & note;
                         MbRegDuplicate * iReg= NULL;
  ...
  class Solid_CalculateMesh_AsyncWorker : public PromiseWorker {
      public:
          Solid_CalculateMesh_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
                                const MbStepData & stepData,
                                const MbFormNote & note);
...
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSolid * _underlying;                         SimpleName  name;
...
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSolid * _underlying;                         MbeCopyMode  sameShell;
                         ProgressIndicator * progInd= NULL;
  ...
  class Solid_GetItemByPath_AsyncWorker : public PromiseWorker {
      public:
          Solid_GetItemByPath_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
                                const MbPath & path,
                                 size_t  ind,
                                 MbMatrix3D & from,
      ...
      private:
MbSolid * _underlying;                        const MbPath & path;
                         size_t  ind;
                         MbMatrix3D & from;
                         size_t  currInd= 0;
...
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSolid * _underlying;                        const MbMatrix3D & mat;
                         MbRegTransform * iReg= NULL;
...
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSolid * _underlying;                        const MbVector3D & v;
                         MbRegTransform * iReg= NULL;
...
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSolid * _underlying;                        const MbAxis3D & axis;
                         double  angle;
                         MbRegTransform * iReg= NULL;
...
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSolid * _underlying;                         MbRegDuplicate * iReg= NULL;
  ...
  class Solid_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          Solid_AddYourGabaritTo_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbCube & cube);
      ...
      private:
MbSolid * _underlying;                         MbCube & cube;
...
MbSolid * _underlying;
  ...
  class Solid_AttributesConvert_AsyncWorker : public PromiseWorker {
      public:
          Solid_AttributesConvert_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbGrid & other);
      ...
      private:
MbSolid * _underlying;                         MbGrid & other;
  ...
  class Solid_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          Solid_GetCreatorsCount_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSolid * _underlying;                         size_t  ind;
...
MbSolid * _underlying;                         size_t  ind;
  ...
  class Solid_DetachCreator_AsyncWorker : public PromiseWorker {
      public:
          Solid_DetachCreator_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
...
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSolid * _underlying;                        const MbCreator * creator;
                         bool  addSame= false;
...
MbSolid * _underlying;
  ...
  class Solid_DeleteCreator_AsyncWorker : public PromiseWorker {
      public:
          Solid_DeleteCreator_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
...
MbSolid * _underlying;                         size_t  ind;
  ...
  class Solid_GetActiveCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          Solid_GetActiveCreatorsCount_AsyncWorker(
MbSolid * _underlying,            Napi::Promise::Deferred const &d);
