...
class Cube : public Napi::ObjectWrap<Cube>
{
  public:
...
{
  public:
    Cube_CalculateMatrix_AsyncWorker(MbCube *_underlying, Napi::Promise::Deferred const &d, size_t pIndex,
                                     const MbCartPoint3D &point, const MbCartPoint3D &fixedPoint, bool useFixed,
                                     bool isotropy);
...
{
  public:
    Cube_ProjectionRect_AsyncWorker(MbCube *_underlying, Napi::Promise::Deferred const &d, const MbPlacement3D &place);
...
{
  public:
    Cube_Intersect_AsyncWorker(MbCube *_underlying, Napi::Promise::Deferred const &d, const MbCube &other,
