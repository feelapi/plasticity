...
class Edge : public Napi::ObjectWrap<Edge>
{
  public:
...
{
  public:
    Edge_Point_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d, double t);
...
{
  public:
    Edge_GetBegPoint_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_GetEndPoint_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_PointProjection_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d, const MbCartPoint3D &p);
...
{
  public:
    Edge_Reverse_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_Tangent_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d, double t);
...
{
  public:
    Edge_GetBegTangent_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_GetEndTangent_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_IsA_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_GetName_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_GetMainName_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_GetFirstName_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_GetNameHash_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_AddYourGabaritTo_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d, MbCube &cube);
...
{
  public:
    Edge_CalculateMesh_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d, const MbStepData &stepData,
...
{
  public:
    Edge_GetOwnChanged_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_GetUseCount_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_AddRef_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_SetStyle_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d, int s);
...
{
  public:
    Edge_GetStyle_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_SetColor_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d, uint32 c);
...
{
  public:
    Edge_GetColor_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d);
...
{
  public:
    Edge_AttributesConvert_AsyncWorker(MbEdge *_underlying, Napi::Promise::Deferred const &d, MbGrid &other);
