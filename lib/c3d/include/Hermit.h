  ...
  Napi::ObjectWrap<Hermit>
{
  ...
  class Hermit_GetPointsCount_AsyncWorker : public PromiseWorker {
      public:
          Hermit_GetPointsCount_AsyncWorker(
...
MbHermit * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbHermit * _underlying;                         ptrdiff_t  index;
...
MbHermit * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbHermit * _underlying;                        const MbCartPoint & pnt;
...
MbHermit * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbHermit * _underlying;                         MbRegTransform * iReg= NULL;
...
MbHermit * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbHermit * _underlying;                         double  t1;
                         double  t2;
                         int  sense;
...
MbHermit * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbHermit * _underlying;                         bool  ignoreParams= false;
...
MbHermit * _underlying;
  ...
  class Hermit_GetWeightCentre_AsyncWorker : public PromiseWorker {
      public:
          Hermit_GetWeightCentre_AsyncWorker(
MbHermit * _underlying,            Napi::Promise::Deferred const &d);
...
MbHermit * _underlying;
  ...
  class Hermit_GetLimitPoint_AsyncWorker : public PromiseWorker {
      public:
          Hermit_GetLimitPoint_AsyncWorker(
MbHermit * _underlying,            Napi::Promise::Deferred const &d,
                                 ptrdiff_t  number);
      ...
      private:
MbHermit * _underlying;                         ptrdiff_t  number;
...
MbHermit * _underlying;                         double & t;
  ...
  class Hermit_PointRelative_AsyncWorker : public PromiseWorker {
      public:
          Hermit_PointRelative_AsyncWorker(
MbHermit * _underlying,            Napi::Promise::Deferred const &d,
                                const MbCartPoint & pnt,
                                 double  eps);
...
MbHermit * _underlying;                        const MbCartPoint & pnt;
  ...
  class Hermit_PointLocation_AsyncWorker : public PromiseWorker {
      public:
          Hermit_PointLocation_AsyncWorker(
MbHermit * _underlying,            Napi::Promise::Deferred const &d,
                                const MbCartPoint & pnt,
                                 double  eps);
...
MbHermit * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbHermit * _underlying;                        const MbVector & to;
                         MbRegTransform * iReg= NULL;
...
MbHermit * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbHermit * _underlying;                        const MbMatrix & matr;
                         MbRegTransform * iReg= NULL;
                        const MbSurface * newSurface= NULL;
...
MbHermit * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbHermit * _underlying;                         MbRegDuplicate * dup= NULL;
  ...
  class Hermit_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          Hermit_AddYourGabaritTo_AsyncWorker(
MbHermit * _underlying,            Napi::Promise::Deferred const &d,
                                 MbRect & rect);
      ...
      private:
MbHermit * _underlying;                         MbRect & rect;
  ...
  class Hermit_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          Hermit_GetUseCount_AsyncWorker(
MbHermit * _underlying,            Napi::Promise::Deferred const &d);
