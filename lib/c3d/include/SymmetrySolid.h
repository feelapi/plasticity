...
class SymmetrySolid : public
  Napi::ObjectWrap<SymmetrySolid>
{
  public:
...
MbSymmetrySolid * _underlying;
  ...
  class SymmetrySolid_Type_AsyncWorker : public PromiseWorker {
      public:
          SymmetrySolid_Type_AsyncWorker(
MbSymmetrySolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbSymmetrySolid * _underlying;
  ...
  class SymmetrySolid_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          SymmetrySolid_GetBasisPoints_AsyncWorker(
MbSymmetrySolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbSymmetrySolid * _underlying;
  ...
  class SymmetrySolid_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          SymmetrySolid_SetBasisPoints_AsyncWorker(
MbSymmetrySolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbSymmetrySolid * _underlying;                        const MbControlData3D & cd;
  ...
  class SymmetrySolid_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          SymmetrySolid_GetBasisItems_AsyncWorker(
MbSymmetrySolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbSymmetrySolid * _underlying;
  ...
  class SymmetrySolid_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          SymmetrySolid_GetCreatorsCount_AsyncWorker(
MbSymmetrySolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbSymmetrySolid * _underlying;                         MbeCreatorType  ct;
  ...
  class SymmetrySolid_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          SymmetrySolid_GetYourNameMaker_AsyncWorker(
MbSymmetrySolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbSymmetrySolid * _underlying;
  ...
  class SymmetrySolid_GetStatus_AsyncWorker : public PromiseWorker {
      public:
          SymmetrySolid_GetStatus_AsyncWorker(
MbSymmetrySolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbSymmetrySolid * _underlying;
  ...
  class SymmetrySolid_SetStatus_AsyncWorker : public PromiseWorker {
      public:
          SymmetrySolid_SetStatus_AsyncWorker(
MbSymmetrySolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeProcessState  l);
      ...
      private:
MbSymmetrySolid * _underlying;                         MbeProcessState  l;
  ...
  class SymmetrySolid_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          SymmetrySolid_CreateShell_AsyncWorker(
MbSymmetrySolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbSymmetrySolid * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class SymmetrySolid_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          SymmetrySolid_GetMainName_AsyncWorker(
MbSymmetrySolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbSymmetrySolid * _underlying;
  ...
  class SymmetrySolid_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          SymmetrySolid_GetUseCount_AsyncWorker(
MbSymmetrySolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbSymmetrySolid * _underlying;
  ...
  class SymmetrySolid_AddRef_AsyncWorker : public PromiseWorker {
      public:
          SymmetrySolid_AddRef_AsyncWorker(
MbSymmetrySolid * _underlying,            Napi::Promise::Deferred const &d);
