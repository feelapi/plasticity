...
class RibSolid : public
  Napi::ObjectWrap<RibSolid>
{
  public:
...
MbRibSolid * _underlying;
  ...
  class RibSolid_GetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          RibSolid_GetBasisPoints_AsyncWorker(
MbRibSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbRibSolid * _underlying;
  ...
  class RibSolid_SetBasisPoints_AsyncWorker : public PromiseWorker {
      public:
          RibSolid_SetBasisPoints_AsyncWorker(
MbRibSolid * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbRibSolid * _underlying;                        const MbControlData3D & cd;
  ...
  class RibSolid_GetBasisItems_AsyncWorker : public PromiseWorker {
      public:
          RibSolid_GetBasisItems_AsyncWorker(
MbRibSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbRibSolid * _underlying;
  ...
  class RibSolid_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          RibSolid_GetCreatorsCount_AsyncWorker(
MbRibSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeCreatorType  ct);
      ...
      private:
MbRibSolid * _underlying;                         MbeCreatorType  ct;
  ...
  class RibSolid_GetYourNameMaker_AsyncWorker : public PromiseWorker {
      public:
          RibSolid_GetYourNameMaker_AsyncWorker(
MbRibSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbRibSolid * _underlying;
  ...
  class RibSolid_GetStatus_AsyncWorker : public PromiseWorker {
      public:
          RibSolid_GetStatus_AsyncWorker(
MbRibSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbRibSolid * _underlying;
  ...
  class RibSolid_SetStatus_AsyncWorker : public PromiseWorker {
      public:
          RibSolid_SetStatus_AsyncWorker(
MbRibSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbeProcessState  l);
      ...
      private:
MbRibSolid * _underlying;                         MbeProcessState  l;
  ...
  class RibSolid_CreateShell_AsyncWorker : public PromiseWorker {
      public:
          RibSolid_CreateShell_AsyncWorker(
MbRibSolid * _underlying,            Napi::Promise::Deferred const &d,
                                 MbFaceShell * shell,
      ...
      private:
MbRibSolid * _underlying;                         MbFaceShell * shell;
                         MbeCopyMode  sameShell;
  ...
  class RibSolid_GetMainName_AsyncWorker : public PromiseWorker {
      public:
          RibSolid_GetMainName_AsyncWorker(
MbRibSolid * _underlying,            Napi::Promise::Deferred const &d);
...
MbRibSolid * _underlying;
  ...
  class RibSolid_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          RibSolid_GetUseCount_AsyncWorker(
MbRibSolid * _underlying,            Napi::Promise::Deferred const &d);
