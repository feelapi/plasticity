...
class PointFrame : public
  Napi::ObjectWrap<PointFrame>
{
  public:
  ...
  class PointFrame_AddVertex_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_AddVertex_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPointFrame * _underlying;                        const MbCartPoint3D & point;
  ...
  class PointFrame_CreateMesh_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_CreateMesh_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPointFrame * _underlying;                        const MbStepData & stepData;
                        const MbFormNote & note;
                         MbRegDuplicate * iReg= NULL;
  ...
  class PointFrame_CalculateMesh_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_CalculateMesh_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
                                const MbStepData & stepData,
                                const MbFormNote & note);
...
MbPointFrame * _underlying;                        const MbStepData & stepData;
  ...
  class PointFrame_GetItemName_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_GetItemName_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d);
...
MbPointFrame * _underlying;
  ...
  class PointFrame_SetItemName_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_SetItemName_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
                                 SimpleName  name);
      ...
      private:
MbPointFrame * _underlying;                         SimpleName  name;
  ...
  class PointFrame_RebuildItem_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_RebuildItem_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPointFrame * _underlying;                         MbeCopyMode  sameShell;
                         ProgressIndicator * progInd= NULL;
  ...
  class PointFrame_GetItemByPath_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_GetItemByPath_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
                                const MbPath & path,
                                 size_t  ind,
                                 MbMatrix3D & from,
      ...
      private:
MbPointFrame * _underlying;                        const MbPath & path;
                         size_t  ind;
                         MbMatrix3D & from;
                         size_t  currInd= 0;
...
MbPointFrame * _underlying;
  ...
  class PointFrame_Transform_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_Transform_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPointFrame * _underlying;                        const MbMatrix3D & mat;
                         MbRegTransform * iReg= NULL;
...
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPointFrame * _underlying;                        const MbVector3D & v;
                         MbRegTransform * iReg= NULL;
...
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPointFrame * _underlying;                        const MbAxis3D & axis;
                         double  angle;
                         MbRegTransform * iReg= NULL;
  ...
  class PointFrame_Refresh_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_Refresh_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d);
...
MbPointFrame * _underlying;
  ...
  class PointFrame_Duplicate_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_Duplicate_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
                                 MbRegDuplicate * iReg = NULL);
      ...
      private:
MbPointFrame * _underlying;                         MbRegDuplicate * iReg= NULL;
  ...
  class PointFrame_AddYourGabaritTo_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_AddYourGabaritTo_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
                                 MbCube & cube);
      ...
      private:
MbPointFrame * _underlying;                         MbCube & cube;
  ...
  class PointFrame_GetUseCount_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_GetUseCount_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d);
...
MbPointFrame * _underlying;
  ...
  class PointFrame_SetStyle_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_SetStyle_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
                                 int  s);
      ...
      private:
MbPointFrame * _underlying;                         int  s;
  ...
  class PointFrame_GetStyle_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_GetStyle_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d);
...
MbPointFrame * _underlying;
  ...
  class PointFrame_SetColor_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_SetColor_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
                                 uint32  c);
      ...
      private:
MbPointFrame * _underlying;                         uint32  c;
  ...
  class PointFrame_GetColor_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_GetColor_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d);
...
MbPointFrame * _underlying;
  ...
  class PointFrame_AttributesConvert_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_AttributesConvert_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
                                 MbGrid & other);
      ...
      private:
MbPointFrame * _underlying;                         MbGrid & other;
  ...
  class PointFrame_GetCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_GetCreatorsCount_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d);
...
MbPointFrame * _underlying;
  ...
  class PointFrame_GetCreator_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_GetCreator_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
      ...
      private:
MbPointFrame * _underlying;                         size_t  ind;
  ...
  class PointFrame_SetCreator_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_SetCreator_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
...
MbPointFrame * _underlying;                         size_t  ind;
  ...
  class PointFrame_DetachCreator_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_DetachCreator_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
...
MbPointFrame * _underlying;                         size_t  ind;
  ...
  class PointFrame_AddCreator_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_AddCreator_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
      ...
      private:
MbPointFrame * _underlying;                        const MbCreator * creator;
                         bool  addSame= false;
  ...
  class PointFrame_GetCreators_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_GetCreators_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d);
...
MbPointFrame * _underlying;
  ...
  class PointFrame_DeleteCreator_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_DeleteCreator_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d,
                                 size_t  ind);
...
MbPointFrame * _underlying;                         size_t  ind;
  ...
  class PointFrame_GetActiveCreatorsCount_AsyncWorker : public PromiseWorker {
      public:
          PointFrame_GetActiveCreatorsCount_AsyncWorker(
MbPointFrame * _underlying,            Napi::Promise::Deferred const &d);
