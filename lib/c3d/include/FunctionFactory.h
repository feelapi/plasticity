...
class FunctionFactory : public
  Napi::ObjectWrap<FunctionFactory>
{
  public:
  ...
  class FunctionFactory_CreateAnalyticalFunction_AsyncWorker : public PromiseWorker {
      public:
          FunctionFactory_CreateAnalyticalFunction_AsyncWorker(
...
,
      ...
      private:
MbFunctionFactory * _underlying;                        const c3d::string_t data;
                        const c3d::string_t argument;
                         double  tmin;
                         double  tmax;
