...
Napi::Object PlaneInstance::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "PlaneInstance", {
...
PlaneInstance::PlaneInstance(const Napi::CallbackInfo& info) : Napi::ObjectWrap<PlaneInstance>(info) {
    ...
    if (info.Length() == 1 && info[0].IsString() && info[0].ToString().Utf8Value() == "__skip_js_init__") return;
        if (info.Length() == 2&&                ((
                info[0].IsObject() &&
                    info[0].ToObject().InstanceOf(PlaneItem::GetConstructor(env))
        )   
)
 &&         ((
                info[1].IsObject() &&
...
(
    ...
    Napi::Value PlaneInstance::GetPlacement_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_GetPlacement_AsyncWorker* asyncWorker = new PlaneInstance_GetPlacement_AsyncWorker(
...
(
    ...
    Napi::Value PlaneInstance::PlaneItemsCount_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_PlaneItemsCount_AsyncWorker* asyncWorker = new PlaneInstance_PlaneItemsCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
const MbPlaneItem * _result = _underlying->GetPlaneItem
(
        info.Length() == 0 || info[0].IsNull() ? 0 : ind
    ...
    Napi::Value PlaneInstance::GetPlaneItem_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_GetPlaneItem_AsyncWorker* asyncWorker = new PlaneInstance_GetPlaneItem_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value PlaneInstance::CreateMesh_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_CreateMesh_AsyncWorker* asyncWorker = new PlaneInstance_CreateMesh_AsyncWorker(
_underlying,            deferred
,
...
,        *mesh
    ...
    Napi::Value PlaneInstance::CalculateMesh_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_CalculateMesh_AsyncWorker* asyncWorker = new PlaneInstance_CalculateMesh_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value PlaneInstance::GetItemName_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_GetItemName_AsyncWorker* asyncWorker = new PlaneInstance_GetItemName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value PlaneInstance::SetItemName_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_SetItemName_AsyncWorker* asyncWorker = new PlaneInstance_SetItemName_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value PlaneInstance::RebuildItem_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_RebuildItem_AsyncWorker* asyncWorker = new PlaneInstance_RebuildItem_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 3 || info[3].IsNull() ? 0 : currInd
    ...
    Napi::Value PlaneInstance::GetItemByPath_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_GetItemByPath_AsyncWorker* asyncWorker = new PlaneInstance_GetItemByPath_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value PlaneInstance::IsA_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_IsA_AsyncWorker* asyncWorker = new PlaneInstance_IsA_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value PlaneInstance::Type_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_Type_AsyncWorker* asyncWorker = new PlaneInstance_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value PlaneInstance::Family_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_Family_AsyncWorker* asyncWorker = new PlaneInstance_Family_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value PlaneInstance::Transform_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_Transform_AsyncWorker* asyncWorker = new PlaneInstance_Transform_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value PlaneInstance::Move_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_Move_AsyncWorker* asyncWorker = new PlaneInstance_Move_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value PlaneInstance::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_Rotate_AsyncWorker* asyncWorker = new PlaneInstance_Rotate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value PlaneInstance::Refresh_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_Refresh_AsyncWorker* asyncWorker = new PlaneInstance_Refresh_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value PlaneInstance::Duplicate_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_Duplicate_AsyncWorker* asyncWorker = new PlaneInstance_Duplicate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value PlaneInstance::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_AddYourGabaritTo_AsyncWorker* asyncWorker = new PlaneInstance_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value PlaneInstance::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_GetUseCount_AsyncWorker* asyncWorker = new PlaneInstance_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value PlaneInstance::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_AddRef_AsyncWorker* asyncWorker = new PlaneInstance_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value PlaneInstance::SetStyle_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_SetStyle_AsyncWorker* asyncWorker = new PlaneInstance_SetStyle_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value PlaneInstance::GetStyle_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_GetStyle_AsyncWorker* asyncWorker = new PlaneInstance_GetStyle_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value PlaneInstance::SetColor_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_SetColor_AsyncWorker* asyncWorker = new PlaneInstance_SetColor_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value PlaneInstance::GetColor_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_GetColor_AsyncWorker* asyncWorker = new PlaneInstance_GetColor_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value PlaneInstance::AttributesConvert_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_AttributesConvert_AsyncWorker* asyncWorker = new PlaneInstance_AttributesConvert_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value PlaneInstance::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_GetCreatorsCount_AsyncWorker* asyncWorker = new PlaneInstance_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value PlaneInstance::GetCreator_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_GetCreator_AsyncWorker* asyncWorker = new PlaneInstance_GetCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value PlaneInstance::SetCreator_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_SetCreator_AsyncWorker* asyncWorker = new PlaneInstance_SetCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value PlaneInstance::DetachCreator_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_DetachCreator_AsyncWorker* asyncWorker = new PlaneInstance_DetachCreator_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? false : addSame
    ...
    Napi::Value PlaneInstance::AddCreator_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_AddCreator_AsyncWorker* asyncWorker = new PlaneInstance_AddCreator_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value PlaneInstance::GetCreators_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_GetCreators_AsyncWorker* asyncWorker = new PlaneInstance_GetCreators_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value PlaneInstance::DeleteCreator_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_DeleteCreator_AsyncWorker* asyncWorker = new PlaneInstance_DeleteCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value PlaneInstance::GetActiveCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        PlaneInstance_GetActiveCreatorsCount_AsyncWorker* asyncWorker = new PlaneInstance_GetActiveCreatorsCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
PlaneInstance::~PlaneInstance() {
    ...
    PlaneInstance_GetPlacement_AsyncWorker::PlaneInstance_GetPlacement_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
    ...
    PlaneInstance_PlaneItemsCount_AsyncWorker::PlaneInstance_PlaneItemsCount_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void PlaneInstance_PlaneItemsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    PlaneInstance_GetPlaneItem_AsyncWorker::PlaneInstance_GetPlaneItem_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    PlaneInstance_CreateMesh_AsyncWorker::PlaneInstance_CreateMesh_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    PlaneInstance_CalculateMesh_AsyncWorker::PlaneInstance_CalculateMesh_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbStepData & stepData,
                        const MbFormNote & note    )
...
,                        *mesh
    ...
    PlaneInstance_GetItemName_AsyncWorker::PlaneInstance_GetItemName_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    PlaneInstance_SetItemName_AsyncWorker::PlaneInstance_SetItemName_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         SimpleName  name    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    PlaneInstance_RebuildItem_AsyncWorker::PlaneInstance_RebuildItem_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        progInd
    ...
    PlaneInstance_GetItemByPath_AsyncWorker::PlaneInstance_GetItemByPath_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbPath & path,
                         size_t  ind,
...
,                        currInd
    ...
    PlaneInstance_IsA_AsyncWorker::PlaneInstance_IsA_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    PlaneInstance_Type_AsyncWorker::PlaneInstance_Type_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    PlaneInstance_Family_AsyncWorker::PlaneInstance_Family_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    PlaneInstance_Transform_AsyncWorker::PlaneInstance_Transform_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    PlaneInstance_Move_AsyncWorker::PlaneInstance_Move_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & v,
                         MbRegTransform * iReg    )
...
,                        iReg
    ...
    PlaneInstance_Rotate_AsyncWorker::PlaneInstance_Rotate_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbAxis3D & axis,
                         double  angle,
...
,                        iReg
    ...
    PlaneInstance_Refresh_AsyncWorker::PlaneInstance_Refresh_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    PlaneInstance_Duplicate_AsyncWorker::PlaneInstance_Duplicate_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         MbRegDuplicate * iReg    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    PlaneInstance_AddYourGabaritTo_AsyncWorker::PlaneInstance_AddYourGabaritTo_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         MbCube & cube    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    void PlaneInstance_AddYourGabaritTo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    PlaneInstance_GetUseCount_AsyncWorker::PlaneInstance_GetUseCount_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    PlaneInstance_AddRef_AsyncWorker::PlaneInstance_AddRef_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    PlaneInstance_SetStyle_AsyncWorker::PlaneInstance_SetStyle_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         int  s    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    PlaneInstance_GetStyle_AsyncWorker::PlaneInstance_GetStyle_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    PlaneInstance_SetColor_AsyncWorker::PlaneInstance_SetColor_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         uint32  c    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    PlaneInstance_GetColor_AsyncWorker::PlaneInstance_GetColor_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
...
{};
    ...
    void PlaneInstance_AttributesConvert_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    PlaneInstance_GetCreatorsCount_AsyncWorker::PlaneInstance_GetCreatorsCount_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void PlaneInstance_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    PlaneInstance_GetCreator_AsyncWorker::PlaneInstance_GetCreator_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    PlaneInstance_SetCreator_AsyncWorker::PlaneInstance_SetCreator_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    PlaneInstance_DetachCreator_AsyncWorker::PlaneInstance_DetachCreator_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    PlaneInstance_AddCreator_AsyncWorker::PlaneInstance_AddCreator_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        addSame
    ...
    PlaneInstance_GetCreators_AsyncWorker::PlaneInstance_GetCreators_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    PlaneInstance_DeleteCreator_AsyncWorker::PlaneInstance_DeleteCreator_AsyncWorker(
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
MbPlaneInstance * _underlying,        Napi::Promise::Deferred const &d
    ...
    void PlaneInstance_GetActiveCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
