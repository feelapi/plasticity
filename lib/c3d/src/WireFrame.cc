...
(
    ...
    Napi::Value WireFrame::GetCurves_async(const Napi::CallbackInfo& info) {
        ...
        WireFrame_GetCurves_AsyncWorker* asyncWorker = new WireFrame_GetCurves_AsyncWorker(
_underlying,            deferred
    ...
    WireFrame_GetCurves_AsyncWorker::WireFrame_GetCurves_AsyncWorker(
MbWireFrame * _underlying,        Napi::Promise::Deferred const &d
    )
