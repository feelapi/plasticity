...
(
    ...
    Napi::Value DraftSolid::IsA_async(const Napi::CallbackInfo& info) {
        ...
        DraftSolid_IsA_AsyncWorker* asyncWorker = new DraftSolid_IsA_AsyncWorker(
...
(
    ...
    Napi::Value DraftSolid::Type_async(const Napi::CallbackInfo& info) {
        ...
        DraftSolid_Type_AsyncWorker* asyncWorker = new DraftSolid_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value DraftSolid::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        DraftSolid_GetBasisPoints_AsyncWorker* asyncWorker = new DraftSolid_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value DraftSolid::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        DraftSolid_SetBasisPoints_AsyncWorker* asyncWorker = new DraftSolid_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value DraftSolid::GetBasisItems_async(const Napi::CallbackInfo& info) {
        ...
        DraftSolid_GetBasisItems_AsyncWorker* asyncWorker = new DraftSolid_GetBasisItems_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value DraftSolid::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        DraftSolid_GetCreatorsCount_AsyncWorker* asyncWorker = new DraftSolid_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value DraftSolid::GetYourNameMaker_async(const Napi::CallbackInfo& info) {
        ...
        DraftSolid_GetYourNameMaker_AsyncWorker* asyncWorker = new DraftSolid_GetYourNameMaker_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value DraftSolid::GetStatus_async(const Napi::CallbackInfo& info) {
        ...
        DraftSolid_GetStatus_AsyncWorker* asyncWorker = new DraftSolid_GetStatus_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value DraftSolid::SetStatus_async(const Napi::CallbackInfo& info) {
        ...
        DraftSolid_SetStatus_AsyncWorker* asyncWorker = new DraftSolid_SetStatus_AsyncWorker(
_underlying,            deferred
,
...
,        items
    ...
    Napi::Value DraftSolid::CreateShell_async(const Napi::CallbackInfo& info) {
        ...
        DraftSolid_CreateShell_AsyncWorker* asyncWorker = new DraftSolid_CreateShell_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value DraftSolid::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        DraftSolid_GetMainName_AsyncWorker* asyncWorker = new DraftSolid_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value DraftSolid::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        DraftSolid_GetUseCount_AsyncWorker* asyncWorker = new DraftSolid_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value DraftSolid::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        DraftSolid_AddRef_AsyncWorker* asyncWorker = new DraftSolid_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
DraftSolid::~DraftSolid() {
    ...
    DraftSolid_IsA_AsyncWorker::DraftSolid_IsA_AsyncWorker(
MbDraftSolid * _underlying,        Napi::Promise::Deferred const &d
    ...
    DraftSolid_Type_AsyncWorker::DraftSolid_Type_AsyncWorker(
MbDraftSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    DraftSolid_GetBasisPoints_AsyncWorker::DraftSolid_GetBasisPoints_AsyncWorker(
MbDraftSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    DraftSolid_SetBasisPoints_AsyncWorker::DraftSolid_SetBasisPoints_AsyncWorker(
MbDraftSolid * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    DraftSolid_GetBasisItems_AsyncWorker::DraftSolid_GetBasisItems_AsyncWorker(
MbDraftSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    DraftSolid_GetCreatorsCount_AsyncWorker::DraftSolid_GetCreatorsCount_AsyncWorker(
MbDraftSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeCreatorType  ct    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    DraftSolid_GetYourNameMaker_AsyncWorker::DraftSolid_GetYourNameMaker_AsyncWorker(
MbDraftSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    DraftSolid_GetStatus_AsyncWorker::DraftSolid_GetStatus_AsyncWorker(
MbDraftSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    DraftSolid_SetStatus_AsyncWorker::DraftSolid_SetStatus_AsyncWorker(
MbDraftSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeProcessState  l    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    DraftSolid_CreateShell_AsyncWorker::DraftSolid_CreateShell_AsyncWorker(
MbDraftSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbFaceShell * shell,
...
,                        items
    ...
    DraftSolid_GetMainName_AsyncWorker::DraftSolid_GetMainName_AsyncWorker(
MbDraftSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    DraftSolid_GetUseCount_AsyncWorker::DraftSolid_GetUseCount_AsyncWorker(
MbDraftSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    DraftSolid_AddRef_AsyncWorker::DraftSolid_AddRef_AsyncWorker(
MbDraftSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
