...
Solid::Solid(const Napi::CallbackInfo &info) : Napi::ObjectWrap<Solid>(info)
{
    ...
    if (info.Length() == 1 && info[0].IsString() && info[0].ToString().Utf8Value() == "__skip_js_init__")
        return;
    if (info.Length() == 2 && ((info[0].IsObject() && info[0].ToObject().InstanceOf(FaceShell::GetConstructor(env)))) &&
        ((info[1].IsObject() && info[1].ToObject().InstanceOf(Creator::GetConstructor(env))))
    ...
    )
    {
        ...
        this->_underlying = underlying;
             ...
             ((info[2].IsObject() && info[2].ToObject().InstanceOf(Creator::GetConstructor(env))) ||
...
Napi::Value Solid::GetEdges_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetEdges_AsyncWorker *asyncWorker = new Solid_GetEdges_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value Solid::GetFaces_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetFaces_AsyncWorker *asyncWorker = new Solid_GetFaces_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
{
    Napi::Env env = info.Env();
    if (info.Length() == 0 || !((info[0].IsObject() && info[0].ToObject().InstanceOf(Name::GetConstructor(env)))))
    {
    ...
    const MbFace *_result = _underlying->FindFaceByName(name
...
Napi::Value Solid::FindFaceByName_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_FindFaceByName_AsyncWorker *asyncWorker = new Solid_FindFaceByName_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::FindFaceByHash(const Napi::CallbackInfo &info)
{
    ...
    const MbFace *_result = _underlying->FindFaceByHash(h
...
Napi::Value Solid::FindFaceByHash_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_FindFaceByHash_AsyncWorker *asyncWorker = new Solid_FindFaceByHash_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::GetFace(const Napi::CallbackInfo &info)
{
    ...
    const MbFace *_result = _underlying->GetFace(index
...
Napi::Value Solid::GetFace_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetFace_AsyncWorker *asyncWorker = new Solid_GetFace_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::GetEdge_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetEdge_AsyncWorker *asyncWorker = new Solid_GetEdge_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::FindEdgeByName(const Napi::CallbackInfo &info)
{
    ...
    MbCurveEdge *_result = _underlying->FindEdgeByName(name
...
Napi::Value Solid::FindEdgeByName_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_FindEdgeByName_AsyncWorker *asyncWorker = new Solid_FindEdgeByName_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::GetShell_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetShell_AsyncWorker *asyncWorker = new Solid_GetShell_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
{
    Napi::Env env = info.Env();
    if (info.Length() == 0 || !((info[0].IsObject() && info[0].ToObject().InstanceOf(Face::GetConstructor(env)))))
    {
    ...
    size_t _result = _underlying->GetFaceIndex(face
...
Napi::Value Solid::GetFaceIndex_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetFaceIndex_AsyncWorker *asyncWorker = new Solid_GetFaceIndex_AsyncWorker(_underlying, deferred,
...
{
    Napi::Env env = info.Env();
    if (info.Length() == 0 || !((info[0].IsObject() && info[0].ToObject().InstanceOf(CurveEdge::GetConstructor(env)))))
    {
    ...
    size_t _result = _underlying->GetEdgeIndex(edge
...
Napi::Value Solid::GetEdgeIndex_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetEdgeIndex_AsyncWorker *asyncWorker = new Solid_GetEdgeIndex_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::GetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetBasisPoints_AsyncWorker *asyncWorker = new Solid_GetBasisPoints_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::SetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_SetBasisPoints_AsyncWorker *asyncWorker = new Solid_SetBasisPoints_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::GetItems_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetItems_AsyncWorker *asyncWorker = new Solid_GetItems_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::IsClosed_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_IsClosed_AsyncWorker *asyncWorker = new Solid_IsClosed_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::GetCube_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetCube_AsyncWorker *asyncWorker = new Solid_GetCube_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
Napi::Value Solid::SetOwnChangedThrough(const Napi::CallbackInfo &info)
{
    ...
    _underlying->SetOwnChangedThrough(type
...
Napi::Value Solid::SetOwnChangedThrough_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_SetOwnChangedThrough_AsyncWorker *asyncWorker =
        new Solid_SetOwnChangedThrough_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::MakeRight_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_MakeRight_AsyncWorker *asyncWorker = new Solid_MakeRight_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::IsRight_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_IsRight_AsyncWorker *asyncWorker = new Solid_IsRight_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
Napi::Value Solid::SolidClassification(const Napi::CallbackInfo &info)
{
    ...
    MbeItemLocation _result =
        _underlying->SolidClassification(solid, info.Length() == 1 || info[1].IsNull() ? Math::metricRegion : epsilon
...
Napi::Value Solid::SolidClassification_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_SolidClassification_AsyncWorker *asyncWorker =
        new Solid_SolidClassification_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::CreateMesh_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_CreateMesh_AsyncWorker *asyncWorker = new Solid_CreateMesh_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::CalculateMesh_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_CalculateMesh_AsyncWorker *asyncWorker = new Solid_CalculateMesh_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::GetItemName_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetItemName_AsyncWorker *asyncWorker = new Solid_GetItemName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::SetItemName_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_SetItemName_AsyncWorker *asyncWorker = new Solid_SetItemName_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::RebuildItem_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_RebuildItem_AsyncWorker *asyncWorker = new Solid_RebuildItem_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::GetItemByPath_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetItemByPath_AsyncWorker *asyncWorker = new Solid_GetItemByPath_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_IsA_AsyncWorker *asyncWorker = new Solid_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::Type_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_Type_AsyncWorker *asyncWorker = new Solid_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::Family_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_Family_AsyncWorker *asyncWorker = new Solid_Family_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::Transform_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_Transform_AsyncWorker *asyncWorker = new Solid_Transform_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::Move_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_Move_AsyncWorker *asyncWorker = new Solid_Move_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::Rotate_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_Rotate_AsyncWorker *asyncWorker = new Solid_Rotate_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::Refresh_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_Refresh_AsyncWorker *asyncWorker = new Solid_Refresh_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::Duplicate_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_Duplicate_AsyncWorker *asyncWorker = new Solid_Duplicate_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::AddYourGabaritTo_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_AddYourGabaritTo_AsyncWorker *asyncWorker = new Solid_AddYourGabaritTo_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetUseCount_AsyncWorker *asyncWorker = new Solid_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_AddRef_AsyncWorker *asyncWorker = new Solid_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::SetStyle_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_SetStyle_AsyncWorker *asyncWorker = new Solid_SetStyle_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::GetStyle_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetStyle_AsyncWorker *asyncWorker = new Solid_GetStyle_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::SetColor_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_SetColor_AsyncWorker *asyncWorker = new Solid_SetColor_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::GetColor_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetColor_AsyncWorker *asyncWorker = new Solid_GetColor_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::AttributesConvert_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_AttributesConvert_AsyncWorker *asyncWorker = new Solid_AttributesConvert_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::GetCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetCreatorsCount_AsyncWorker *asyncWorker = new Solid_GetCreatorsCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::GetCreator_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetCreator_AsyncWorker *asyncWorker = new Solid_GetCreator_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::SetCreator_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_SetCreator_AsyncWorker *asyncWorker = new Solid_SetCreator_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::DetachCreator_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_DetachCreator_AsyncWorker *asyncWorker = new Solid_DetachCreator_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::AddCreator_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_AddCreator_AsyncWorker *asyncWorker = new Solid_AddCreator_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::GetCreators_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetCreators_AsyncWorker *asyncWorker = new Solid_GetCreators_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Solid::DeleteCreator_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_DeleteCreator_AsyncWorker *asyncWorker = new Solid_DeleteCreator_AsyncWorker(_underlying, deferred,
...
Napi::Value Solid::GetActiveCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    Solid_GetActiveCreatorsCount_AsyncWorker *asyncWorker =
        new Solid_GetActiveCreatorsCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Solid_GetEdges_AsyncWorker::Solid_GetEdges_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
...
Solid_GetFaces_AsyncWorker::Solid_GetFaces_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_FindFaceByName_AsyncWorker::Solid_FindFaceByName_AsyncWorker(MbSolid *_underlying,
                                                                   Napi::Promise::Deferred const &d, const MbName &name)
...
Solid_FindFaceByHash_AsyncWorker::Solid_FindFaceByHash_AsyncWorker(MbSolid *_underlying,
                                                                   Napi::Promise::Deferred const &d, const SimpleName h)
    : _underlying(_underlying), PromiseWorker(d), h(h){};
...
Solid_GetFace_AsyncWorker::Solid_GetFace_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
                                                     size_t index)
...
Solid_GetEdge_AsyncWorker::Solid_GetEdge_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
                                                     size_t index)
    : _underlying(_underlying), PromiseWorker(d), index(index){};
...
Solid_FindEdgeByName_AsyncWorker::Solid_FindEdgeByName_AsyncWorker(MbSolid *_underlying,
                                                                   Napi::Promise::Deferred const &d, const MbName &name)
    : _underlying(_underlying), PromiseWorker(d), name(name){};
...
Solid_GetShell_AsyncWorker::Solid_GetShell_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_GetFaceIndex_AsyncWorker::Solid_GetFaceIndex_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
                                                               const MbFace &face)
    : _underlying(_underlying), PromiseWorker(d), face(face){};
...
Solid_GetEdgeIndex_AsyncWorker::Solid_GetEdgeIndex_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
                                                               const MbCurveEdge &edge)
    : _underlying(_underlying), PromiseWorker(d), edge(edge){};
...
Solid_GetBasisPoints_AsyncWorker::Solid_GetBasisPoints_AsyncWorker(MbSolid *_underlying,
...
Solid_SetBasisPoints_AsyncWorker::Solid_SetBasisPoints_AsyncWorker(MbSolid *_underlying,
                                                                   Napi::Promise::Deferred const &d,
...
Solid_GetItems_AsyncWorker::Solid_GetItems_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_IsClosed_AsyncWorker::Solid_IsClosed_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_GetCube_AsyncWorker::Solid_GetCube_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_SetOwnChangedThrough_AsyncWorker::Solid_SetOwnChangedThrough_AsyncWorker(MbSolid *_underlying,
                                                                               Napi::Promise::Deferred const &d,
                                                                               MbeChangedType type)
    : _underlying(_underlying), PromiseWorker(d), type(type){};
...
Solid_MakeRight_AsyncWorker::Solid_MakeRight_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_IsRight_AsyncWorker::Solid_IsRight_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_SolidClassification_AsyncWorker::Solid_SolidClassification_AsyncWorker(MbSolid *_underlying,
                                                                             Napi::Promise::Deferred const &d,
                                                                             const MbSolid &solid, double epsilon)
    : _underlying(_underlying), PromiseWorker(d), solid(solid), epsilon(epsilon){};

void Solid_SolidClassification_AsyncWorker::Execute()
{
    EnterParallelRegion();

    MbeItemLocation _result = _underlying->SolidClassification(solid, epsilon);
...
Solid_CreateMesh_AsyncWorker::Solid_CreateMesh_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
...
Solid_CalculateMesh_AsyncWorker::Solid_CalculateMesh_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
                                                                 const MbStepData &stepData, const MbFormNote &note)
...
Solid_GetItemName_AsyncWorker::Solid_GetItemName_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_SetItemName_AsyncWorker::Solid_SetItemName_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
                                                             SimpleName name)
    : _underlying(_underlying), PromiseWorker(d), name(name){};
...
Solid_RebuildItem_AsyncWorker::Solid_RebuildItem_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
...
Solid_GetItemByPath_AsyncWorker::Solid_GetItemByPath_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
...
Solid_IsA_AsyncWorker::Solid_IsA_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_Type_AsyncWorker::Solid_Type_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_Family_AsyncWorker::Solid_Family_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_Transform_AsyncWorker::Solid_Transform_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
...
Solid_Move_AsyncWorker::Solid_Move_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
...
Solid_Rotate_AsyncWorker::Solid_Rotate_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
...
Solid_Refresh_AsyncWorker::Solid_Refresh_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_Duplicate_AsyncWorker::Solid_Duplicate_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
                                                         MbRegDuplicate *iReg)
...
Solid_AddYourGabaritTo_AsyncWorker::Solid_AddYourGabaritTo_AsyncWorker(MbSolid *_underlying,
...
Solid_GetUseCount_AsyncWorker::Solid_GetUseCount_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_AddRef_AsyncWorker::Solid_AddRef_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_SetStyle_AsyncWorker::Solid_SetStyle_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d, int s)
...
Solid_GetStyle_AsyncWorker::Solid_GetStyle_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_SetColor_AsyncWorker::Solid_SetColor_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d, uint32 c)
...
Solid_GetColor_AsyncWorker::Solid_GetColor_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_AttributesConvert_AsyncWorker::Solid_AttributesConvert_AsyncWorker(MbSolid *_underlying,
                                                                         Napi::Promise::Deferred const &d,
                                                                         MbGrid &other)
...
Solid_GetCreatorsCount_AsyncWorker::Solid_GetCreatorsCount_AsyncWorker(MbSolid *_underlying,
                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_GetCreator_AsyncWorker::Solid_GetCreator_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
                                                           size_t ind)
...
Solid_SetCreator_AsyncWorker::Solid_SetCreator_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
                                                           size_t ind)
    : _underlying(_underlying), PromiseWorker(d), ind(ind){};
...
Solid_DetachCreator_AsyncWorker::Solid_DetachCreator_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
                                                                 size_t ind)
    : _underlying(_underlying), PromiseWorker(d), ind(ind){};
...
Solid_AddCreator_AsyncWorker::Solid_AddCreator_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
...
Solid_GetCreators_AsyncWorker::Solid_GetCreators_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Solid_DeleteCreator_AsyncWorker::Solid_DeleteCreator_AsyncWorker(MbSolid *_underlying, Napi::Promise::Deferred const &d,
                                                                 size_t ind)
    : _underlying(_underlying), PromiseWorker(d), ind(ind){};
...
Solid_GetActiveCreatorsCount_AsyncWorker::Solid_GetActiveCreatorsCount_AsyncWorker(MbSolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
