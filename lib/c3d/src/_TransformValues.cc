...
_TransformValues::_TransformValues(const Napi::CallbackInfo& info) : Napi::ObjectWrap<_TransformValues>(info) {
    ...
    if (info.Length() == 1 && info[0].IsString() && info[0].ToString().Utf8Value() == "__skip_js_init__") return;
        if (info.Length() == 0        
            ...
            this->_underlying = underlying;
                ...
                info[0].IsObject() &&
                    info[0].ToObject().InstanceOf(Matrix3D::GetConstructor(env))
        )   
)
 ...
 &&         ((
                info[3].IsObject() &&
                    info[3].ToObject().InstanceOf(CartPoint3D::GetConstructor(env))
        )   
)
...
(
    ...
    Napi::Value _TransformValues::Move_async(const Napi::CallbackInfo& info) {
        ...
        _TransformValues_Move_AsyncWorker* asyncWorker = new _TransformValues_Move_AsyncWorker(
...
,        ang
    ...
    Napi::Value _TransformValues::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        _TransformValues_Rotate_AsyncWorker* asyncWorker = new _TransformValues_Rotate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value _TransformValues::GetMatrix_async(const Napi::CallbackInfo& info) {
        ...
        _TransformValues_GetMatrix_AsyncWorker* asyncWorker = new _TransformValues_GetMatrix_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value _TransformValues::SetFixed_async(const Napi::CallbackInfo& info) {
        ...
        _TransformValues_SetFixed_AsyncWorker* asyncWorker = new _TransformValues_SetFixed_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value _TransformValues::SetFixedPoint_async(const Napi::CallbackInfo& info) {
        ...
        _TransformValues_SetFixedPoint_AsyncWorker* asyncWorker = new _TransformValues_SetFixedPoint_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
    ...
    _TransformValues_Move_AsyncWorker::_TransformValues_Move_AsyncWorker(
TransformValues * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & to    )
...
{};
    ...
    _TransformValues_Rotate_AsyncWorker::_TransformValues_Rotate_AsyncWorker(
TransformValues * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbAxis3D & axis,
                         double  ang    )
...
,                        ang
    ...
    _TransformValues_GetMatrix_AsyncWorker::_TransformValues_GetMatrix_AsyncWorker(
TransformValues * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    _TransformValues_SetFixed_AsyncWorker::_TransformValues_SetFixed_AsyncWorker(
TransformValues * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  b    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    _TransformValues_SetFixedPoint_AsyncWorker::_TransformValues_SetFixedPoint_AsyncWorker(
TransformValues * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void _TransformValues_SetFixedPoint_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
