...
MergingFlags::MergingFlags(const Napi::CallbackInfo &info) : Napi::ObjectWrap<MergingFlags>(info)
{
    ...
    else if (info.Length() == 2 && ((info[0].IsBoolean())) && ((info[1].IsBoolean()))
...
Napi::Value MergingFlags::SetMergingFaces_async(const Napi::CallbackInfo &info)
{
    ...
    MergingFlags_SetMergingFaces_AsyncWorker *asyncWorker =
        new MergingFlags_SetMergingFaces_AsyncWorker(_underlying, deferred,
...
Napi::Value MergingFlags::SetMergingEdges_async(const Napi::CallbackInfo &info)
{
    ...
    MergingFlags_SetMergingEdges_AsyncWorker *asyncWorker =
        new MergingFlags_SetMergingEdges_AsyncWorker(_underlying, deferred,
...
MergingFlags_SetMergingFaces_AsyncWorker::MergingFlags_SetMergingFaces_AsyncWorker(MbMergingFlags *_underlying,
...
MergingFlags_SetMergingEdges_AsyncWorker::MergingFlags_SetMergingEdges_AsyncWorker(MbMergingFlags *_underlying,
                                                                                   Napi::Promise::Deferred const &d,
                                                                                   bool s)
    : _underlying(_underlying), PromiseWorker(d), s(s){};
