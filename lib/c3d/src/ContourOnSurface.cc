...
Napi::Object ContourOnSurface::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "ContourOnSurface", {
...
(
    ...
    Napi::Value ContourOnSurface::GetContour_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetContour_AsyncWorker* asyncWorker = new ContourOnSurface_GetContour_AsyncWorker(
...
(
    ...
    Napi::Value ContourOnSurface::GetSurface_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetSurface_AsyncWorker* asyncWorker = new ContourOnSurface_GetSurface_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::GetSegment_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetSegment_AsyncWorker* asyncWorker = new ContourOnSurface_GetSegment_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnSurface::GetSegmentsCount_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetSegmentsCount_AsyncWorker* asyncWorker = new ContourOnSurface_GetSegmentsCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
if (_result) {
    ...
    Napi::Value ContourOnSurface::GetPlaneCurve_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetPlaneCurve_AsyncWorker* asyncWorker = new ContourOnSurface_GetPlaneCurve_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnSurface::IsPlanar_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_IsPlanar_AsyncWorker* asyncWorker = new ContourOnSurface_IsPlanar_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnSurface::IsClosed_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_IsClosed_AsyncWorker* asyncWorker = new ContourOnSurface_IsClosed_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::IsTouch_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_IsTouch_AsyncWorker* asyncWorker = new ContourOnSurface_IsTouch_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::GetTMax_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetTMax_AsyncWorker* asyncWorker = new ContourOnSurface_GetTMax_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::GetTMin_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetTMin_AsyncWorker* asyncWorker = new ContourOnSurface_GetTMin_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::GetPeriod_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetPeriod_AsyncWorker* asyncWorker = new ContourOnSurface_GetPeriod_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::IsPeriodic_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_IsPeriodic_AsyncWorker* asyncWorker = new ContourOnSurface_IsPeriodic_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::IsStraight_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_IsStraight_AsyncWorker* asyncWorker = new ContourOnSurface_IsStraight_AsyncWorker(
_underlying,            deferred
,
...
,        sense
    ...
    Napi::Value ContourOnSurface::Trimmed_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_Trimmed_AsyncWorker* asyncWorker = new ContourOnSurface_Trimmed_AsyncWorker(
_underlying,            deferred
,
...
,        *n
    ...
    Napi::Value ContourOnSurface::Normal_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_Normal_AsyncWorker* asyncWorker = new ContourOnSurface_Normal_AsyncWorker(
_underlying,            deferred
,
...
,        *tan
    ...
    Napi::Value ContourOnSurface::Tangent_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_Tangent_AsyncWorker* asyncWorker = new ContourOnSurface_Tangent_AsyncWorker(
_underlying,            deferred
,
...
,        *b
    ...
    Napi::Value ContourOnSurface::BNormal_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_BNormal_AsyncWorker* asyncWorker = new ContourOnSurface_BNormal_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnSurface::GetCentre_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetCentre_AsyncWorker* asyncWorker = new ContourOnSurface_GetCentre_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        *point
    ...
    Napi::Value ContourOnSurface::GetLimitPoint_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetLimitPoint_AsyncWorker* asyncWorker = new ContourOnSurface_GetLimitPoint_AsyncWorker(
_underlying,            deferred
,
...
,        *p
    ...
    Napi::Value ContourOnSurface::PointOn_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_PointOn_AsyncWorker* asyncWorker = new ContourOnSurface_PointOn_AsyncWorker(
_underlying,            deferred
,
...
,        *p
    ...
    Napi::Value ContourOnSurface::_PointOn_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface__PointOn_AsyncWorker* asyncWorker = new ContourOnSurface__PointOn_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : tRange
    ...
    Napi::Value ContourOnSurface::NearPointProjection_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_NearPointProjection_AsyncWorker* asyncWorker = new ContourOnSurface_NearPointProjection_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value ContourOnSurface::GetSurfaceCurve_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetSurfaceCurve_AsyncWorker* asyncWorker = new ContourOnSurface_GetSurfaceCurve_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnSurface::GetWeightCentre_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetWeightCentre_AsyncWorker* asyncWorker = new ContourOnSurface_GetWeightCentre_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::GetBasisCurve_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetBasisCurve_AsyncWorker* asyncWorker = new ContourOnSurface_GetBasisCurve_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetBasisPoints_AsyncWorker* asyncWorker = new ContourOnSurface_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_SetBasisPoints_AsyncWorker* asyncWorker = new ContourOnSurface_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnSurface::Inverse_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_Inverse_AsyncWorker* asyncWorker = new ContourOnSurface_Inverse_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? Math::DefaultMathVersion() : version
    ...
    Napi::Value ContourOnSurface::GetProjection_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetProjection_AsyncWorker* asyncWorker = new ContourOnSurface_GetProjection_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnSurface::GetCircleAxis_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetCircleAxis_AsyncWorker* asyncWorker = new ContourOnSurface_GetCircleAxis_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::IsA_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_IsA_AsyncWorker* asyncWorker = new ContourOnSurface_IsA_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::Type_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_Type_AsyncWorker* asyncWorker = new ContourOnSurface_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::Family_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_Family_AsyncWorker* asyncWorker = new ContourOnSurface_Family_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value ContourOnSurface::Transform_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_Transform_AsyncWorker* asyncWorker = new ContourOnSurface_Transform_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value ContourOnSurface::Move_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_Move_AsyncWorker* asyncWorker = new ContourOnSurface_Move_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value ContourOnSurface::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_Rotate_AsyncWorker* asyncWorker = new ContourOnSurface_Rotate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnSurface::Refresh_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_Refresh_AsyncWorker* asyncWorker = new ContourOnSurface_Refresh_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::Duplicate_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_Duplicate_AsyncWorker* asyncWorker = new ContourOnSurface_Duplicate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnSurface::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_AddYourGabaritTo_AsyncWorker* asyncWorker = new ContourOnSurface_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnSurface::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_GetUseCount_AsyncWorker* asyncWorker = new ContourOnSurface_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnSurface::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnSurface_AddRef_AsyncWorker* asyncWorker = new ContourOnSurface_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
ContourOnSurface::~ContourOnSurface() {
    ...
    ContourOnSurface_GetContour_AsyncWorker::ContourOnSurface_GetContour_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    ...
    ContourOnSurface_GetSurface_AsyncWorker::ContourOnSurface_GetSurface_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnSurface_GetSegment_AsyncWorker::ContourOnSurface_GetSegment_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  index    )
        :_underlying(_underlying),PromiseWorker(d),
...
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    ...
    void ContourOnSurface_GetSegmentsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnSurface_GetPlaneCurve_AsyncWorker::ContourOnSurface_GetPlaneCurve_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  saveParams,
                         PlanarCheckParams  params    )
...
,                        params
    ...
    void ContourOnSurface_GetPlaneCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnSurface_IsPlanar_AsyncWorker::ContourOnSurface_IsPlanar_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         double  accuracy    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    ContourOnSurface_IsClosed_AsyncWorker::ContourOnSurface_IsClosed_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnSurface_IsTouch_AsyncWorker::ContourOnSurface_IsTouch_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnSurface_GetTMax_AsyncWorker::ContourOnSurface_GetTMax_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnSurface_GetTMin_AsyncWorker::ContourOnSurface_GetTMin_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnSurface_GetPeriod_AsyncWorker::ContourOnSurface_GetPeriod_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnSurface_IsPeriodic_AsyncWorker::ContourOnSurface_IsPeriodic_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnSurface_IsStraight_AsyncWorker::ContourOnSurface_IsStraight_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  ignoreParams    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    ContourOnSurface_Trimmed_AsyncWorker::ContourOnSurface_Trimmed_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         double  t1,
                         double  t2,
...
,                        sense
    ...
    ContourOnSurface_Normal_AsyncWorker::ContourOnSurface_Normal_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *n
    ...
    ContourOnSurface_Tangent_AsyncWorker::ContourOnSurface_Tangent_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *tan
    ...
    ContourOnSurface_BNormal_AsyncWorker::ContourOnSurface_BNormal_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *b
    ...
    ContourOnSurface_GetCentre_AsyncWorker::ContourOnSurface_GetCentre_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnSurface_GetLimitPoint_AsyncWorker::ContourOnSurface_GetLimitPoint_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         ptrdiff_t  number    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *point
    ...
    void ContourOnSurface_GetLimitPoint_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnSurface_PointOn_AsyncWorker::ContourOnSurface_PointOn_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *p
    ...
    ContourOnSurface__PointOn_AsyncWorker::ContourOnSurface__PointOn_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        tRange
    ...
    void ContourOnSurface_NearPointProjection_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        version
    ...
    void ContourOnSurface_GetSurfaceCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    ...
    void ContourOnSurface_GetWeightCentre_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnSurface_GetBasisCurve_AsyncWorker::ContourOnSurface_GetBasisCurve_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void ContourOnSurface_GetBasisCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    ...
    void ContourOnSurface_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void ContourOnSurface_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnSurface_Inverse_AsyncWorker::ContourOnSurface_Inverse_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnSurface_GetProjection_AsyncWorker::ContourOnSurface_GetProjection_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        version
    ...
    void ContourOnSurface_GetProjection_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnSurface_GetCircleAxis_AsyncWorker::ContourOnSurface_GetCircleAxis_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void ContourOnSurface_GetCircleAxis_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnSurface_IsA_AsyncWorker::ContourOnSurface_IsA_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnSurface_Type_AsyncWorker::ContourOnSurface_Type_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnSurface_Family_AsyncWorker::ContourOnSurface_Family_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnSurface_Transform_AsyncWorker::ContourOnSurface_Transform_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    ContourOnSurface_Move_AsyncWorker::ContourOnSurface_Move_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & v,
                         MbRegTransform * iReg    )
...
,                        iReg
    ...
    ContourOnSurface_Rotate_AsyncWorker::ContourOnSurface_Rotate_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbAxis3D & axis,
                         double  angle,
...
,                        iReg
    ...
    ContourOnSurface_Refresh_AsyncWorker::ContourOnSurface_Refresh_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnSurface_Duplicate_AsyncWorker::ContourOnSurface_Duplicate_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         MbRegDuplicate * iReg    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    void ContourOnSurface_AddYourGabaritTo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnSurface_GetUseCount_AsyncWorker::ContourOnSurface_GetUseCount_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnSurface_AddRef_AsyncWorker::ContourOnSurface_AddRef_AsyncWorker(
MbContourOnSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
