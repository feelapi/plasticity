...
{
    Napi::Function func =
        DefineClass(env, "CurveEvolutionSolid",
                    {
...
Napi::Value CurveEvolutionSolid::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEvolutionSolid_IsA_AsyncWorker *asyncWorker = new CurveEvolutionSolid_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value CurveEvolutionSolid::Type_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEvolutionSolid_Type_AsyncWorker *asyncWorker = new CurveEvolutionSolid_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEvolutionSolid::GetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEvolutionSolid_GetBasisPoints_AsyncWorker *asyncWorker =
        new CurveEvolutionSolid_GetBasisPoints_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEvolutionSolid::SetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEvolutionSolid_SetBasisPoints_AsyncWorker *asyncWorker =
        new CurveEvolutionSolid_SetBasisPoints_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEvolutionSolid::GetBasisItems_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEvolutionSolid_GetBasisItems_AsyncWorker *asyncWorker =
        new CurveEvolutionSolid_GetBasisItems_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEvolutionSolid::GetCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEvolutionSolid_GetCreatorsCount_AsyncWorker *asyncWorker =
        new CurveEvolutionSolid_GetCreatorsCount_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEvolutionSolid::GetYourNameMaker_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEvolutionSolid_GetYourNameMaker_AsyncWorker *asyncWorker =
        new CurveEvolutionSolid_GetYourNameMaker_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEvolutionSolid::GetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEvolutionSolid_GetStatus_AsyncWorker *asyncWorker =
        new CurveEvolutionSolid_GetStatus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEvolutionSolid::SetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEvolutionSolid_SetStatus_AsyncWorker *asyncWorker =
        new CurveEvolutionSolid_SetStatus_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEvolutionSolid::CreateShell_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEvolutionSolid_CreateShell_AsyncWorker *asyncWorker =
        new CurveEvolutionSolid_CreateShell_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEvolutionSolid::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEvolutionSolid_GetMainName_AsyncWorker *asyncWorker =
        new CurveEvolutionSolid_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEvolutionSolid::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEvolutionSolid_GetUseCount_AsyncWorker *asyncWorker =
        new CurveEvolutionSolid_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEvolutionSolid::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEvolutionSolid_AddRef_AsyncWorker *asyncWorker =
        new CurveEvolutionSolid_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
CurveEvolutionSolid_IsA_AsyncWorker::CurveEvolutionSolid_IsA_AsyncWorker(MbCurveEvolutionSolid *_underlying,
...
CurveEvolutionSolid_Type_AsyncWorker::CurveEvolutionSolid_Type_AsyncWorker(MbCurveEvolutionSolid *_underlying,
                                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void CurveEvolutionSolid_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
CurveEvolutionSolid_SetBasisPoints_AsyncWorker::CurveEvolutionSolid_SetBasisPoints_AsyncWorker(
    MbCurveEvolutionSolid *_underlying, Napi::Promise::Deferred const &d, const MbControlData3D &cd)
...
void CurveEvolutionSolid_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                            Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void CurveEvolutionSolid_GetBasisItems_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                           Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
CurveEvolutionSolid_GetCreatorsCount_AsyncWorker::CurveEvolutionSolid_GetCreatorsCount_AsyncWorker(
    MbCurveEvolutionSolid *_underlying, Napi::Promise::Deferred const &d, MbeCreatorType ct)
...
void CurveEvolutionSolid_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                              Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void CurveEvolutionSolid_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                              Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
CurveEvolutionSolid_GetStatus_AsyncWorker::CurveEvolutionSolid_GetStatus_AsyncWorker(MbCurveEvolutionSolid *_underlying,
                                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void CurveEvolutionSolid_GetStatus_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                       Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
CurveEvolutionSolid_SetStatus_AsyncWorker::CurveEvolutionSolid_SetStatus_AsyncWorker(MbCurveEvolutionSolid *_underlying,
                                                                                     Napi::Promise::Deferred const &d,
                                                                                     MbeProcessState l)
...
void CurveEvolutionSolid_SetStatus_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                       Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
CurveEvolutionSolid_CreateShell_AsyncWorker::CurveEvolutionSolid_CreateShell_AsyncWorker(
    MbCurveEvolutionSolid *_underlying, Napi::Promise::Deferred const &d, MbFaceShell *shell, MbeCopyMode sameShell)
...
void CurveEvolutionSolid_CreateShell_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                         Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void CurveEvolutionSolid_GetMainName_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                         Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void CurveEvolutionSolid_GetUseCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                         Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
CurveEvolutionSolid_AddRef_AsyncWorker::CurveEvolutionSolid_AddRef_AsyncWorker(MbCurveEvolutionSolid *_underlying,
                                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
