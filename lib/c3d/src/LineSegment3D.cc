...
Napi::Object LineSegment3D::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "LineSegment3D", {
...
if (_result) {
    ...
    Napi::Value LineSegment3D::GetPlaneCurve_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_GetPlaneCurve_AsyncWorker* asyncWorker = new LineSegment3D_GetPlaneCurve_AsyncWorker(
...
(
    ...
    Napi::Value LineSegment3D::IsPlanar_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_IsPlanar_AsyncWorker* asyncWorker = new LineSegment3D_IsPlanar_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value LineSegment3D::IsClosed_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_IsClosed_AsyncWorker* asyncWorker = new LineSegment3D_IsClosed_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value LineSegment3D::IsTouch_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_IsTouch_AsyncWorker* asyncWorker = new LineSegment3D_IsTouch_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value LineSegment3D::GetTMax_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_GetTMax_AsyncWorker* asyncWorker = new LineSegment3D_GetTMax_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value LineSegment3D::GetTMin_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_GetTMin_AsyncWorker* asyncWorker = new LineSegment3D_GetTMin_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value LineSegment3D::GetPeriod_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_GetPeriod_AsyncWorker* asyncWorker = new LineSegment3D_GetPeriod_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value LineSegment3D::IsPeriodic_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_IsPeriodic_AsyncWorker* asyncWorker = new LineSegment3D_IsPeriodic_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value LineSegment3D::IsStraight_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_IsStraight_AsyncWorker* asyncWorker = new LineSegment3D_IsStraight_AsyncWorker(
_underlying,            deferred
,
...
,        sense
    ...
    Napi::Value LineSegment3D::Trimmed_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_Trimmed_AsyncWorker* asyncWorker = new LineSegment3D_Trimmed_AsyncWorker(
_underlying,            deferred
,
...
,        *n
    ...
    Napi::Value LineSegment3D::Normal_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_Normal_AsyncWorker* asyncWorker = new LineSegment3D_Normal_AsyncWorker(
_underlying,            deferred
,
...
,        *tan
    ...
    Napi::Value LineSegment3D::Tangent_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_Tangent_AsyncWorker* asyncWorker = new LineSegment3D_Tangent_AsyncWorker(
_underlying,            deferred
,
...
,        *b
    ...
    Napi::Value LineSegment3D::BNormal_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_BNormal_AsyncWorker* asyncWorker = new LineSegment3D_BNormal_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value LineSegment3D::GetCentre_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_GetCentre_AsyncWorker* asyncWorker = new LineSegment3D_GetCentre_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        *point
    ...
    Napi::Value LineSegment3D::GetLimitPoint_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_GetLimitPoint_AsyncWorker* asyncWorker = new LineSegment3D_GetLimitPoint_AsyncWorker(
_underlying,            deferred
,
...
,        *p
    ...
    Napi::Value LineSegment3D::PointOn_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_PointOn_AsyncWorker* asyncWorker = new LineSegment3D_PointOn_AsyncWorker(
_underlying,            deferred
,
...
,        *p
    ...
    Napi::Value LineSegment3D::_PointOn_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D__PointOn_AsyncWorker* asyncWorker = new LineSegment3D__PointOn_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : tRange
    ...
    Napi::Value LineSegment3D::NearPointProjection_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_NearPointProjection_AsyncWorker* asyncWorker = new LineSegment3D_NearPointProjection_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value LineSegment3D::GetSurfaceCurve_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_GetSurfaceCurve_AsyncWorker* asyncWorker = new LineSegment3D_GetSurfaceCurve_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value LineSegment3D::GetWeightCentre_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_GetWeightCentre_AsyncWorker* asyncWorker = new LineSegment3D_GetWeightCentre_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value LineSegment3D::GetBasisCurve_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_GetBasisCurve_AsyncWorker* asyncWorker = new LineSegment3D_GetBasisCurve_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value LineSegment3D::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_GetBasisPoints_AsyncWorker* asyncWorker = new LineSegment3D_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value LineSegment3D::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_SetBasisPoints_AsyncWorker* asyncWorker = new LineSegment3D_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value LineSegment3D::Inverse_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_Inverse_AsyncWorker* asyncWorker = new LineSegment3D_Inverse_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? Math::DefaultMathVersion() : version
    ...
    Napi::Value LineSegment3D::GetProjection_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_GetProjection_AsyncWorker* asyncWorker = new LineSegment3D_GetProjection_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value LineSegment3D::GetCircleAxis_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_GetCircleAxis_AsyncWorker* asyncWorker = new LineSegment3D_GetCircleAxis_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value LineSegment3D::IsA_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_IsA_AsyncWorker* asyncWorker = new LineSegment3D_IsA_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value LineSegment3D::Type_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_Type_AsyncWorker* asyncWorker = new LineSegment3D_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value LineSegment3D::Family_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_Family_AsyncWorker* asyncWorker = new LineSegment3D_Family_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value LineSegment3D::Transform_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_Transform_AsyncWorker* asyncWorker = new LineSegment3D_Transform_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value LineSegment3D::Move_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_Move_AsyncWorker* asyncWorker = new LineSegment3D_Move_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value LineSegment3D::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_Rotate_AsyncWorker* asyncWorker = new LineSegment3D_Rotate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value LineSegment3D::Refresh_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_Refresh_AsyncWorker* asyncWorker = new LineSegment3D_Refresh_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value LineSegment3D::Duplicate_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_Duplicate_AsyncWorker* asyncWorker = new LineSegment3D_Duplicate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value LineSegment3D::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_AddYourGabaritTo_AsyncWorker* asyncWorker = new LineSegment3D_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value LineSegment3D::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_GetUseCount_AsyncWorker* asyncWorker = new LineSegment3D_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value LineSegment3D::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        LineSegment3D_AddRef_AsyncWorker* asyncWorker = new LineSegment3D_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
LineSegment3D::~LineSegment3D() {
    ...
    LineSegment3D_GetPlaneCurve_AsyncWorker::LineSegment3D_GetPlaneCurve_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  saveParams,
                         PlanarCheckParams  params    )
...
,                        params
    ...
    LineSegment3D_IsPlanar_AsyncWorker::LineSegment3D_IsPlanar_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double  accuracy    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    LineSegment3D_IsClosed_AsyncWorker::LineSegment3D_IsClosed_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_IsTouch_AsyncWorker::LineSegment3D_IsTouch_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_GetTMax_AsyncWorker::LineSegment3D_GetTMax_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_GetTMin_AsyncWorker::LineSegment3D_GetTMin_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_GetPeriod_AsyncWorker::LineSegment3D_GetPeriod_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_IsPeriodic_AsyncWorker::LineSegment3D_IsPeriodic_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_IsStraight_AsyncWorker::LineSegment3D_IsStraight_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  ignoreParams    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    LineSegment3D_Trimmed_AsyncWorker::LineSegment3D_Trimmed_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double  t1,
                         double  t2,
...
,                        sense
    ...
    LineSegment3D_Normal_AsyncWorker::LineSegment3D_Normal_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *n
    ...
    LineSegment3D_Tangent_AsyncWorker::LineSegment3D_Tangent_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *tan
    ...
    LineSegment3D_BNormal_AsyncWorker::LineSegment3D_BNormal_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *b
    ...
    LineSegment3D_GetCentre_AsyncWorker::LineSegment3D_GetCentre_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_GetLimitPoint_AsyncWorker::LineSegment3D_GetLimitPoint_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                         ptrdiff_t  number    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *point
    ...
    LineSegment3D_PointOn_AsyncWorker::LineSegment3D_PointOn_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *p
    ...
    LineSegment3D__PointOn_AsyncWorker::LineSegment3D__PointOn_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        tRange
    ...
    void LineSegment3D_NearPointProjection_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    LineSegment3D_GetSurfaceCurve_AsyncWorker::LineSegment3D_GetSurfaceCurve_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                         VERSION  version    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        version
    ...
    void LineSegment3D_GetSurfaceCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    LineSegment3D_GetWeightCentre_AsyncWorker::LineSegment3D_GetWeightCentre_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void LineSegment3D_GetWeightCentre_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    LineSegment3D_GetBasisCurve_AsyncWorker::LineSegment3D_GetBasisCurve_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_GetBasisPoints_AsyncWorker::LineSegment3D_GetBasisPoints_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_SetBasisPoints_AsyncWorker::LineSegment3D_SetBasisPoints_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    LineSegment3D_Inverse_AsyncWorker::LineSegment3D_Inverse_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_GetProjection_AsyncWorker::LineSegment3D_GetProjection_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        version
    ...
    LineSegment3D_GetCircleAxis_AsyncWorker::LineSegment3D_GetCircleAxis_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_IsA_AsyncWorker::LineSegment3D_IsA_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_Type_AsyncWorker::LineSegment3D_Type_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_Family_AsyncWorker::LineSegment3D_Family_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_Transform_AsyncWorker::LineSegment3D_Transform_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    LineSegment3D_Move_AsyncWorker::LineSegment3D_Move_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & v,
                         MbRegTransform * iReg    )
...
,                        iReg
    ...
    LineSegment3D_Rotate_AsyncWorker::LineSegment3D_Rotate_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbAxis3D & axis,
                         double  angle,
...
,                        iReg
    ...
    LineSegment3D_Refresh_AsyncWorker::LineSegment3D_Refresh_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_Duplicate_AsyncWorker::LineSegment3D_Duplicate_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                         MbRegDuplicate * iReg    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    LineSegment3D_AddYourGabaritTo_AsyncWorker::LineSegment3D_AddYourGabaritTo_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
,
                         MbCube & cube    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    void LineSegment3D_AddYourGabaritTo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    LineSegment3D_GetUseCount_AsyncWorker::LineSegment3D_GetUseCount_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    LineSegment3D_AddRef_AsyncWorker::LineSegment3D_AddRef_AsyncWorker(
MbLineSegment3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
