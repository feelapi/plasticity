...
{
    Napi::Function func =
        DefineClass(env, "ShellCuttingParams",
                    {
...
ShellCuttingParams::ShellCuttingParams(const Napi::CallbackInfo &info) : Napi::ObjectWrap<ShellCuttingParams>(info)
{
    ...
    if (info.Length() == 7 &&
        ...
        ((info[4].IsObject() && info[4].ToObject().InstanceOf(MergingFlags::GetConstructor(env)))) &&
        ((info[5].IsBoolean())) &&
    ...
    )
    {
        ...
        MbShellCuttingParams *underlying =
            new MbShellCuttingParams(place, contour, sameContour, dir, mergingFlags, cutAsClosed, snMaker);
        if (underlying == NULL)
        {
    ...
    )
    {
        ...
        MbShellCuttingParams *underlying =
            new MbShellCuttingParams(place, contour, sameContour, dir, part, mergingFlags, cutAsClosed, snMaker);
        if (underlying == NULL)
        {
            Napi::Error::New(env, "Invalid construction").ThrowAsJavaScriptException();
            return;
        ...
        this->_underlying = underlying;
             ...
             ((info[1].IsBoolean())) &&
             ((info[2].IsObject() && info[2].ToObject().InstanceOf(MergingFlags::GetConstructor(env)))) &&
             ((info[3].IsBoolean())) &&
    ...
    )
    {
        ...
        MbShellCuttingParams *underlying =
            new MbShellCuttingParams(surface, sameSurface, mergingFlags, cutAsClosed, snMaker);
        if (underlying == NULL)
        {
            Napi::Error::New(env, "Invalid construction").ThrowAsJavaScriptException();
            return;
        ...
        this->_underlying = underlying;
             ...
             ((info[0].IsObject() && info[0].ToObject().InstanceOf(Surface::GetConstructor(env)))) &&
             ((info[1].IsBoolean())) && ((info[2].IsNumber())) &&
             ((info[3].IsObject() && info[3].ToObject().InstanceOf(MergingFlags::GetConstructor(env)))) &&
             ((info[4].IsBoolean())) &&
    ...
    )
    {
        ...
        MbShellCuttingParams *underlying =
            new MbShellCuttingParams(surface, sameSurface, part, mergingFlags, cutAsClosed, snMaker);
        if (underlying == NULL)
        {
            Napi::Error::New(env, "Invalid construction").ThrowAsJavaScriptException();
            return;
...
Napi::Value ShellCuttingParams::SetSurfaceProlongType(const Napi::CallbackInfo &info)
{
    ...
    _underlying->SetSurfaceProlongType(pt
...
Napi::Value ShellCuttingParams::SetSurfaceProlongType_async(const Napi::CallbackInfo &info)
{
    ...
    ShellCuttingParams_SetSurfaceProlongType_AsyncWorker *asyncWorker =
        new ShellCuttingParams_SetSurfaceProlongType_AsyncWorker(_underlying, deferred,
...
Napi::Value ShellCuttingParams::AddSurfaceProlongType(const Napi::CallbackInfo &info)
{
    ...
    _underlying->AddSurfaceProlongType(pt
...
Napi::Value ShellCuttingParams::AddSurfaceProlongType_async(const Napi::CallbackInfo &info)
{
    ...
    ShellCuttingParams_AddSurfaceProlongType_AsyncWorker *asyncWorker =
        new ShellCuttingParams_AddSurfaceProlongType_AsyncWorker(_underlying, deferred,
...
ShellCuttingParams_SetSurfaceProlongType_AsyncWorker::ShellCuttingParams_SetSurfaceProlongType_AsyncWorker(
    MbShellCuttingParams *_underlying, Napi::Promise::Deferred const &d, MbeSurfaceProlongType pt)
    : _underlying(_underlying), PromiseWorker(d), pt(pt){};
...
void ShellCuttingParams_SetSurfaceProlongType_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
void ShellCuttingParams_AddSurfaceProlongType_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                                  Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
