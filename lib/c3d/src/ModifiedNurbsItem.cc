...
Napi::Object ModifiedNurbsItem::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "ModifiedNurbsItem", {
...
(
    ...
    Napi::Value ModifiedNurbsItem::IsA_async(const Napi::CallbackInfo& info) {
        ...
        ModifiedNurbsItem_IsA_AsyncWorker* asyncWorker = new ModifiedNurbsItem_IsA_AsyncWorker(
...
(
    ...
    Napi::Value ModifiedNurbsItem::Type_async(const Napi::CallbackInfo& info) {
        ...
        ModifiedNurbsItem_Type_AsyncWorker* asyncWorker = new ModifiedNurbsItem_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ModifiedNurbsItem::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        ModifiedNurbsItem_GetBasisPoints_AsyncWorker* asyncWorker = new ModifiedNurbsItem_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ModifiedNurbsItem::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        ModifiedNurbsItem_SetBasisPoints_AsyncWorker* asyncWorker = new ModifiedNurbsItem_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ModifiedNurbsItem::GetBasisItems_async(const Napi::CallbackInfo& info) {
        ...
        ModifiedNurbsItem_GetBasisItems_AsyncWorker* asyncWorker = new ModifiedNurbsItem_GetBasisItems_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ModifiedNurbsItem::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        ModifiedNurbsItem_GetCreatorsCount_AsyncWorker* asyncWorker = new ModifiedNurbsItem_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ModifiedNurbsItem::GetYourNameMaker_async(const Napi::CallbackInfo& info) {
        ...
        ModifiedNurbsItem_GetYourNameMaker_AsyncWorker* asyncWorker = new ModifiedNurbsItem_GetYourNameMaker_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ModifiedNurbsItem::GetStatus_async(const Napi::CallbackInfo& info) {
        ...
        ModifiedNurbsItem_GetStatus_AsyncWorker* asyncWorker = new ModifiedNurbsItem_GetStatus_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ModifiedNurbsItem::SetStatus_async(const Napi::CallbackInfo& info) {
        ...
        ModifiedNurbsItem_SetStatus_AsyncWorker* asyncWorker = new ModifiedNurbsItem_SetStatus_AsyncWorker(
_underlying,            deferred
,
...
,        items
    ...
    Napi::Value ModifiedNurbsItem::CreateShell_async(const Napi::CallbackInfo& info) {
        ...
        ModifiedNurbsItem_CreateShell_AsyncWorker* asyncWorker = new ModifiedNurbsItem_CreateShell_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ModifiedNurbsItem::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        ModifiedNurbsItem_GetMainName_AsyncWorker* asyncWorker = new ModifiedNurbsItem_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ModifiedNurbsItem::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        ModifiedNurbsItem_GetUseCount_AsyncWorker* asyncWorker = new ModifiedNurbsItem_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ModifiedNurbsItem::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        ModifiedNurbsItem_AddRef_AsyncWorker* asyncWorker = new ModifiedNurbsItem_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
ModifiedNurbsItem::~ModifiedNurbsItem() {
    ...
    ModifiedNurbsItem_IsA_AsyncWorker::ModifiedNurbsItem_IsA_AsyncWorker(
MbModifiedNurbsItem * _underlying,        Napi::Promise::Deferred const &d
    ...
    ModifiedNurbsItem_Type_AsyncWorker::ModifiedNurbsItem_Type_AsyncWorker(
MbModifiedNurbsItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
...
MbModifiedNurbsItem * _underlying,        Napi::Promise::Deferred const &d
    ...
    void ModifiedNurbsItem_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void ModifiedNurbsItem_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbModifiedNurbsItem * _underlying,        Napi::Promise::Deferred const &d
    ...
    void ModifiedNurbsItem_GetBasisItems_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void ModifiedNurbsItem_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbModifiedNurbsItem * _underlying,        Napi::Promise::Deferred const &d
    ...
    void ModifiedNurbsItem_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ModifiedNurbsItem_GetStatus_AsyncWorker::ModifiedNurbsItem_GetStatus_AsyncWorker(
MbModifiedNurbsItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ModifiedNurbsItem_SetStatus_AsyncWorker::ModifiedNurbsItem_SetStatus_AsyncWorker(
MbModifiedNurbsItem * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeProcessState  l    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    ModifiedNurbsItem_CreateShell_AsyncWorker::ModifiedNurbsItem_CreateShell_AsyncWorker(
MbModifiedNurbsItem * _underlying,        Napi::Promise::Deferred const &d
,
                         MbFaceShell * shell,
...
,                        items
    ...
    void ModifiedNurbsItem_CreateShell_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ModifiedNurbsItem_GetMainName_AsyncWorker::ModifiedNurbsItem_GetMainName_AsyncWorker(
MbModifiedNurbsItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void ModifiedNurbsItem_GetMainName_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ModifiedNurbsItem_GetUseCount_AsyncWorker::ModifiedNurbsItem_GetUseCount_AsyncWorker(
MbModifiedNurbsItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void ModifiedNurbsItem_GetUseCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ModifiedNurbsItem_AddRef_AsyncWorker::ModifiedNurbsItem_AddRef_AsyncWorker(
MbModifiedNurbsItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
