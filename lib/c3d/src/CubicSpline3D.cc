...
Napi::Object CubicSpline3D::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "CubicSpline3D", {
...
Napi::Function CubicSpline3D::GetConstructor(Napi::Env env) {
 ...
 MbCubicSpline3D * _result = MbCubicSpline3D::Create
(
        initFlat
,        plane
    ...
    Napi::Value CubicSpline3D::Create_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_Create_AsyncWorker* asyncWorker = new CubicSpline3D_Create_AsyncWorker(
            deferred
,
...
(
    ...
    Napi::Value CubicSpline3D::GetPoints_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetPoints_AsyncWorker* asyncWorker = new CubicSpline3D_GetPoints_AsyncWorker(
...
,        pnt
    ...
    Napi::Value CubicSpline3D::ChangePoint_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_ChangePoint_AsyncWorker* asyncWorker = new CubicSpline3D_ChangePoint_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CubicSpline3D::RemovePoint_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_RemovePoint_AsyncWorker* asyncWorker = new CubicSpline3D_RemovePoint_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CubicSpline3D::Rebuild_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_Rebuild_AsyncWorker* asyncWorker = new CubicSpline3D_Rebuild_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::GetCount_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetCount_AsyncWorker* asyncWorker = new CubicSpline3D_GetCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
if (_result) {
    ...
    Napi::Value CubicSpline3D::GetPlaneCurve_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetPlaneCurve_AsyncWorker* asyncWorker = new CubicSpline3D_GetPlaneCurve_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CubicSpline3D::IsPlanar_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_IsPlanar_AsyncWorker* asyncWorker = new CubicSpline3D_IsPlanar_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CubicSpline3D::IsClosed_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_IsClosed_AsyncWorker* asyncWorker = new CubicSpline3D_IsClosed_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::IsTouch_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_IsTouch_AsyncWorker* asyncWorker = new CubicSpline3D_IsTouch_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::GetTMax_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetTMax_AsyncWorker* asyncWorker = new CubicSpline3D_GetTMax_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::GetTMin_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetTMin_AsyncWorker* asyncWorker = new CubicSpline3D_GetTMin_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::GetPeriod_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetPeriod_AsyncWorker* asyncWorker = new CubicSpline3D_GetPeriod_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::IsPeriodic_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_IsPeriodic_AsyncWorker* asyncWorker = new CubicSpline3D_IsPeriodic_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::IsStraight_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_IsStraight_AsyncWorker* asyncWorker = new CubicSpline3D_IsStraight_AsyncWorker(
_underlying,            deferred
,
...
,        sense
    ...
    Napi::Value CubicSpline3D::Trimmed_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_Trimmed_AsyncWorker* asyncWorker = new CubicSpline3D_Trimmed_AsyncWorker(
_underlying,            deferred
,
...
,        *n
    ...
    Napi::Value CubicSpline3D::Normal_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_Normal_AsyncWorker* asyncWorker = new CubicSpline3D_Normal_AsyncWorker(
_underlying,            deferred
,
...
,        *tan
    ...
    Napi::Value CubicSpline3D::Tangent_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_Tangent_AsyncWorker* asyncWorker = new CubicSpline3D_Tangent_AsyncWorker(
_underlying,            deferred
,
...
,        *b
    ...
    Napi::Value CubicSpline3D::BNormal_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_BNormal_AsyncWorker* asyncWorker = new CubicSpline3D_BNormal_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CubicSpline3D::GetCentre_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetCentre_AsyncWorker* asyncWorker = new CubicSpline3D_GetCentre_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        *point
    ...
    Napi::Value CubicSpline3D::GetLimitPoint_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetLimitPoint_AsyncWorker* asyncWorker = new CubicSpline3D_GetLimitPoint_AsyncWorker(
_underlying,            deferred
,
...
,        *p
    ...
    Napi::Value CubicSpline3D::PointOn_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_PointOn_AsyncWorker* asyncWorker = new CubicSpline3D_PointOn_AsyncWorker(
_underlying,            deferred
,
...
,        *p
    ...
    Napi::Value CubicSpline3D::_PointOn_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D__PointOn_AsyncWorker* asyncWorker = new CubicSpline3D__PointOn_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : tRange
    ...
    Napi::Value CubicSpline3D::NearPointProjection_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_NearPointProjection_AsyncWorker* asyncWorker = new CubicSpline3D_NearPointProjection_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value CubicSpline3D::GetSurfaceCurve_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetSurfaceCurve_AsyncWorker* asyncWorker = new CubicSpline3D_GetSurfaceCurve_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CubicSpline3D::GetWeightCentre_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetWeightCentre_AsyncWorker* asyncWorker = new CubicSpline3D_GetWeightCentre_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::GetBasisCurve_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetBasisCurve_AsyncWorker* asyncWorker = new CubicSpline3D_GetBasisCurve_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetBasisPoints_AsyncWorker* asyncWorker = new CubicSpline3D_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_SetBasisPoints_AsyncWorker* asyncWorker = new CubicSpline3D_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CubicSpline3D::Inverse_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_Inverse_AsyncWorker* asyncWorker = new CubicSpline3D_Inverse_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? Math::DefaultMathVersion() : version
    ...
    Napi::Value CubicSpline3D::GetProjection_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetProjection_AsyncWorker* asyncWorker = new CubicSpline3D_GetProjection_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CubicSpline3D::GetCircleAxis_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetCircleAxis_AsyncWorker* asyncWorker = new CubicSpline3D_GetCircleAxis_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::IsA_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_IsA_AsyncWorker* asyncWorker = new CubicSpline3D_IsA_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::Type_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_Type_AsyncWorker* asyncWorker = new CubicSpline3D_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::Family_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_Family_AsyncWorker* asyncWorker = new CubicSpline3D_Family_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value CubicSpline3D::Transform_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_Transform_AsyncWorker* asyncWorker = new CubicSpline3D_Transform_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value CubicSpline3D::Move_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_Move_AsyncWorker* asyncWorker = new CubicSpline3D_Move_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value CubicSpline3D::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_Rotate_AsyncWorker* asyncWorker = new CubicSpline3D_Rotate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CubicSpline3D::Refresh_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_Refresh_AsyncWorker* asyncWorker = new CubicSpline3D_Refresh_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::Duplicate_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_Duplicate_AsyncWorker* asyncWorker = new CubicSpline3D_Duplicate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CubicSpline3D::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_AddYourGabaritTo_AsyncWorker* asyncWorker = new CubicSpline3D_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CubicSpline3D::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_GetUseCount_AsyncWorker* asyncWorker = new CubicSpline3D_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CubicSpline3D::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        CubicSpline3D_AddRef_AsyncWorker* asyncWorker = new CubicSpline3D_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
CubicSpline3D::~CubicSpline3D() {
    ...
    CubicSpline3D_Create_AsyncWorker::CubicSpline3D_Create_AsyncWorker(
...
,                        plane
    ...
    CubicSpline3D_GetPoints_AsyncWorker::CubicSpline3D_GetPoints_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
    ...
    CubicSpline3D_ChangePoint_AsyncWorker::CubicSpline3D_ChangePoint_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         ptrdiff_t  index,
...
,                        pnt
    ...
    CubicSpline3D_RemovePoint_AsyncWorker::CubicSpline3D_RemovePoint_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         ptrdiff_t  index    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    CubicSpline3D_Rebuild_AsyncWorker::CubicSpline3D_Rebuild_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_GetCount_AsyncWorker::CubicSpline3D_GetCount_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_GetPlaneCurve_AsyncWorker::CubicSpline3D_GetPlaneCurve_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  saveParams,
                         PlanarCheckParams  params    )
...
,                        params
    ...
    CubicSpline3D_IsPlanar_AsyncWorker::CubicSpline3D_IsPlanar_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double  accuracy    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    CubicSpline3D_IsClosed_AsyncWorker::CubicSpline3D_IsClosed_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_IsTouch_AsyncWorker::CubicSpline3D_IsTouch_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_GetTMax_AsyncWorker::CubicSpline3D_GetTMax_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_GetTMin_AsyncWorker::CubicSpline3D_GetTMin_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_GetPeriod_AsyncWorker::CubicSpline3D_GetPeriod_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_IsPeriodic_AsyncWorker::CubicSpline3D_IsPeriodic_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_IsStraight_AsyncWorker::CubicSpline3D_IsStraight_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  ignoreParams    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    CubicSpline3D_Trimmed_AsyncWorker::CubicSpline3D_Trimmed_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double  t1,
                         double  t2,
...
,                        sense
    ...
    CubicSpline3D_Normal_AsyncWorker::CubicSpline3D_Normal_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *n
    ...
    CubicSpline3D_Tangent_AsyncWorker::CubicSpline3D_Tangent_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *tan
    ...
    CubicSpline3D_BNormal_AsyncWorker::CubicSpline3D_BNormal_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *b
    ...
    CubicSpline3D_GetCentre_AsyncWorker::CubicSpline3D_GetCentre_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_GetLimitPoint_AsyncWorker::CubicSpline3D_GetLimitPoint_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         ptrdiff_t  number    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *point
    ...
    CubicSpline3D_PointOn_AsyncWorker::CubicSpline3D_PointOn_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *p
    ...
    CubicSpline3D__PointOn_AsyncWorker::CubicSpline3D__PointOn_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        tRange
    ...
    void CubicSpline3D_NearPointProjection_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    CubicSpline3D_GetSurfaceCurve_AsyncWorker::CubicSpline3D_GetSurfaceCurve_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         VERSION  version    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        version
    ...
    void CubicSpline3D_GetSurfaceCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    CubicSpline3D_GetWeightCentre_AsyncWorker::CubicSpline3D_GetWeightCentre_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void CubicSpline3D_GetWeightCentre_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    CubicSpline3D_GetBasisCurve_AsyncWorker::CubicSpline3D_GetBasisCurve_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_GetBasisPoints_AsyncWorker::CubicSpline3D_GetBasisPoints_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_SetBasisPoints_AsyncWorker::CubicSpline3D_SetBasisPoints_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    CubicSpline3D_Inverse_AsyncWorker::CubicSpline3D_Inverse_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_GetProjection_AsyncWorker::CubicSpline3D_GetProjection_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        version
    ...
    CubicSpline3D_GetCircleAxis_AsyncWorker::CubicSpline3D_GetCircleAxis_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_IsA_AsyncWorker::CubicSpline3D_IsA_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_Type_AsyncWorker::CubicSpline3D_Type_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_Family_AsyncWorker::CubicSpline3D_Family_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_Transform_AsyncWorker::CubicSpline3D_Transform_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    CubicSpline3D_Move_AsyncWorker::CubicSpline3D_Move_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & v,
                         MbRegTransform * iReg    )
...
,                        iReg
    ...
    CubicSpline3D_Rotate_AsyncWorker::CubicSpline3D_Rotate_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbAxis3D & axis,
                         double  angle,
...
,                        iReg
    ...
    CubicSpline3D_Refresh_AsyncWorker::CubicSpline3D_Refresh_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_Duplicate_AsyncWorker::CubicSpline3D_Duplicate_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         MbRegDuplicate * iReg    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    CubicSpline3D_AddYourGabaritTo_AsyncWorker::CubicSpline3D_AddYourGabaritTo_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
,
                         MbCube & cube    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    void CubicSpline3D_AddYourGabaritTo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    CubicSpline3D_GetUseCount_AsyncWorker::CubicSpline3D_GetUseCount_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CubicSpline3D_AddRef_AsyncWorker::CubicSpline3D_AddRef_AsyncWorker(
MbCubicSpline3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
