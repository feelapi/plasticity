...
Napi::Value SymmetrySolid::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    SymmetrySolid_IsA_AsyncWorker *asyncWorker = new SymmetrySolid_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value SymmetrySolid::Type_async(const Napi::CallbackInfo &info)
{
    ...
    SymmetrySolid_Type_AsyncWorker *asyncWorker = new SymmetrySolid_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SymmetrySolid::GetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    SymmetrySolid_GetBasisPoints_AsyncWorker *asyncWorker =
        new SymmetrySolid_GetBasisPoints_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SymmetrySolid::SetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    SymmetrySolid_SetBasisPoints_AsyncWorker *asyncWorker =
        new SymmetrySolid_SetBasisPoints_AsyncWorker(_underlying, deferred,
...
Napi::Value SymmetrySolid::GetBasisItems_async(const Napi::CallbackInfo &info)
{
    ...
    SymmetrySolid_GetBasisItems_AsyncWorker *asyncWorker =
        new SymmetrySolid_GetBasisItems_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SymmetrySolid::GetCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    SymmetrySolid_GetCreatorsCount_AsyncWorker *asyncWorker =
        new SymmetrySolid_GetCreatorsCount_AsyncWorker(_underlying, deferred,
...
Napi::Value SymmetrySolid::GetYourNameMaker_async(const Napi::CallbackInfo &info)
{
    ...
    SymmetrySolid_GetYourNameMaker_AsyncWorker *asyncWorker =
        new SymmetrySolid_GetYourNameMaker_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SymmetrySolid::GetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    SymmetrySolid_GetStatus_AsyncWorker *asyncWorker = new SymmetrySolid_GetStatus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SymmetrySolid::SetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    SymmetrySolid_SetStatus_AsyncWorker *asyncWorker = new SymmetrySolid_SetStatus_AsyncWorker(_underlying, deferred,
...
Napi::Value SymmetrySolid::CreateShell_async(const Napi::CallbackInfo &info)
{
    ...
    SymmetrySolid_CreateShell_AsyncWorker *asyncWorker =
        new SymmetrySolid_CreateShell_AsyncWorker(_underlying, deferred,
...
Napi::Value SymmetrySolid::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    SymmetrySolid_GetMainName_AsyncWorker *asyncWorker =
        new SymmetrySolid_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SymmetrySolid::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    SymmetrySolid_GetUseCount_AsyncWorker *asyncWorker =
        new SymmetrySolid_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SymmetrySolid::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    SymmetrySolid_AddRef_AsyncWorker *asyncWorker = new SymmetrySolid_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
SymmetrySolid_IsA_AsyncWorker::SymmetrySolid_IsA_AsyncWorker(MbSymmetrySolid *_underlying,
...
SymmetrySolid_Type_AsyncWorker::SymmetrySolid_Type_AsyncWorker(MbSymmetrySolid *_underlying,
                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SymmetrySolid_GetBasisPoints_AsyncWorker::SymmetrySolid_GetBasisPoints_AsyncWorker(MbSymmetrySolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SymmetrySolid_SetBasisPoints_AsyncWorker::SymmetrySolid_SetBasisPoints_AsyncWorker(MbSymmetrySolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d,
...
SymmetrySolid_GetBasisItems_AsyncWorker::SymmetrySolid_GetBasisItems_AsyncWorker(MbSymmetrySolid *_underlying,
                                                                                 Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SymmetrySolid_GetCreatorsCount_AsyncWorker::SymmetrySolid_GetCreatorsCount_AsyncWorker(MbSymmetrySolid *_underlying,
                                                                                       Napi::Promise::Deferred const &d,
                                                                                       MbeCreatorType ct)
...
void SymmetrySolid_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
SymmetrySolid_GetYourNameMaker_AsyncWorker::SymmetrySolid_GetYourNameMaker_AsyncWorker(MbSymmetrySolid *_underlying,
                                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void SymmetrySolid_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                        Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
SymmetrySolid_GetStatus_AsyncWorker::SymmetrySolid_GetStatus_AsyncWorker(MbSymmetrySolid *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SymmetrySolid_SetStatus_AsyncWorker::SymmetrySolid_SetStatus_AsyncWorker(MbSymmetrySolid *_underlying,
                                                                         Napi::Promise::Deferred const &d,
                                                                         MbeProcessState l)
...
SymmetrySolid_CreateShell_AsyncWorker::SymmetrySolid_CreateShell_AsyncWorker(MbSymmetrySolid *_underlying,
                                                                             Napi::Promise::Deferred const &d,
...
SymmetrySolid_GetMainName_AsyncWorker::SymmetrySolid_GetMainName_AsyncWorker(MbSymmetrySolid *_underlying,
                                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SymmetrySolid_GetUseCount_AsyncWorker::SymmetrySolid_GetUseCount_AsyncWorker(MbSymmetrySolid *_underlying,
                                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SymmetrySolid_AddRef_AsyncWorker::SymmetrySolid_AddRef_AsyncWorker(MbSymmetrySolid *_underlying,
                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
