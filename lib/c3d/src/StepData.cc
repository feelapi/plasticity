...
(
    ...
    Napi::Value StepData::SetSag_async(const Napi::CallbackInfo& info) {
        ...
        StepData_SetSag_AsyncWorker* asyncWorker = new StepData_SetSag_AsyncWorker(
...
(
    ...
    Napi::Value StepData::SetAngle_async(const Napi::CallbackInfo& info) {
        ...
        StepData_SetAngle_AsyncWorker* asyncWorker = new StepData_SetAngle_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value StepData::SetLength_async(const Napi::CallbackInfo& info) {
        ...
        StepData_SetLength_AsyncWorker* asyncWorker = new StepData_SetLength_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value StepData::SetMaxCount_async(const Napi::CallbackInfo& info) {
        ...
        StepData_SetMaxCount_AsyncWorker* asyncWorker = new StepData_SetMaxCount_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value StepData::GetSag_async(const Napi::CallbackInfo& info) {
        ...
        StepData_GetSag_AsyncWorker* asyncWorker = new StepData_GetSag_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value StepData::GetAngle_async(const Napi::CallbackInfo& info) {
        ...
        StepData_GetAngle_AsyncWorker* asyncWorker = new StepData_GetAngle_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value StepData::GetLength_async(const Napi::CallbackInfo& info) {
        ...
        StepData_GetLength_AsyncWorker* asyncWorker = new StepData_GetLength_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
_underlying->SetStepType
(
        t
,        info.Length() == 1 || info[1].IsNull() ? true : add
    ...
    Napi::Value StepData::SetStepType_async(const Napi::CallbackInfo& info) {
        ...
        StepData_SetStepType_AsyncWorker* asyncWorker = new StepData_SetStepType_AsyncWorker(
_underlying,            deferred
,
...
,        a
,        l
,        info.Length() == 4 || info[4].IsNull() ? 0 : c
    ...
    Napi::Value StepData::Init_async(const Napi::CallbackInfo& info) {
        ...
        StepData_Init_AsyncWorker* asyncWorker = new StepData_Init_AsyncWorker(
_underlying,            deferred
,
    ...
    StepData_SetSag_AsyncWorker::StepData_SetSag_AsyncWorker(
MbStepData * _underlying,        Napi::Promise::Deferred const &d
,
                         double  s    )
...
{};
    ...
    StepData_SetAngle_AsyncWorker::StepData_SetAngle_AsyncWorker(
MbStepData * _underlying,        Napi::Promise::Deferred const &d
,
                         double  a    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    StepData_SetLength_AsyncWorker::StepData_SetLength_AsyncWorker(
MbStepData * _underlying,        Napi::Promise::Deferred const &d
,
                         double  l    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    StepData_SetMaxCount_AsyncWorker::StepData_SetMaxCount_AsyncWorker(
MbStepData * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  c    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    StepData_GetSag_AsyncWorker::StepData_GetSag_AsyncWorker(
MbStepData * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    StepData_GetAngle_AsyncWorker::StepData_GetAngle_AsyncWorker(
MbStepData * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    StepData_GetLength_AsyncWorker::StepData_GetLength_AsyncWorker(
MbStepData * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    StepData_SetStepType_AsyncWorker::StepData_SetStepType_AsyncWorker(
MbStepData * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeStepType  t,
                         bool  add    )
...
,                        add
    ...
    StepData_Init_AsyncWorker::StepData_Init_AsyncWorker(
MbStepData * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeStepType  t,
                         double  s,
