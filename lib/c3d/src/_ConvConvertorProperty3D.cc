...
Napi::Object _ConvConvertorProperty3D::Init(const Napi::Env env, Napi::Object exports)
{
    Napi::Function func = DefineClass(
        env, "ConvConvertorProperty3D",
        {
            InstanceMethod<&_ConvConvertorProperty3D::Id>("Id"),

            InstanceAccessor<&_ConvConvertorProperty3D::GetValue_enableAutostitch,
                             &_ConvConvertorProperty3D::SetValue_enableAutostitch>("enableAutostitch"),
            InstanceAccessor<&_ConvConvertorProperty3D::GetValue_joinSimilarFaces,
                             &_ConvConvertorProperty3D::SetValue_joinSimilarFaces>("joinSimilarFaces"),
            InstanceAccessor<&_ConvConvertorProperty3D::GetValue_addRemovedFacesAsShells,
                             &_ConvConvertorProperty3D::SetValue_addRemovedFacesAsShells>("addRemovedFacesAsShells"),
            InstanceAccessor<&_ConvConvertorProperty3D::GetValue_lengthUnitsFactor,
                             &_ConvConvertorProperty3D::SetValue_lengthUnitsFactor>("lengthUnitsFactor"),
            InstanceAccessor<&_ConvConvertorProperty3D::GetValue_appUnitsFactor,
                             &_ConvConvertorProperty3D::SetValue_appUnitsFactor>("appUnitsFactor"),
            InstanceAccessor<&_ConvConvertorProperty3D::GetValue_auditEnabled,
                             &_ConvConvertorProperty3D::SetValue_auditEnabled>("auditEnabled"),
        });
...
_ConvConvertorProperty3D::_ConvConvertorProperty3D(const Napi::CallbackInfo &info)
    : Napi::ObjectWrap<_ConvConvertorProperty3D>(info)
{
...
void _ConvConvertorProperty3D::SetValue_addRemovedFacesAsShells(const Napi::CallbackInfo &info,
