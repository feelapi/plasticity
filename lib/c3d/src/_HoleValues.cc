...
Napi::Object _HoleValues::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "HoleValues", {
...
(
    ...
    Napi::Value _HoleValues::SetSurface_async(const Napi::CallbackInfo& info) {
        ...
        _HoleValues_SetSurface_AsyncWorker* asyncWorker = new _HoleValues_SetSurface_AsyncWorker(
...
(
    ...
    Napi::Value _HoleValues::SetPhantom_async(const Napi::CallbackInfo& info) {
        ...
        _HoleValues_SetPhantom_AsyncWorker* asyncWorker = new _HoleValues_SetPhantom_AsyncWorker(
_underlying,            deferred
,
...
void _HoleValues::SetValue_azimuthAngle(const Napi::CallbackInfo &info, const Napi::Value &value) {
    ...
    _HoleValues_SetSurface_AsyncWorker::_HoleValues_SetSurface_AsyncWorker(
...
{};
    ...
    _HoleValues_SetPhantom_AsyncWorker::_HoleValues_SetPhantom_AsyncWorker(
HoleValues * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  s    )
        :_underlying(_underlying),PromiseWorker(d),
