...
Napi::Value _SweptValues::CheckSelfInt_async(const Napi::CallbackInfo &info)
{
    ...
    _SweptValues_CheckSelfInt_AsyncWorker *asyncWorker =
        new _SweptValues_CheckSelfInt_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value _SweptValues::SetCheckSelfInt_async(const Napi::CallbackInfo &info)
{
    ...
    _SweptValues_SetCheckSelfInt_AsyncWorker *asyncWorker =
        new _SweptValues_SetCheckSelfInt_AsyncWorker(_underlying, deferred,
...
_SweptValues_CheckSelfInt_AsyncWorker::_SweptValues_CheckSelfInt_AsyncWorker(SweptValues *_underlying,
...
_SweptValues_SetCheckSelfInt_AsyncWorker::_SweptValues_SetCheckSelfInt_AsyncWorker(SweptValues *_underlying,
                                                                                   Napi::Promise::Deferred const &d,
                                                                                   bool c)
