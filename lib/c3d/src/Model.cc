...
{
    Napi::Env env = info.Env();
    if (info.Length() == 0 || !((info[0].IsObject() && info[0].ToObject().InstanceOf(Item::GetConstructor(env)))))
    {
    ...
    MbItem *_result = _underlying->AddItem(item, info.Length() == 1 || info[1].IsNull() ? c3d::UNDEFINED_SNAME : n
...
Napi::Value Model::AddItem_async(const Napi::CallbackInfo &info)
{
    ...
    Model_AddItem_AsyncWorker *asyncWorker = new Model_AddItem_AsyncWorker(_underlying, deferred,
...
Napi::Value Model::ItemsCount_async(const Napi::CallbackInfo &info)
{
    ...
    Model_ItemsCount_AsyncWorker *asyncWorker = new Model_ItemsCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Model::GetItems_async(const Napi::CallbackInfo &info)
{
    ...
    Model_GetItems_AsyncWorker *asyncWorker = new Model_GetItems_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
Napi::Value Model::DetachItem(const Napi::CallbackInfo &info)
{
    ...
    bool _result = _underlying->DetachItem(item, info.Length() == 1 || info[1].IsNull() ? true : resetName
...
Napi::Value Model::DetachItem_async(const Napi::CallbackInfo &info)
{
    ...
    Model_DetachItem_AsyncWorker *asyncWorker = new Model_DetachItem_AsyncWorker(_underlying, deferred,
...
Napi::Value Model::DeleteItem(const Napi::CallbackInfo &info)
{
    ...
    _underlying->DeleteItem(item, info.Length() == 1 || info[1].IsNull() ? true : resetName
...
Napi::Value Model::DeleteItem_async(const Napi::CallbackInfo &info)
{
    ...
    Model_DeleteItem_AsyncWorker *asyncWorker = new Model_DeleteItem_AsyncWorker(_underlying, deferred,
...
Napi::Value Model::GetItemByName(const Napi::CallbackInfo &info)
{
    ...
    const MbItem *item = _underlying->GetItemByName(n, *path, *from
...
Napi::Value Model::GetItemByName_async(const Napi::CallbackInfo &info)
{
    ...
    Model_GetItemByName_AsyncWorker *asyncWorker = new Model_GetItemByName_AsyncWorker(_underlying, deferred,
...
Napi::Value Model::NearestMesh(const Napi::CallbackInfo &info)
{
    ...
    bool success = _underlying->NearestMesh(sType, tType, pType, axis, maxDistance, gridPriority, find, findName,
                                            element, elementName, *path, *from
...
Napi::Value Model::NearestMesh_async(const Napi::CallbackInfo &info)
{
    ...
    Model_NearestMesh_AsyncWorker *asyncWorker = new Model_NearestMesh_AsyncWorker(_underlying, deferred,
...
Napi::Value Model::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    Model_GetUseCount_AsyncWorker *asyncWorker = new Model_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Model::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    Model_AddRef_AsyncWorker *asyncWorker = new Model_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Model::SetStyle_async(const Napi::CallbackInfo &info)
{
    ...
    Model_SetStyle_AsyncWorker *asyncWorker = new Model_SetStyle_AsyncWorker(_underlying, deferred,
...
Napi::Value Model::GetStyle_async(const Napi::CallbackInfo &info)
{
    ...
    Model_GetStyle_AsyncWorker *asyncWorker = new Model_GetStyle_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Model::SetColor_async(const Napi::CallbackInfo &info)
{
    ...
    Model_SetColor_AsyncWorker *asyncWorker = new Model_SetColor_AsyncWorker(_underlying, deferred,
...
Napi::Value Model::GetColor_async(const Napi::CallbackInfo &info)
{
    ...
    Model_GetColor_AsyncWorker *asyncWorker = new Model_GetColor_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Model::AttributesConvert_async(const Napi::CallbackInfo &info)
{
    ...
    Model_AttributesConvert_AsyncWorker *asyncWorker = new Model_AttributesConvert_AsyncWorker(_underlying, deferred,
...
Napi::Value Model::GetCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    Model_GetCreatorsCount_AsyncWorker *asyncWorker = new Model_GetCreatorsCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Model::GetCreator_async(const Napi::CallbackInfo &info)
{
    ...
    Model_GetCreator_AsyncWorker *asyncWorker = new Model_GetCreator_AsyncWorker(_underlying, deferred,
...
Napi::Value Model::SetCreator_async(const Napi::CallbackInfo &info)
{
    ...
    Model_SetCreator_AsyncWorker *asyncWorker = new Model_SetCreator_AsyncWorker(_underlying, deferred,
...
Napi::Value Model::DetachCreator_async(const Napi::CallbackInfo &info)
{
    ...
    Model_DetachCreator_AsyncWorker *asyncWorker = new Model_DetachCreator_AsyncWorker(_underlying, deferred,
...
Napi::Value Model::AddCreator_async(const Napi::CallbackInfo &info)
{
    ...
    Model_AddCreator_AsyncWorker *asyncWorker = new Model_AddCreator_AsyncWorker(_underlying, deferred,
...
Napi::Value Model::GetCreators_async(const Napi::CallbackInfo &info)
{
    ...
    Model_GetCreators_AsyncWorker *asyncWorker = new Model_GetCreators_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Model::DeleteCreator_async(const Napi::CallbackInfo &info)
{
    ...
    Model_DeleteCreator_AsyncWorker *asyncWorker = new Model_DeleteCreator_AsyncWorker(_underlying, deferred,
...
Napi::Value Model::GetActiveCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    Model_GetActiveCreatorsCount_AsyncWorker *asyncWorker =
        new Model_GetActiveCreatorsCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Model_AddItem_AsyncWorker::Model_AddItem_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d,
                                                     MbItem &item, SimpleName n)
    : _underlying(_underlying), PromiseWorker(d), item(item), n(n){};

void Model_AddItem_AsyncWorker::Execute()
{
    EnterParallelRegion();

    MbItem *_result = _underlying->AddItem(item, n);
...
Model_ItemsCount_AsyncWorker::Model_ItemsCount_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d)
...
Model_GetItems_AsyncWorker::Model_GetItems_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Model_DetachItem_AsyncWorker::Model_DetachItem_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d,
                                                           MbItem *item, bool resetName)
    : _underlying(_underlying), PromiseWorker(d), item(item), resetName(resetName){};

void Model_DetachItem_AsyncWorker::Execute()
{
    EnterParallelRegion();

    bool _result = _underlying->DetachItem(item, resetName);
...
Model_DeleteItem_AsyncWorker::Model_DeleteItem_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d,
                                                           MbItem *item, bool resetName)
    : _underlying(_underlying), PromiseWorker(d), item(item), resetName(resetName){};
...
void Model_DeleteItem_AsyncWorker::Execute()
{
    ...
    _underlying->DeleteItem(item, resetName);
...
Model_GetItemByName_AsyncWorker::Model_GetItemByName_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d,
                                                                 SimpleName n)
...
Model_NearestMesh_AsyncWorker::Model_NearestMesh_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d,
                                                             MbeSpaceType sType, MbeTopologyType tType,
                                                             MbePlaneType pType, const MbAxis3D &axis,
                                                             double maxDistance, bool gridPriority)
...
Model_GetUseCount_AsyncWorker::Model_GetUseCount_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Model_AddRef_AsyncWorker::Model_AddRef_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Model_SetStyle_AsyncWorker::Model_SetStyle_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, int s)
...
Model_GetStyle_AsyncWorker::Model_GetStyle_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Model_SetColor_AsyncWorker::Model_SetColor_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d, uint32 c)
...
Model_GetColor_AsyncWorker::Model_GetColor_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Model_AttributesConvert_AsyncWorker::Model_AttributesConvert_AsyncWorker(MbModel *_underlying,
...
Model_GetCreatorsCount_AsyncWorker::Model_GetCreatorsCount_AsyncWorker(MbModel *_underlying,
                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Model_GetCreator_AsyncWorker::Model_GetCreator_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d,
                                                           size_t ind)
...
Model_SetCreator_AsyncWorker::Model_SetCreator_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d,
                                                           size_t ind)
    : _underlying(_underlying), PromiseWorker(d), ind(ind){};
...
Model_DetachCreator_AsyncWorker::Model_DetachCreator_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d,
                                                                 size_t ind)
    : _underlying(_underlying), PromiseWorker(d), ind(ind){};
...
Model_AddCreator_AsyncWorker::Model_AddCreator_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d,
...
Model_GetCreators_AsyncWorker::Model_GetCreators_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Model_DeleteCreator_AsyncWorker::Model_DeleteCreator_AsyncWorker(MbModel *_underlying, Napi::Promise::Deferred const &d,
                                                                 size_t ind)
    : _underlying(_underlying), PromiseWorker(d), ind(ind){};
...
Model_GetActiveCreatorsCount_AsyncWorker::Model_GetActiveCreatorsCount_AsyncWorker(MbModel *_underlying,
                                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
