...
,        sz
    ...
    Napi::Value Matrix3D::Scale_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_Scale_AsyncWorker* asyncWorker = new Matrix3D_Scale_AsyncWorker(
...
,
 ...
 MbMatrix3D & _result = _underlying->Rotate
(
        axis
,        angle
    ...
    Napi::Value Matrix3D::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_Rotate_AsyncWorker* asyncWorker = new Matrix3D_Rotate_AsyncWorker(
_underlying,            deferred
,
...
,        normal
    ...
    Napi::Value Matrix3D::Symmetry_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_Symmetry_AsyncWorker* asyncWorker = new Matrix3D_Symmetry_AsyncWorker(
_underlying,            deferred
,
 ...
 MbVector3D  _result = _underlying->GetRow
(
        i
    ...
    Napi::Value Matrix3D::GetRow_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_GetRow_AsyncWorker* asyncWorker = new Matrix3D_GetRow_AsyncWorker(
_underlying,            deferred
,
 ...
 MbVector3D  _result = _underlying->GetColumn
(
        i
    ...
    Napi::Value Matrix3D::GetColumn_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_GetColumn_AsyncWorker* asyncWorker = new Matrix3D_GetColumn_AsyncWorker(
_underlying,            deferred
,
...
,        h
    ...
    Napi::Value Matrix3D::SetRow_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_SetRow_AsyncWorker* asyncWorker = new Matrix3D_SetRow_AsyncWorker(
_underlying,            deferred
,
...
,        h
    ...
    Napi::Value Matrix3D::SetColumn_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_SetColumn_AsyncWorker* asyncWorker = new Matrix3D_SetColumn_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Matrix3D::GetAxisX_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_GetAxisX_AsyncWorker* asyncWorker = new Matrix3D_GetAxisX_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Matrix3D::GetAxisY_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_GetAxisY_AsyncWorker* asyncWorker = new Matrix3D_GetAxisY_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Matrix3D::GetAxisZ_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_GetAxisZ_AsyncWorker* asyncWorker = new Matrix3D_GetAxisZ_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Matrix3D::GetOrigin_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_GetOrigin_AsyncWorker* asyncWorker = new Matrix3D_GetOrigin_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        j
    ...
    Napi::Value Matrix3D::El_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_El_AsyncWorker* asyncWorker = new Matrix3D_El_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Matrix3D::GetOffset_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_GetOffset_AsyncWorker* asyncWorker = new Matrix3D_GetOffset_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
 ...
 MbMatrix3D & _result = _underlying->Div
(
        from
    ...
    Napi::Value Matrix3D::Div_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_Div_AsyncWorker* asyncWorker = new Matrix3D_Div_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Matrix3D::Adj_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_Adj_AsyncWorker* asyncWorker = new Matrix3D_Adj_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Matrix3D::SetOffset_async(const Napi::CallbackInfo& info) {
        ...
        Matrix3D_SetOffset_AsyncWorker* asyncWorker = new Matrix3D_SetOffset_AsyncWorker(
_underlying,            deferred
,
    ...
    Matrix3D_Scale_AsyncWorker::Matrix3D_Scale_AsyncWorker(
...
,                        sz
    ...
    Matrix3D_Rotate_AsyncWorker::Matrix3D_Rotate_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbAxis3D & axis,
                         double  angle    )
...
,                        angle
    ...
    Matrix3D_Symmetry_AsyncWorker::Matrix3D_Symmetry_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        normal
    ...
    Matrix3D_GetRow_AsyncWorker::Matrix3D_GetRow_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  i    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Matrix3D_GetColumn_AsyncWorker::Matrix3D_GetColumn_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  i    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Matrix3D_SetRow_AsyncWorker::Matrix3D_SetRow_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  i,
                         MbHomogeneous3D  h    )
...
,                        h
    ...
    Matrix3D_SetColumn_AsyncWorker::Matrix3D_SetColumn_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  i,
                         MbHomogeneous3D  h    )
...
,                        h
    ...
    Matrix3D_GetAxisX_AsyncWorker::Matrix3D_GetAxisX_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Matrix3D_GetAxisY_AsyncWorker::Matrix3D_GetAxisY_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Matrix3D_GetAxisZ_AsyncWorker::Matrix3D_GetAxisZ_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Matrix3D_GetOrigin_AsyncWorker::Matrix3D_GetOrigin_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Matrix3D_El_AsyncWorker::Matrix3D_El_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  i,
                         size_t  j    )
...
,                        j
    ...
    Matrix3D_GetOffset_AsyncWorker::Matrix3D_GetOffset_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Matrix3D_Div_AsyncWorker::Matrix3D_Div_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
,
                         MbMatrix3D & from    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Matrix3D_Adj_AsyncWorker::Matrix3D_Adj_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Matrix3D_SetOffset_AsyncWorker::Matrix3D_SetOffset_AsyncWorker(
MbMatrix3D * _underlying,        Napi::Promise::Deferred const &d
,
