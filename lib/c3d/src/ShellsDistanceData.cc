...
Napi::Object ShellsDistanceData::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "ShellsDistanceData", {
...
(
    ...
    Napi::Value ShellsDistanceData::GetMinDistanse_async(const Napi::CallbackInfo& info) {
        ...
        ShellsDistanceData_GetMinDistanse_AsyncWorker* asyncWorker = new ShellsDistanceData_GetMinDistanse_AsyncWorker(
...
MbShellsDistanceData  _underlying,        Napi::Promise::Deferred const &d
    ...
    void ShellsDistanceData_GetMinDistanse_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
