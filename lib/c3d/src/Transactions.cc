...
Napi::Object Transactions::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "Transactions", {
...
(
    ...
    Napi::Value Transactions::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        Transactions_GetCreatorsCount_AsyncWorker* asyncWorker = new Transactions_GetCreatorsCount_AsyncWorker(
...
(
    ...
    Napi::Value Transactions::GetCreator_async(const Napi::CallbackInfo& info) {
        ...
        Transactions_GetCreator_AsyncWorker* asyncWorker = new Transactions_GetCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Transactions::SetCreator_async(const Napi::CallbackInfo& info) {
        ...
        Transactions_SetCreator_AsyncWorker* asyncWorker = new Transactions_SetCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Transactions::DetachCreator_async(const Napi::CallbackInfo& info) {
        ...
        Transactions_DetachCreator_AsyncWorker* asyncWorker = new Transactions_DetachCreator_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? false : addSame
    ...
    Napi::Value Transactions::AddCreator_async(const Napi::CallbackInfo& info) {
        ...
        Transactions_AddCreator_AsyncWorker* asyncWorker = new Transactions_AddCreator_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value Transactions::GetCreators_async(const Napi::CallbackInfo& info) {
        ...
        Transactions_GetCreators_AsyncWorker* asyncWorker = new Transactions_GetCreators_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Transactions::DeleteCreator_async(const Napi::CallbackInfo& info) {
        ...
        Transactions_DeleteCreator_AsyncWorker* asyncWorker = new Transactions_DeleteCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Transactions::GetActiveCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        Transactions_GetActiveCreatorsCount_AsyncWorker* asyncWorker = new Transactions_GetActiveCreatorsCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
    ...
    Transactions_GetCreatorsCount_AsyncWorker::Transactions_GetCreatorsCount_AsyncWorker(
MbTransactions * _underlying,        Napi::Promise::Deferred const &d
    ...
    void Transactions_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    Transactions_GetCreator_AsyncWorker::Transactions_GetCreator_AsyncWorker(
MbTransactions * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Transactions_SetCreator_AsyncWorker::Transactions_SetCreator_AsyncWorker(
MbTransactions * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Transactions_DetachCreator_AsyncWorker::Transactions_DetachCreator_AsyncWorker(
MbTransactions * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Transactions_AddCreator_AsyncWorker::Transactions_AddCreator_AsyncWorker(
MbTransactions * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        addSame
    ...
    Transactions_GetCreators_AsyncWorker::Transactions_GetCreators_AsyncWorker(
MbTransactions * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Transactions_DeleteCreator_AsyncWorker::Transactions_DeleteCreator_AsyncWorker(
MbTransactions * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
MbTransactions * _underlying,        Napi::Promise::Deferred const &d
    ...
    void Transactions_GetActiveCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
