...
Napi::Object CurveLoftedSolid::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "CurveLoftedSolid", {
...
(
    ...
    Napi::Value CurveLoftedSolid::IsA_async(const Napi::CallbackInfo& info) {
        ...
        CurveLoftedSolid_IsA_AsyncWorker* asyncWorker = new CurveLoftedSolid_IsA_AsyncWorker(
...
(
    ...
    Napi::Value CurveLoftedSolid::Type_async(const Napi::CallbackInfo& info) {
        ...
        CurveLoftedSolid_Type_AsyncWorker* asyncWorker = new CurveLoftedSolid_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CurveLoftedSolid::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        CurveLoftedSolid_GetBasisPoints_AsyncWorker* asyncWorker = new CurveLoftedSolid_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CurveLoftedSolid::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        CurveLoftedSolid_SetBasisPoints_AsyncWorker* asyncWorker = new CurveLoftedSolid_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CurveLoftedSolid::GetBasisItems_async(const Napi::CallbackInfo& info) {
        ...
        CurveLoftedSolid_GetBasisItems_AsyncWorker* asyncWorker = new CurveLoftedSolid_GetBasisItems_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CurveLoftedSolid::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        CurveLoftedSolid_GetCreatorsCount_AsyncWorker* asyncWorker = new CurveLoftedSolid_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CurveLoftedSolid::GetYourNameMaker_async(const Napi::CallbackInfo& info) {
        ...
        CurveLoftedSolid_GetYourNameMaker_AsyncWorker* asyncWorker = new CurveLoftedSolid_GetYourNameMaker_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CurveLoftedSolid::GetStatus_async(const Napi::CallbackInfo& info) {
        ...
        CurveLoftedSolid_GetStatus_AsyncWorker* asyncWorker = new CurveLoftedSolid_GetStatus_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CurveLoftedSolid::SetStatus_async(const Napi::CallbackInfo& info) {
        ...
        CurveLoftedSolid_SetStatus_AsyncWorker* asyncWorker = new CurveLoftedSolid_SetStatus_AsyncWorker(
_underlying,            deferred
,
...
,        items
    ...
    Napi::Value CurveLoftedSolid::CreateShell_async(const Napi::CallbackInfo& info) {
        ...
        CurveLoftedSolid_CreateShell_AsyncWorker* asyncWorker = new CurveLoftedSolid_CreateShell_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CurveLoftedSolid::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        CurveLoftedSolid_GetMainName_AsyncWorker* asyncWorker = new CurveLoftedSolid_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CurveLoftedSolid::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        CurveLoftedSolid_GetUseCount_AsyncWorker* asyncWorker = new CurveLoftedSolid_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CurveLoftedSolid::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        CurveLoftedSolid_AddRef_AsyncWorker* asyncWorker = new CurveLoftedSolid_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
CurveLoftedSolid::~CurveLoftedSolid() {
    ...
    CurveLoftedSolid_IsA_AsyncWorker::CurveLoftedSolid_IsA_AsyncWorker(
MbCurveLoftedSolid * _underlying,        Napi::Promise::Deferred const &d
    ...
    CurveLoftedSolid_Type_AsyncWorker::CurveLoftedSolid_Type_AsyncWorker(
MbCurveLoftedSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
...
MbCurveLoftedSolid * _underlying,        Napi::Promise::Deferred const &d
    ...
    void CurveLoftedSolid_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void CurveLoftedSolid_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    CurveLoftedSolid_GetBasisItems_AsyncWorker::CurveLoftedSolid_GetBasisItems_AsyncWorker(
MbCurveLoftedSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void CurveLoftedSolid_GetBasisItems_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void CurveLoftedSolid_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbCurveLoftedSolid * _underlying,        Napi::Promise::Deferred const &d
    ...
    void CurveLoftedSolid_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    CurveLoftedSolid_GetStatus_AsyncWorker::CurveLoftedSolid_GetStatus_AsyncWorker(
MbCurveLoftedSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CurveLoftedSolid_SetStatus_AsyncWorker::CurveLoftedSolid_SetStatus_AsyncWorker(
MbCurveLoftedSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeProcessState  l    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    CurveLoftedSolid_CreateShell_AsyncWorker::CurveLoftedSolid_CreateShell_AsyncWorker(
MbCurveLoftedSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbFaceShell * shell,
...
,                        items
    ...
    CurveLoftedSolid_GetMainName_AsyncWorker::CurveLoftedSolid_GetMainName_AsyncWorker(
MbCurveLoftedSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CurveLoftedSolid_GetUseCount_AsyncWorker::CurveLoftedSolid_GetUseCount_AsyncWorker(
MbCurveLoftedSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CurveLoftedSolid_AddRef_AsyncWorker::CurveLoftedSolid_AddRef_AsyncWorker(
MbCurveLoftedSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
