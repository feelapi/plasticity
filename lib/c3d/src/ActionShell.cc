...
Napi::Value ActionShell::ExtensionShell(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result = ::ExtensionShell(solid, sameShell, face, edges, params, operNames, result
...
Napi::Value ActionShell::ExtensionShell_async(const Napi::CallbackInfo &info)
{
    ...
    ActionShell_ExtensionShell_AsyncWorker *asyncWorker = new ActionShell_ExtensionShell_AsyncWorker(deferred,
...
Napi::Value ActionShell::OffsetShell(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result =
        ::OffsetShell(solid, sameShell, initFaces, checkFacesConnection, p, operNames, copyFaceAttrs, result
...
Napi::Value ActionShell::OffsetShell_async(const Napi::CallbackInfo &info)
{
    ...
    ActionShell_OffsetShell_AsyncWorker *asyncWorker = new ActionShell_OffsetShell_AsyncWorker(deferred,
...
ActionShell_ExtensionShell_AsyncWorker::ActionShell_ExtensionShell_AsyncWorker(
    Napi::Promise::Deferred const &d, MbSolid &solid, MbeCopyMode sameShell, MbFace &face,
    const RPArray<MbCurveEdge> &edges, const ExtensionValues &params, const MbSNameMaker &operNames)
    : PromiseWorker(d), solid(solid), sameShell(sameShell), face(face), edges(edges), params(params),
      operNames(operNames){};
...
ActionShell_OffsetShell_AsyncWorker::ActionShell_OffsetShell_AsyncWorker(
    Napi::Promise::Deferred const &d, MbSolid &solid, MbeCopyMode sameShell, RPArray<MbFace> &initFaces,
    bool checkFacesConnection, SweptValues &p, const MbSNameMaker &operNames, bool copyFaceAttrs)
    : PromiseWorker(d), solid(solid), sameShell(sameShell), initFaces(initFaces),
      checkFacesConnection(checkFacesConnection), p(p), operNames(operNames), copyFaceAttrs(copyFaceAttrs){};
