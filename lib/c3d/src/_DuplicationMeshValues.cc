...
Napi::Object _DuplicationMeshValues::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "DuplicationMeshValues", {
...
_DuplicationMeshValues::_DuplicationMeshValues(const Napi::CallbackInfo& info) : Napi::ObjectWrap<_DuplicationMeshValues>(info) {
 ...
 &&         ((
                info[4].IsObject() &&
                    info[4].ToObject().InstanceOf(Vector3D::GetConstructor(env))
        )   
)
 &&         ((
                info[5].IsNumber()
 ...
 &&         ((
                info[7].IsObject() &&
                    info[7].ToObject().InstanceOf(CartPoint3D::GetConstructor(env))
        )   
 ...
 &&         ((
         ...
         || (info[8].IsNull() || info[8].IsUndefined())
)
        ...
        if (!(info[7].IsNull() || info[7].IsUndefined())) {
            CartPoint3D *center_ = CartPoint3D::Unwrap(info[7].ToObject());
                ...
                DuplicationMeshValues *underlying = new DuplicationMeshValues(isPolar,dir1,step1,num1,dir2,step2,num2,center,isAlongAxis);
                if (underlying == NULL) {
...
_underlying->GenerateTransformMatrices
(
        *matrices
    ...
    Napi::Value _DuplicationMeshValues::GenerateTransformMatrices_async(const Napi::CallbackInfo& info) {
        ...
        _DuplicationMeshValues_GenerateTransformMatrices_AsyncWorker* asyncWorker = new _DuplicationMeshValues_GenerateTransformMatrices_AsyncWorker(
_underlying,            deferred
    ...
    _DuplicationMeshValues_GenerateTransformMatrices_AsyncWorker::_DuplicationMeshValues_GenerateTransformMatrices_AsyncWorker(
DuplicationMeshValues * _underlying,        Napi::Promise::Deferred const &d
    ...
    void _DuplicationMeshValues_GenerateTransformMatrices_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
