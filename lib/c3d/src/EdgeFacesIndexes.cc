...
Napi::Object EdgeFacesIndexes::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "EdgeFacesIndexes", {
        ...
        InstanceAccessor<&EdgeFacesIndexes::GetValue_facePIndex, &EdgeFacesIndexes::SetValue_facePIndex>("facePIndex"),
        InstanceAccessor<&EdgeFacesIndexes::GetValue_faceMIndex, &EdgeFacesIndexes::SetValue_faceMIndex>("faceMIndex"),
