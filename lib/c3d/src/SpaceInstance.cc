...
Napi::Object SpaceInstance::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "SpaceInstance", {
...
(
    ...
    Napi::Value SpaceInstance::GetSpaceItem_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_GetSpaceItem_AsyncWorker* asyncWorker = new SpaceInstance_GetSpaceItem_AsyncWorker(
...
(
    ...
    Napi::Value SpaceInstance::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_GetBasisPoints_AsyncWorker* asyncWorker = new SpaceInstance_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SpaceInstance::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_SetBasisPoints_AsyncWorker* asyncWorker = new SpaceInstance_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value SpaceInstance::CreateMesh_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_CreateMesh_AsyncWorker* asyncWorker = new SpaceInstance_CreateMesh_AsyncWorker(
_underlying,            deferred
,
...
,        *mesh
    ...
    Napi::Value SpaceInstance::CalculateMesh_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_CalculateMesh_AsyncWorker* asyncWorker = new SpaceInstance_CalculateMesh_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SpaceInstance::GetItemName_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_GetItemName_AsyncWorker* asyncWorker = new SpaceInstance_GetItemName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SpaceInstance::SetItemName_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_SetItemName_AsyncWorker* asyncWorker = new SpaceInstance_SetItemName_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value SpaceInstance::RebuildItem_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_RebuildItem_AsyncWorker* asyncWorker = new SpaceInstance_RebuildItem_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 3 || info[3].IsNull() ? 0 : currInd
    ...
    Napi::Value SpaceInstance::GetItemByPath_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_GetItemByPath_AsyncWorker* asyncWorker = new SpaceInstance_GetItemByPath_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SpaceInstance::IsA_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_IsA_AsyncWorker* asyncWorker = new SpaceInstance_IsA_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SpaceInstance::Type_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_Type_AsyncWorker* asyncWorker = new SpaceInstance_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SpaceInstance::Family_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_Family_AsyncWorker* asyncWorker = new SpaceInstance_Family_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value SpaceInstance::Transform_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_Transform_AsyncWorker* asyncWorker = new SpaceInstance_Transform_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value SpaceInstance::Move_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_Move_AsyncWorker* asyncWorker = new SpaceInstance_Move_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value SpaceInstance::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_Rotate_AsyncWorker* asyncWorker = new SpaceInstance_Rotate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SpaceInstance::Refresh_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_Refresh_AsyncWorker* asyncWorker = new SpaceInstance_Refresh_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SpaceInstance::Duplicate_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_Duplicate_AsyncWorker* asyncWorker = new SpaceInstance_Duplicate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SpaceInstance::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_AddYourGabaritTo_AsyncWorker* asyncWorker = new SpaceInstance_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SpaceInstance::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_GetUseCount_AsyncWorker* asyncWorker = new SpaceInstance_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SpaceInstance::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_AddRef_AsyncWorker* asyncWorker = new SpaceInstance_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SpaceInstance::SetStyle_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_SetStyle_AsyncWorker* asyncWorker = new SpaceInstance_SetStyle_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SpaceInstance::GetStyle_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_GetStyle_AsyncWorker* asyncWorker = new SpaceInstance_GetStyle_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SpaceInstance::SetColor_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_SetColor_AsyncWorker* asyncWorker = new SpaceInstance_SetColor_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SpaceInstance::GetColor_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_GetColor_AsyncWorker* asyncWorker = new SpaceInstance_GetColor_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SpaceInstance::AttributesConvert_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_AttributesConvert_AsyncWorker* asyncWorker = new SpaceInstance_AttributesConvert_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SpaceInstance::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_GetCreatorsCount_AsyncWorker* asyncWorker = new SpaceInstance_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SpaceInstance::GetCreator_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_GetCreator_AsyncWorker* asyncWorker = new SpaceInstance_GetCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SpaceInstance::SetCreator_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_SetCreator_AsyncWorker* asyncWorker = new SpaceInstance_SetCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SpaceInstance::DetachCreator_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_DetachCreator_AsyncWorker* asyncWorker = new SpaceInstance_DetachCreator_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? false : addSame
    ...
    Napi::Value SpaceInstance::AddCreator_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_AddCreator_AsyncWorker* asyncWorker = new SpaceInstance_AddCreator_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value SpaceInstance::GetCreators_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_GetCreators_AsyncWorker* asyncWorker = new SpaceInstance_GetCreators_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SpaceInstance::DeleteCreator_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_DeleteCreator_AsyncWorker* asyncWorker = new SpaceInstance_DeleteCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SpaceInstance::GetActiveCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        SpaceInstance_GetActiveCreatorsCount_AsyncWorker* asyncWorker = new SpaceInstance_GetActiveCreatorsCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
SpaceInstance::~SpaceInstance() {
    ...
    SpaceInstance_GetSpaceItem_AsyncWorker::SpaceInstance_GetSpaceItem_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
    ...
    SpaceInstance_GetBasisPoints_AsyncWorker::SpaceInstance_GetBasisPoints_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SpaceInstance_SetBasisPoints_AsyncWorker::SpaceInstance_SetBasisPoints_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    SpaceInstance_CreateMesh_AsyncWorker::SpaceInstance_CreateMesh_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    SpaceInstance_CalculateMesh_AsyncWorker::SpaceInstance_CalculateMesh_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbStepData & stepData,
                        const MbFormNote & note    )
...
,                        *mesh
    ...
    SpaceInstance_GetItemName_AsyncWorker::SpaceInstance_GetItemName_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SpaceInstance_SetItemName_AsyncWorker::SpaceInstance_SetItemName_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         SimpleName  name    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    SpaceInstance_RebuildItem_AsyncWorker::SpaceInstance_RebuildItem_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        progInd
    ...
    SpaceInstance_GetItemByPath_AsyncWorker::SpaceInstance_GetItemByPath_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbPath & path,
                         size_t  ind,
...
,                        currInd
    ...
    SpaceInstance_IsA_AsyncWorker::SpaceInstance_IsA_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SpaceInstance_Type_AsyncWorker::SpaceInstance_Type_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SpaceInstance_Family_AsyncWorker::SpaceInstance_Family_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SpaceInstance_Transform_AsyncWorker::SpaceInstance_Transform_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    SpaceInstance_Move_AsyncWorker::SpaceInstance_Move_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & v,
                         MbRegTransform * iReg    )
...
,                        iReg
    ...
    SpaceInstance_Rotate_AsyncWorker::SpaceInstance_Rotate_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbAxis3D & axis,
                         double  angle,
...
,                        iReg
    ...
    SpaceInstance_Refresh_AsyncWorker::SpaceInstance_Refresh_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SpaceInstance_Duplicate_AsyncWorker::SpaceInstance_Duplicate_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         MbRegDuplicate * iReg    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    SpaceInstance_AddYourGabaritTo_AsyncWorker::SpaceInstance_AddYourGabaritTo_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         MbCube & cube    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    void SpaceInstance_AddYourGabaritTo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    SpaceInstance_GetUseCount_AsyncWorker::SpaceInstance_GetUseCount_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SpaceInstance_AddRef_AsyncWorker::SpaceInstance_AddRef_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SpaceInstance_SetStyle_AsyncWorker::SpaceInstance_SetStyle_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         int  s    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    SpaceInstance_GetStyle_AsyncWorker::SpaceInstance_GetStyle_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SpaceInstance_SetColor_AsyncWorker::SpaceInstance_SetColor_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         uint32  c    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    SpaceInstance_GetColor_AsyncWorker::SpaceInstance_GetColor_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
...
{};
    ...
    void SpaceInstance_AttributesConvert_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    SpaceInstance_GetCreatorsCount_AsyncWorker::SpaceInstance_GetCreatorsCount_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void SpaceInstance_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    SpaceInstance_GetCreator_AsyncWorker::SpaceInstance_GetCreator_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    SpaceInstance_SetCreator_AsyncWorker::SpaceInstance_SetCreator_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    SpaceInstance_DetachCreator_AsyncWorker::SpaceInstance_DetachCreator_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    SpaceInstance_AddCreator_AsyncWorker::SpaceInstance_AddCreator_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        addSame
    ...
    SpaceInstance_GetCreators_AsyncWorker::SpaceInstance_GetCreators_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SpaceInstance_DeleteCreator_AsyncWorker::SpaceInstance_DeleteCreator_AsyncWorker(
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
MbSpaceInstance * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SpaceInstance_GetActiveCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
