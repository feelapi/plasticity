...
{
    Napi::Function func =
        DefineClass(env, "DuplicationSolid",
                    {
...
Napi::Value DuplicationSolid::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    DuplicationSolid_IsA_AsyncWorker *asyncWorker = new DuplicationSolid_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value DuplicationSolid::Type_async(const Napi::CallbackInfo &info)
{
    ...
    DuplicationSolid_Type_AsyncWorker *asyncWorker = new DuplicationSolid_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value DuplicationSolid::GetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    DuplicationSolid_GetBasisPoints_AsyncWorker *asyncWorker =
        new DuplicationSolid_GetBasisPoints_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value DuplicationSolid::SetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    DuplicationSolid_SetBasisPoints_AsyncWorker *asyncWorker =
        new DuplicationSolid_SetBasisPoints_AsyncWorker(_underlying, deferred,
...
Napi::Value DuplicationSolid::GetBasisItems_async(const Napi::CallbackInfo &info)
{
    ...
    DuplicationSolid_GetBasisItems_AsyncWorker *asyncWorker =
        new DuplicationSolid_GetBasisItems_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value DuplicationSolid::GetCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    DuplicationSolid_GetCreatorsCount_AsyncWorker *asyncWorker =
        new DuplicationSolid_GetCreatorsCount_AsyncWorker(_underlying, deferred,
...
Napi::Value DuplicationSolid::GetYourNameMaker_async(const Napi::CallbackInfo &info)
{
    ...
    DuplicationSolid_GetYourNameMaker_AsyncWorker *asyncWorker =
        new DuplicationSolid_GetYourNameMaker_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value DuplicationSolid::GetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    DuplicationSolid_GetStatus_AsyncWorker *asyncWorker =
        new DuplicationSolid_GetStatus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value DuplicationSolid::SetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    DuplicationSolid_SetStatus_AsyncWorker *asyncWorker =
        new DuplicationSolid_SetStatus_AsyncWorker(_underlying, deferred,
...
Napi::Value DuplicationSolid::CreateShell_async(const Napi::CallbackInfo &info)
{
    ...
    DuplicationSolid_CreateShell_AsyncWorker *asyncWorker =
        new DuplicationSolid_CreateShell_AsyncWorker(_underlying, deferred,
...
Napi::Value DuplicationSolid::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    DuplicationSolid_GetMainName_AsyncWorker *asyncWorker =
        new DuplicationSolid_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value DuplicationSolid::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    DuplicationSolid_GetUseCount_AsyncWorker *asyncWorker =
        new DuplicationSolid_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value DuplicationSolid::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    DuplicationSolid_AddRef_AsyncWorker *asyncWorker = new DuplicationSolid_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
DuplicationSolid_IsA_AsyncWorker::DuplicationSolid_IsA_AsyncWorker(MbDuplicationSolid *_underlying,
...
DuplicationSolid_Type_AsyncWorker::DuplicationSolid_Type_AsyncWorker(MbDuplicationSolid *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void DuplicationSolid_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
DuplicationSolid_SetBasisPoints_AsyncWorker::DuplicationSolid_SetBasisPoints_AsyncWorker(
    MbDuplicationSolid *_underlying, Napi::Promise::Deferred const &d, const MbControlData3D &cd)
...
void DuplicationSolid_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                         Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
DuplicationSolid_GetBasisItems_AsyncWorker::DuplicationSolid_GetBasisItems_AsyncWorker(MbDuplicationSolid *_underlying,
                                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void DuplicationSolid_GetBasisItems_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                        Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
DuplicationSolid_GetCreatorsCount_AsyncWorker::DuplicationSolid_GetCreatorsCount_AsyncWorker(
    MbDuplicationSolid *_underlying, Napi::Promise::Deferred const &d, MbeCreatorType ct)
...
void DuplicationSolid_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                           Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void DuplicationSolid_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                           Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
DuplicationSolid_GetStatus_AsyncWorker::DuplicationSolid_GetStatus_AsyncWorker(MbDuplicationSolid *_underlying,
                                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
DuplicationSolid_SetStatus_AsyncWorker::DuplicationSolid_SetStatus_AsyncWorker(MbDuplicationSolid *_underlying,
                                                                               Napi::Promise::Deferred const &d,
                                                                               MbeProcessState l)
...
DuplicationSolid_CreateShell_AsyncWorker::DuplicationSolid_CreateShell_AsyncWorker(MbDuplicationSolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d,
                                                                                   MbFaceShell *shell,
...
DuplicationSolid_GetMainName_AsyncWorker::DuplicationSolid_GetMainName_AsyncWorker(MbDuplicationSolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
DuplicationSolid_GetUseCount_AsyncWorker::DuplicationSolid_GetUseCount_AsyncWorker(MbDuplicationSolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
DuplicationSolid_AddRef_AsyncWorker::DuplicationSolid_AddRef_AsyncWorker(MbDuplicationSolid *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
