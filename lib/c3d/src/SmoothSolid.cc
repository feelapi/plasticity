...
Napi::Value SmoothSolid::GetParameters_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_GetParameters_AsyncWorker *asyncWorker =
        new SmoothSolid_GetParameters_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value SmoothSolid::SetParameters_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_SetParameters_AsyncWorker *asyncWorker =
        new SmoothSolid_SetParameters_AsyncWorker(_underlying, deferred,
...
Napi::Value SmoothSolid::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_IsA_AsyncWorker *asyncWorker = new SmoothSolid_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SmoothSolid::Type_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_Type_AsyncWorker *asyncWorker = new SmoothSolid_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SmoothSolid::GetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_GetBasisPoints_AsyncWorker *asyncWorker =
        new SmoothSolid_GetBasisPoints_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SmoothSolid::SetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_SetBasisPoints_AsyncWorker *asyncWorker =
        new SmoothSolid_SetBasisPoints_AsyncWorker(_underlying, deferred,
...
Napi::Value SmoothSolid::GetBasisItems_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_GetBasisItems_AsyncWorker *asyncWorker =
        new SmoothSolid_GetBasisItems_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SmoothSolid::GetCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_GetCreatorsCount_AsyncWorker *asyncWorker =
        new SmoothSolid_GetCreatorsCount_AsyncWorker(_underlying, deferred,
...
Napi::Value SmoothSolid::GetYourNameMaker_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_GetYourNameMaker_AsyncWorker *asyncWorker =
        new SmoothSolid_GetYourNameMaker_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SmoothSolid::GetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_GetStatus_AsyncWorker *asyncWorker = new SmoothSolid_GetStatus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SmoothSolid::SetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_SetStatus_AsyncWorker *asyncWorker = new SmoothSolid_SetStatus_AsyncWorker(_underlying, deferred,
...
Napi::Value SmoothSolid::CreateShell_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_CreateShell_AsyncWorker *asyncWorker = new SmoothSolid_CreateShell_AsyncWorker(_underlying, deferred,
...
Napi::Value SmoothSolid::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_GetMainName_AsyncWorker *asyncWorker = new SmoothSolid_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SmoothSolid::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_GetUseCount_AsyncWorker *asyncWorker = new SmoothSolid_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SmoothSolid::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    SmoothSolid_AddRef_AsyncWorker *asyncWorker = new SmoothSolid_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
SmoothSolid_GetParameters_AsyncWorker::SmoothSolid_GetParameters_AsyncWorker(MbSmoothSolid *_underlying,
...
SmoothSolid_SetParameters_AsyncWorker::SmoothSolid_SetParameters_AsyncWorker(MbSmoothSolid *_underlying,
                                                                             Napi::Promise::Deferred const &d,
...
SmoothSolid_IsA_AsyncWorker::SmoothSolid_IsA_AsyncWorker(MbSmoothSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SmoothSolid_Type_AsyncWorker::SmoothSolid_Type_AsyncWorker(MbSmoothSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SmoothSolid_GetBasisPoints_AsyncWorker::SmoothSolid_GetBasisPoints_AsyncWorker(MbSmoothSolid *_underlying,
                                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SmoothSolid_SetBasisPoints_AsyncWorker::SmoothSolid_SetBasisPoints_AsyncWorker(MbSmoothSolid *_underlying,
                                                                               Napi::Promise::Deferred const &d,
...
SmoothSolid_GetBasisItems_AsyncWorker::SmoothSolid_GetBasisItems_AsyncWorker(MbSmoothSolid *_underlying,
                                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SmoothSolid_GetCreatorsCount_AsyncWorker::SmoothSolid_GetCreatorsCount_AsyncWorker(MbSmoothSolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d,
                                                                                   MbeCreatorType ct)
...
SmoothSolid_GetYourNameMaker_AsyncWorker::SmoothSolid_GetYourNameMaker_AsyncWorker(MbSmoothSolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SmoothSolid_GetStatus_AsyncWorker::SmoothSolid_GetStatus_AsyncWorker(MbSmoothSolid *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SmoothSolid_SetStatus_AsyncWorker::SmoothSolid_SetStatus_AsyncWorker(MbSmoothSolid *_underlying,
                                                                     Napi::Promise::Deferred const &d,
                                                                     MbeProcessState l)
...
SmoothSolid_CreateShell_AsyncWorker::SmoothSolid_CreateShell_AsyncWorker(MbSmoothSolid *_underlying,
                                                                         Napi::Promise::Deferred const &d,
...
SmoothSolid_GetMainName_AsyncWorker::SmoothSolid_GetMainName_AsyncWorker(MbSmoothSolid *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SmoothSolid_GetUseCount_AsyncWorker::SmoothSolid_GetUseCount_AsyncWorker(MbSmoothSolid *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SmoothSolid_AddRef_AsyncWorker::SmoothSolid_AddRef_AsyncWorker(MbSmoothSolid *_underlying,
                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
