...
Napi::Object _EvolutionValues::Init(const Napi::Env env, Napi::Object exports)
{
    Napi::Function func = DefineClass(
        env, "EvolutionValues",
        {
            ...
            InstanceAccessor<&_EvolutionValues::GetValue_thickness1, &_EvolutionValues::SetValue_thickness1>(
                "thickness1"),
            InstanceAccessor<&_EvolutionValues::GetValue_thickness2, &_EvolutionValues::SetValue_thickness2>(
                "thickness2"),
            InstanceAccessor<&_EvolutionValues::GetValue_shellClosed, &_EvolutionValues::SetValue_shellClosed>(
                "shellClosed"),
        });
...
Napi::Value _EvolutionValues::SetParallel_async(const Napi::CallbackInfo &info)
{
    ...
    _EvolutionValues_SetParallel_AsyncWorker *asyncWorker =
        new _EvolutionValues_SetParallel_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value _EvolutionValues::SetKeepingAngle_async(const Napi::CallbackInfo &info)
{
    ...
    _EvolutionValues_SetKeepingAngle_AsyncWorker *asyncWorker =
        new _EvolutionValues_SetKeepingAngle_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value _EvolutionValues::SetOrthogonal_async(const Napi::CallbackInfo &info)
{
    ...
    _EvolutionValues_SetOrthogonal_AsyncWorker *asyncWorker =
        new _EvolutionValues_SetOrthogonal_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value _EvolutionValues::CheckSelfInt_async(const Napi::CallbackInfo &info)
{
    ...
    _EvolutionValues_CheckSelfInt_AsyncWorker *asyncWorker =
        new _EvolutionValues_CheckSelfInt_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value _EvolutionValues::SetCheckSelfInt_async(const Napi::CallbackInfo &info)
{
    ...
    _EvolutionValues_SetCheckSelfInt_AsyncWorker *asyncWorker =
        new _EvolutionValues_SetCheckSelfInt_AsyncWorker(_underlying, deferred,
...
_EvolutionValues_SetParallel_AsyncWorker::_EvolutionValues_SetParallel_AsyncWorker(EvolutionValues *_underlying,
...
void _EvolutionValues_SetKeepingAngle_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
_EvolutionValues_SetOrthogonal_AsyncWorker::_EvolutionValues_SetOrthogonal_AsyncWorker(EvolutionValues *_underlying,
                                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void _EvolutionValues_SetOrthogonal_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                        Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
_EvolutionValues_CheckSelfInt_AsyncWorker::_EvolutionValues_CheckSelfInt_AsyncWorker(EvolutionValues *_underlying,
                                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void _EvolutionValues_CheckSelfInt_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                       Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
_EvolutionValues_SetCheckSelfInt_AsyncWorker::_EvolutionValues_SetCheckSelfInt_AsyncWorker(
    EvolutionValues *_underlying, Napi::Promise::Deferred const &d, bool c)
...
void _EvolutionValues_SetCheckSelfInt_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                          Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
