...
Napi::Object FaceShell::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "FaceShell", {
...
(
    ...
    Napi::Value FaceShell::GetBoundaryEdges_async(const Napi::CallbackInfo& info) {
        ...
        FaceShell_GetBoundaryEdges_AsyncWorker* asyncWorker = new FaceShell_GetBoundaryEdges_AsyncWorker(
...
(
    ...
    Napi::Value FaceShell::GetFaces_async(const Napi::CallbackInfo& info) {
        ...
        FaceShell_GetFaces_AsyncWorker* asyncWorker = new FaceShell_GetFaces_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
if (!(info[0].IsNull() || info[0].IsUndefined())) {
 ...
 bool  _result = _underlying->FindFacesIndexByEdges
(
        init
,        *functions
,        *slideways
...
if (!(info[0].IsNull() || info[0].IsUndefined())) {
    ...
    for (size_t i = 0; i < init_.Length(); i++) {
        ...
        FaceShell_FindFacesIndexByEdges_AsyncWorker* asyncWorker = new FaceShell_FindFacesIndexByEdges_AsyncWorker(
_underlying,            deferred
,
                                *init                        );
        asyncWorker->Queue();
...
if (!(info[1].IsNull() || info[1].IsUndefined())) {
    ...
    for (size_t i = 0; i < initFunctions_.Length(); i++) {
        if (initFunctions_[i].IsNull() || initFunctions_[i].IsUndefined()) {
            ...
            if (!initFunctions_[i].IsObject() || !initFunctions_[i].ToObject().InstanceOf(Function::GetConstructor(env))) {
...
if (!(info[2].IsNull() || info[2].IsUndefined())) {
 ...
 bool  _result = _underlying->FindEdgesByFacesIndex
(
        indexes
,        functions
,        slideways
...
,
 ...
 MbFaceShell * _result = _underlying->Copy
(
        sameShell
,        info.Length() == 1 || info[1].IsNull() ? NULL : history
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value FaceShell::Copy_async(const Napi::CallbackInfo& info) {
        ...
        FaceShell_Copy_AsyncWorker* asyncWorker = new FaceShell_Copy_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value FaceShell::GetEdge_async(const Napi::CallbackInfo& info) {
        ...
        FaceShell_GetEdge_AsyncWorker* asyncWorker = new FaceShell_GetEdge_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value FaceShell::SetOwnChangedThrough_async(const Napi::CallbackInfo& info) {
        ...
        FaceShell_SetOwnChangedThrough_AsyncWorker* asyncWorker = new FaceShell_SetOwnChangedThrough_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value FaceShell::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        FaceShell_GetUseCount_AsyncWorker* asyncWorker = new FaceShell_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value FaceShell::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        FaceShell_AddRef_AsyncWorker* asyncWorker = new FaceShell_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
FaceShell::~FaceShell() {
    ...
    FaceShell_GetBoundaryEdges_AsyncWorker::FaceShell_GetBoundaryEdges_AsyncWorker(
MbFaceShell * _underlying,        Napi::Promise::Deferred const &d
    )
    ...
    FaceShell_GetFaces_AsyncWorker::FaceShell_GetFaces_AsyncWorker(
MbFaceShell * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
...
,                        *indexes
    ...
    void FaceShell_FindFacesIndexByEdges_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        initSlideways
    ...
    void FaceShell_FindEdgesByFacesIndex_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    FaceShell_Copy_AsyncWorker::FaceShell_Copy_AsyncWorker(
MbFaceShell * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeCopyMode  sameShell,
                         MbShellHistory * history,
                         MbRegDuplicate * iReg    )
        :_underlying(_underlying),PromiseWorker(d),
                        sameShell(sameShell)
,
...
,                        iReg
    ...
    FaceShell_GetEdge_AsyncWorker::FaceShell_GetEdge_AsyncWorker(
MbFaceShell * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  index    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    FaceShell_SetOwnChangedThrough_AsyncWorker::FaceShell_SetOwnChangedThrough_AsyncWorker(
MbFaceShell * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeChangedType  n    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    void FaceShell_SetOwnChangedThrough_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    FaceShell_GetUseCount_AsyncWorker::FaceShell_GetUseCount_AsyncWorker(
MbFaceShell * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    FaceShell_AddRef_AsyncWorker::FaceShell_AddRef_AsyncWorker(
MbFaceShell * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
