...
(
    ...
    Napi::Value HoleSolid::IsA_async(const Napi::CallbackInfo& info) {
        ...
        HoleSolid_IsA_AsyncWorker* asyncWorker = new HoleSolid_IsA_AsyncWorker(
...
(
    ...
    Napi::Value HoleSolid::Type_async(const Napi::CallbackInfo& info) {
        ...
        HoleSolid_Type_AsyncWorker* asyncWorker = new HoleSolid_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value HoleSolid::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        HoleSolid_GetBasisPoints_AsyncWorker* asyncWorker = new HoleSolid_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value HoleSolid::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        HoleSolid_SetBasisPoints_AsyncWorker* asyncWorker = new HoleSolid_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value HoleSolid::GetBasisItems_async(const Napi::CallbackInfo& info) {
        ...
        HoleSolid_GetBasisItems_AsyncWorker* asyncWorker = new HoleSolid_GetBasisItems_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value HoleSolid::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        HoleSolid_GetCreatorsCount_AsyncWorker* asyncWorker = new HoleSolid_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value HoleSolid::GetYourNameMaker_async(const Napi::CallbackInfo& info) {
        ...
        HoleSolid_GetYourNameMaker_AsyncWorker* asyncWorker = new HoleSolid_GetYourNameMaker_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value HoleSolid::GetStatus_async(const Napi::CallbackInfo& info) {
        ...
        HoleSolid_GetStatus_AsyncWorker* asyncWorker = new HoleSolid_GetStatus_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value HoleSolid::SetStatus_async(const Napi::CallbackInfo& info) {
        ...
        HoleSolid_SetStatus_AsyncWorker* asyncWorker = new HoleSolid_SetStatus_AsyncWorker(
_underlying,            deferred
,
...
,        items
    ...
    Napi::Value HoleSolid::CreateShell_async(const Napi::CallbackInfo& info) {
        ...
        HoleSolid_CreateShell_AsyncWorker* asyncWorker = new HoleSolid_CreateShell_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value HoleSolid::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        HoleSolid_GetMainName_AsyncWorker* asyncWorker = new HoleSolid_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value HoleSolid::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        HoleSolid_GetUseCount_AsyncWorker* asyncWorker = new HoleSolid_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value HoleSolid::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        HoleSolid_AddRef_AsyncWorker* asyncWorker = new HoleSolid_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
HoleSolid::~HoleSolid() {
    ...
    HoleSolid_IsA_AsyncWorker::HoleSolid_IsA_AsyncWorker(
MbHoleSolid * _underlying,        Napi::Promise::Deferred const &d
    ...
    HoleSolid_Type_AsyncWorker::HoleSolid_Type_AsyncWorker(
MbHoleSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    HoleSolid_GetBasisPoints_AsyncWorker::HoleSolid_GetBasisPoints_AsyncWorker(
MbHoleSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    HoleSolid_SetBasisPoints_AsyncWorker::HoleSolid_SetBasisPoints_AsyncWorker(
MbHoleSolid * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    HoleSolid_GetBasisItems_AsyncWorker::HoleSolid_GetBasisItems_AsyncWorker(
MbHoleSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    HoleSolid_GetCreatorsCount_AsyncWorker::HoleSolid_GetCreatorsCount_AsyncWorker(
MbHoleSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeCreatorType  ct    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    HoleSolid_GetYourNameMaker_AsyncWorker::HoleSolid_GetYourNameMaker_AsyncWorker(
MbHoleSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    HoleSolid_GetStatus_AsyncWorker::HoleSolid_GetStatus_AsyncWorker(
MbHoleSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    HoleSolid_SetStatus_AsyncWorker::HoleSolid_SetStatus_AsyncWorker(
MbHoleSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeProcessState  l    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    HoleSolid_CreateShell_AsyncWorker::HoleSolid_CreateShell_AsyncWorker(
MbHoleSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbFaceShell * shell,
...
,                        items
    ...
    HoleSolid_GetMainName_AsyncWorker::HoleSolid_GetMainName_AsyncWorker(
MbHoleSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    HoleSolid_GetUseCount_AsyncWorker::HoleSolid_GetUseCount_AsyncWorker(
MbHoleSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    HoleSolid_AddRef_AsyncWorker::HoleSolid_AddRef_AsyncWorker(
MbHoleSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
