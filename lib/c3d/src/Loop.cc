...
Napi::Function Loop::GetConstructor(Napi::Env env) {
 ...
 MbContourOnSurface & _result = _underlying->MakeContourOnSurface
(
        surf
,        faceSense
,        doExact
    ...
    Napi::Value Loop::MakeContourOnSurface_async(const Napi::CallbackInfo& info) {
        ...
        Loop_MakeContourOnSurface_AsyncWorker* asyncWorker = new Loop_MakeContourOnSurface_AsyncWorker(
...
(
    ...
    Napi::Value Loop::GetEdgesCount_async(const Napi::CallbackInfo& info) {
        ...
        Loop_GetEdgesCount_AsyncWorker* asyncWorker = new Loop_GetEdgesCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
 ...
 MbOrientedEdge * _result = _underlying->GetOrientedEdge
(
        index
    ...
    Napi::Value Loop::GetOrientedEdge_async(const Napi::CallbackInfo& info) {
        ...
        Loop_GetOrientedEdge_AsyncWorker* asyncWorker = new Loop_GetOrientedEdge_AsyncWorker(
_underlying,            deferred
,
...
(
        *edges
,        info.Length() == 0 || info[0].IsNull() ? true : findSame
    ...
    Napi::Value Loop::GetEdges_async(const Napi::CallbackInfo& info) {
        ...
        Loop_GetEdges_AsyncWorker* asyncWorker = new Loop_GetEdges_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Loop::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        Loop_GetUseCount_AsyncWorker* asyncWorker = new Loop_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Loop::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        Loop_AddRef_AsyncWorker* asyncWorker = new Loop_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
Loop::~Loop() {
    ...
    Loop_MakeContourOnSurface_AsyncWorker::Loop_MakeContourOnSurface_AsyncWorker(
...
,                        doExact
    ...
    Loop_GetEdgesCount_AsyncWorker::Loop_GetEdgesCount_AsyncWorker(
MbLoop * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Loop_GetOrientedEdge_AsyncWorker::Loop_GetOrientedEdge_AsyncWorker(
MbLoop * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  index    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Loop_GetEdges_AsyncWorker::Loop_GetEdges_AsyncWorker(
MbLoop * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  findSame    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        findSame
    ...
    Loop_GetUseCount_AsyncWorker::Loop_GetUseCount_AsyncWorker(
MbLoop * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Loop_AddRef_AsyncWorker::Loop_AddRef_AsyncWorker(
MbLoop * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
