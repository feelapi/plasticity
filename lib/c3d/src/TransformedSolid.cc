...
{
    Napi::Function func =
        DefineClass(env, "TransformedSolid",
                    {
...
Napi::Value TransformedSolid::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    TransformedSolid_IsA_AsyncWorker *asyncWorker = new TransformedSolid_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value TransformedSolid::Type_async(const Napi::CallbackInfo &info)
{
    ...
    TransformedSolid_Type_AsyncWorker *asyncWorker = new TransformedSolid_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TransformedSolid::GetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    TransformedSolid_GetBasisPoints_AsyncWorker *asyncWorker =
        new TransformedSolid_GetBasisPoints_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TransformedSolid::SetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    TransformedSolid_SetBasisPoints_AsyncWorker *asyncWorker =
        new TransformedSolid_SetBasisPoints_AsyncWorker(_underlying, deferred,
...
Napi::Value TransformedSolid::GetBasisItems_async(const Napi::CallbackInfo &info)
{
    ...
    TransformedSolid_GetBasisItems_AsyncWorker *asyncWorker =
        new TransformedSolid_GetBasisItems_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TransformedSolid::GetCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    TransformedSolid_GetCreatorsCount_AsyncWorker *asyncWorker =
        new TransformedSolid_GetCreatorsCount_AsyncWorker(_underlying, deferred,
...
Napi::Value TransformedSolid::GetYourNameMaker_async(const Napi::CallbackInfo &info)
{
    ...
    TransformedSolid_GetYourNameMaker_AsyncWorker *asyncWorker =
        new TransformedSolid_GetYourNameMaker_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TransformedSolid::GetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    TransformedSolid_GetStatus_AsyncWorker *asyncWorker =
        new TransformedSolid_GetStatus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TransformedSolid::SetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    TransformedSolid_SetStatus_AsyncWorker *asyncWorker =
        new TransformedSolid_SetStatus_AsyncWorker(_underlying, deferred,
...
Napi::Value TransformedSolid::CreateShell_async(const Napi::CallbackInfo &info)
{
    ...
    TransformedSolid_CreateShell_AsyncWorker *asyncWorker =
        new TransformedSolid_CreateShell_AsyncWorker(_underlying, deferred,
...
Napi::Value TransformedSolid::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    TransformedSolid_GetMainName_AsyncWorker *asyncWorker =
        new TransformedSolid_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TransformedSolid::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    TransformedSolid_GetUseCount_AsyncWorker *asyncWorker =
        new TransformedSolid_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TransformedSolid::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    TransformedSolid_AddRef_AsyncWorker *asyncWorker = new TransformedSolid_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
TransformedSolid_IsA_AsyncWorker::TransformedSolid_IsA_AsyncWorker(MbTransformedSolid *_underlying,
...
TransformedSolid_Type_AsyncWorker::TransformedSolid_Type_AsyncWorker(MbTransformedSolid *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void TransformedSolid_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
TransformedSolid_SetBasisPoints_AsyncWorker::TransformedSolid_SetBasisPoints_AsyncWorker(
    MbTransformedSolid *_underlying, Napi::Promise::Deferred const &d, const MbControlData3D &cd)
...
void TransformedSolid_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                         Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
TransformedSolid_GetBasisItems_AsyncWorker::TransformedSolid_GetBasisItems_AsyncWorker(MbTransformedSolid *_underlying,
                                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void TransformedSolid_GetBasisItems_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                        Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
TransformedSolid_GetCreatorsCount_AsyncWorker::TransformedSolid_GetCreatorsCount_AsyncWorker(
    MbTransformedSolid *_underlying, Napi::Promise::Deferred const &d, MbeCreatorType ct)
...
void TransformedSolid_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                           Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void TransformedSolid_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                           Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
TransformedSolid_GetStatus_AsyncWorker::TransformedSolid_GetStatus_AsyncWorker(MbTransformedSolid *_underlying,
                                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TransformedSolid_SetStatus_AsyncWorker::TransformedSolid_SetStatus_AsyncWorker(MbTransformedSolid *_underlying,
                                                                               Napi::Promise::Deferred const &d,
                                                                               MbeProcessState l)
...
TransformedSolid_CreateShell_AsyncWorker::TransformedSolid_CreateShell_AsyncWorker(MbTransformedSolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d,
                                                                                   MbFaceShell *shell,
...
TransformedSolid_GetMainName_AsyncWorker::TransformedSolid_GetMainName_AsyncWorker(MbTransformedSolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TransformedSolid_GetUseCount_AsyncWorker::TransformedSolid_GetUseCount_AsyncWorker(MbTransformedSolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TransformedSolid_AddRef_AsyncWorker::TransformedSolid_AddRef_AsyncWorker(MbTransformedSolid *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
