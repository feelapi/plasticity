...
Napi::Value Region::DetachContours(const Napi::CallbackInfo &info)
{
    ...
    _underlying->DetachContours(*dstContours
...
Napi::Value Region::DetachContours_async(const Napi::CallbackInfo &info)
{
    ...
    Region_DetachContours_AsyncWorker *asyncWorker = new Region_DetachContours_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value Region::GetContoursCount_async(const Napi::CallbackInfo &info)
{
    ...
    Region_GetContoursCount_AsyncWorker *asyncWorker = new Region_GetContoursCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
Napi::Value Region::SetContour(const Napi::CallbackInfo &info)
{
    ...
    MbContour *_result = _underlying->SetContour(k
...
Napi::Value Region::SetContour_async(const Napi::CallbackInfo &info)
{
    ...
    Region_SetContour_AsyncWorker *asyncWorker = new Region_SetContour_AsyncWorker(_underlying, deferred,
...
Napi::Value Region::GetContour(const Napi::CallbackInfo &info)
{
    ...
    const MbContour *_result = _underlying->GetContour(k
...
Napi::Value Region::GetContour_async(const Napi::CallbackInfo &info)
{
    ...
    Region_GetContour_AsyncWorker *asyncWorker = new Region_GetContour_AsyncWorker(_underlying, deferred,
...
Napi::Value Region::GetOutContour_async(const Napi::CallbackInfo &info)
{
    ...
    Region_GetOutContour_AsyncWorker *asyncWorker = new Region_GetOutContour_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Region::SetCorrect_async(const Napi::CallbackInfo &info)
{
    ...
    Region_SetCorrect_AsyncWorker *asyncWorker = new Region_SetCorrect_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Region::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    Region_IsA_AsyncWorker *asyncWorker = new Region_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Region::Type_async(const Napi::CallbackInfo &info)
{
    ...
    Region_Type_AsyncWorker *asyncWorker = new Region_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Region::Family_async(const Napi::CallbackInfo &info)
{
    ...
    Region_Family_AsyncWorker *asyncWorker = new Region_Family_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Region::Move_async(const Napi::CallbackInfo &info)
{
    ...
    Region_Move_AsyncWorker *asyncWorker = new Region_Move_AsyncWorker(_underlying, deferred,
...
Napi::Value Region::Transform_async(const Napi::CallbackInfo &info)
{
    ...
    Region_Transform_AsyncWorker *asyncWorker = new Region_Transform_AsyncWorker(_underlying, deferred,
...
Napi::Value Region::Duplicate_async(const Napi::CallbackInfo &info)
{
    ...
    Region_Duplicate_AsyncWorker *asyncWorker = new Region_Duplicate_AsyncWorker(_underlying, deferred,
...
Napi::Value Region::AddYourGabaritTo_async(const Napi::CallbackInfo &info)
{
    ...
    Region_AddYourGabaritTo_AsyncWorker *asyncWorker = new Region_AddYourGabaritTo_AsyncWorker(_underlying, deferred,
...
Napi::Value Region::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    Region_GetUseCount_AsyncWorker *asyncWorker = new Region_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Region::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    Region_AddRef_AsyncWorker *asyncWorker = new Region_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Region_DetachContours_AsyncWorker::Region_DetachContours_AsyncWorker(MbRegion *_underlying,
...
Region_GetContoursCount_AsyncWorker::Region_GetContoursCount_AsyncWorker(MbRegion *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Region_SetContour_AsyncWorker::Region_SetContour_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d,
                                                             size_t k)
    : _underlying(_underlying), PromiseWorker(d), k(k){};
...
Region_GetContour_AsyncWorker::Region_GetContour_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d,
                                                             size_t k)
    : _underlying(_underlying), PromiseWorker(d), k(k){};
...
Region_GetOutContour_AsyncWorker::Region_GetOutContour_AsyncWorker(MbRegion *_underlying,
                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Region_SetCorrect_AsyncWorker::Region_SetCorrect_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Region_IsA_AsyncWorker::Region_IsA_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Region_Type_AsyncWorker::Region_Type_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Region_Family_AsyncWorker::Region_Family_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Region_Move_AsyncWorker::Region_Move_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d,
...
Region_Transform_AsyncWorker::Region_Transform_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d,
...
Region_Duplicate_AsyncWorker::Region_Duplicate_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d,
                                                           MbRegDuplicate *dup)
...
Region_AddYourGabaritTo_AsyncWorker::Region_AddYourGabaritTo_AsyncWorker(MbRegion *_underlying,
...
Region_GetUseCount_AsyncWorker::Region_GetUseCount_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Region_AddRef_AsyncWorker::Region_AddRef_AsyncWorker(MbRegion *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
