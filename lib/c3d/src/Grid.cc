...
(
    ...
    Napi::Value Grid::SetStepData_async(const Napi::CallbackInfo& info) {
        ...
        Grid_SetStepData_AsyncWorker* asyncWorker = new Grid_SetStepData_AsyncWorker(
...
(
    ...
    Napi::Value Grid::IsSearchTreeReady_async(const Napi::CallbackInfo& info) {
        ...
        Grid_IsSearchTreeReady_AsyncWorker* asyncWorker = new Grid_IsSearchTreeReady_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Grid::CreateSearchTree_async(const Napi::CallbackInfo& info) {
        ...
        Grid_CreateSearchTree_AsyncWorker* asyncWorker = new Grid_CreateSearchTree_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Grid::DeleteSearchTree_async(const Napi::CallbackInfo& info) {
        ...
        Grid_DeleteSearchTree_AsyncWorker* asyncWorker = new Grid_DeleteSearchTree_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Grid::GetCube_async(const Napi::CallbackInfo& info) {
        ...
        Grid_GetCube_AsyncWorker* asyncWorker = new Grid_GetCube_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
_underlying->CreateGridTopology
(
        keepExisting
    ...
    Napi::Value Grid::CreateGridTopology_async(const Napi::CallbackInfo& info) {
        ...
        Grid_CreateGridTopology_AsyncWorker* asyncWorker = new Grid_CreateGridTopology_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Grid::IsGridTopologyReady_async(const Napi::CallbackInfo& info) {
        ...
        Grid_IsGridTopologyReady_AsyncWorker* asyncWorker = new Grid_IsGridTopologyReady_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Grid::SetItem_async(const Napi::CallbackInfo& info) {
        ...
        Grid_SetItem_AsyncWorker* asyncWorker = new Grid_SetItem_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Grid::SetPrimitiveName_async(const Napi::CallbackInfo& info) {
        ...
        Grid_SetPrimitiveName_AsyncWorker* asyncWorker = new Grid_SetPrimitiveName_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Grid::SetPrimitiveType_async(const Napi::CallbackInfo& info) {
        ...
        Grid_SetPrimitiveType_AsyncWorker* asyncWorker = new Grid_SetPrimitiveType_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Grid::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        Grid_GetUseCount_AsyncWorker* asyncWorker = new Grid_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Grid::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        Grid_AddRef_AsyncWorker* asyncWorker = new Grid_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Grid::SetStyle_async(const Napi::CallbackInfo& info) {
        ...
        Grid_SetStyle_AsyncWorker* asyncWorker = new Grid_SetStyle_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Grid::GetStyle_async(const Napi::CallbackInfo& info) {
        ...
        Grid_GetStyle_AsyncWorker* asyncWorker = new Grid_GetStyle_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Grid::SetColor_async(const Napi::CallbackInfo& info) {
        ...
        Grid_SetColor_AsyncWorker* asyncWorker = new Grid_SetColor_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Grid::GetColor_async(const Napi::CallbackInfo& info) {
        ...
        Grid_GetColor_AsyncWorker* asyncWorker = new Grid_GetColor_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Grid::AttributesConvert_async(const Napi::CallbackInfo& info) {
        ...
        Grid_AttributesConvert_AsyncWorker* asyncWorker = new Grid_AttributesConvert_AsyncWorker(
_underlying,            deferred
,
...
Grid::~Grid() {
    ...
    Grid_SetStepData_AsyncWorker::Grid_SetStepData_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    Grid_IsSearchTreeReady_AsyncWorker::Grid_IsSearchTreeReady_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Grid_CreateSearchTree_AsyncWorker::Grid_CreateSearchTree_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Grid_DeleteSearchTree_AsyncWorker::Grid_DeleteSearchTree_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Grid_GetCube_AsyncWorker::Grid_GetCube_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Grid_CreateGridTopology_AsyncWorker::Grid_CreateGridTopology_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  keepExisting    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Grid_IsGridTopologyReady_AsyncWorker::Grid_IsGridTopologyReady_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Grid_SetItem_AsyncWorker::Grid_SetItem_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbRefItem * g    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Grid_SetPrimitiveName_AsyncWorker::Grid_SetPrimitiveName_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
,
                         SimpleName  n    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Grid_SetPrimitiveType_AsyncWorker::Grid_SetPrimitiveType_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeRefType  t    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Grid_GetUseCount_AsyncWorker::Grid_GetUseCount_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Grid_AddRef_AsyncWorker::Grid_AddRef_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Grid_SetStyle_AsyncWorker::Grid_SetStyle_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
,
                         int  s    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Grid_GetStyle_AsyncWorker::Grid_GetStyle_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Grid_SetColor_AsyncWorker::Grid_SetColor_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
,
                         uint32  c    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Grid_GetColor_AsyncWorker::Grid_GetColor_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Grid_AttributesConvert_AsyncWorker::Grid_AttributesConvert_AsyncWorker(
MbGrid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbGrid & other    )
        :_underlying(_underlying),PromiseWorker(d),
