...
Napi::Object _LoftedValues::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "LoftedValues", {
...
(
    ...
    Napi::Value _LoftedValues::CheckSelfInt_async(const Napi::CallbackInfo& info) {
        ...
        _LoftedValues_CheckSelfInt_AsyncWorker* asyncWorker = new _LoftedValues_CheckSelfInt_AsyncWorker(
...
(
    ...
    Napi::Value _LoftedValues::SetCheckSelfInt_async(const Napi::CallbackInfo& info) {
        ...
        _LoftedValues_SetCheckSelfInt_AsyncWorker* asyncWorker = new _LoftedValues_SetCheckSelfInt_AsyncWorker(
_underlying,            deferred
,
...
void _LoftedValues::SetValue_shellClosed(const Napi::CallbackInfo &info, const Napi::Value &value) {
    ...
    _LoftedValues_CheckSelfInt_AsyncWorker::_LoftedValues_CheckSelfInt_AsyncWorker(
LoftedValues * _underlying,        Napi::Promise::Deferred const &d
    ...
    _LoftedValues_SetCheckSelfInt_AsyncWorker::_LoftedValues_SetCheckSelfInt_AsyncWorker(
LoftedValues * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  c    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    void _LoftedValues_SetCheckSelfInt_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
