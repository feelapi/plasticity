...
Napi::Value Name::Hash_async(const Napi::CallbackInfo &info)
{
    ...
    Name_Hash_AsyncWorker *asyncWorker = new Name_Hash_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value Name::GetFirstName_async(const Napi::CallbackInfo &info)
{
    ...
    Name_GetFirstName_AsyncWorker *asyncWorker = new Name_GetFirstName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Name::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    Name_GetMainName_AsyncWorker *asyncWorker = new Name_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Name_Hash_AsyncWorker::Name_Hash_AsyncWorker(MbName *_underlying, Napi::Promise::Deferred const &d)
...
Name_GetFirstName_AsyncWorker::Name_GetFirstName_AsyncWorker(MbName *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Name_GetMainName_AsyncWorker::Name_GetMainName_AsyncWorker(MbName *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
