...
Napi::Object SurfaceIntersectionCurve::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "SurfaceIntersectionCurve", {
...
SurfaceIntersectionCurve::SurfaceIntersectionCurve(const Napi::CallbackInfo& info) : Napi::ObjectWrap<SurfaceIntersectionCurve>(info) {
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetSurfaceOne_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetSurfaceOne_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetSurfaceOne_AsyncWorker(
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetSurfaceTwo_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetSurfaceTwo_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetSurfaceTwo_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetPCurveOne_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetPCurveOne_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetPCurveOne_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetPCurveTwo_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetPCurveTwo_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetPCurveTwo_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetSCurveOne_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetSCurveOne_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetSCurveOne_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetSCurveTwo_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetSCurveTwo_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetSCurveTwo_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetSpaceCurve_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetSpaceCurve_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetSpaceCurve_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetCurveOneSurface_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetCurveOneSurface_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetCurveOneSurface_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetCurveTwoSurface_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetCurveTwoSurface_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetCurveTwoSurface_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
if (_result) {
    ...
    Napi::Value SurfaceIntersectionCurve::GetPlaneCurve_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetPlaneCurve_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetPlaneCurve_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::IsPlanar_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_IsPlanar_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_IsPlanar_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::IsClosed_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_IsClosed_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_IsClosed_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::IsTouch_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_IsTouch_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_IsTouch_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetTMax_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetTMax_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetTMax_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetTMin_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetTMin_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetTMin_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetPeriod_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetPeriod_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetPeriod_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::IsPeriodic_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_IsPeriodic_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_IsPeriodic_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::IsStraight_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_IsStraight_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_IsStraight_AsyncWorker(
_underlying,            deferred
,
...
,        sense
    ...
    Napi::Value SurfaceIntersectionCurve::Trimmed_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_Trimmed_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_Trimmed_AsyncWorker(
_underlying,            deferred
,
...
,        *n
    ...
    Napi::Value SurfaceIntersectionCurve::Normal_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_Normal_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_Normal_AsyncWorker(
_underlying,            deferred
,
...
,        *tan
    ...
    Napi::Value SurfaceIntersectionCurve::Tangent_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_Tangent_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_Tangent_AsyncWorker(
_underlying,            deferred
,
...
,        *b
    ...
    Napi::Value SurfaceIntersectionCurve::BNormal_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_BNormal_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_BNormal_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetCentre_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetCentre_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetCentre_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        *point
    ...
    Napi::Value SurfaceIntersectionCurve::GetLimitPoint_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetLimitPoint_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetLimitPoint_AsyncWorker(
_underlying,            deferred
,
...
,        *p
    ...
    Napi::Value SurfaceIntersectionCurve::PointOn_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_PointOn_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_PointOn_AsyncWorker(
_underlying,            deferred
,
...
,        *p
    ...
    Napi::Value SurfaceIntersectionCurve::_PointOn_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve__PointOn_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve__PointOn_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : tRange
    ...
    Napi::Value SurfaceIntersectionCurve::NearPointProjection_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_NearPointProjection_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_NearPointProjection_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value SurfaceIntersectionCurve::GetSurfaceCurve_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetSurfaceCurve_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetSurfaceCurve_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetWeightCentre_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetWeightCentre_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetWeightCentre_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetBasisCurve_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetBasisCurve_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetBasisCurve_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetBasisPoints_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_SetBasisPoints_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::Inverse_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_Inverse_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_Inverse_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? Math::DefaultMathVersion() : version
    ...
    Napi::Value SurfaceIntersectionCurve::GetProjection_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetProjection_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetProjection_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetCircleAxis_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetCircleAxis_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetCircleAxis_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::IsA_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_IsA_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_IsA_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::Type_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_Type_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::Family_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_Family_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_Family_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value SurfaceIntersectionCurve::Transform_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_Transform_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_Transform_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value SurfaceIntersectionCurve::Move_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_Move_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_Move_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value SurfaceIntersectionCurve::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_Rotate_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_Rotate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::Refresh_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_Refresh_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_Refresh_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::Duplicate_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_Duplicate_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_Duplicate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_AddYourGabaritTo_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_GetUseCount_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SurfaceIntersectionCurve::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        SurfaceIntersectionCurve_AddRef_AsyncWorker* asyncWorker = new SurfaceIntersectionCurve_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetSurfaceOne_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetSurfaceTwo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetPCurveOne_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetPCurveTwo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetSCurveOne_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetSCurveTwo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetSpaceCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetCurveOneSurface_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetCurveTwoSurface_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        params
    ...
    void SurfaceIntersectionCurve_GetPlaneCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void SurfaceIntersectionCurve_IsPlanar_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_IsClosed_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_IsTouch_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetTMax_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetTMin_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetPeriod_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_IsPeriodic_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void SurfaceIntersectionCurve_IsStraight_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        sense
    ...
    void SurfaceIntersectionCurve_Trimmed_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        *n
    ...
    void SurfaceIntersectionCurve_Normal_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        *tan
    ...
    void SurfaceIntersectionCurve_Tangent_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        *b
    ...
    void SurfaceIntersectionCurve_BNormal_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetCentre_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        *point
    ...
    void SurfaceIntersectionCurve_GetLimitPoint_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        *p
    ...
    void SurfaceIntersectionCurve_PointOn_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        *p
    ...
    void SurfaceIntersectionCurve__PointOn_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        tRange
    ...
    void SurfaceIntersectionCurve_NearPointProjection_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        version
    ...
    void SurfaceIntersectionCurve_GetSurfaceCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetWeightCentre_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetBasisCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void SurfaceIntersectionCurve_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_Inverse_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        version
    ...
    void SurfaceIntersectionCurve_GetProjection_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetCircleAxis_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_Type_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_Family_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        iReg
    ...
    void SurfaceIntersectionCurve_Transform_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        iReg
    ...
    void SurfaceIntersectionCurve_Move_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        iReg
    ...
    void SurfaceIntersectionCurve_Rotate_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_Refresh_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void SurfaceIntersectionCurve_Duplicate_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void SurfaceIntersectionCurve_AddYourGabaritTo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_GetUseCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbSurfaceIntersectionCurve * _underlying,        Napi::Promise::Deferred const &d
    ...
    void SurfaceIntersectionCurve_AddRef_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
