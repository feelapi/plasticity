...
Napi::Function Cube::GetConstructor(Napi::Env env) {
 ...
 bool  _result = _underlying->CalculateMatrix
(
        pIndex
,        point
,        fixedPoint
...
,        *matrix
    ...
    Napi::Value Cube::CalculateMatrix_async(const Napi::CallbackInfo& info) {
        ...
        Cube_CalculateMatrix_AsyncWorker* asyncWorker = new Cube_CalculateMatrix_AsyncWorker(
...
,        *rect
    ...
    Napi::Value Cube::ProjectionRect_async(const Napi::CallbackInfo& info) {
        ...
        Cube_ProjectionRect_AsyncWorker* asyncWorker = new Cube_ProjectionRect_AsyncWorker(
_underlying,            deferred
,
 ...
 bool  _result = _underlying->Intersect
(
        other
,        info.Length() == 1 || info[1].IsNull() ? c3d::MIN_RADIUS : eps
    ...
    Napi::Value Cube::Intersect_async(const Napi::CallbackInfo& info) {
        ...
        Cube_Intersect_AsyncWorker* asyncWorker = new Cube_Intersect_AsyncWorker(
_underlying,            deferred
,
...
void Cube::SetValue_pmax(const Napi::CallbackInfo &info, const Napi::Value &value) {
    ...
    Cube_CalculateMatrix_AsyncWorker::Cube_CalculateMatrix_AsyncWorker(
...
,                        *matrix
    ...
    Cube_ProjectionRect_AsyncWorker::Cube_ProjectionRect_AsyncWorker(
MbCube * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        *rect
    ...
    Cube_Intersect_AsyncWorker::Cube_Intersect_AsyncWorker(
MbCube * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbCube & other,
                         double  eps    )
