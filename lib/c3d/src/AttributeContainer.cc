...
{
    Napi::Function func =
        DefineClass(env, "AttributeContainer",
                    {
...
Napi::Value AttributeContainer::SetStyle_async(const Napi::CallbackInfo &info)
{
    ...
    AttributeContainer_SetStyle_AsyncWorker *asyncWorker =
        new AttributeContainer_SetStyle_AsyncWorker(_underlying, deferred,
...
Napi::Value AttributeContainer::GetStyle_async(const Napi::CallbackInfo &info)
{
    ...
    AttributeContainer_GetStyle_AsyncWorker *asyncWorker =
        new AttributeContainer_GetStyle_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value AttributeContainer::SetColor_async(const Napi::CallbackInfo &info)
{
    ...
    AttributeContainer_SetColor_AsyncWorker *asyncWorker =
        new AttributeContainer_SetColor_AsyncWorker(_underlying, deferred,
...
Napi::Value AttributeContainer::GetColor_async(const Napi::CallbackInfo &info)
{
    ...
    AttributeContainer_GetColor_AsyncWorker *asyncWorker =
        new AttributeContainer_GetColor_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value AttributeContainer::AttributesConvert_async(const Napi::CallbackInfo &info)
{
    ...
    AttributeContainer_AttributesConvert_AsyncWorker *asyncWorker =
        new AttributeContainer_AttributesConvert_AsyncWorker(_underlying, deferred,
...
AttributeContainer_SetStyle_AsyncWorker::AttributeContainer_SetStyle_AsyncWorker(MbAttributeContainer *_underlying,
...
AttributeContainer_GetStyle_AsyncWorker::AttributeContainer_GetStyle_AsyncWorker(MbAttributeContainer *_underlying,
                                                                                 Napi::Promise::Deferred const &d)
...
AttributeContainer_SetColor_AsyncWorker::AttributeContainer_SetColor_AsyncWorker(MbAttributeContainer *_underlying,
                                                                                 Napi::Promise::Deferred const &d,
                                                                                 uint32 c)
...
AttributeContainer_GetColor_AsyncWorker::AttributeContainer_GetColor_AsyncWorker(MbAttributeContainer *_underlying,
                                                                                 Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
AttributeContainer_AttributesConvert_AsyncWorker::AttributeContainer_AttributesConvert_AsyncWorker(
    MbAttributeContainer *_underlying, Napi::Promise::Deferred const &d, MbGrid &other)
...
void AttributeContainer_AttributesConvert_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
