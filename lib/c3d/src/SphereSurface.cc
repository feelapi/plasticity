...
Napi::Object SphereSurface::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "SphereSurface", {
...
(
    ...
    Napi::Value SphereSurface::GetSurface_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_GetSurface_AsyncWorker* asyncWorker = new SphereSurface_GetSurface_AsyncWorker(
...
(
    ...
    Napi::Value SphereSurface::GetUEpsilon_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_GetUEpsilon_AsyncWorker* asyncWorker = new SphereSurface_GetUEpsilon_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SphereSurface::GetVEpsilon_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_GetVEpsilon_AsyncWorker* asyncWorker = new SphereSurface_GetVEpsilon_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SphereSurface::GetUMid_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_GetUMid_AsyncWorker* asyncWorker = new SphereSurface_GetUMid_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SphereSurface::GetVMid_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_GetVMid_AsyncWorker* asyncWorker = new SphereSurface_GetVMid_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SphereSurface::GetUMin_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_GetUMin_AsyncWorker* asyncWorker = new SphereSurface_GetUMin_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SphereSurface::GetUMax_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_GetUMax_AsyncWorker* asyncWorker = new SphereSurface_GetUMax_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SphereSurface::GetVMin_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_GetVMin_AsyncWorker* asyncWorker = new SphereSurface_GetVMin_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SphereSurface::GetVMax_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_GetVMax_AsyncWorker* asyncWorker = new SphereSurface_GetVMax_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SphereSurface::GetUParamToUnit_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_GetUParamToUnit_AsyncWorker* asyncWorker = new SphereSurface_GetUParamToUnit_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SphereSurface::GetVParamToUnit_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_GetVParamToUnit_AsyncWorker* asyncWorker = new SphereSurface_GetVParamToUnit_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SphereSurface::GetRadius_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_GetRadius_AsyncWorker* asyncWorker = new SphereSurface_GetRadius_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        *result
    ...
    Napi::Value SphereSurface::Normal_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_Normal_AsyncWorker* asyncWorker = new SphereSurface_Normal_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value SphereSurface::NearDirectPointProjection_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_NearDirectPointProjection_AsyncWorker* asyncWorker = new SphereSurface_NearDirectPointProjection_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SphereSurface::IsA_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_IsA_AsyncWorker* asyncWorker = new SphereSurface_IsA_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SphereSurface::Type_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_Type_AsyncWorker* asyncWorker = new SphereSurface_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SphereSurface::Family_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_Family_AsyncWorker* asyncWorker = new SphereSurface_Family_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value SphereSurface::Transform_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_Transform_AsyncWorker* asyncWorker = new SphereSurface_Transform_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value SphereSurface::Move_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_Move_AsyncWorker* asyncWorker = new SphereSurface_Move_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value SphereSurface::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_Rotate_AsyncWorker* asyncWorker = new SphereSurface_Rotate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SphereSurface::Refresh_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_Refresh_AsyncWorker* asyncWorker = new SphereSurface_Refresh_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SphereSurface::Duplicate_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_Duplicate_AsyncWorker* asyncWorker = new SphereSurface_Duplicate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SphereSurface::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_AddYourGabaritTo_AsyncWorker* asyncWorker = new SphereSurface_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SphereSurface::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_GetUseCount_AsyncWorker* asyncWorker = new SphereSurface_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SphereSurface::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        SphereSurface_AddRef_AsyncWorker* asyncWorker = new SphereSurface_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
SphereSurface::~SphereSurface() {
    ...
    SphereSurface_GetSurface_AsyncWorker::SphereSurface_GetSurface_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
    ...
    SphereSurface_GetUEpsilon_AsyncWorker::SphereSurface_GetUEpsilon_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SphereSurface_GetVEpsilon_AsyncWorker::SphereSurface_GetVEpsilon_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SphereSurface_GetUMid_AsyncWorker::SphereSurface_GetUMid_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SphereSurface_GetVMid_AsyncWorker::SphereSurface_GetVMid_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SphereSurface_GetUMin_AsyncWorker::SphereSurface_GetUMin_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SphereSurface_GetUMax_AsyncWorker::SphereSurface_GetUMax_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SphereSurface_GetVMin_AsyncWorker::SphereSurface_GetVMin_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SphereSurface_GetVMax_AsyncWorker::SphereSurface_GetVMax_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SphereSurface_GetUParamToUnit_AsyncWorker::SphereSurface_GetUParamToUnit_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void SphereSurface_GetUParamToUnit_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    SphereSurface_GetVParamToUnit_AsyncWorker::SphereSurface_GetVParamToUnit_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void SphereSurface_GetVParamToUnit_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    SphereSurface_GetRadius_AsyncWorker::SphereSurface_GetRadius_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SphereSurface_Normal_AsyncWorker::SphereSurface_Normal_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         double & u,
                         double & v    )
...
,                        onlyPositiveDirection
    ...
    void SphereSurface_NearDirectPointProjection_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    SphereSurface_IsA_AsyncWorker::SphereSurface_IsA_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SphereSurface_Type_AsyncWorker::SphereSurface_Type_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SphereSurface_Family_AsyncWorker::SphereSurface_Family_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SphereSurface_Transform_AsyncWorker::SphereSurface_Transform_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    SphereSurface_Move_AsyncWorker::SphereSurface_Move_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & v,
                         MbRegTransform * iReg    )
...
,                        iReg
    ...
    SphereSurface_Rotate_AsyncWorker::SphereSurface_Rotate_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbAxis3D & axis,
                         double  angle,
...
,                        iReg
    ...
    SphereSurface_Refresh_AsyncWorker::SphereSurface_Refresh_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SphereSurface_Duplicate_AsyncWorker::SphereSurface_Duplicate_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         MbRegDuplicate * iReg    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    SphereSurface_AddYourGabaritTo_AsyncWorker::SphereSurface_AddYourGabaritTo_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         MbCube & cube    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    void SphereSurface_AddYourGabaritTo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    SphereSurface_GetUseCount_AsyncWorker::SphereSurface_GetUseCount_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SphereSurface_AddRef_AsyncWorker::SphereSurface_AddRef_AsyncWorker(
MbSphereSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
