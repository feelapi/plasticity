...
_underlying->InitBoolean
(
        _closed
,        info.Length() == 1 || info[1].IsNull() ? false : _allowNonIntersecting
    ...
    Napi::Value BooleanFlags::InitBoolean_async(const Napi::CallbackInfo& info) {
        ...
        BooleanFlags_InitBoolean_AsyncWorker* asyncWorker = new BooleanFlags_InitBoolean_AsyncWorker(
...
,        info.Length() == 1 || info[1].IsNull() ? false : _allowNonIntersecting
    ...
    Napi::Value BooleanFlags::InitCutting_async(const Napi::CallbackInfo& info) {
        ...
        BooleanFlags_InitCutting_AsyncWorker* asyncWorker = new BooleanFlags_InitCutting_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value BooleanFlags::SetMergingFaces_async(const Napi::CallbackInfo& info) {
        ...
        BooleanFlags_SetMergingFaces_AsyncWorker* asyncWorker = new BooleanFlags_SetMergingFaces_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value BooleanFlags::SetMergingEdges_async(const Napi::CallbackInfo& info) {
        ...
        BooleanFlags_SetMergingEdges_AsyncWorker* asyncWorker = new BooleanFlags_SetMergingEdges_AsyncWorker(
_underlying,            deferred
,
    ...
    BooleanFlags_InitBoolean_AsyncWorker::BooleanFlags_InitBoolean_AsyncWorker(
MbBooleanFlags * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  _closed,
                         bool  _allowNonIntersecting    )
        :_underlying(_underlying),PromiseWorker(d),
                        _closed(_closed)
,
                        _allowNonIntersecting(_allowNonIntersecting)
{};
...
,                        _allowNonIntersecting
    ...
    BooleanFlags_InitCutting_AsyncWorker::BooleanFlags_InitCutting_AsyncWorker(
MbBooleanFlags * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  _closed,
                         bool  _allowNonIntersecting    )
...
,                        _allowNonIntersecting
    ...
    BooleanFlags_SetMergingFaces_AsyncWorker::BooleanFlags_SetMergingFaces_AsyncWorker(
MbBooleanFlags * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  s    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    BooleanFlags_SetMergingEdges_AsyncWorker::BooleanFlags_SetMergingEdges_AsyncWorker(
MbBooleanFlags * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  s    )
        :_underlying(_underlying),PromiseWorker(d),
