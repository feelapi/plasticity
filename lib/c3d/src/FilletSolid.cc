...
Napi::Value FilletSolid::GetParameters_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_GetParameters_AsyncWorker *asyncWorker =
        new FilletSolid_GetParameters_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value FilletSolid::SetParameters_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_SetParameters_AsyncWorker *asyncWorker =
        new FilletSolid_SetParameters_AsyncWorker(_underlying, deferred,
...
Napi::Value FilletSolid::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_IsA_AsyncWorker *asyncWorker = new FilletSolid_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value FilletSolid::Type_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_Type_AsyncWorker *asyncWorker = new FilletSolid_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value FilletSolid::GetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_GetBasisPoints_AsyncWorker *asyncWorker =
        new FilletSolid_GetBasisPoints_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value FilletSolid::SetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_SetBasisPoints_AsyncWorker *asyncWorker =
        new FilletSolid_SetBasisPoints_AsyncWorker(_underlying, deferred,
...
Napi::Value FilletSolid::GetBasisItems_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_GetBasisItems_AsyncWorker *asyncWorker =
        new FilletSolid_GetBasisItems_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value FilletSolid::GetCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_GetCreatorsCount_AsyncWorker *asyncWorker =
        new FilletSolid_GetCreatorsCount_AsyncWorker(_underlying, deferred,
...
Napi::Value FilletSolid::GetYourNameMaker_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_GetYourNameMaker_AsyncWorker *asyncWorker =
        new FilletSolid_GetYourNameMaker_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value FilletSolid::GetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_GetStatus_AsyncWorker *asyncWorker = new FilletSolid_GetStatus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value FilletSolid::SetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_SetStatus_AsyncWorker *asyncWorker = new FilletSolid_SetStatus_AsyncWorker(_underlying, deferred,
...
Napi::Value FilletSolid::CreateShell_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_CreateShell_AsyncWorker *asyncWorker = new FilletSolid_CreateShell_AsyncWorker(_underlying, deferred,
...
Napi::Value FilletSolid::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_GetMainName_AsyncWorker *asyncWorker = new FilletSolid_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value FilletSolid::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_GetUseCount_AsyncWorker *asyncWorker = new FilletSolid_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value FilletSolid::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    FilletSolid_AddRef_AsyncWorker *asyncWorker = new FilletSolid_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
FilletSolid_GetParameters_AsyncWorker::FilletSolid_GetParameters_AsyncWorker(MbFilletSolid *_underlying,
...
FilletSolid_SetParameters_AsyncWorker::FilletSolid_SetParameters_AsyncWorker(MbFilletSolid *_underlying,
                                                                             Napi::Promise::Deferred const &d,
...
FilletSolid_IsA_AsyncWorker::FilletSolid_IsA_AsyncWorker(MbFilletSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
FilletSolid_Type_AsyncWorker::FilletSolid_Type_AsyncWorker(MbFilletSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
FilletSolid_GetBasisPoints_AsyncWorker::FilletSolid_GetBasisPoints_AsyncWorker(MbFilletSolid *_underlying,
                                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
FilletSolid_SetBasisPoints_AsyncWorker::FilletSolid_SetBasisPoints_AsyncWorker(MbFilletSolid *_underlying,
                                                                               Napi::Promise::Deferred const &d,
...
FilletSolid_GetBasisItems_AsyncWorker::FilletSolid_GetBasisItems_AsyncWorker(MbFilletSolid *_underlying,
                                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
FilletSolid_GetCreatorsCount_AsyncWorker::FilletSolid_GetCreatorsCount_AsyncWorker(MbFilletSolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d,
                                                                                   MbeCreatorType ct)
...
FilletSolid_GetYourNameMaker_AsyncWorker::FilletSolid_GetYourNameMaker_AsyncWorker(MbFilletSolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
FilletSolid_GetStatus_AsyncWorker::FilletSolid_GetStatus_AsyncWorker(MbFilletSolid *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
FilletSolid_SetStatus_AsyncWorker::FilletSolid_SetStatus_AsyncWorker(MbFilletSolid *_underlying,
                                                                     Napi::Promise::Deferred const &d,
                                                                     MbeProcessState l)
...
FilletSolid_CreateShell_AsyncWorker::FilletSolid_CreateShell_AsyncWorker(MbFilletSolid *_underlying,
                                                                         Napi::Promise::Deferred const &d,
...
FilletSolid_GetMainName_AsyncWorker::FilletSolid_GetMainName_AsyncWorker(MbFilletSolid *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
FilletSolid_GetUseCount_AsyncWorker::FilletSolid_GetUseCount_AsyncWorker(MbFilletSolid *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
FilletSolid_AddRef_AsyncWorker::FilletSolid_AddRef_AsyncWorker(MbFilletSolid *_underlying,
                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
