...
Napi::Object ExtensionShell::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "ExtensionShell", {
...
(
    ...
    Napi::Value ExtensionShell::IsA_async(const Napi::CallbackInfo& info) {
        ...
        ExtensionShell_IsA_AsyncWorker* asyncWorker = new ExtensionShell_IsA_AsyncWorker(
...
(
    ...
    Napi::Value ExtensionShell::Type_async(const Napi::CallbackInfo& info) {
        ...
        ExtensionShell_Type_AsyncWorker* asyncWorker = new ExtensionShell_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ExtensionShell::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        ExtensionShell_GetBasisPoints_AsyncWorker* asyncWorker = new ExtensionShell_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ExtensionShell::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        ExtensionShell_SetBasisPoints_AsyncWorker* asyncWorker = new ExtensionShell_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ExtensionShell::GetBasisItems_async(const Napi::CallbackInfo& info) {
        ...
        ExtensionShell_GetBasisItems_AsyncWorker* asyncWorker = new ExtensionShell_GetBasisItems_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ExtensionShell::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        ExtensionShell_GetCreatorsCount_AsyncWorker* asyncWorker = new ExtensionShell_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ExtensionShell::GetYourNameMaker_async(const Napi::CallbackInfo& info) {
        ...
        ExtensionShell_GetYourNameMaker_AsyncWorker* asyncWorker = new ExtensionShell_GetYourNameMaker_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ExtensionShell::GetStatus_async(const Napi::CallbackInfo& info) {
        ...
        ExtensionShell_GetStatus_AsyncWorker* asyncWorker = new ExtensionShell_GetStatus_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ExtensionShell::SetStatus_async(const Napi::CallbackInfo& info) {
        ...
        ExtensionShell_SetStatus_AsyncWorker* asyncWorker = new ExtensionShell_SetStatus_AsyncWorker(
_underlying,            deferred
,
...
,        items
    ...
    Napi::Value ExtensionShell::CreateShell_async(const Napi::CallbackInfo& info) {
        ...
        ExtensionShell_CreateShell_AsyncWorker* asyncWorker = new ExtensionShell_CreateShell_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ExtensionShell::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        ExtensionShell_GetMainName_AsyncWorker* asyncWorker = new ExtensionShell_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ExtensionShell::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        ExtensionShell_GetUseCount_AsyncWorker* asyncWorker = new ExtensionShell_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ExtensionShell::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        ExtensionShell_AddRef_AsyncWorker* asyncWorker = new ExtensionShell_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
ExtensionShell::~ExtensionShell() {
    ...
    ExtensionShell_IsA_AsyncWorker::ExtensionShell_IsA_AsyncWorker(
MbExtensionShell * _underlying,        Napi::Promise::Deferred const &d
    ...
    ExtensionShell_Type_AsyncWorker::ExtensionShell_Type_AsyncWorker(
MbExtensionShell * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ExtensionShell_GetBasisPoints_AsyncWorker::ExtensionShell_GetBasisPoints_AsyncWorker(
MbExtensionShell * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void ExtensionShell_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ExtensionShell_SetBasisPoints_AsyncWorker::ExtensionShell_SetBasisPoints_AsyncWorker(
MbExtensionShell * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    void ExtensionShell_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ExtensionShell_GetBasisItems_AsyncWorker::ExtensionShell_GetBasisItems_AsyncWorker(
MbExtensionShell * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
...
{};
    ...
    void ExtensionShell_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbExtensionShell * _underlying,        Napi::Promise::Deferred const &d
    ...
    void ExtensionShell_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ExtensionShell_GetStatus_AsyncWorker::ExtensionShell_GetStatus_AsyncWorker(
MbExtensionShell * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ExtensionShell_SetStatus_AsyncWorker::ExtensionShell_SetStatus_AsyncWorker(
MbExtensionShell * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeProcessState  l    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    ExtensionShell_CreateShell_AsyncWorker::ExtensionShell_CreateShell_AsyncWorker(
MbExtensionShell * _underlying,        Napi::Promise::Deferred const &d
,
                         MbFaceShell * shell,
...
,                        items
    ...
    ExtensionShell_GetMainName_AsyncWorker::ExtensionShell_GetMainName_AsyncWorker(
MbExtensionShell * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ExtensionShell_GetUseCount_AsyncWorker::ExtensionShell_GetUseCount_AsyncWorker(
MbExtensionShell * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ExtensionShell_AddRef_AsyncWorker::ExtensionShell_AddRef_AsyncWorker(
MbExtensionShell * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
