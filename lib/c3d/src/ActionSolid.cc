...
if (!(info[0].IsNull() || info[0].IsUndefined())) {
 ...
 MbResultType  _result = ::ElementarySolid
(
        points
,        solidType
,        names
...
if (!(info[0].IsNull() || info[0].IsUndefined())) {
    ...
    for (size_t i = 0; i < points_.Length(); i++) {
        ...
        ActionSolid_ElementarySolid_AsyncWorker* asyncWorker = new ActionSolid_ElementarySolid_AsyncWorker(
            deferred
,
                                *points                ,
...
if (!(info[3].IsNull() || info[3].IsUndefined())) {
 ...
 MbResultType  _result = ::FilletSolid
(
        solid
,        sameShell
,        initCurves
...
if (!(info[3].IsNull() || info[3].IsUndefined())) {
    ...
    for (size_t i = 0; i < initBounds_.Length(); i++) {
        ...
        ActionSolid_FilletSolid_AsyncWorker* asyncWorker = new ActionSolid_FilletSolid_AsyncWorker(
            deferred
,
        ...
        Napi::Value ActionSolid::ChamferSolid(const Napi::CallbackInfo& info) {
            ...
            if (info.Length() == 4 || !(
              (info[4].IsObject() && info[4].ToObject().InstanceOf(SNameMaker::GetConstructor(env)))
)) {
                    Napi::Error::New(env, "SNameMaker names is required.").ThrowAsJavaScriptException();
                    return env.Undefined();
            }
...
if (!(info[2].IsNull() || info[2].IsUndefined())) {
 ...
 MbResultType  _result = ::ChamferSolid
(
        solid
,        sameShell
,        edges
...
if (!(info[2].IsNull() || info[2].IsUndefined())) {
    ...
    for (size_t i = 0; i < edges_.Length(); i++) {
        ...
        ActionSolid_ChamferSolid_AsyncWorker* asyncWorker = new ActionSolid_ChamferSolid_AsyncWorker(
            deferred
,
 ...
 MbResultType  _result = ::BooleanResult
(
        solid1
,        sameShell1
,        solid2
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionSolid::BooleanResult_async(const Napi::CallbackInfo& info) {
        ...
        ActionSolid_BooleanResult_AsyncWorker* asyncWorker = new ActionSolid_BooleanResult_AsyncWorker(
            deferred
,
...
if (!(info[2].IsNull() || info[2].IsUndefined())) {
 ...
 MbResultType  _result = ::UnionResult
(
        solid
,        sameShell
,        solids
...
if (!(info[2].IsNull() || info[2].IsUndefined())) {
    ...
    for (size_t i = 0; i < solids_.Length(); i++) {
        ...
        ActionSolid_UnionResult_AsyncWorker* asyncWorker = new ActionSolid_UnionResult_AsyncWorker(
            deferred
,
...
if (!(info[4].IsNull() || info[4].IsUndefined())) {
 ...
 MbResultType  _result = ::DraftSolid
(
        solid
,        sameShell
,        neutralPlace
...
if (!(info[4].IsNull() || info[4].IsUndefined())) {
    ...
    for (size_t i = 0; i < faces_.Length(); i++) {
        ...
        ActionSolid_DraftSolid_AsyncWorker* asyncWorker = new ActionSolid_DraftSolid_AsyncWorker(
            deferred
,
 ...
 MbResultType  _result = ::SolidCutting
(
        solid
,        sameShell
,        cuttingParams
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionSolid::SolidCutting_async(const Napi::CallbackInfo& info) {
        ...
        ActionSolid_SolidCutting_AsyncWorker* asyncWorker = new ActionSolid_SolidCutting_AsyncWorker(
            deferred
,
...
if (!(info[6].IsNull() || info[6].IsUndefined())) {
 ...
 MbResultType  _result = ::SplitSolid
(
        solid
,        sameShell
,        spPlace
...
if (!(info[6].IsNull() || info[6].IsUndefined())) {
    ...
    for (size_t i = 0; i < selFaces_.Length(); i++) {
        ...
        ActionSolid_SplitSolid_AsyncWorker* asyncWorker = new ActionSolid_SplitSolid_AsyncWorker(
            deferred
,
...
if (!(info[4].IsNull() || info[4].IsUndefined())) {
    ...
    for (size_t i = 0; i < selFaces_.Length(); i++) {
        ...
        ActionSolid_SplitSolidBySpaceItem_AsyncWorker* asyncWorker = new ActionSolid_SplitSolidBySpaceItem_AsyncWorker(
            deferred
,
...
,        names
    ...
    Napi::Value ActionSolid::DetachParts_async(const Napi::CallbackInfo& info) {
        ...
        ActionSolid_DetachParts_AsyncWorker* asyncWorker = new ActionSolid_DetachParts_AsyncWorker(
            deferred
,
...
if (!(info[6].IsNull() || info[6].IsUndefined())) {
 ...
 MbResultType  _result = ::LoftedSolid
(
        pl
,        c
,        spine
...
if (!(info[6].IsNull() || info[6].IsUndefined())) {
    ...
    for (size_t i = 0; i < ns_.Length(); i++) {
        ...
        ActionSolid_LoftedSolid_AsyncWorker* asyncWorker = new ActionSolid_LoftedSolid_AsyncWorker(
            deferred
,
                                *pl                ,
                                *c                ,
        ...
        Napi::Value ActionSolid::ExtrusionSolid(const Napi::CallbackInfo& info) {
            Napi::Env env = info.Env();
                        if (info.Length() == 0 || !(
              (info[0].IsObject() && info[0].ToObject().InstanceOf(SweptData::GetConstructor(env)))
)) {
...
if (!(info[7].IsNull() || info[7].IsUndefined())) {
    ...
    for (size_t i = 0; i < contoursNames_.Length(); i++) {
        if (contoursNames_[i].IsNull() || contoursNames_[i].IsUndefined()) {
            ...
            if (!contoursNames_[i].IsObject() || !contoursNames_[i].ToObject().InstanceOf(SNameMaker::GetConstructor(env))) {
 ...
 MbResultType  _result = ::ExtrusionSolid
(
        sweptData
,        direction
,        solid1
...
if (!(info[7].IsNull() || info[7].IsUndefined())) {
    ...
    for (size_t i = 0; i < contoursNames_.Length(); i++) {
        ...
        ActionSolid_ExtrusionSolid_AsyncWorker* asyncWorker = new ActionSolid_ExtrusionSolid_AsyncWorker(
            deferred
,
        ...
        Napi::Value ActionSolid::ExtrusionResult(const Napi::CallbackInfo& info) {
            ...
            if (info.Length() == 2 || !(
              (info[2].IsObject() && info[2].ToObject().InstanceOf(SweptData::GetConstructor(env)))
)) {
                    Napi::Error::New(env, "SweptData sweptData is required.").ThrowAsJavaScriptException();
                    return env.Undefined();
            }
...
if (!(info[7].IsNull() || info[7].IsUndefined())) {
 ...
 MbResultType  _result = ::ExtrusionResult
(
        solid
,        sameShell
,        sweptData
...
if (!(info[7].IsNull() || info[7].IsUndefined())) {
    ...
    for (size_t i = 0; i < contoursNames_.Length(); i++) {
        ...
        ActionSolid_ExtrusionResult_AsyncWorker* asyncWorker = new ActionSolid_ExtrusionResult_AsyncWorker(
            deferred
,
 ...
 MbResultType  _result = ::SymmetrySolid
(
        solid
,        sameShell
,        place
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionSolid::SymmetrySolid_async(const Napi::CallbackInfo& info) {
        ...
        ActionSolid_SymmetrySolid_AsyncWorker* asyncWorker = new ActionSolid_SymmetrySolid_AsyncWorker(
            deferred
,
 ...
 MbResultType  _result = ::MirrorSolid
(
        solid
,        place
,        names
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionSolid::MirrorSolid_async(const Napi::CallbackInfo& info) {
        ...
        ActionSolid_MirrorSolid_AsyncWorker* asyncWorker = new ActionSolid_MirrorSolid_AsyncWorker(
            deferred
,
...
if (!(info[4].IsNull() || info[4].IsUndefined())) {
 ...
 MbResultType  _result = ::ThinSolid
(
        solid
,        sameShell
,        outFaces
...
if (!(info[4].IsNull() || info[4].IsUndefined())) {
    ...
    for (size_t i = 0; i < offDists_.Length(); i++) {
        ...
        ActionSolid_ThinSolid_AsyncWorker* asyncWorker = new ActionSolid_ThinSolid_AsyncWorker(
            deferred
,
...
if (!(info[4].IsNull() || info[4].IsUndefined())) {
 ...
 MbResultType  _result = ::RevolutionSolid
(
        sweptData
,        axis
,        params
...
if (!(info[4].IsNull() || info[4].IsUndefined())) {
    ...
    for (size_t i = 0; i < contoursNames_.Length(); i++) {
        ...
        ActionSolid_RevolutionSolid_AsyncWorker* asyncWorker = new ActionSolid_RevolutionSolid_AsyncWorker(
            deferred
,
...
if (!(info[4].IsNull() || info[4].IsUndefined())) {
 ...
 MbResultType  _result = ::EvolutionSolid
(
        sweptData
,        spine
,        params
...
if (!(info[4].IsNull() || info[4].IsUndefined())) {
    ...
    for (size_t i = 0; i < contoursNames_.Length(); i++) {
        ...
        ActionSolid_EvolutionSolid_AsyncWorker* asyncWorker = new ActionSolid_EvolutionSolid_AsyncWorker(
            deferred
,
 ...
 MbResultType  _result = ::DuplicationSolid
(
        solid
,        params
,        names
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionSolid::DuplicationSolid_async(const Napi::CallbackInfo& info) {
        ...
        ActionSolid_DuplicationSolid_AsyncWorker* asyncWorker = new ActionSolid_DuplicationSolid_AsyncWorker(
            deferred
,
 ...
 MbResultType  _result = ::HoleSolid
(
        solid
,        sameShell
,        place
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionSolid::HoleSolid_async(const Napi::CallbackInfo& info) {
        ...
        ActionSolid_HoleSolid_AsyncWorker* asyncWorker = new ActionSolid_HoleSolid_AsyncWorker(
            deferred
,
    ...
    ActionSolid_ElementarySolid_AsyncWorker::ActionSolid_ElementarySolid_AsyncWorker(
...
,                        result
    ...
    ActionSolid_ChamferSolid_AsyncWorker::ActionSolid_ChamferSolid_AsyncWorker(
        Napi::Promise::Deferred const &d
,
                         MbSolid & solid,
                         MbeCopyMode  sameShell,
...
,
        ...
        :PromiseWorker(d),
                        solid1(solid1)
,
                        sameShell1(sameShell1)
,
                        solid2(solid2)
,
                        sameShell2(sameShell2)
,
                        oType(oType)
,
                        flags(flags)
...
,                        result
    ...
    ActionSolid_SolidCutting_AsyncWorker::ActionSolid_SolidCutting_AsyncWorker(
        Napi::Promise::Deferred const &d
,
                         MbSolid & solid,
                         MbeCopyMode  sameShell,
...
,                        result
    ...
    void ActionSolid_SplitSolidBySpaceItem_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ActionSolid_DetachParts_AsyncWorker::ActionSolid_DetachParts_AsyncWorker(
        Napi::Promise::Deferred const &d
,
                         MbSolid & solid,
                         bool  sort,
...
,                        result
    ...
    ActionSolid_SymmetrySolid_AsyncWorker::ActionSolid_SymmetrySolid_AsyncWorker(
        Napi::Promise::Deferred const &d
,
                         MbSolid & solid,
                         MbeCopyMode  sameShell,
...
,                        result
    ...
    ActionSolid_MirrorSolid_AsyncWorker::ActionSolid_MirrorSolid_AsyncWorker(
        Napi::Promise::Deferred const &d
,
                        const MbSolid & solid,
                        const MbPlacement3D & place,
...
,                        result
    ...
    ActionSolid_ThinSolid_AsyncWorker::ActionSolid_ThinSolid_AsyncWorker(
        Napi::Promise::Deferred const &d
,
                         MbSolid & solid,
                         MbeCopyMode  sameShell,
...
,                        result
    ...
    ActionSolid_DuplicationSolid_AsyncWorker::ActionSolid_DuplicationSolid_AsyncWorker(
        Napi::Promise::Deferred const &d
,
                        const MbSolid & solid,
...
,                        result
    ...
    ActionSolid_HoleSolid_AsyncWorker::ActionSolid_HoleSolid_AsyncWorker(
        Napi::Promise::Deferred const &d
,
                         MbSolid * solid,
                         MbeCopyMode  sameShell,
