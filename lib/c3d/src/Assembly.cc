...
Napi::Object Assembly::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "Assembly", {
...
(
    ...
    Napi::Value Assembly::GetItems_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_GetItems_AsyncWorker* asyncWorker = new Assembly_GetItems_AsyncWorker(
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value Assembly::CreateMesh_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_CreateMesh_AsyncWorker* asyncWorker = new Assembly_CreateMesh_AsyncWorker(
_underlying,            deferred
,
...
,        *mesh
    ...
    Napi::Value Assembly::CalculateMesh_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_CalculateMesh_AsyncWorker* asyncWorker = new Assembly_CalculateMesh_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Assembly::GetItemName_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_GetItemName_AsyncWorker* asyncWorker = new Assembly_GetItemName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Assembly::SetItemName_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_SetItemName_AsyncWorker* asyncWorker = new Assembly_SetItemName_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value Assembly::RebuildItem_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_RebuildItem_AsyncWorker* asyncWorker = new Assembly_RebuildItem_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 3 || info[3].IsNull() ? 0 : currInd
    ...
    Napi::Value Assembly::GetItemByPath_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_GetItemByPath_AsyncWorker* asyncWorker = new Assembly_GetItemByPath_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Assembly::IsA_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_IsA_AsyncWorker* asyncWorker = new Assembly_IsA_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Assembly::Type_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_Type_AsyncWorker* asyncWorker = new Assembly_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Assembly::Family_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_Family_AsyncWorker* asyncWorker = new Assembly_Family_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value Assembly::Transform_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_Transform_AsyncWorker* asyncWorker = new Assembly_Transform_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value Assembly::Move_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_Move_AsyncWorker* asyncWorker = new Assembly_Move_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value Assembly::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_Rotate_AsyncWorker* asyncWorker = new Assembly_Rotate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Assembly::Refresh_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_Refresh_AsyncWorker* asyncWorker = new Assembly_Refresh_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Assembly::Duplicate_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_Duplicate_AsyncWorker* asyncWorker = new Assembly_Duplicate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Assembly::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_AddYourGabaritTo_AsyncWorker* asyncWorker = new Assembly_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Assembly::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_GetUseCount_AsyncWorker* asyncWorker = new Assembly_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Assembly::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_AddRef_AsyncWorker* asyncWorker = new Assembly_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Assembly::SetStyle_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_SetStyle_AsyncWorker* asyncWorker = new Assembly_SetStyle_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Assembly::GetStyle_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_GetStyle_AsyncWorker* asyncWorker = new Assembly_GetStyle_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Assembly::SetColor_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_SetColor_AsyncWorker* asyncWorker = new Assembly_SetColor_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Assembly::GetColor_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_GetColor_AsyncWorker* asyncWorker = new Assembly_GetColor_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Assembly::AttributesConvert_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_AttributesConvert_AsyncWorker* asyncWorker = new Assembly_AttributesConvert_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Assembly::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_GetCreatorsCount_AsyncWorker* asyncWorker = new Assembly_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Assembly::GetCreator_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_GetCreator_AsyncWorker* asyncWorker = new Assembly_GetCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Assembly::SetCreator_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_SetCreator_AsyncWorker* asyncWorker = new Assembly_SetCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Assembly::DetachCreator_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_DetachCreator_AsyncWorker* asyncWorker = new Assembly_DetachCreator_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? false : addSame
    ...
    Napi::Value Assembly::AddCreator_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_AddCreator_AsyncWorker* asyncWorker = new Assembly_AddCreator_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value Assembly::GetCreators_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_GetCreators_AsyncWorker* asyncWorker = new Assembly_GetCreators_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Assembly::DeleteCreator_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_DeleteCreator_AsyncWorker* asyncWorker = new Assembly_DeleteCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Assembly::GetActiveCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        Assembly_GetActiveCreatorsCount_AsyncWorker* asyncWorker = new Assembly_GetActiveCreatorsCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
Assembly::~Assembly() {
    ...
    Assembly_GetItems_AsyncWorker::Assembly_GetItems_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
    ...
    Assembly_CreateMesh_AsyncWorker::Assembly_CreateMesh_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    Assembly_CalculateMesh_AsyncWorker::Assembly_CalculateMesh_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbStepData & stepData,
                        const MbFormNote & note    )
...
,                        *mesh
    ...
    Assembly_GetItemName_AsyncWorker::Assembly_GetItemName_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Assembly_SetItemName_AsyncWorker::Assembly_SetItemName_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
                         SimpleName  name    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Assembly_RebuildItem_AsyncWorker::Assembly_RebuildItem_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        progInd
    ...
    Assembly_GetItemByPath_AsyncWorker::Assembly_GetItemByPath_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbPath & path,
                         size_t  ind,
...
,                        currInd
    ...
    Assembly_IsA_AsyncWorker::Assembly_IsA_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Assembly_Type_AsyncWorker::Assembly_Type_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Assembly_Family_AsyncWorker::Assembly_Family_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Assembly_Transform_AsyncWorker::Assembly_Transform_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    Assembly_Move_AsyncWorker::Assembly_Move_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & v,
                         MbRegTransform * iReg    )
...
,                        iReg
    ...
    Assembly_Rotate_AsyncWorker::Assembly_Rotate_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbAxis3D & axis,
                         double  angle,
...
,                        iReg
    ...
    Assembly_Refresh_AsyncWorker::Assembly_Refresh_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Assembly_Duplicate_AsyncWorker::Assembly_Duplicate_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
                         MbRegDuplicate * iReg    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Assembly_AddYourGabaritTo_AsyncWorker::Assembly_AddYourGabaritTo_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
                         MbCube & cube    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Assembly_GetUseCount_AsyncWorker::Assembly_GetUseCount_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Assembly_AddRef_AsyncWorker::Assembly_AddRef_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Assembly_SetStyle_AsyncWorker::Assembly_SetStyle_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
                         int  s    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Assembly_GetStyle_AsyncWorker::Assembly_GetStyle_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Assembly_SetColor_AsyncWorker::Assembly_SetColor_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
                         uint32  c    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Assembly_GetColor_AsyncWorker::Assembly_GetColor_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Assembly_AttributesConvert_AsyncWorker::Assembly_AttributesConvert_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
                         MbGrid & other    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Assembly_GetCreatorsCount_AsyncWorker::Assembly_GetCreatorsCount_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Assembly_GetCreator_AsyncWorker::Assembly_GetCreator_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Assembly_SetCreator_AsyncWorker::Assembly_SetCreator_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Assembly_DetachCreator_AsyncWorker::Assembly_DetachCreator_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Assembly_AddCreator_AsyncWorker::Assembly_AddCreator_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        addSame
    ...
    Assembly_GetCreators_AsyncWorker::Assembly_GetCreators_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Assembly_DeleteCreator_AsyncWorker::Assembly_DeleteCreator_AsyncWorker(
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
MbAssembly * _underlying,        Napi::Promise::Deferred const &d
    ...
    void Assembly_GetActiveCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
