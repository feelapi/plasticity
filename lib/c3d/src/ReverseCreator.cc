...
{
    Napi::Function func =
        DefineClass(env, "ReverseCreator",
                    {
...
Napi::Value ReverseCreator::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    ReverseCreator_IsA_AsyncWorker *asyncWorker = new ReverseCreator_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value ReverseCreator::Type_async(const Napi::CallbackInfo &info)
{
    ...
    ReverseCreator_Type_AsyncWorker *asyncWorker = new ReverseCreator_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ReverseCreator::GetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    ReverseCreator_GetBasisPoints_AsyncWorker *asyncWorker =
        new ReverseCreator_GetBasisPoints_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ReverseCreator::SetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    ReverseCreator_SetBasisPoints_AsyncWorker *asyncWorker =
        new ReverseCreator_SetBasisPoints_AsyncWorker(_underlying, deferred,
...
Napi::Value ReverseCreator::GetBasisItems_async(const Napi::CallbackInfo &info)
{
    ...
    ReverseCreator_GetBasisItems_AsyncWorker *asyncWorker =
        new ReverseCreator_GetBasisItems_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ReverseCreator::GetCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    ReverseCreator_GetCreatorsCount_AsyncWorker *asyncWorker =
        new ReverseCreator_GetCreatorsCount_AsyncWorker(_underlying, deferred,
...
Napi::Value ReverseCreator::GetYourNameMaker_async(const Napi::CallbackInfo &info)
{
    ...
    ReverseCreator_GetYourNameMaker_AsyncWorker *asyncWorker =
        new ReverseCreator_GetYourNameMaker_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ReverseCreator::GetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    ReverseCreator_GetStatus_AsyncWorker *asyncWorker = new ReverseCreator_GetStatus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ReverseCreator::SetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    ReverseCreator_SetStatus_AsyncWorker *asyncWorker = new ReverseCreator_SetStatus_AsyncWorker(_underlying, deferred,
...
Napi::Value ReverseCreator::CreateShell_async(const Napi::CallbackInfo &info)
{
    ...
    ReverseCreator_CreateShell_AsyncWorker *asyncWorker =
        new ReverseCreator_CreateShell_AsyncWorker(_underlying, deferred,
...
Napi::Value ReverseCreator::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    ReverseCreator_GetMainName_AsyncWorker *asyncWorker =
        new ReverseCreator_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ReverseCreator::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    ReverseCreator_GetUseCount_AsyncWorker *asyncWorker =
        new ReverseCreator_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ReverseCreator::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    ReverseCreator_AddRef_AsyncWorker *asyncWorker = new ReverseCreator_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
ReverseCreator_IsA_AsyncWorker::ReverseCreator_IsA_AsyncWorker(MbReverseCreator *_underlying,
...
ReverseCreator_Type_AsyncWorker::ReverseCreator_Type_AsyncWorker(MbReverseCreator *_underlying,
                                                                 Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ReverseCreator_GetBasisPoints_AsyncWorker::ReverseCreator_GetBasisPoints_AsyncWorker(MbReverseCreator *_underlying,
                                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void ReverseCreator_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
ReverseCreator_SetBasisPoints_AsyncWorker::ReverseCreator_SetBasisPoints_AsyncWorker(MbReverseCreator *_underlying,
                                                                                     Napi::Promise::Deferred const &d,
...
void ReverseCreator_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                       Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ReverseCreator_GetBasisItems_AsyncWorker::ReverseCreator_GetBasisItems_AsyncWorker(MbReverseCreator *_underlying,
                                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ReverseCreator_GetCreatorsCount_AsyncWorker::ReverseCreator_GetCreatorsCount_AsyncWorker(
    MbReverseCreator *_underlying, Napi::Promise::Deferred const &d, MbeCreatorType ct)
...
void ReverseCreator_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                         Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void ReverseCreator_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                         Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ReverseCreator_GetStatus_AsyncWorker::ReverseCreator_GetStatus_AsyncWorker(MbReverseCreator *_underlying,
                                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ReverseCreator_SetStatus_AsyncWorker::ReverseCreator_SetStatus_AsyncWorker(MbReverseCreator *_underlying,
                                                                           Napi::Promise::Deferred const &d,
                                                                           MbeProcessState l)
...
ReverseCreator_CreateShell_AsyncWorker::ReverseCreator_CreateShell_AsyncWorker(MbReverseCreator *_underlying,
                                                                               Napi::Promise::Deferred const &d,
                                                                               MbFaceShell *shell,
...
ReverseCreator_GetMainName_AsyncWorker::ReverseCreator_GetMainName_AsyncWorker(MbReverseCreator *_underlying,
                                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ReverseCreator_GetUseCount_AsyncWorker::ReverseCreator_GetUseCount_AsyncWorker(MbReverseCreator *_underlying,
                                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ReverseCreator_AddRef_AsyncWorker::ReverseCreator_AddRef_AsyncWorker(MbReverseCreator *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
