...
Napi::Object Surface::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "Surface", {
...
(
    ...
    Napi::Value Surface::GetSurface_async(const Napi::CallbackInfo& info) {
        ...
        Surface_GetSurface_AsyncWorker* asyncWorker = new Surface_GetSurface_AsyncWorker(
...
(
    ...
    Napi::Value Surface::GetUEpsilon_async(const Napi::CallbackInfo& info) {
        ...
        Surface_GetUEpsilon_AsyncWorker* asyncWorker = new Surface_GetUEpsilon_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Surface::GetVEpsilon_async(const Napi::CallbackInfo& info) {
        ...
        Surface_GetVEpsilon_AsyncWorker* asyncWorker = new Surface_GetVEpsilon_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Surface::GetUMid_async(const Napi::CallbackInfo& info) {
        ...
        Surface_GetUMid_AsyncWorker* asyncWorker = new Surface_GetUMid_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Surface::GetVMid_async(const Napi::CallbackInfo& info) {
        ...
        Surface_GetVMid_AsyncWorker* asyncWorker = new Surface_GetVMid_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Surface::GetUMin_async(const Napi::CallbackInfo& info) {
        ...
        Surface_GetUMin_AsyncWorker* asyncWorker = new Surface_GetUMin_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Surface::GetUMax_async(const Napi::CallbackInfo& info) {
        ...
        Surface_GetUMax_AsyncWorker* asyncWorker = new Surface_GetUMax_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Surface::GetVMin_async(const Napi::CallbackInfo& info) {
        ...
        Surface_GetVMin_AsyncWorker* asyncWorker = new Surface_GetVMin_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Surface::GetVMax_async(const Napi::CallbackInfo& info) {
        ...
        Surface_GetVMax_AsyncWorker* asyncWorker = new Surface_GetVMax_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Surface::GetUParamToUnit_async(const Napi::CallbackInfo& info) {
        ...
        Surface_GetUParamToUnit_AsyncWorker* asyncWorker = new Surface_GetUParamToUnit_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Surface::GetVParamToUnit_async(const Napi::CallbackInfo& info) {
        ...
        Surface_GetVParamToUnit_AsyncWorker* asyncWorker = new Surface_GetVParamToUnit_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Surface::GetRadius_async(const Napi::CallbackInfo& info) {
        ...
        Surface_GetRadius_AsyncWorker* asyncWorker = new Surface_GetRadius_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        *p
    ...
    Napi::Value Surface::PointOn_async(const Napi::CallbackInfo& info) {
        ...
        Surface_PointOn_AsyncWorker* asyncWorker = new Surface_PointOn_AsyncWorker(
_underlying,            deferred
,
...
,        *result
    ...
    Napi::Value Surface::Normal_async(const Napi::CallbackInfo& info) {
        ...
        Surface_Normal_AsyncWorker* asyncWorker = new Surface_Normal_AsyncWorker(
_underlying,            deferred
,
...
(
        place
,        info.Length() == 0 || info[0].IsNull() ? false : exact
...
if (_result) {
    ...
    Napi::Value Surface::GetPlacement_async(const Napi::CallbackInfo& info) {
        ...
        Surface_GetPlacement_AsyncWorker* asyncWorker = new Surface_GetPlacement_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value Surface::NearDirectPointProjection_async(const Napi::CallbackInfo& info) {
        ...
        Surface_NearDirectPointProjection_AsyncWorker* asyncWorker = new Surface_NearDirectPointProjection_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Surface::IsA_async(const Napi::CallbackInfo& info) {
        ...
        Surface_IsA_AsyncWorker* asyncWorker = new Surface_IsA_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Surface::Type_async(const Napi::CallbackInfo& info) {
        ...
        Surface_Type_AsyncWorker* asyncWorker = new Surface_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Surface::Family_async(const Napi::CallbackInfo& info) {
        ...
        Surface_Family_AsyncWorker* asyncWorker = new Surface_Family_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value Surface::Transform_async(const Napi::CallbackInfo& info) {
        ...
        Surface_Transform_AsyncWorker* asyncWorker = new Surface_Transform_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value Surface::Move_async(const Napi::CallbackInfo& info) {
        ...
        Surface_Move_AsyncWorker* asyncWorker = new Surface_Move_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value Surface::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        Surface_Rotate_AsyncWorker* asyncWorker = new Surface_Rotate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Surface::Refresh_async(const Napi::CallbackInfo& info) {
        ...
        Surface_Refresh_AsyncWorker* asyncWorker = new Surface_Refresh_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Surface::Duplicate_async(const Napi::CallbackInfo& info) {
        ...
        Surface_Duplicate_AsyncWorker* asyncWorker = new Surface_Duplicate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Surface::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        Surface_AddYourGabaritTo_AsyncWorker* asyncWorker = new Surface_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Surface::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        Surface_GetUseCount_AsyncWorker* asyncWorker = new Surface_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Surface::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        Surface_AddRef_AsyncWorker* asyncWorker = new Surface_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
Surface::~Surface() {
    ...
    Surface_GetSurface_AsyncWorker::Surface_GetSurface_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    ...
    Surface_GetUEpsilon_AsyncWorker::Surface_GetUEpsilon_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_GetVEpsilon_AsyncWorker::Surface_GetVEpsilon_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_GetUMid_AsyncWorker::Surface_GetUMid_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_GetVMid_AsyncWorker::Surface_GetVMid_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_GetUMin_AsyncWorker::Surface_GetUMin_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_GetUMax_AsyncWorker::Surface_GetUMax_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_GetVMin_AsyncWorker::Surface_GetVMin_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_GetVMax_AsyncWorker::Surface_GetVMax_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_GetUParamToUnit_AsyncWorker::Surface_GetUParamToUnit_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_GetVParamToUnit_AsyncWorker::Surface_GetVParamToUnit_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_GetRadius_AsyncWorker::Surface_GetRadius_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_PointOn_AsyncWorker::Surface_PointOn_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         MbCartPoint & uv    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *p
    ...
    Surface_Normal_AsyncWorker::Surface_Normal_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         double & u,
                         double & v    )
...
,                        *result
    ...
    Surface_GetPlacement_AsyncWorker::Surface_GetPlacement_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  exact    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        onlyPositiveDirection
    ...
    void Surface_NearDirectPointProjection_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    Surface_IsA_AsyncWorker::Surface_IsA_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_Type_AsyncWorker::Surface_Type_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_Family_AsyncWorker::Surface_Family_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_Transform_AsyncWorker::Surface_Transform_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    Surface_Move_AsyncWorker::Surface_Move_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & v,
                         MbRegTransform * iReg    )
...
,                        iReg
    ...
    Surface_Rotate_AsyncWorker::Surface_Rotate_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbAxis3D & axis,
                         double  angle,
...
,                        iReg
    ...
    Surface_Refresh_AsyncWorker::Surface_Refresh_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_Duplicate_AsyncWorker::Surface_Duplicate_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         MbRegDuplicate * iReg    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Surface_AddYourGabaritTo_AsyncWorker::Surface_AddYourGabaritTo_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
,
                         MbCube & cube    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Surface_GetUseCount_AsyncWorker::Surface_GetUseCount_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Surface_AddRef_AsyncWorker::Surface_AddRef_AsyncWorker(
MbSurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
