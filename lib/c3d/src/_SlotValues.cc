...
Napi::Object _SlotValues::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "SlotValues", {
...
(
    ...
    Napi::Value _SlotValues::SetSurface_async(const Napi::CallbackInfo& info) {
        ...
        _SlotValues_SetSurface_AsyncWorker* asyncWorker = new _SlotValues_SetSurface_AsyncWorker(
...
(
    ...
    Napi::Value _SlotValues::SetPhantom_async(const Napi::CallbackInfo& info) {
        ...
        _SlotValues_SetPhantom_AsyncWorker* asyncWorker = new _SlotValues_SetPhantom_AsyncWorker(
_underlying,            deferred
,
...
void _SlotValues::SetValue_azimuthAngle(const Napi::CallbackInfo &info, const Napi::Value &value) {
    ...
    _SlotValues_SetSurface_AsyncWorker::_SlotValues_SetSurface_AsyncWorker(
SlotValues * _underlying,        Napi::Promise::Deferred const &d
,
                         MbSurface * s    )
...
{};
    ...
    _SlotValues_SetPhantom_AsyncWorker::_SlotValues_SetPhantom_AsyncWorker(
SlotValues * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  s    )
        :_underlying(_underlying),PromiseWorker(d),
