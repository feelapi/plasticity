...
Napi::Object ActionDirect::Init(Napi::Env env, Napi::Object exports) {
    ...
    object.Set("CollectFacesForModification_async", Napi::Function::New<&ActionDirect::CollectFacesForModification_async>(env));
 ...
 MbResultType  _result = ::CollectFacesForModification
(
        shell
,        way
,        radius
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionDirect::CollectFacesForModification_async(const Napi::CallbackInfo& info) {
        ...
        ActionDirect_CollectFacesForModification_AsyncWorker* asyncWorker = new ActionDirect_CollectFacesForModification_AsyncWorker(
            deferred
,
...
if (!(info[3].IsNull() || info[3].IsUndefined())) {
 ...
 MbResultType  _result = ::FaceModifiedSolid
(
        solid
,        sameShell
,        params
...
if (!(info[3].IsNull() || info[3].IsUndefined())) {
    ...
    for (size_t i = 0; i < faces_.Length(); i++) {
        ...
        ActionDirect_FaceModifiedSolid_AsyncWorker* asyncWorker = new ActionDirect_FaceModifiedSolid_AsyncWorker(
            deferred
,
 ...
 MbResultType  _result = ::TransformedSolid
(
        solid
,        sameShell
,        params
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionDirect::TransformedSolid_async(const Napi::CallbackInfo& info) {
        ...
        ActionDirect_TransformedSolid_AsyncWorker* asyncWorker = new ActionDirect_TransformedSolid_AsyncWorker(
            deferred
,
...
if (!(info[3].IsNull() || info[3].IsUndefined())) {
 ...
 MbResultType  _result = ::EdgeModifiedSolid
(
        solid
,        sameShell
,        params
...
if (!(info[3].IsNull() || info[3].IsUndefined())) {
    ...
    for (size_t i = 0; i < edges_.Length(); i++) {
        ...
        ActionDirect_EdgeModifiedSolid_AsyncWorker* asyncWorker = new ActionDirect_EdgeModifiedSolid_AsyncWorker(
            deferred
,
...
,                        *faces
    ...
    void ActionDirect_CollectFacesForModification_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
...
,                        result
    ...
    void ActionDirect_FaceModifiedSolid_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ActionDirect_TransformedSolid_AsyncWorker::ActionDirect_TransformedSolid_AsyncWorker(
        Napi::Promise::Deferred const &d
,
                         MbSolid & solid,
                         MbeCopyMode  sameShell,
...
,                        result
    ...
    void ActionDirect_TransformedSolid_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        result
    ...
    void ActionDirect_EdgeModifiedSolid_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
