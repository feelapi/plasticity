...
Napi::Object Bezier3D::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "Bezier3D", {
...
(
    ...
    Napi::Value Bezier3D::GetPoints_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetPoints_AsyncWorker* asyncWorker = new Bezier3D_GetPoints_AsyncWorker(
...
,        pnt
    ...
    Napi::Value Bezier3D::ChangePoint_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_ChangePoint_AsyncWorker* asyncWorker = new Bezier3D_ChangePoint_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Bezier3D::RemovePoint_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_RemovePoint_AsyncWorker* asyncWorker = new Bezier3D_RemovePoint_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Bezier3D::Rebuild_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_Rebuild_AsyncWorker* asyncWorker = new Bezier3D_Rebuild_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::GetCount_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetCount_AsyncWorker* asyncWorker = new Bezier3D_GetCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
if (_result) {
    ...
    Napi::Value Bezier3D::GetPlaneCurve_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetPlaneCurve_AsyncWorker* asyncWorker = new Bezier3D_GetPlaneCurve_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Bezier3D::IsPlanar_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_IsPlanar_AsyncWorker* asyncWorker = new Bezier3D_IsPlanar_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Bezier3D::IsClosed_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_IsClosed_AsyncWorker* asyncWorker = new Bezier3D_IsClosed_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::IsTouch_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_IsTouch_AsyncWorker* asyncWorker = new Bezier3D_IsTouch_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::GetTMax_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetTMax_AsyncWorker* asyncWorker = new Bezier3D_GetTMax_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::GetTMin_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetTMin_AsyncWorker* asyncWorker = new Bezier3D_GetTMin_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::GetPeriod_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetPeriod_AsyncWorker* asyncWorker = new Bezier3D_GetPeriod_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::IsPeriodic_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_IsPeriodic_AsyncWorker* asyncWorker = new Bezier3D_IsPeriodic_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::IsStraight_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_IsStraight_AsyncWorker* asyncWorker = new Bezier3D_IsStraight_AsyncWorker(
_underlying,            deferred
,
...
,        sense
    ...
    Napi::Value Bezier3D::Trimmed_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_Trimmed_AsyncWorker* asyncWorker = new Bezier3D_Trimmed_AsyncWorker(
_underlying,            deferred
,
...
,        *n
    ...
    Napi::Value Bezier3D::Normal_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_Normal_AsyncWorker* asyncWorker = new Bezier3D_Normal_AsyncWorker(
_underlying,            deferred
,
...
,        *tan
    ...
    Napi::Value Bezier3D::Tangent_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_Tangent_AsyncWorker* asyncWorker = new Bezier3D_Tangent_AsyncWorker(
_underlying,            deferred
,
...
,        *b
    ...
    Napi::Value Bezier3D::BNormal_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_BNormal_AsyncWorker* asyncWorker = new Bezier3D_BNormal_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Bezier3D::GetCentre_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetCentre_AsyncWorker* asyncWorker = new Bezier3D_GetCentre_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        *point
    ...
    Napi::Value Bezier3D::GetLimitPoint_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetLimitPoint_AsyncWorker* asyncWorker = new Bezier3D_GetLimitPoint_AsyncWorker(
_underlying,            deferred
,
...
,        *p
    ...
    Napi::Value Bezier3D::PointOn_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_PointOn_AsyncWorker* asyncWorker = new Bezier3D_PointOn_AsyncWorker(
_underlying,            deferred
,
...
,        *p
    ...
    Napi::Value Bezier3D::_PointOn_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D__PointOn_AsyncWorker* asyncWorker = new Bezier3D__PointOn_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : tRange
    ...
    Napi::Value Bezier3D::NearPointProjection_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_NearPointProjection_AsyncWorker* asyncWorker = new Bezier3D_NearPointProjection_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value Bezier3D::GetSurfaceCurve_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetSurfaceCurve_AsyncWorker* asyncWorker = new Bezier3D_GetSurfaceCurve_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Bezier3D::GetWeightCentre_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetWeightCentre_AsyncWorker* asyncWorker = new Bezier3D_GetWeightCentre_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::GetBasisCurve_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetBasisCurve_AsyncWorker* asyncWorker = new Bezier3D_GetBasisCurve_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetBasisPoints_AsyncWorker* asyncWorker = new Bezier3D_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_SetBasisPoints_AsyncWorker* asyncWorker = new Bezier3D_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Bezier3D::Inverse_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_Inverse_AsyncWorker* asyncWorker = new Bezier3D_Inverse_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? Math::DefaultMathVersion() : version
    ...
    Napi::Value Bezier3D::GetProjection_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetProjection_AsyncWorker* asyncWorker = new Bezier3D_GetProjection_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Bezier3D::GetCircleAxis_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetCircleAxis_AsyncWorker* asyncWorker = new Bezier3D_GetCircleAxis_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::IsA_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_IsA_AsyncWorker* asyncWorker = new Bezier3D_IsA_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::Type_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_Type_AsyncWorker* asyncWorker = new Bezier3D_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::Family_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_Family_AsyncWorker* asyncWorker = new Bezier3D_Family_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value Bezier3D::Transform_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_Transform_AsyncWorker* asyncWorker = new Bezier3D_Transform_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value Bezier3D::Move_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_Move_AsyncWorker* asyncWorker = new Bezier3D_Move_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value Bezier3D::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_Rotate_AsyncWorker* asyncWorker = new Bezier3D_Rotate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Bezier3D::Refresh_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_Refresh_AsyncWorker* asyncWorker = new Bezier3D_Refresh_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::Duplicate_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_Duplicate_AsyncWorker* asyncWorker = new Bezier3D_Duplicate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Bezier3D::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_AddYourGabaritTo_AsyncWorker* asyncWorker = new Bezier3D_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Bezier3D::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_GetUseCount_AsyncWorker* asyncWorker = new Bezier3D_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Bezier3D::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        Bezier3D_AddRef_AsyncWorker* asyncWorker = new Bezier3D_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
Bezier3D::~Bezier3D() {
    ...
    Bezier3D_GetPoints_AsyncWorker::Bezier3D_GetPoints_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
    ...
    Bezier3D_ChangePoint_AsyncWorker::Bezier3D_ChangePoint_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         ptrdiff_t  index,
...
,                        pnt
    ...
    Bezier3D_RemovePoint_AsyncWorker::Bezier3D_RemovePoint_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         ptrdiff_t  index    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Bezier3D_Rebuild_AsyncWorker::Bezier3D_Rebuild_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_GetCount_AsyncWorker::Bezier3D_GetCount_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_GetPlaneCurve_AsyncWorker::Bezier3D_GetPlaneCurve_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  saveParams,
                         PlanarCheckParams  params    )
...
,                        params
    ...
    Bezier3D_IsPlanar_AsyncWorker::Bezier3D_IsPlanar_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double  accuracy    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Bezier3D_IsClosed_AsyncWorker::Bezier3D_IsClosed_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_IsTouch_AsyncWorker::Bezier3D_IsTouch_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_GetTMax_AsyncWorker::Bezier3D_GetTMax_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_GetTMin_AsyncWorker::Bezier3D_GetTMin_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_GetPeriod_AsyncWorker::Bezier3D_GetPeriod_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_IsPeriodic_AsyncWorker::Bezier3D_IsPeriodic_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_IsStraight_AsyncWorker::Bezier3D_IsStraight_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  ignoreParams    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Bezier3D_Trimmed_AsyncWorker::Bezier3D_Trimmed_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double  t1,
                         double  t2,
...
,                        sense
    ...
    Bezier3D_Normal_AsyncWorker::Bezier3D_Normal_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *n
    ...
    Bezier3D_Tangent_AsyncWorker::Bezier3D_Tangent_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *tan
    ...
    Bezier3D_BNormal_AsyncWorker::Bezier3D_BNormal_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *b
    ...
    Bezier3D_GetCentre_AsyncWorker::Bezier3D_GetCentre_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_GetLimitPoint_AsyncWorker::Bezier3D_GetLimitPoint_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         ptrdiff_t  number    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *point
    ...
    Bezier3D_PointOn_AsyncWorker::Bezier3D_PointOn_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *p
    ...
    Bezier3D__PointOn_AsyncWorker::Bezier3D__PointOn_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *p
    ...
    Bezier3D_NearPointProjection_AsyncWorker::Bezier3D_NearPointProjection_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbCartPoint3D & pnt,
                         bool  ext,
...
,                        tRange
    ...
    Bezier3D_GetSurfaceCurve_AsyncWorker::Bezier3D_GetSurfaceCurve_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         VERSION  version    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        version
    ...
    Bezier3D_GetWeightCentre_AsyncWorker::Bezier3D_GetWeightCentre_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_GetBasisCurve_AsyncWorker::Bezier3D_GetBasisCurve_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_GetBasisPoints_AsyncWorker::Bezier3D_GetBasisPoints_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_SetBasisPoints_AsyncWorker::Bezier3D_SetBasisPoints_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    Bezier3D_Inverse_AsyncWorker::Bezier3D_Inverse_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_GetProjection_AsyncWorker::Bezier3D_GetProjection_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        version
    ...
    Bezier3D_GetCircleAxis_AsyncWorker::Bezier3D_GetCircleAxis_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_IsA_AsyncWorker::Bezier3D_IsA_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_Type_AsyncWorker::Bezier3D_Type_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_Family_AsyncWorker::Bezier3D_Family_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_Transform_AsyncWorker::Bezier3D_Transform_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    Bezier3D_Move_AsyncWorker::Bezier3D_Move_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & v,
                         MbRegTransform * iReg    )
...
,                        iReg
    ...
    Bezier3D_Rotate_AsyncWorker::Bezier3D_Rotate_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbAxis3D & axis,
                         double  angle,
...
,                        iReg
    ...
    Bezier3D_Refresh_AsyncWorker::Bezier3D_Refresh_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_Duplicate_AsyncWorker::Bezier3D_Duplicate_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         MbRegDuplicate * iReg    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Bezier3D_AddYourGabaritTo_AsyncWorker::Bezier3D_AddYourGabaritTo_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
,
                         MbCube & cube    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Bezier3D_GetUseCount_AsyncWorker::Bezier3D_GetUseCount_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Bezier3D_AddRef_AsyncWorker::Bezier3D_AddRef_AsyncWorker(
MbBezier3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
