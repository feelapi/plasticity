...
Napi::Object BooleanSolid::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "BooleanSolid", {
...
(
    ...
    Napi::Value BooleanSolid::IsA_async(const Napi::CallbackInfo& info) {
        ...
        BooleanSolid_IsA_AsyncWorker* asyncWorker = new BooleanSolid_IsA_AsyncWorker(
...
(
    ...
    Napi::Value BooleanSolid::Type_async(const Napi::CallbackInfo& info) {
        ...
        BooleanSolid_Type_AsyncWorker* asyncWorker = new BooleanSolid_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value BooleanSolid::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        BooleanSolid_GetBasisPoints_AsyncWorker* asyncWorker = new BooleanSolid_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value BooleanSolid::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        BooleanSolid_SetBasisPoints_AsyncWorker* asyncWorker = new BooleanSolid_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value BooleanSolid::GetBasisItems_async(const Napi::CallbackInfo& info) {
        ...
        BooleanSolid_GetBasisItems_AsyncWorker* asyncWorker = new BooleanSolid_GetBasisItems_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value BooleanSolid::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        BooleanSolid_GetCreatorsCount_AsyncWorker* asyncWorker = new BooleanSolid_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value BooleanSolid::GetYourNameMaker_async(const Napi::CallbackInfo& info) {
        ...
        BooleanSolid_GetYourNameMaker_AsyncWorker* asyncWorker = new BooleanSolid_GetYourNameMaker_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value BooleanSolid::GetStatus_async(const Napi::CallbackInfo& info) {
        ...
        BooleanSolid_GetStatus_AsyncWorker* asyncWorker = new BooleanSolid_GetStatus_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value BooleanSolid::SetStatus_async(const Napi::CallbackInfo& info) {
        ...
        BooleanSolid_SetStatus_AsyncWorker* asyncWorker = new BooleanSolid_SetStatus_AsyncWorker(
_underlying,            deferred
,
...
,        items
    ...
    Napi::Value BooleanSolid::CreateShell_async(const Napi::CallbackInfo& info) {
        ...
        BooleanSolid_CreateShell_AsyncWorker* asyncWorker = new BooleanSolid_CreateShell_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value BooleanSolid::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        BooleanSolid_GetMainName_AsyncWorker* asyncWorker = new BooleanSolid_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value BooleanSolid::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        BooleanSolid_GetUseCount_AsyncWorker* asyncWorker = new BooleanSolid_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value BooleanSolid::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        BooleanSolid_AddRef_AsyncWorker* asyncWorker = new BooleanSolid_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
BooleanSolid::~BooleanSolid() {
    ...
    BooleanSolid_IsA_AsyncWorker::BooleanSolid_IsA_AsyncWorker(
MbBooleanSolid * _underlying,        Napi::Promise::Deferred const &d
    ...
    BooleanSolid_Type_AsyncWorker::BooleanSolid_Type_AsyncWorker(
MbBooleanSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    BooleanSolid_GetBasisPoints_AsyncWorker::BooleanSolid_GetBasisPoints_AsyncWorker(
MbBooleanSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    BooleanSolid_SetBasisPoints_AsyncWorker::BooleanSolid_SetBasisPoints_AsyncWorker(
MbBooleanSolid * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    BooleanSolid_GetBasisItems_AsyncWorker::BooleanSolid_GetBasisItems_AsyncWorker(
MbBooleanSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    BooleanSolid_GetCreatorsCount_AsyncWorker::BooleanSolid_GetCreatorsCount_AsyncWorker(
MbBooleanSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeCreatorType  ct    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    void BooleanSolid_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    BooleanSolid_GetYourNameMaker_AsyncWorker::BooleanSolid_GetYourNameMaker_AsyncWorker(
MbBooleanSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void BooleanSolid_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    BooleanSolid_GetStatus_AsyncWorker::BooleanSolid_GetStatus_AsyncWorker(
MbBooleanSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    BooleanSolid_SetStatus_AsyncWorker::BooleanSolid_SetStatus_AsyncWorker(
MbBooleanSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeProcessState  l    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    BooleanSolid_CreateShell_AsyncWorker::BooleanSolid_CreateShell_AsyncWorker(
MbBooleanSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbFaceShell * shell,
...
,                        items
    ...
    BooleanSolid_GetMainName_AsyncWorker::BooleanSolid_GetMainName_AsyncWorker(
MbBooleanSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    BooleanSolid_GetUseCount_AsyncWorker::BooleanSolid_GetUseCount_AsyncWorker(
MbBooleanSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    BooleanSolid_AddRef_AsyncWorker::BooleanSolid_AddRef_AsyncWorker(
MbBooleanSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
