...
underlying->AddRef();            this->_underlying = underlying;
                ...
                info[0].IsObject() &&
                    info[0].ToObject().InstanceOf(Contour::GetConstructor(env))
        )   
)
 &&         ((
                info[1].IsObject() &&
                    info[1].ToObject().InstanceOf(VertexOfMultilineInfo::GetConstructor(env))
        )   
)
 &&         ((
                info[2].IsArray()
 ...
 &&         ((
                info[3].IsObject() &&
                    info[3].ToObject().InstanceOf(MLTipParams::GetConstructor(env))
        )   
)
 &&         ((
                info[4].IsObject() &&
                    info[4].ToObject().InstanceOf(MLTipParams::GetConstructor(env))
        )   
)
 &&         ((
                info[5].IsBoolean()
    ...
    for (size_t i = 0; i < _equidRadii_.Length(); i++) {
        if (_equidRadii_[i].IsNull() || _equidRadii_[i].IsUndefined()) {
            ...
            if (!_equidRadii_[i].IsNumber()) {
                ...
                Napi::Error::New(env, "Passed null for non-optional parameter '_begTipParams'").ThrowAsJavaScriptException();
                return;
        }
        ...
        const StMLTipParams & _begTipParams =*_begTipParams_->_underlying;
                ...
                Napi::Error::New(env, "Passed null for non-optional parameter '_endTipParams'").ThrowAsJavaScriptException();
                return;
        }
        ...
        const StMLTipParams & _endTipParams =*_endTipParams_->_underlying;
                ...
                MbMultiline *underlying = new MbMultiline(_basisCurve,vertInfo,_equidRadii,_begTipParams,_endTipParams,_processClosed,_isTransparent);
                if (underlying == NULL) {
                    Napi::Error::New(env, "Invalid construction").ThrowAsJavaScriptException();
                    return;
                }
...
(
    ...
    Napi::Value Multiline::GetBegTipCurve_async(const Napi::CallbackInfo& info) {
        ...
        Multiline_GetBegTipCurve_AsyncWorker* asyncWorker = new Multiline_GetBegTipCurve_AsyncWorker(
...
(
    ...
    Napi::Value Multiline::GetEndTipCurve_async(const Napi::CallbackInfo& info) {
        ...
        Multiline_GetEndTipCurve_AsyncWorker* asyncWorker = new Multiline_GetEndTipCurve_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Multiline::GetCurvesCount_async(const Napi::CallbackInfo& info) {
        ...
        Multiline_GetCurvesCount_AsyncWorker* asyncWorker = new Multiline_GetCurvesCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
const MbContourWithBreaks * _result = _underlying->GetCurve
(
        i
    ...
    Napi::Value Multiline::GetCurve_async(const Napi::CallbackInfo& info) {
        ...
        Multiline_GetCurve_AsyncWorker* asyncWorker = new Multiline_GetCurve_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Multiline::IsA_async(const Napi::CallbackInfo& info) {
        ...
        Multiline_IsA_AsyncWorker* asyncWorker = new Multiline_IsA_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Multiline::Type_async(const Napi::CallbackInfo& info) {
        ...
        Multiline_Type_AsyncWorker* asyncWorker = new Multiline_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Multiline::Family_async(const Napi::CallbackInfo& info) {
        ...
        Multiline_Family_AsyncWorker* asyncWorker = new Multiline_Family_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : newSurface
    ...
    Napi::Value Multiline::Move_async(const Napi::CallbackInfo& info) {
        ...
        Multiline_Move_AsyncWorker* asyncWorker = new Multiline_Move_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : newSurface
    ...
    Napi::Value Multiline::Transform_async(const Napi::CallbackInfo& info) {
        ...
        Multiline_Transform_AsyncWorker* asyncWorker = new Multiline_Transform_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Multiline::Duplicate_async(const Napi::CallbackInfo& info) {
        ...
        Multiline_Duplicate_AsyncWorker* asyncWorker = new Multiline_Duplicate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Multiline::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        Multiline_AddYourGabaritTo_AsyncWorker* asyncWorker = new Multiline_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Multiline::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        Multiline_GetUseCount_AsyncWorker* asyncWorker = new Multiline_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Multiline::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        Multiline_AddRef_AsyncWorker* asyncWorker = new Multiline_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
Multiline::~Multiline() {
    ...
    Multiline_GetBegTipCurve_AsyncWorker::Multiline_GetBegTipCurve_AsyncWorker(
MbMultiline * _underlying,        Napi::Promise::Deferred const &d
    )
    ...
    Multiline_GetEndTipCurve_AsyncWorker::Multiline_GetEndTipCurve_AsyncWorker(
MbMultiline * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Multiline_GetCurvesCount_AsyncWorker::Multiline_GetCurvesCount_AsyncWorker(
MbMultiline * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Multiline_GetCurve_AsyncWorker::Multiline_GetCurve_AsyncWorker(
MbMultiline * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  i    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Multiline_IsA_AsyncWorker::Multiline_IsA_AsyncWorker(
MbMultiline * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Multiline_Type_AsyncWorker::Multiline_Type_AsyncWorker(
MbMultiline * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Multiline_Family_AsyncWorker::Multiline_Family_AsyncWorker(
MbMultiline * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Multiline_Move_AsyncWorker::Multiline_Move_AsyncWorker(
MbMultiline * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector & to,
                         MbRegTransform * iReg    )
...
,                        newSurface
    ...
    Multiline_Transform_AsyncWorker::Multiline_Transform_AsyncWorker(
MbMultiline * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbMatrix & matr,
                         MbRegTransform * iReg,
...
,                        newSurface
    ...
    Multiline_Duplicate_AsyncWorker::Multiline_Duplicate_AsyncWorker(
MbMultiline * _underlying,        Napi::Promise::Deferred const &d
,
                         MbRegDuplicate * dup    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Multiline_AddYourGabaritTo_AsyncWorker::Multiline_AddYourGabaritTo_AsyncWorker(
MbMultiline * _underlying,        Napi::Promise::Deferred const &d
,
                         MbRect & rect    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Multiline_GetUseCount_AsyncWorker::Multiline_GetUseCount_AsyncWorker(
MbMultiline * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Multiline_AddRef_AsyncWorker::Multiline_AddRef_AsyncWorker(
MbMultiline * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
