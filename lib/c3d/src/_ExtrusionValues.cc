...
Napi::Object _ExtrusionValues::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "ExtrusionValues", {
        ...
        InstanceAccessor<&_ExtrusionValues::GetValue_thickness1, &_ExtrusionValues::SetValue_thickness1>("thickness1"),
        InstanceAccessor<&_ExtrusionValues::GetValue_thickness2, &_ExtrusionValues::SetValue_thickness2>("thickness2"),
        InstanceAccessor<&_ExtrusionValues::GetValue_shellClosed, &_ExtrusionValues::SetValue_shellClosed>("shellClosed"),
    });
...
(
    ...
    Napi::Value _ExtrusionValues::CheckSelfInt_async(const Napi::CallbackInfo& info) {
        ...
        _ExtrusionValues_CheckSelfInt_AsyncWorker* asyncWorker = new _ExtrusionValues_CheckSelfInt_AsyncWorker(
...
(
    ...
    Napi::Value _ExtrusionValues::SetCheckSelfInt_async(const Napi::CallbackInfo& info) {
        ...
        _ExtrusionValues_SetCheckSelfInt_AsyncWorker* asyncWorker = new _ExtrusionValues_SetCheckSelfInt_AsyncWorker(
_underlying,            deferred
,
...
void _ExtrusionValues::SetValue_shellClosed(const Napi::CallbackInfo &info, const Napi::Value &value) {
    ...
    _ExtrusionValues_CheckSelfInt_AsyncWorker::_ExtrusionValues_CheckSelfInt_AsyncWorker(
ExtrusionValues  _underlying,        Napi::Promise::Deferred const &d
    ...
    void _ExtrusionValues_CheckSelfInt_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
...
{};
    ...
    void _ExtrusionValues_SetCheckSelfInt_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
