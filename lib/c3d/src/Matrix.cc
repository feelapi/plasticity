    ...
    if (info.Length() == 1 && info[0].IsString() && info[0].ToString().Utf8Value() == "__skip_js_init__") return;
        if (info.Length() == 0        
            ...
            this->_underlying = underlying;
                ...
                info[0].IsObject() &&
                    info[0].ToObject().InstanceOf(Placement::GetConstructor(env))
        )   
)
...
(
    ...
    Napi::Value Matrix::Scale_async(const Napi::CallbackInfo& info) {
        ...
        Matrix_Scale_AsyncWorker* asyncWorker = new Matrix_Scale_AsyncWorker(
...
(
    ...
    Napi::Value Matrix::ScaleX_async(const Napi::CallbackInfo& info) {
        ...
        Matrix_ScaleX_AsyncWorker* asyncWorker = new Matrix_ScaleX_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Matrix::ScaleY_async(const Napi::CallbackInfo& info) {
        ...
        Matrix_ScaleY_AsyncWorker* asyncWorker = new Matrix_ScaleY_AsyncWorker(
_underlying,            deferred
,
    ...
    Matrix_Scale_AsyncWorker::Matrix_Scale_AsyncWorker(
...
{};
    ...
    Matrix_ScaleX_AsyncWorker::Matrix_ScaleX_AsyncWorker(
MbMatrix * _underlying,        Napi::Promise::Deferred const &d
,
                         double  s    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Matrix_ScaleY_AsyncWorker::Matrix_ScaleY_AsyncWorker(
MbMatrix * _underlying,        Napi::Promise::Deferred const &d
,
                         double  s    )
        :_underlying(_underlying),PromiseWorker(d),
