...
,        key.c_str(), key.length()
    ...
    Napi::Value Enabler::EnableMathModules_async(const Napi::CallbackInfo& info) {
        ...
        Enabler_EnableMathModules_AsyncWorker* asyncWorker = new Enabler_EnableMathModules_AsyncWorker(
            deferred
,
                                name.c_str(), name.length(),
                                key.c_str(), key.length()        );
    ...
    Enabler_EnableMathModules_AsyncWorker::Enabler_EnableMathModules_AsyncWorker(
