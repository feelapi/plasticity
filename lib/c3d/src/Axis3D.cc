...
Axis3D::Axis3D(const Napi::CallbackInfo& info) : Napi::ObjectWrap<Axis3D>(info) {
    ...
    if (info.Length() == 1 && info[0].IsString() && info[0].ToString().Utf8Value() == "__skip_js_init__") return;
        if (info.Length() == 1&&                ((
                info[0].IsObject() &&
                    info[0].ToObject().InstanceOf(Axis3D::GetConstructor(env))
        )   
)
        ...
        const MbAxis3D & axis =*axis_->_underlying;
            ...
            this->_underlying = underlying;
                ...
                info[0].IsObject() &&
                    info[0].ToObject().InstanceOf(Vector3D::GetConstructor(env))
        )   
)
...
,        angle
    ...
    Napi::Value Axis3D::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        Axis3D_Rotate_AsyncWorker* asyncWorker = new Axis3D_Rotate_AsyncWorker(
...
(
    ...
    Napi::Value Axis3D::Move_async(const Napi::CallbackInfo& info) {
        ...
        Axis3D_Move_AsyncWorker* asyncWorker = new Axis3D_Move_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Axis3D::GetOrigin_async(const Napi::CallbackInfo& info) {
        ...
        Axis3D_GetOrigin_AsyncWorker* asyncWorker = new Axis3D_GetOrigin_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Axis3D::GetAxisZ_async(const Napi::CallbackInfo& info) {
        ...
        Axis3D_GetAxisZ_AsyncWorker* asyncWorker = new Axis3D_GetAxisZ_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
    ...
    Axis3D_Rotate_AsyncWorker::Axis3D_Rotate_AsyncWorker(
...
,                        angle
    ...
    Axis3D_Move_AsyncWorker::Axis3D_Move_AsyncWorker(
MbAxis3D * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & to    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Axis3D_GetOrigin_AsyncWorker::Axis3D_GetOrigin_AsyncWorker(
MbAxis3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Axis3D_GetAxisZ_AsyncWorker::Axis3D_GetAxisZ_AsyncWorker(
MbAxis3D * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
