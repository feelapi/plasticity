...
Napi::Object TransformationMaker::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "TransformationMaker", {
...
(
    ...
    Napi::Value TransformationMaker::IsA_async(const Napi::CallbackInfo& info) {
        ...
        TransformationMaker_IsA_AsyncWorker* asyncWorker = new TransformationMaker_IsA_AsyncWorker(
...
(
    ...
    Napi::Value TransformationMaker::Type_async(const Napi::CallbackInfo& info) {
        ...
        TransformationMaker_Type_AsyncWorker* asyncWorker = new TransformationMaker_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TransformationMaker::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        TransformationMaker_GetBasisPoints_AsyncWorker* asyncWorker = new TransformationMaker_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TransformationMaker::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        TransformationMaker_SetBasisPoints_AsyncWorker* asyncWorker = new TransformationMaker_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value TransformationMaker::GetBasisItems_async(const Napi::CallbackInfo& info) {
        ...
        TransformationMaker_GetBasisItems_AsyncWorker* asyncWorker = new TransformationMaker_GetBasisItems_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TransformationMaker::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        TransformationMaker_GetCreatorsCount_AsyncWorker* asyncWorker = new TransformationMaker_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value TransformationMaker::GetYourNameMaker_async(const Napi::CallbackInfo& info) {
        ...
        TransformationMaker_GetYourNameMaker_AsyncWorker* asyncWorker = new TransformationMaker_GetYourNameMaker_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TransformationMaker::GetStatus_async(const Napi::CallbackInfo& info) {
        ...
        TransformationMaker_GetStatus_AsyncWorker* asyncWorker = new TransformationMaker_GetStatus_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TransformationMaker::SetStatus_async(const Napi::CallbackInfo& info) {
        ...
        TransformationMaker_SetStatus_AsyncWorker* asyncWorker = new TransformationMaker_SetStatus_AsyncWorker(
_underlying,            deferred
,
...
,        items
    ...
    Napi::Value TransformationMaker::CreateShell_async(const Napi::CallbackInfo& info) {
        ...
        TransformationMaker_CreateShell_AsyncWorker* asyncWorker = new TransformationMaker_CreateShell_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value TransformationMaker::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        TransformationMaker_GetMainName_AsyncWorker* asyncWorker = new TransformationMaker_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TransformationMaker::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        TransformationMaker_GetUseCount_AsyncWorker* asyncWorker = new TransformationMaker_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TransformationMaker::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        TransformationMaker_AddRef_AsyncWorker* asyncWorker = new TransformationMaker_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
TransformationMaker::~TransformationMaker() {
    ...
    TransformationMaker_IsA_AsyncWorker::TransformationMaker_IsA_AsyncWorker(
MbTransformationMaker * _underlying,        Napi::Promise::Deferred const &d
    ...
    TransformationMaker_Type_AsyncWorker::TransformationMaker_Type_AsyncWorker(
MbTransformationMaker * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
...
MbTransformationMaker * _underlying,        Napi::Promise::Deferred const &d
    ...
    void TransformationMaker_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void TransformationMaker_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbTransformationMaker * _underlying,        Napi::Promise::Deferred const &d
    ...
    void TransformationMaker_GetBasisItems_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void TransformationMaker_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbTransformationMaker * _underlying,        Napi::Promise::Deferred const &d
    ...
    void TransformationMaker_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    TransformationMaker_GetStatus_AsyncWorker::TransformationMaker_GetStatus_AsyncWorker(
MbTransformationMaker * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void TransformationMaker_GetStatus_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    TransformationMaker_SetStatus_AsyncWorker::TransformationMaker_SetStatus_AsyncWorker(
MbTransformationMaker * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeProcessState  l    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    void TransformationMaker_SetStatus_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
,                        items
    ...
    void TransformationMaker_CreateShell_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbTransformationMaker * _underlying,        Napi::Promise::Deferred const &d
    ...
    void TransformationMaker_GetMainName_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbTransformationMaker * _underlying,        Napi::Promise::Deferred const &d
    ...
    void TransformationMaker_GetUseCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    TransformationMaker_AddRef_AsyncWorker::TransformationMaker_AddRef_AsyncWorker(
MbTransformationMaker * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
