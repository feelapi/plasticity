...
Napi::Value ShellHistory::InitOrigins(const Napi::CallbackInfo &info)
{
    ...
    _underlying->InitOrigins(origin
...
Napi::Value ShellHistory::InitOrigins_async(const Napi::CallbackInfo &info)
{
    ...
    ShellHistory_InitOrigins_AsyncWorker *asyncWorker =
        new ShellHistory_InitOrigins_AsyncWorker(_underlying, deferred, *origin);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ShellHistory::SetOrigins_async(const Napi::CallbackInfo &info)
{
    ...
    ShellHistory_SetOrigins_AsyncWorker *asyncWorker = new ShellHistory_SetOrigins_AsyncWorker(_underlying, deferred,
...
Napi::Value ShellHistory::SetOriginFaces_async(const Napi::CallbackInfo &info)
{
    ...
    ShellHistory_SetOriginFaces_AsyncWorker *asyncWorker =
        new ShellHistory_SetOriginFaces_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ShellHistory::SetCopyFaces_async(const Napi::CallbackInfo &info)
{
    ...
    ShellHistory_SetCopyFaces_AsyncWorker *asyncWorker =
        new ShellHistory_SetCopyFaces_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
ShellHistory_InitOrigins_AsyncWorker::ShellHistory_InitOrigins_AsyncWorker(MbShellHistory *_underlying,
                                                                           Napi::Promise::Deferred const &d,
                                                                           const RPArray<MbFace> &origin)
    : _underlying(_underlying), PromiseWorker(d), origin(origin){};
...
ShellHistory_SetOrigins_AsyncWorker::ShellHistory_SetOrigins_AsyncWorker(MbShellHistory *_underlying,
                                                                         Napi::Promise::Deferred const &d,
                                                                         MbFaceShell &shell)
    : _underlying(_underlying), PromiseWorker(d), shell(shell){};
...
ShellHistory_SetOriginFaces_AsyncWorker::ShellHistory_SetOriginFaces_AsyncWorker(MbShellHistory *_underlying,
                                                                                 Napi::Promise::Deferred const &d)
...
ShellHistory_SetCopyFaces_AsyncWorker::ShellHistory_SetCopyFaces_AsyncWorker(MbShellHistory *_underlying,
                                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
