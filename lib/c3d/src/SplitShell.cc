...
Napi::Value SplitShell::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    SplitShell_IsA_AsyncWorker *asyncWorker = new SplitShell_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value SplitShell::Type_async(const Napi::CallbackInfo &info)
{
    ...
    SplitShell_Type_AsyncWorker *asyncWorker = new SplitShell_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SplitShell::GetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    SplitShell_GetBasisPoints_AsyncWorker *asyncWorker =
        new SplitShell_GetBasisPoints_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SplitShell::SetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    SplitShell_SetBasisPoints_AsyncWorker *asyncWorker =
        new SplitShell_SetBasisPoints_AsyncWorker(_underlying, deferred,
...
Napi::Value SplitShell::GetBasisItems_async(const Napi::CallbackInfo &info)
{
    ...
    SplitShell_GetBasisItems_AsyncWorker *asyncWorker = new SplitShell_GetBasisItems_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SplitShell::GetCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    SplitShell_GetCreatorsCount_AsyncWorker *asyncWorker =
        new SplitShell_GetCreatorsCount_AsyncWorker(_underlying, deferred,
...
Napi::Value SplitShell::GetYourNameMaker_async(const Napi::CallbackInfo &info)
{
    ...
    SplitShell_GetYourNameMaker_AsyncWorker *asyncWorker =
        new SplitShell_GetYourNameMaker_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SplitShell::GetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    SplitShell_GetStatus_AsyncWorker *asyncWorker = new SplitShell_GetStatus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SplitShell::SetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    SplitShell_SetStatus_AsyncWorker *asyncWorker = new SplitShell_SetStatus_AsyncWorker(_underlying, deferred,
...
Napi::Value SplitShell::CreateShell_async(const Napi::CallbackInfo &info)
{
    ...
    SplitShell_CreateShell_AsyncWorker *asyncWorker = new SplitShell_CreateShell_AsyncWorker(_underlying, deferred,
...
Napi::Value SplitShell::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    SplitShell_GetMainName_AsyncWorker *asyncWorker = new SplitShell_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SplitShell::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    SplitShell_GetUseCount_AsyncWorker *asyncWorker = new SplitShell_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value SplitShell::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    SplitShell_AddRef_AsyncWorker *asyncWorker = new SplitShell_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
SplitShell_IsA_AsyncWorker::SplitShell_IsA_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d)
...
SplitShell_Type_AsyncWorker::SplitShell_Type_AsyncWorker(MbSplitShell *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SplitShell_GetBasisPoints_AsyncWorker::SplitShell_GetBasisPoints_AsyncWorker(MbSplitShell *_underlying,
...
SplitShell_SetBasisPoints_AsyncWorker::SplitShell_SetBasisPoints_AsyncWorker(MbSplitShell *_underlying,
                                                                             Napi::Promise::Deferred const &d,
...
SplitShell_GetBasisItems_AsyncWorker::SplitShell_GetBasisItems_AsyncWorker(MbSplitShell *_underlying,
                                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SplitShell_GetCreatorsCount_AsyncWorker::SplitShell_GetCreatorsCount_AsyncWorker(MbSplitShell *_underlying,
                                                                                 Napi::Promise::Deferred const &d,
                                                                                 MbeCreatorType ct)
...
SplitShell_GetYourNameMaker_AsyncWorker::SplitShell_GetYourNameMaker_AsyncWorker(MbSplitShell *_underlying,
                                                                                 Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SplitShell_GetStatus_AsyncWorker::SplitShell_GetStatus_AsyncWorker(MbSplitShell *_underlying,
                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SplitShell_SetStatus_AsyncWorker::SplitShell_SetStatus_AsyncWorker(MbSplitShell *_underlying,
...
SplitShell_CreateShell_AsyncWorker::SplitShell_CreateShell_AsyncWorker(MbSplitShell *_underlying,
                                                                       Napi::Promise::Deferred const &d,
...
SplitShell_GetMainName_AsyncWorker::SplitShell_GetMainName_AsyncWorker(MbSplitShell *_underlying,
                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SplitShell_GetUseCount_AsyncWorker::SplitShell_GetUseCount_AsyncWorker(MbSplitShell *_underlying,
                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
SplitShell_AddRef_AsyncWorker::SplitShell_AddRef_AsyncWorker(MbSplitShell *_underlying,
                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
