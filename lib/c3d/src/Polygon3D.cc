...
Napi::Value Polygon3D::SetItem_async(const Napi::CallbackInfo &info)
{
    ...
    Polygon3D_SetItem_AsyncWorker *asyncWorker = new Polygon3D_SetItem_AsyncWorker(_underlying, deferred,
...
Napi::Value Polygon3D::SetPrimitiveName_async(const Napi::CallbackInfo &info)
{
    ...
    Polygon3D_SetPrimitiveName_AsyncWorker *asyncWorker =
        new Polygon3D_SetPrimitiveName_AsyncWorker(_underlying, deferred,
...
Napi::Value Polygon3D::SetPrimitiveType_async(const Napi::CallbackInfo &info)
{
    ...
    Polygon3D_SetPrimitiveType_AsyncWorker *asyncWorker =
        new Polygon3D_SetPrimitiveType_AsyncWorker(_underlying, deferred,
...
Napi::Value Polygon3D::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    Polygon3D_GetUseCount_AsyncWorker *asyncWorker = new Polygon3D_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Polygon3D::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    Polygon3D_AddRef_AsyncWorker *asyncWorker = new Polygon3D_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Polygon3D::SetStyle_async(const Napi::CallbackInfo &info)
{
    ...
    Polygon3D_SetStyle_AsyncWorker *asyncWorker = new Polygon3D_SetStyle_AsyncWorker(_underlying, deferred,
...
Napi::Value Polygon3D::GetStyle_async(const Napi::CallbackInfo &info)
{
    ...
    Polygon3D_GetStyle_AsyncWorker *asyncWorker = new Polygon3D_GetStyle_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Polygon3D::SetColor_async(const Napi::CallbackInfo &info)
{
    ...
    Polygon3D_SetColor_AsyncWorker *asyncWorker = new Polygon3D_SetColor_AsyncWorker(_underlying, deferred,
...
Napi::Value Polygon3D::GetColor_async(const Napi::CallbackInfo &info)
{
    ...
    Polygon3D_GetColor_AsyncWorker *asyncWorker = new Polygon3D_GetColor_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Polygon3D::AttributesConvert_async(const Napi::CallbackInfo &info)
{
    ...
    Polygon3D_AttributesConvert_AsyncWorker *asyncWorker =
        new Polygon3D_AttributesConvert_AsyncWorker(_underlying, deferred,
...
Polygon3D_SetItem_AsyncWorker::Polygon3D_SetItem_AsyncWorker(MbPolygon3D *_underlying, Napi::Promise::Deferred const &d,
                                                             const MbRefItem *g)
...
Polygon3D_SetPrimitiveName_AsyncWorker::Polygon3D_SetPrimitiveName_AsyncWorker(MbPolygon3D *_underlying,
...
Polygon3D_SetPrimitiveType_AsyncWorker::Polygon3D_SetPrimitiveType_AsyncWorker(MbPolygon3D *_underlying,
                                                                               Napi::Promise::Deferred const &d,
                                                                               MbeRefType t)
...
Polygon3D_GetUseCount_AsyncWorker::Polygon3D_GetUseCount_AsyncWorker(MbPolygon3D *_underlying,
                                                                     Napi::Promise::Deferred const &d)
...
Polygon3D_AddRef_AsyncWorker::Polygon3D_AddRef_AsyncWorker(MbPolygon3D *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Polygon3D_SetStyle_AsyncWorker::Polygon3D_SetStyle_AsyncWorker(MbPolygon3D *_underlying,
...
Polygon3D_GetStyle_AsyncWorker::Polygon3D_GetStyle_AsyncWorker(MbPolygon3D *_underlying,
                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Polygon3D_SetColor_AsyncWorker::Polygon3D_SetColor_AsyncWorker(MbPolygon3D *_underlying,
...
Polygon3D_GetColor_AsyncWorker::Polygon3D_GetColor_AsyncWorker(MbPolygon3D *_underlying,
                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Polygon3D_AttributesConvert_AsyncWorker::Polygon3D_AttributesConvert_AsyncWorker(MbPolygon3D *_underlying,
                                                                                 Napi::Promise::Deferred const &d,
                                                                                 MbGrid &other)
