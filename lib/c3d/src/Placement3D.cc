...
Napi::Value Placement3D::InitYZ(const Napi::CallbackInfo &info)
{
    ...
    MbPlacement3D &_result = _underlying->InitYZ(p, axisY, axisZ
...
Napi::Value Placement3D::InitYZ_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_InitYZ_AsyncWorker *asyncWorker = new Placement3D_InitYZ_AsyncWorker(_underlying, deferred,
...
Napi::Value Placement3D::Move(const Napi::CallbackInfo &info)
{
    ...
    MbPlacement3D &_result = _underlying->Move(to
...
Napi::Value Placement3D::Move_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_Move_AsyncWorker *asyncWorker = new Placement3D_Move_AsyncWorker(_underlying, deferred,
...
Napi::Value Placement3D::Rotate(const Napi::CallbackInfo &info)
{
    ...
    MbPlacement3D &_result = _underlying->Rotate(axis, angle
...
Napi::Value Placement3D::Rotate_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_Rotate_AsyncWorker *asyncWorker = new Placement3D_Rotate_AsyncWorker(_underlying, deferred,
...
Napi::Value Placement3D::Scale(const Napi::CallbackInfo &info)
{
    ...
    MbPlacement3D &_result = _underlying->Scale(sx, sy, sz
...
Napi::Value Placement3D::Scale_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_Scale_AsyncWorker *asyncWorker = new Placement3D_Scale_AsyncWorker(_underlying, deferred,
...
Napi::Value Placement3D::SetAxisX_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_SetAxisX_AsyncWorker *asyncWorker = new Placement3D_SetAxisX_AsyncWorker(_underlying, deferred,
...
Napi::Value Placement3D::SetAxisY_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_SetAxisY_AsyncWorker *asyncWorker = new Placement3D_SetAxisY_AsyncWorker(_underlying, deferred,
...
Napi::Value Placement3D::SetAxisZ_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_SetAxisZ_AsyncWorker *asyncWorker = new Placement3D_SetAxisZ_AsyncWorker(_underlying, deferred,
...
Napi::Value Placement3D::GetOrigin_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_GetOrigin_AsyncWorker *asyncWorker = new Placement3D_GetOrigin_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Placement3D::SetOrigin_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_SetOrigin_AsyncWorker *asyncWorker = new Placement3D_SetOrigin_AsyncWorker(_underlying, deferred,
...
Napi::Value Placement3D::GetAxisZ_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_GetAxisZ_AsyncWorker *asyncWorker = new Placement3D_GetAxisZ_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Placement3D::GetAxisY_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_GetAxisY_AsyncWorker *asyncWorker = new Placement3D_GetAxisY_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Placement3D::GetAxisX_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_GetAxisX_AsyncWorker *asyncWorker = new Placement3D_GetAxisX_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Placement3D::Normalize_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_Normalize_AsyncWorker *asyncWorker = new Placement3D_Normalize_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Placement3D::Reset_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_Reset_AsyncWorker *asyncWorker = new Placement3D_Reset_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Placement3D::Invert_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_Invert_AsyncWorker *asyncWorker = new Placement3D_Invert_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Placement3D::GetXEpsilon_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_GetXEpsilon_AsyncWorker *asyncWorker = new Placement3D_GetXEpsilon_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Placement3D::GetYEpsilon_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_GetYEpsilon_AsyncWorker *asyncWorker = new Placement3D_GetYEpsilon_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
Napi::Value Placement3D::PointProjection(const Napi::CallbackInfo &info)
{
    ...
    _underlying->PointProjection(p, x, y
...
Napi::Value Placement3D::PointProjection_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_PointProjection_AsyncWorker *asyncWorker =
        new Placement3D_PointProjection_AsyncWorker(_underlying, deferred,
...
Napi::Value Placement3D::PointRelative(const Napi::CallbackInfo &info)
{
    ...
    MbeItemLocation _result =
        _underlying->PointRelative(pnt, info.Length() == 1 || info[1].IsNull() ? Math::angleRegion : eps
...
Napi::Value Placement3D::PointRelative_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_PointRelative_AsyncWorker *asyncWorker =
        new Placement3D_PointRelative_AsyncWorker(_underlying, deferred,
...
Napi::Value Placement3D::GetMatrixToPlace(const Napi::CallbackInfo &info)
{
    ...
    _underlying->GetMatrixToPlace(p, *matrix, info.Length() == 1 || info[1].IsNull() ? Math::angleRegion : eps
...
Napi::Value Placement3D::GetMatrixToPlace_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_GetMatrixToPlace_AsyncWorker *asyncWorker =
        new Placement3D_GetMatrixToPlace_AsyncWorker(_underlying, deferred,
...
Napi::Value Placement3D::GetVectorFrom(const Napi::CallbackInfo &info)
{
    ...
    _underlying->GetVectorFrom(x1, y1, z1, *v, info.Length() == 3 || info[3].IsNull() ? ls_CartesianSystem : type
...
Napi::Value Placement3D::GetVectorFrom_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_GetVectorFrom_AsyncWorker *asyncWorker =
        new Placement3D_GetVectorFrom_AsyncWorker(_underlying, deferred,
...
Napi::Value Placement3D::GetPointFrom(const Napi::CallbackInfo &info)
{
    ...
    _underlying->GetPointFrom(x1, y1, z1, *p, info.Length() == 3 || info[3].IsNull() ? ls_CartesianSystem : type
...
Napi::Value Placement3D::GetPointFrom_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_GetPointFrom_AsyncWorker *asyncWorker = new Placement3D_GetPointFrom_AsyncWorker(_underlying, deferred,
...
Napi::Value Placement3D::GetPointInto(const Napi::CallbackInfo &info)
{
    ...
    _underlying->GetPointInto(p, info.Length() == 1 || info[1].IsNull() ? ls_CartesianSystem : type
...
Napi::Value Placement3D::GetPointInto_async(const Napi::CallbackInfo &info)
{
    ...
    Placement3D_GetPointInto_AsyncWorker *asyncWorker = new Placement3D_GetPointInto_AsyncWorker(_underlying, deferred,
...
Placement3D_InitYZ_AsyncWorker::Placement3D_InitYZ_AsyncWorker(MbPlacement3D *_underlying,
                                                               Napi::Promise::Deferred const &d, const MbCartPoint3D &p,
                                                               const MbVector3D &axisY, const MbVector3D &axisZ)
    : _underlying(_underlying), PromiseWorker(d), p(p), axisY(axisY), axisZ(axisZ){};
...
Placement3D_Move_AsyncWorker::Placement3D_Move_AsyncWorker(MbPlacement3D *_underlying, Napi::Promise::Deferred const &d,
                                                           const MbVector3D &to)
...
Placement3D_Rotate_AsyncWorker::Placement3D_Rotate_AsyncWorker(MbPlacement3D *_underlying,
...
Placement3D_Scale_AsyncWorker::Placement3D_Scale_AsyncWorker(MbPlacement3D *_underlying,
                                                             Napi::Promise::Deferred const &d, double sx, double sy,
                                                             double sz)
...
Placement3D_SetAxisX_AsyncWorker::Placement3D_SetAxisX_AsyncWorker(MbPlacement3D *_underlying,
...
Placement3D_SetAxisY_AsyncWorker::Placement3D_SetAxisY_AsyncWorker(MbPlacement3D *_underlying,
                                                                   Napi::Promise::Deferred const &d,
                                                                   const MbVector3D &a)
    : _underlying(_underlying), PromiseWorker(d), a(a){};
...
Placement3D_SetAxisZ_AsyncWorker::Placement3D_SetAxisZ_AsyncWorker(MbPlacement3D *_underlying,
                                                                   Napi::Promise::Deferred const &d,
                                                                   const MbVector3D &a)
    : _underlying(_underlying), PromiseWorker(d), a(a){};
...
Placement3D_GetOrigin_AsyncWorker::Placement3D_GetOrigin_AsyncWorker(MbPlacement3D *_underlying,
                                                                     Napi::Promise::Deferred const &d)
...
Placement3D_SetOrigin_AsyncWorker::Placement3D_SetOrigin_AsyncWorker(MbPlacement3D *_underlying,
                                                                     Napi::Promise::Deferred const &d,
                                                                     const MbCartPoint3D &o)
    : _underlying(_underlying), PromiseWorker(d), o(o){};
...
Placement3D_GetAxisZ_AsyncWorker::Placement3D_GetAxisZ_AsyncWorker(MbPlacement3D *_underlying,
                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Placement3D_GetAxisY_AsyncWorker::Placement3D_GetAxisY_AsyncWorker(MbPlacement3D *_underlying,
                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Placement3D_GetAxisX_AsyncWorker::Placement3D_GetAxisX_AsyncWorker(MbPlacement3D *_underlying,
                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Placement3D_Normalize_AsyncWorker::Placement3D_Normalize_AsyncWorker(MbPlacement3D *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Placement3D_Reset_AsyncWorker::Placement3D_Reset_AsyncWorker(MbPlacement3D *_underlying,
                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Placement3D_Invert_AsyncWorker::Placement3D_Invert_AsyncWorker(MbPlacement3D *_underlying,
                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Placement3D_GetXEpsilon_AsyncWorker::Placement3D_GetXEpsilon_AsyncWorker(MbPlacement3D *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Placement3D_GetYEpsilon_AsyncWorker::Placement3D_GetYEpsilon_AsyncWorker(MbPlacement3D *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Placement3D_PointProjection_AsyncWorker::Placement3D_PointProjection_AsyncWorker(MbPlacement3D *_underlying,
                                                                                 Napi::Promise::Deferred const &d,
...
Placement3D_PointRelative_AsyncWorker::Placement3D_PointRelative_AsyncWorker(MbPlacement3D *_underlying,
                                                                             Napi::Promise::Deferred const &d,
                                                                             const MbCartPoint3D &pnt, double eps)
...
Placement3D_GetMatrixToPlace_AsyncWorker::Placement3D_GetMatrixToPlace_AsyncWorker(MbPlacement3D *_underlying,
                                                                                   Napi::Promise::Deferred const &d,
                                                                                   const MbPlacement3D &p, double eps)
    : _underlying(_underlying), PromiseWorker(d), p(p), eps(eps){};
...
void Placement3D_GetMatrixToPlace_AsyncWorker::Execute()
{
    ...
    _underlying->GetMatrixToPlace(p, *matrix, eps);
...
Placement3D_GetVectorFrom_AsyncWorker::Placement3D_GetVectorFrom_AsyncWorker(MbPlacement3D *_underlying,
                                                                             Napi::Promise::Deferred const &d,
                                                                             double x1, double y1, double z1,
                                                                             MbeLocalSystemType3D type)
    : _underlying(_underlying), PromiseWorker(d), x1(x1), y1(y1), z1(z1), type(type){};
...
void Placement3D_GetVectorFrom_AsyncWorker::Execute()
{
    ...
    _underlying->GetVectorFrom(x1, y1, z1, *v, type);
...
Placement3D_GetPointFrom_AsyncWorker::Placement3D_GetPointFrom_AsyncWorker(MbPlacement3D *_underlying,
                                                                           Napi::Promise::Deferred const &d, double x1,
                                                                           double y1, double z1,
                                                                           MbeLocalSystemType3D type)
    : _underlying(_underlying), PromiseWorker(d), x1(x1), y1(y1), z1(z1), type(type){};
...
void Placement3D_GetPointFrom_AsyncWorker::Execute()
{
    ...
    _underlying->GetPointFrom(x1, y1, z1, *p, type);
...
Placement3D_GetPointInto_AsyncWorker::Placement3D_GetPointInto_AsyncWorker(MbPlacement3D *_underlying,
                                                                           Napi::Promise::Deferred const &d,
                                                                           MbCartPoint3D &p, MbeLocalSystemType3D type)
    : _underlying(_underlying), PromiseWorker(d), p(p), type(type){};

void Placement3D_GetPointInto_AsyncWorker::Execute()
{
    EnterParallelRegion();

    _underlying->GetPointInto(p, type);
