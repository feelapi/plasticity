...
Napi::Value CurveTangent::LinePointTangentCurve(const Napi::CallbackInfo &info)
{
    ...
    ::LinePointTangentCurve(pnt, pCurve, *pLine, info.Length() == 2 || info[2].IsNull() ? false : lineAsCurve
...
Napi::Value CurveTangent::LinePointTangentCurve_async(const Napi::CallbackInfo &info)
{
    ...
    CurveTangent_LinePointTangentCurve_AsyncWorker *asyncWorker =
        new CurveTangent_LinePointTangentCurve_AsyncWorker(deferred,
...
Napi::Value CurveTangent::LineTangentTwoCurves(const Napi::CallbackInfo &info)
{
    ...
    ::LineTangentTwoCurves(pCurve1, pCurve2, pLine, secondPoint
...
Napi::Value CurveTangent::LineTangentTwoCurves_async(const Napi::CallbackInfo &info)
{
    ...
    CurveTangent_LineTangentTwoCurves_AsyncWorker *asyncWorker =
        new CurveTangent_LineTangentTwoCurves_AsyncWorker(deferred,
...
CurveTangent_LinePointTangentCurve_AsyncWorker::CurveTangent_LinePointTangentCurve_AsyncWorker(
    Napi::Promise::Deferred const &d, const MbCartPoint &pnt, const MbCurve &pCurve, bool lineAsCurve)
    : PromiseWorker(d), pnt(pnt), pCurve(pCurve), lineAsCurve(lineAsCurve){};
...
void CurveTangent_LinePointTangentCurve_AsyncWorker::Execute()
{
    ...
    ::LinePointTangentCurve(pnt, pCurve, *pLine, lineAsCurve);
...
void CurveTangent_LinePointTangentCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
CurveTangent_LineTangentTwoCurves_AsyncWorker::CurveTangent_LineTangentTwoCurves_AsyncWorker(
    Napi::Promise::Deferred const &d, const MbCurve *pCurve1, const MbCurve *pCurve2)
    : PromiseWorker(d), pCurve1(pCurve1), pCurve2(pCurve2){};
...
void CurveTangent_LineTangentTwoCurves_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                           Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
