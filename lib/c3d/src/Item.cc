...
Napi::Object Item::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "Item", {
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value Item::CreateMesh_async(const Napi::CallbackInfo& info) {
        ...
        Item_CreateMesh_AsyncWorker* asyncWorker = new Item_CreateMesh_AsyncWorker(
...
,        *mesh
    ...
    Napi::Value Item::CalculateMesh_async(const Napi::CallbackInfo& info) {
        ...
        Item_CalculateMesh_AsyncWorker* asyncWorker = new Item_CalculateMesh_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Item::GetItemName_async(const Napi::CallbackInfo& info) {
        ...
        Item_GetItemName_AsyncWorker* asyncWorker = new Item_GetItemName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Item::SetItemName_async(const Napi::CallbackInfo& info) {
        ...
        Item_SetItemName_AsyncWorker* asyncWorker = new Item_SetItemName_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value Item::RebuildItem_async(const Napi::CallbackInfo& info) {
        ...
        Item_RebuildItem_AsyncWorker* asyncWorker = new Item_RebuildItem_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 3 || info[3].IsNull() ? 0 : currInd
    ...
    Napi::Value Item::GetItemByPath_async(const Napi::CallbackInfo& info) {
        ...
        Item_GetItemByPath_AsyncWorker* asyncWorker = new Item_GetItemByPath_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Item::IsA_async(const Napi::CallbackInfo& info) {
        ...
        Item_IsA_AsyncWorker* asyncWorker = new Item_IsA_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Item::Type_async(const Napi::CallbackInfo& info) {
        ...
        Item_Type_AsyncWorker* asyncWorker = new Item_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Item::Family_async(const Napi::CallbackInfo& info) {
        ...
        Item_Family_AsyncWorker* asyncWorker = new Item_Family_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value Item::Transform_async(const Napi::CallbackInfo& info) {
        ...
        Item_Transform_AsyncWorker* asyncWorker = new Item_Transform_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value Item::Move_async(const Napi::CallbackInfo& info) {
        ...
        Item_Move_AsyncWorker* asyncWorker = new Item_Move_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value Item::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        Item_Rotate_AsyncWorker* asyncWorker = new Item_Rotate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Item::Refresh_async(const Napi::CallbackInfo& info) {
        ...
        Item_Refresh_AsyncWorker* asyncWorker = new Item_Refresh_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Item::Duplicate_async(const Napi::CallbackInfo& info) {
        ...
        Item_Duplicate_AsyncWorker* asyncWorker = new Item_Duplicate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Item::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        Item_AddYourGabaritTo_AsyncWorker* asyncWorker = new Item_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Item::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        Item_GetUseCount_AsyncWorker* asyncWorker = new Item_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Item::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        Item_AddRef_AsyncWorker* asyncWorker = new Item_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Item::SetStyle_async(const Napi::CallbackInfo& info) {
        ...
        Item_SetStyle_AsyncWorker* asyncWorker = new Item_SetStyle_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Item::GetStyle_async(const Napi::CallbackInfo& info) {
        ...
        Item_GetStyle_AsyncWorker* asyncWorker = new Item_GetStyle_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Item::SetColor_async(const Napi::CallbackInfo& info) {
        ...
        Item_SetColor_AsyncWorker* asyncWorker = new Item_SetColor_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Item::GetColor_async(const Napi::CallbackInfo& info) {
        ...
        Item_GetColor_AsyncWorker* asyncWorker = new Item_GetColor_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Item::AttributesConvert_async(const Napi::CallbackInfo& info) {
        ...
        Item_AttributesConvert_AsyncWorker* asyncWorker = new Item_AttributesConvert_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Item::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        Item_GetCreatorsCount_AsyncWorker* asyncWorker = new Item_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Item::GetCreator_async(const Napi::CallbackInfo& info) {
        ...
        Item_GetCreator_AsyncWorker* asyncWorker = new Item_GetCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Item::SetCreator_async(const Napi::CallbackInfo& info) {
        ...
        Item_SetCreator_AsyncWorker* asyncWorker = new Item_SetCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Item::DetachCreator_async(const Napi::CallbackInfo& info) {
        ...
        Item_DetachCreator_AsyncWorker* asyncWorker = new Item_DetachCreator_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? false : addSame
    ...
    Napi::Value Item::AddCreator_async(const Napi::CallbackInfo& info) {
        ...
        Item_AddCreator_AsyncWorker* asyncWorker = new Item_AddCreator_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value Item::GetCreators_async(const Napi::CallbackInfo& info) {
        ...
        Item_GetCreators_AsyncWorker* asyncWorker = new Item_GetCreators_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Item::DeleteCreator_async(const Napi::CallbackInfo& info) {
        ...
        Item_DeleteCreator_AsyncWorker* asyncWorker = new Item_DeleteCreator_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Item::GetActiveCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        Item_GetActiveCreatorsCount_AsyncWorker* asyncWorker = new Item_GetActiveCreatorsCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
Item::~Item() {
    ...
    Item_CreateMesh_AsyncWorker::Item_CreateMesh_AsyncWorker(
...
,                        iReg
    ...
    Item_CalculateMesh_AsyncWorker::Item_CalculateMesh_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbStepData & stepData,
                        const MbFormNote & note    )
...
,                        *mesh
    ...
    Item_GetItemName_AsyncWorker::Item_GetItemName_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Item_SetItemName_AsyncWorker::Item_SetItemName_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
                         SimpleName  name    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Item_RebuildItem_AsyncWorker::Item_RebuildItem_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        progInd
    ...
    Item_GetItemByPath_AsyncWorker::Item_GetItemByPath_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbPath & path,
                         size_t  ind,
...
,                        currInd
    ...
    Item_IsA_AsyncWorker::Item_IsA_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Item_Type_AsyncWorker::Item_Type_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Item_Family_AsyncWorker::Item_Family_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Item_Transform_AsyncWorker::Item_Transform_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    Item_Move_AsyncWorker::Item_Move_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & v,
                         MbRegTransform * iReg    )
...
,                        iReg
    ...
    Item_Rotate_AsyncWorker::Item_Rotate_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbAxis3D & axis,
                         double  angle,
...
,                        iReg
    ...
    Item_Refresh_AsyncWorker::Item_Refresh_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Item_Duplicate_AsyncWorker::Item_Duplicate_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
                         MbRegDuplicate * iReg    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Item_AddYourGabaritTo_AsyncWorker::Item_AddYourGabaritTo_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
                         MbCube & cube    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Item_GetUseCount_AsyncWorker::Item_GetUseCount_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Item_AddRef_AsyncWorker::Item_AddRef_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Item_SetStyle_AsyncWorker::Item_SetStyle_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
                         int  s    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Item_GetStyle_AsyncWorker::Item_GetStyle_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Item_SetColor_AsyncWorker::Item_SetColor_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
                         uint32  c    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Item_GetColor_AsyncWorker::Item_GetColor_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Item_AttributesConvert_AsyncWorker::Item_AttributesConvert_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
                         MbGrid & other    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Item_GetCreatorsCount_AsyncWorker::Item_GetCreatorsCount_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Item_GetCreator_AsyncWorker::Item_GetCreator_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Item_SetCreator_AsyncWorker::Item_SetCreator_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Item_DetachCreator_AsyncWorker::Item_DetachCreator_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Item_AddCreator_AsyncWorker::Item_AddCreator_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        addSame
    ...
    Item_GetCreators_AsyncWorker::Item_GetCreators_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Item_DeleteCreator_AsyncWorker::Item_DeleteCreator_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  ind    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Item_GetActiveCreatorsCount_AsyncWorker::Item_GetActiveCreatorsCount_AsyncWorker(
MbItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
