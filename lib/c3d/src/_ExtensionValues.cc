...
Napi::Object _ExtensionValues::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "ExtensionValues", {
...
Napi::Function _ExtensionValues::GetConstructor(Napi::Env env) {
    ...
    return f;
        ...
        Napi::Value _ExtensionValues::InitByDistance(const Napi::CallbackInfo& info) {
            ...
            const ExtensionValues::ExtensionType t = static_cast<ExtensionValues::ExtensionType>(info[0].ToNumber().Uint32Value());
...
,        dist
    ...
    Napi::Value _ExtensionValues::InitByDistance_async(const Napi::CallbackInfo& info) {
        ...
        _ExtensionValues_InitByDistance_AsyncWorker* asyncWorker = new _ExtensionValues_InitByDistance_AsyncWorker(
...
,        v
    ...
    Napi::Value _ExtensionValues::InitByVertex_async(const Napi::CallbackInfo& info) {
        ...
        _ExtensionValues_InitByVertex_AsyncWorker* asyncWorker = new _ExtensionValues_InitByVertex_AsyncWorker(
_underlying,            deferred
,
...
,        s
    ...
    Napi::Value _ExtensionValues::InitByShell_async(const Napi::CallbackInfo& info) {
        ...
        _ExtensionValues_InitByShell_AsyncWorker* asyncWorker = new _ExtensionValues_InitByShell_AsyncWorker(
_underlying,            deferred
,
...
void _ExtensionValues::SetValue_type(const Napi::CallbackInfo &info, const Napi::Value &value) {
    Napi::Env env = info.Env();
        const ExtensionValues::ExtensionType type = static_cast<ExtensionValues::ExtensionType>(info[0].ToNumber().Uint32Value());
...
void _ExtensionValues::SetValue_way(const Napi::CallbackInfo &info, const Napi::Value &value) {
    Napi::Env env = info.Env();
        const ExtensionValues::ExtensionWay way = static_cast<ExtensionValues::ExtensionWay>(info[0].ToNumber().Uint32Value());
...
void _ExtensionValues::SetValue_kind(const Napi::CallbackInfo &info, const Napi::Value &value) {
    Napi::Env env = info.Env();
        const ExtensionValues::LateralKind kind = static_cast<ExtensionValues::LateralKind>(info[0].ToNumber().Uint32Value());
...
ExtensionValues * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        dist
    ...
    void _ExtensionValues_InitByDistance_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    _ExtensionValues_InitByVertex_AsyncWorker::_ExtensionValues_InitByVertex_AsyncWorker(
ExtensionValues * _underlying,        Napi::Promise::Deferred const &d
,
                         ExtensionValues::ExtensionType  t,
                         ExtensionValues::LateralKind  k,
...
,                        v
    ...
    void _ExtensionValues_InitByVertex_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    _ExtensionValues_InitByShell_AsyncWorker::_ExtensionValues_InitByShell_AsyncWorker(
ExtensionValues * _underlying,        Napi::Promise::Deferred const &d
,
                         ExtensionValues::ExtensionType  t,
                         ExtensionValues::LateralKind  k,
