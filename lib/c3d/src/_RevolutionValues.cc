...
Napi::Object _RevolutionValues::Init(const Napi::Env env, Napi::Object exports)
{
    Napi::Function func = DefineClass(
        env, "RevolutionValues",
        {
            ...
            InstanceAccessor<&_RevolutionValues::GetValue_thickness1, &_RevolutionValues::SetValue_thickness1>(
                "thickness1"),
            InstanceAccessor<&_RevolutionValues::GetValue_thickness2, &_RevolutionValues::SetValue_thickness2>(
                "thickness2"),
            InstanceAccessor<&_RevolutionValues::GetValue_shellClosed, &_RevolutionValues::SetValue_shellClosed>(
                "shellClosed"),
        });
...
Napi::Value _RevolutionValues::CheckSelfInt_async(const Napi::CallbackInfo &info)
{
    ...
    _RevolutionValues_CheckSelfInt_AsyncWorker *asyncWorker =
        new _RevolutionValues_CheckSelfInt_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value _RevolutionValues::SetCheckSelfInt_async(const Napi::CallbackInfo &info)
{
    ...
    _RevolutionValues_SetCheckSelfInt_AsyncWorker *asyncWorker =
        new _RevolutionValues_SetCheckSelfInt_AsyncWorker(_underlying, deferred,
...
_RevolutionValues_CheckSelfInt_AsyncWorker::_RevolutionValues_CheckSelfInt_AsyncWorker(RevolutionValues *_underlying,
...
void _RevolutionValues_CheckSelfInt_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
_RevolutionValues_SetCheckSelfInt_AsyncWorker::_RevolutionValues_SetCheckSelfInt_AsyncWorker(
    RevolutionValues *_underlying, Napi::Promise::Deferred const &d, bool c)
...
void _RevolutionValues_SetCheckSelfInt_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                           Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
