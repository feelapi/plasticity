...
(
    ...
    Napi::Value Vertex::IsA_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_IsA_AsyncWorker* asyncWorker = new Vertex_IsA_AsyncWorker(
...
(
    ...
    Napi::Value Vertex::GetName_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_GetName_AsyncWorker* asyncWorker = new Vertex_GetName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Vertex::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_GetMainName_AsyncWorker* asyncWorker = new Vertex_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Vertex::GetFirstName_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_GetFirstName_AsyncWorker* asyncWorker = new Vertex_GetFirstName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Vertex::GetNameHash_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_GetNameHash_AsyncWorker* asyncWorker = new Vertex_GetNameHash_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Vertex::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_AddYourGabaritTo_AsyncWorker* asyncWorker = new Vertex_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
,        *mesh
    ...
    Napi::Value Vertex::CalculateMesh_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_CalculateMesh_AsyncWorker* asyncWorker = new Vertex_CalculateMesh_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Vertex::GetOwnChanged_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_GetOwnChanged_AsyncWorker* asyncWorker = new Vertex_GetOwnChanged_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Vertex::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_GetUseCount_AsyncWorker* asyncWorker = new Vertex_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Vertex::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_AddRef_AsyncWorker* asyncWorker = new Vertex_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Vertex::SetStyle_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_SetStyle_AsyncWorker* asyncWorker = new Vertex_SetStyle_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Vertex::GetStyle_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_GetStyle_AsyncWorker* asyncWorker = new Vertex_GetStyle_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Vertex::SetColor_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_SetColor_AsyncWorker* asyncWorker = new Vertex_SetColor_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Vertex::GetColor_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_GetColor_AsyncWorker* asyncWorker = new Vertex_GetColor_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Vertex::AttributesConvert_async(const Napi::CallbackInfo& info) {
        ...
        Vertex_AttributesConvert_AsyncWorker* asyncWorker = new Vertex_AttributesConvert_AsyncWorker(
_underlying,            deferred
,
...
Vertex::~Vertex() {
    ...
    Vertex_IsA_AsyncWorker::Vertex_IsA_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
    )
    ...
    Vertex_GetName_AsyncWorker::Vertex_GetName_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Vertex_GetMainName_AsyncWorker::Vertex_GetMainName_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Vertex_GetFirstName_AsyncWorker::Vertex_GetFirstName_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Vertex_GetNameHash_AsyncWorker::Vertex_GetNameHash_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Vertex_AddYourGabaritTo_AsyncWorker::Vertex_AddYourGabaritTo_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
,
                         MbCube & cube    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Vertex_CalculateMesh_AsyncWorker::Vertex_CalculateMesh_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        *mesh
    ...
    Vertex_GetOwnChanged_AsyncWorker::Vertex_GetOwnChanged_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Vertex_GetUseCount_AsyncWorker::Vertex_GetUseCount_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Vertex_AddRef_AsyncWorker::Vertex_AddRef_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Vertex_SetStyle_AsyncWorker::Vertex_SetStyle_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
,
                         int  s    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Vertex_GetStyle_AsyncWorker::Vertex_GetStyle_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Vertex_SetColor_AsyncWorker::Vertex_SetColor_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
,
                         uint32  c    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Vertex_GetColor_AsyncWorker::Vertex_GetColor_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Vertex_AttributesConvert_AsyncWorker::Vertex_AttributesConvert_AsyncWorker(
MbVertex * _underlying,        Napi::Promise::Deferred const &d
,
                         MbGrid & other    )
        :_underlying(_underlying),PromiseWorker(d),
