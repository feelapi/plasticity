...
(
    ...
    Napi::Value RibSolid::IsA_async(const Napi::CallbackInfo& info) {
        ...
        RibSolid_IsA_AsyncWorker* asyncWorker = new RibSolid_IsA_AsyncWorker(
...
(
    ...
    Napi::Value RibSolid::Type_async(const Napi::CallbackInfo& info) {
        ...
        RibSolid_Type_AsyncWorker* asyncWorker = new RibSolid_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value RibSolid::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        RibSolid_GetBasisPoints_AsyncWorker* asyncWorker = new RibSolid_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value RibSolid::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        RibSolid_SetBasisPoints_AsyncWorker* asyncWorker = new RibSolid_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value RibSolid::GetBasisItems_async(const Napi::CallbackInfo& info) {
        ...
        RibSolid_GetBasisItems_AsyncWorker* asyncWorker = new RibSolid_GetBasisItems_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value RibSolid::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        RibSolid_GetCreatorsCount_AsyncWorker* asyncWorker = new RibSolid_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value RibSolid::GetYourNameMaker_async(const Napi::CallbackInfo& info) {
        ...
        RibSolid_GetYourNameMaker_AsyncWorker* asyncWorker = new RibSolid_GetYourNameMaker_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value RibSolid::GetStatus_async(const Napi::CallbackInfo& info) {
        ...
        RibSolid_GetStatus_AsyncWorker* asyncWorker = new RibSolid_GetStatus_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value RibSolid::SetStatus_async(const Napi::CallbackInfo& info) {
        ...
        RibSolid_SetStatus_AsyncWorker* asyncWorker = new RibSolid_SetStatus_AsyncWorker(
_underlying,            deferred
,
...
,        items
    ...
    Napi::Value RibSolid::CreateShell_async(const Napi::CallbackInfo& info) {
        ...
        RibSolid_CreateShell_AsyncWorker* asyncWorker = new RibSolid_CreateShell_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value RibSolid::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        RibSolid_GetMainName_AsyncWorker* asyncWorker = new RibSolid_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value RibSolid::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        RibSolid_GetUseCount_AsyncWorker* asyncWorker = new RibSolid_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value RibSolid::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        RibSolid_AddRef_AsyncWorker* asyncWorker = new RibSolid_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
RibSolid::~RibSolid() {
    ...
    RibSolid_IsA_AsyncWorker::RibSolid_IsA_AsyncWorker(
MbRibSolid * _underlying,        Napi::Promise::Deferred const &d
    )
    ...
    RibSolid_Type_AsyncWorker::RibSolid_Type_AsyncWorker(
MbRibSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    RibSolid_GetBasisPoints_AsyncWorker::RibSolid_GetBasisPoints_AsyncWorker(
MbRibSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    RibSolid_SetBasisPoints_AsyncWorker::RibSolid_SetBasisPoints_AsyncWorker(
MbRibSolid * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    RibSolid_GetBasisItems_AsyncWorker::RibSolid_GetBasisItems_AsyncWorker(
MbRibSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    RibSolid_GetCreatorsCount_AsyncWorker::RibSolid_GetCreatorsCount_AsyncWorker(
MbRibSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeCreatorType  ct    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    RibSolid_GetYourNameMaker_AsyncWorker::RibSolid_GetYourNameMaker_AsyncWorker(
MbRibSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    RibSolid_GetStatus_AsyncWorker::RibSolid_GetStatus_AsyncWorker(
MbRibSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    RibSolid_SetStatus_AsyncWorker::RibSolid_SetStatus_AsyncWorker(
MbRibSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeProcessState  l    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    RibSolid_CreateShell_AsyncWorker::RibSolid_CreateShell_AsyncWorker(
MbRibSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbFaceShell * shell,
...
,                        items
    ...
    RibSolid_GetMainName_AsyncWorker::RibSolid_GetMainName_AsyncWorker(
MbRibSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    RibSolid_GetUseCount_AsyncWorker::RibSolid_GetUseCount_AsyncWorker(
MbRibSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    RibSolid_AddRef_AsyncWorker::RibSolid_AddRef_AsyncWorker(
MbRibSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
