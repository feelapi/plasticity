...
Napi::Value PlaneItem::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    PlaneItem_IsA_AsyncWorker *asyncWorker = new PlaneItem_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value PlaneItem::Type_async(const Napi::CallbackInfo &info)
{
    ...
    PlaneItem_Type_AsyncWorker *asyncWorker = new PlaneItem_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value PlaneItem::Family_async(const Napi::CallbackInfo &info)
{
    ...
    PlaneItem_Family_AsyncWorker *asyncWorker = new PlaneItem_Family_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value PlaneItem::Move_async(const Napi::CallbackInfo &info)
{
    ...
    PlaneItem_Move_AsyncWorker *asyncWorker = new PlaneItem_Move_AsyncWorker(_underlying, deferred,
...
Napi::Value PlaneItem::Transform_async(const Napi::CallbackInfo &info)
{
    ...
    PlaneItem_Transform_AsyncWorker *asyncWorker = new PlaneItem_Transform_AsyncWorker(_underlying, deferred,
...
Napi::Value PlaneItem::Duplicate_async(const Napi::CallbackInfo &info)
{
    ...
    PlaneItem_Duplicate_AsyncWorker *asyncWorker = new PlaneItem_Duplicate_AsyncWorker(_underlying, deferred,
...
Napi::Value PlaneItem::AddYourGabaritTo_async(const Napi::CallbackInfo &info)
{
    ...
    PlaneItem_AddYourGabaritTo_AsyncWorker *asyncWorker =
        new PlaneItem_AddYourGabaritTo_AsyncWorker(_underlying, deferred,
...
Napi::Value PlaneItem::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    PlaneItem_GetUseCount_AsyncWorker *asyncWorker = new PlaneItem_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value PlaneItem::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    PlaneItem_AddRef_AsyncWorker *asyncWorker = new PlaneItem_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
PlaneItem_IsA_AsyncWorker::PlaneItem_IsA_AsyncWorker(MbPlaneItem *_underlying, Napi::Promise::Deferred const &d)
...
PlaneItem_Type_AsyncWorker::PlaneItem_Type_AsyncWorker(MbPlaneItem *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
PlaneItem_Family_AsyncWorker::PlaneItem_Family_AsyncWorker(MbPlaneItem *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
PlaneItem_Move_AsyncWorker::PlaneItem_Move_AsyncWorker(MbPlaneItem *_underlying, Napi::Promise::Deferred const &d,
...
PlaneItem_Transform_AsyncWorker::PlaneItem_Transform_AsyncWorker(MbPlaneItem *_underlying,
...
PlaneItem_Duplicate_AsyncWorker::PlaneItem_Duplicate_AsyncWorker(MbPlaneItem *_underlying,
...
PlaneItem_AddYourGabaritTo_AsyncWorker::PlaneItem_AddYourGabaritTo_AsyncWorker(MbPlaneItem *_underlying,
...
PlaneItem_GetUseCount_AsyncWorker::PlaneItem_GetUseCount_AsyncWorker(MbPlaneItem *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
PlaneItem_AddRef_AsyncWorker::PlaneItem_AddRef_AsyncWorker(MbPlaneItem *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
