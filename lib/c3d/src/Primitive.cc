...
Napi::Value Primitive::SetItem_async(const Napi::CallbackInfo &info)
{
    ...
    Primitive_SetItem_AsyncWorker *asyncWorker = new Primitive_SetItem_AsyncWorker(_underlying, deferred,
...
Napi::Value Primitive::SetPrimitiveName_async(const Napi::CallbackInfo &info)
{
    ...
    Primitive_SetPrimitiveName_AsyncWorker *asyncWorker =
        new Primitive_SetPrimitiveName_AsyncWorker(_underlying, deferred,
...
Napi::Value Primitive::SetPrimitiveType_async(const Napi::CallbackInfo &info)
{
    ...
    Primitive_SetPrimitiveType_AsyncWorker *asyncWorker =
        new Primitive_SetPrimitiveType_AsyncWorker(_underlying, deferred,
...
Napi::Value Primitive::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    Primitive_GetUseCount_AsyncWorker *asyncWorker = new Primitive_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Primitive::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    Primitive_AddRef_AsyncWorker *asyncWorker = new Primitive_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Primitive::SetStyle_async(const Napi::CallbackInfo &info)
{
    ...
    Primitive_SetStyle_AsyncWorker *asyncWorker = new Primitive_SetStyle_AsyncWorker(_underlying, deferred,
...
Napi::Value Primitive::GetStyle_async(const Napi::CallbackInfo &info)
{
    ...
    Primitive_GetStyle_AsyncWorker *asyncWorker = new Primitive_GetStyle_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Primitive::SetColor_async(const Napi::CallbackInfo &info)
{
    ...
    Primitive_SetColor_AsyncWorker *asyncWorker = new Primitive_SetColor_AsyncWorker(_underlying, deferred,
...
Napi::Value Primitive::GetColor_async(const Napi::CallbackInfo &info)
{
    ...
    Primitive_GetColor_AsyncWorker *asyncWorker = new Primitive_GetColor_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value Primitive::AttributesConvert_async(const Napi::CallbackInfo &info)
{
    ...
    Primitive_AttributesConvert_AsyncWorker *asyncWorker =
        new Primitive_AttributesConvert_AsyncWorker(_underlying, deferred,
...
Primitive_SetItem_AsyncWorker::Primitive_SetItem_AsyncWorker(MbPrimitive *_underlying, Napi::Promise::Deferred const &d,
                                                             const MbRefItem *g)
...
Primitive_SetPrimitiveName_AsyncWorker::Primitive_SetPrimitiveName_AsyncWorker(MbPrimitive *_underlying,
...
Primitive_SetPrimitiveType_AsyncWorker::Primitive_SetPrimitiveType_AsyncWorker(MbPrimitive *_underlying,
                                                                               Napi::Promise::Deferred const &d,
                                                                               MbeRefType t)
...
Primitive_GetUseCount_AsyncWorker::Primitive_GetUseCount_AsyncWorker(MbPrimitive *_underlying,
                                                                     Napi::Promise::Deferred const &d)
...
Primitive_AddRef_AsyncWorker::Primitive_AddRef_AsyncWorker(MbPrimitive *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Primitive_SetStyle_AsyncWorker::Primitive_SetStyle_AsyncWorker(MbPrimitive *_underlying,
...
Primitive_GetStyle_AsyncWorker::Primitive_GetStyle_AsyncWorker(MbPrimitive *_underlying,
                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Primitive_SetColor_AsyncWorker::Primitive_SetColor_AsyncWorker(MbPrimitive *_underlying,
...
Primitive_GetColor_AsyncWorker::Primitive_GetColor_AsyncWorker(MbPrimitive *_underlying,
                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
Primitive_AttributesConvert_AsyncWorker::Primitive_AttributesConvert_AsyncWorker(MbPrimitive *_underlying,
                                                                                 Napi::Promise::Deferred const &d,
                                                                                 MbGrid &other)
