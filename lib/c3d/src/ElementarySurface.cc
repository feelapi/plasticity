...
Napi::Object ElementarySurface::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "ElementarySurface", {
...
(
    ...
    Napi::Value ElementarySurface::GetSurface_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_GetSurface_AsyncWorker* asyncWorker = new ElementarySurface_GetSurface_AsyncWorker(
...
(
    ...
    Napi::Value ElementarySurface::GetUEpsilon_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_GetUEpsilon_AsyncWorker* asyncWorker = new ElementarySurface_GetUEpsilon_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ElementarySurface::GetVEpsilon_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_GetVEpsilon_AsyncWorker* asyncWorker = new ElementarySurface_GetVEpsilon_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ElementarySurface::GetUMid_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_GetUMid_AsyncWorker* asyncWorker = new ElementarySurface_GetUMid_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ElementarySurface::GetVMid_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_GetVMid_AsyncWorker* asyncWorker = new ElementarySurface_GetVMid_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ElementarySurface::GetUMin_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_GetUMin_AsyncWorker* asyncWorker = new ElementarySurface_GetUMin_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ElementarySurface::GetUMax_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_GetUMax_AsyncWorker* asyncWorker = new ElementarySurface_GetUMax_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ElementarySurface::GetVMin_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_GetVMin_AsyncWorker* asyncWorker = new ElementarySurface_GetVMin_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ElementarySurface::GetVMax_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_GetVMax_AsyncWorker* asyncWorker = new ElementarySurface_GetVMax_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ElementarySurface::GetUParamToUnit_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_GetUParamToUnit_AsyncWorker* asyncWorker = new ElementarySurface_GetUParamToUnit_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ElementarySurface::GetVParamToUnit_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_GetVParamToUnit_AsyncWorker* asyncWorker = new ElementarySurface_GetVParamToUnit_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ElementarySurface::GetRadius_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_GetRadius_AsyncWorker* asyncWorker = new ElementarySurface_GetRadius_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        *result
    ...
    Napi::Value ElementarySurface::Normal_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_Normal_AsyncWorker* asyncWorker = new ElementarySurface_Normal_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value ElementarySurface::NearDirectPointProjection_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_NearDirectPointProjection_AsyncWorker* asyncWorker = new ElementarySurface_NearDirectPointProjection_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ElementarySurface::IsA_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_IsA_AsyncWorker* asyncWorker = new ElementarySurface_IsA_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ElementarySurface::Type_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_Type_AsyncWorker* asyncWorker = new ElementarySurface_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ElementarySurface::Family_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_Family_AsyncWorker* asyncWorker = new ElementarySurface_Family_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value ElementarySurface::Transform_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_Transform_AsyncWorker* asyncWorker = new ElementarySurface_Transform_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value ElementarySurface::Move_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_Move_AsyncWorker* asyncWorker = new ElementarySurface_Move_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value ElementarySurface::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_Rotate_AsyncWorker* asyncWorker = new ElementarySurface_Rotate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ElementarySurface::Refresh_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_Refresh_AsyncWorker* asyncWorker = new ElementarySurface_Refresh_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ElementarySurface::Duplicate_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_Duplicate_AsyncWorker* asyncWorker = new ElementarySurface_Duplicate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ElementarySurface::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_AddYourGabaritTo_AsyncWorker* asyncWorker = new ElementarySurface_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ElementarySurface::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_GetUseCount_AsyncWorker* asyncWorker = new ElementarySurface_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ElementarySurface::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        ElementarySurface_AddRef_AsyncWorker* asyncWorker = new ElementarySurface_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
ElementarySurface::~ElementarySurface() {
    ...
    ElementarySurface_GetSurface_AsyncWorker::ElementarySurface_GetSurface_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    ...
    ElementarySurface_GetUEpsilon_AsyncWorker::ElementarySurface_GetUEpsilon_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void ElementarySurface_GetUEpsilon_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ElementarySurface_GetVEpsilon_AsyncWorker::ElementarySurface_GetVEpsilon_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void ElementarySurface_GetVEpsilon_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ElementarySurface_GetUMid_AsyncWorker::ElementarySurface_GetUMid_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ElementarySurface_GetVMid_AsyncWorker::ElementarySurface_GetVMid_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ElementarySurface_GetUMin_AsyncWorker::ElementarySurface_GetUMin_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ElementarySurface_GetUMax_AsyncWorker::ElementarySurface_GetUMax_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ElementarySurface_GetVMin_AsyncWorker::ElementarySurface_GetVMin_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ElementarySurface_GetVMax_AsyncWorker::ElementarySurface_GetVMax_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
...
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    ...
    void ElementarySurface_GetUParamToUnit_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    ...
    void ElementarySurface_GetVParamToUnit_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ElementarySurface_GetRadius_AsyncWorker::ElementarySurface_GetRadius_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ElementarySurface_Normal_AsyncWorker::ElementarySurface_Normal_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
,
                         double & u,
                         double & v    )
...
,                        onlyPositiveDirection
    ...
    void ElementarySurface_NearDirectPointProjection_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ElementarySurface_IsA_AsyncWorker::ElementarySurface_IsA_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ElementarySurface_Type_AsyncWorker::ElementarySurface_Type_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ElementarySurface_Family_AsyncWorker::ElementarySurface_Family_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ElementarySurface_Transform_AsyncWorker::ElementarySurface_Transform_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    ElementarySurface_Move_AsyncWorker::ElementarySurface_Move_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & v,
                         MbRegTransform * iReg    )
...
,                        iReg
    ...
    ElementarySurface_Rotate_AsyncWorker::ElementarySurface_Rotate_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbAxis3D & axis,
                         double  angle,
...
,                        iReg
    ...
    ElementarySurface_Refresh_AsyncWorker::ElementarySurface_Refresh_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ElementarySurface_Duplicate_AsyncWorker::ElementarySurface_Duplicate_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
,
                         MbRegDuplicate * iReg    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    void ElementarySurface_AddYourGabaritTo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ElementarySurface_GetUseCount_AsyncWorker::ElementarySurface_GetUseCount_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void ElementarySurface_GetUseCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ElementarySurface_AddRef_AsyncWorker::ElementarySurface_AddRef_AsyncWorker(
MbElementarySurface * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
