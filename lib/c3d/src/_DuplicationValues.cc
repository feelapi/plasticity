...
Napi::Object _DuplicationValues::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "DuplicationValues", {
...
(
    ...
    Napi::Value _DuplicationValues::GenerateTransformMatrices_async(const Napi::CallbackInfo& info) {
        ...
        _DuplicationValues_GenerateTransformMatrices_AsyncWorker* asyncWorker = new _DuplicationValues_GenerateTransformMatrices_AsyncWorker(
...
DuplicationValues * _underlying,        Napi::Promise::Deferred const &d
    ...
    void _DuplicationValues_GenerateTransformMatrices_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
