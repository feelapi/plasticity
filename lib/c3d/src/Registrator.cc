...
Napi::Value Registrator::AutoReg_async(const Napi::CallbackInfo &info)
{
    ...
    Registrator_AutoReg_AsyncWorker *asyncWorker = new Registrator_AutoReg_AsyncWorker(deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}

Registrator_AutoReg_AsyncWorker::Registrator_AutoReg_AsyncWorker(Napi::Promise::Deferred const &d) : PromiseWorker(d){};
