...
(
    ...
    Napi::Value Mutex::EnterParallelRegion_async(const Napi::CallbackInfo& info) {
        ...
        Mutex_EnterParallelRegion_AsyncWorker* asyncWorker = new Mutex_EnterParallelRegion_AsyncWorker(
            deferred
        );
        asyncWorker->Queue();
...
(
    ...
    Napi::Value Mutex::ExitParallelRegion_async(const Napi::CallbackInfo& info) {
        ...
        Mutex_ExitParallelRegion_AsyncWorker* asyncWorker = new Mutex_ExitParallelRegion_AsyncWorker(
            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
    ...
    Mutex_EnterParallelRegion_AsyncWorker::Mutex_EnterParallelRegion_AsyncWorker(
    ...
    Mutex_ExitParallelRegion_AsyncWorker::Mutex_ExitParallelRegion_AsyncWorker(
        Napi::Promise::Deferred const &d
    )
        :PromiseWorker(d){};
