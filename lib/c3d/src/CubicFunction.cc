...
Napi::Value CubicFunction::InsertValue(const Napi::CallbackInfo &info)
{
    ...
    bool _result = _underlying->InsertValue(t, newValue
...
Napi::Value CubicFunction::InsertValue_async(const Napi::CallbackInfo &info)
{
    ...
    CubicFunction_InsertValue_AsyncWorker *asyncWorker =
        new CubicFunction_InsertValue_AsyncWorker(_underlying, deferred,
...
CubicFunction_InsertValue_AsyncWorker::CubicFunction_InsertValue_AsyncWorker(MbCubicFunction *_underlying,
                                                                             Napi::Promise::Deferred const &d, double t,
                                                                             double newValue)
    : _underlying(_underlying), PromiseWorker(d), t(t), newValue(newValue){};
