...
Napi::Object NurbsBlockSolid::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "NurbsBlockSolid", {
...
(
    ...
    Napi::Value NurbsBlockSolid::IsA_async(const Napi::CallbackInfo& info) {
        ...
        NurbsBlockSolid_IsA_AsyncWorker* asyncWorker = new NurbsBlockSolid_IsA_AsyncWorker(
...
(
    ...
    Napi::Value NurbsBlockSolid::Type_async(const Napi::CallbackInfo& info) {
        ...
        NurbsBlockSolid_Type_AsyncWorker* asyncWorker = new NurbsBlockSolid_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value NurbsBlockSolid::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        NurbsBlockSolid_GetBasisPoints_AsyncWorker* asyncWorker = new NurbsBlockSolid_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value NurbsBlockSolid::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        NurbsBlockSolid_SetBasisPoints_AsyncWorker* asyncWorker = new NurbsBlockSolid_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value NurbsBlockSolid::GetBasisItems_async(const Napi::CallbackInfo& info) {
        ...
        NurbsBlockSolid_GetBasisItems_AsyncWorker* asyncWorker = new NurbsBlockSolid_GetBasisItems_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value NurbsBlockSolid::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        NurbsBlockSolid_GetCreatorsCount_AsyncWorker* asyncWorker = new NurbsBlockSolid_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value NurbsBlockSolid::GetYourNameMaker_async(const Napi::CallbackInfo& info) {
        ...
        NurbsBlockSolid_GetYourNameMaker_AsyncWorker* asyncWorker = new NurbsBlockSolid_GetYourNameMaker_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value NurbsBlockSolid::GetStatus_async(const Napi::CallbackInfo& info) {
        ...
        NurbsBlockSolid_GetStatus_AsyncWorker* asyncWorker = new NurbsBlockSolid_GetStatus_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value NurbsBlockSolid::SetStatus_async(const Napi::CallbackInfo& info) {
        ...
        NurbsBlockSolid_SetStatus_AsyncWorker* asyncWorker = new NurbsBlockSolid_SetStatus_AsyncWorker(
_underlying,            deferred
,
...
,        items
    ...
    Napi::Value NurbsBlockSolid::CreateShell_async(const Napi::CallbackInfo& info) {
        ...
        NurbsBlockSolid_CreateShell_AsyncWorker* asyncWorker = new NurbsBlockSolid_CreateShell_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value NurbsBlockSolid::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        NurbsBlockSolid_GetMainName_AsyncWorker* asyncWorker = new NurbsBlockSolid_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value NurbsBlockSolid::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        NurbsBlockSolid_GetUseCount_AsyncWorker* asyncWorker = new NurbsBlockSolid_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value NurbsBlockSolid::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        NurbsBlockSolid_AddRef_AsyncWorker* asyncWorker = new NurbsBlockSolid_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
NurbsBlockSolid::~NurbsBlockSolid() {
    ...
    NurbsBlockSolid_IsA_AsyncWorker::NurbsBlockSolid_IsA_AsyncWorker(
MbNurbsBlockSolid * _underlying,        Napi::Promise::Deferred const &d
    ...
    NurbsBlockSolid_Type_AsyncWorker::NurbsBlockSolid_Type_AsyncWorker(
MbNurbsBlockSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    NurbsBlockSolid_GetBasisPoints_AsyncWorker::NurbsBlockSolid_GetBasisPoints_AsyncWorker(
MbNurbsBlockSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void NurbsBlockSolid_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    NurbsBlockSolid_SetBasisPoints_AsyncWorker::NurbsBlockSolid_SetBasisPoints_AsyncWorker(
MbNurbsBlockSolid * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    void NurbsBlockSolid_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    NurbsBlockSolid_GetBasisItems_AsyncWorker::NurbsBlockSolid_GetBasisItems_AsyncWorker(
MbNurbsBlockSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void NurbsBlockSolid_GetBasisItems_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void NurbsBlockSolid_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbNurbsBlockSolid * _underlying,        Napi::Promise::Deferred const &d
    ...
    void NurbsBlockSolid_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    NurbsBlockSolid_GetStatus_AsyncWorker::NurbsBlockSolid_GetStatus_AsyncWorker(
MbNurbsBlockSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    NurbsBlockSolid_SetStatus_AsyncWorker::NurbsBlockSolid_SetStatus_AsyncWorker(
MbNurbsBlockSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeProcessState  l    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    NurbsBlockSolid_CreateShell_AsyncWorker::NurbsBlockSolid_CreateShell_AsyncWorker(
MbNurbsBlockSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbFaceShell * shell,
...
,                        items
    ...
    NurbsBlockSolid_GetMainName_AsyncWorker::NurbsBlockSolid_GetMainName_AsyncWorker(
MbNurbsBlockSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    NurbsBlockSolid_GetUseCount_AsyncWorker::NurbsBlockSolid_GetUseCount_AsyncWorker(
MbNurbsBlockSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    NurbsBlockSolid_AddRef_AsyncWorker::NurbsBlockSolid_AddRef_AsyncWorker(
MbNurbsBlockSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
