...
Napi::Object FaceModifiedSolid::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "FaceModifiedSolid", {
...
(
    ...
    Napi::Value FaceModifiedSolid::IsA_async(const Napi::CallbackInfo& info) {
        ...
        FaceModifiedSolid_IsA_AsyncWorker* asyncWorker = new FaceModifiedSolid_IsA_AsyncWorker(
...
(
    ...
    Napi::Value FaceModifiedSolid::Type_async(const Napi::CallbackInfo& info) {
        ...
        FaceModifiedSolid_Type_AsyncWorker* asyncWorker = new FaceModifiedSolid_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value FaceModifiedSolid::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        FaceModifiedSolid_GetBasisPoints_AsyncWorker* asyncWorker = new FaceModifiedSolid_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value FaceModifiedSolid::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        FaceModifiedSolid_SetBasisPoints_AsyncWorker* asyncWorker = new FaceModifiedSolid_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value FaceModifiedSolid::GetBasisItems_async(const Napi::CallbackInfo& info) {
        ...
        FaceModifiedSolid_GetBasisItems_AsyncWorker* asyncWorker = new FaceModifiedSolid_GetBasisItems_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value FaceModifiedSolid::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        FaceModifiedSolid_GetCreatorsCount_AsyncWorker* asyncWorker = new FaceModifiedSolid_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value FaceModifiedSolid::GetYourNameMaker_async(const Napi::CallbackInfo& info) {
        ...
        FaceModifiedSolid_GetYourNameMaker_AsyncWorker* asyncWorker = new FaceModifiedSolid_GetYourNameMaker_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value FaceModifiedSolid::GetStatus_async(const Napi::CallbackInfo& info) {
        ...
        FaceModifiedSolid_GetStatus_AsyncWorker* asyncWorker = new FaceModifiedSolid_GetStatus_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value FaceModifiedSolid::SetStatus_async(const Napi::CallbackInfo& info) {
        ...
        FaceModifiedSolid_SetStatus_AsyncWorker* asyncWorker = new FaceModifiedSolid_SetStatus_AsyncWorker(
_underlying,            deferred
,
...
,        items
    ...
    Napi::Value FaceModifiedSolid::CreateShell_async(const Napi::CallbackInfo& info) {
        ...
        FaceModifiedSolid_CreateShell_AsyncWorker* asyncWorker = new FaceModifiedSolid_CreateShell_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value FaceModifiedSolid::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        FaceModifiedSolid_GetMainName_AsyncWorker* asyncWorker = new FaceModifiedSolid_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value FaceModifiedSolid::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        FaceModifiedSolid_GetUseCount_AsyncWorker* asyncWorker = new FaceModifiedSolid_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value FaceModifiedSolid::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        FaceModifiedSolid_AddRef_AsyncWorker* asyncWorker = new FaceModifiedSolid_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
FaceModifiedSolid::~FaceModifiedSolid() {
    ...
    FaceModifiedSolid_IsA_AsyncWorker::FaceModifiedSolid_IsA_AsyncWorker(
MbFaceModifiedSolid * _underlying,        Napi::Promise::Deferred const &d
    ...
    FaceModifiedSolid_Type_AsyncWorker::FaceModifiedSolid_Type_AsyncWorker(
MbFaceModifiedSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
...
MbFaceModifiedSolid * _underlying,        Napi::Promise::Deferred const &d
    ...
    void FaceModifiedSolid_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void FaceModifiedSolid_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbFaceModifiedSolid * _underlying,        Napi::Promise::Deferred const &d
    ...
    void FaceModifiedSolid_GetBasisItems_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void FaceModifiedSolid_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbFaceModifiedSolid * _underlying,        Napi::Promise::Deferred const &d
    ...
    void FaceModifiedSolid_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    FaceModifiedSolid_GetStatus_AsyncWorker::FaceModifiedSolid_GetStatus_AsyncWorker(
MbFaceModifiedSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    FaceModifiedSolid_SetStatus_AsyncWorker::FaceModifiedSolid_SetStatus_AsyncWorker(
MbFaceModifiedSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeProcessState  l    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    FaceModifiedSolid_CreateShell_AsyncWorker::FaceModifiedSolid_CreateShell_AsyncWorker(
MbFaceModifiedSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbFaceShell * shell,
...
,                        items
    ...
    void FaceModifiedSolid_CreateShell_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    FaceModifiedSolid_GetMainName_AsyncWorker::FaceModifiedSolid_GetMainName_AsyncWorker(
MbFaceModifiedSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void FaceModifiedSolid_GetMainName_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    FaceModifiedSolid_GetUseCount_AsyncWorker::FaceModifiedSolid_GetUseCount_AsyncWorker(
MbFaceModifiedSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void FaceModifiedSolid_GetUseCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    FaceModifiedSolid_AddRef_AsyncWorker::FaceModifiedSolid_AddRef_AsyncWorker(
MbFaceModifiedSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
