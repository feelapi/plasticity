...
Napi::Value ControlData3D::Count_async(const Napi::CallbackInfo &info)
{
    ...
    ControlData3D_Count_AsyncWorker *asyncWorker = new ControlData3D_Count_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value ControlData3D::GetPoint(const Napi::CallbackInfo &info)
{
    ...
    bool _result = _underlying->GetPoint(i, *p
...
Napi::Value ControlData3D::GetPoint_async(const Napi::CallbackInfo &info)
{
    ...
    ControlData3D_GetPoint_AsyncWorker *asyncWorker = new ControlData3D_GetPoint_AsyncWorker(_underlying, deferred,
...
Napi::Value ControlData3D::SetPoint(const Napi::CallbackInfo &info)
{
    ...
    bool _result = _underlying->SetPoint(i, p
...
Napi::Value ControlData3D::SetPoint_async(const Napi::CallbackInfo &info)
{
    ...
    ControlData3D_SetPoint_AsyncWorker *asyncWorker = new ControlData3D_SetPoint_AsyncWorker(_underlying, deferred,
...
Napi::Value ControlData3D::TotalCount_async(const Napi::CallbackInfo &info)
{
    ...
    ControlData3D_TotalCount_AsyncWorker *asyncWorker = new ControlData3D_TotalCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ControlData3D::ShareCount_async(const Napi::CallbackInfo &info)
{
    ...
    ControlData3D_ShareCount_AsyncWorker *asyncWorker = new ControlData3D_ShareCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ControlData3D::ResetIndex_async(const Napi::CallbackInfo &info)
{
    ...
    ControlData3D_ResetIndex_AsyncWorker *asyncWorker = new ControlData3D_ResetIndex_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
ControlData3D_Count_AsyncWorker::ControlData3D_Count_AsyncWorker(MbControlData3D *_underlying,
...
ControlData3D_GetPoint_AsyncWorker::ControlData3D_GetPoint_AsyncWorker(MbControlData3D *_underlying,
...
ControlData3D_SetPoint_AsyncWorker::ControlData3D_SetPoint_AsyncWorker(MbControlData3D *_underlying,
                                                                       Napi::Promise::Deferred const &d, size_t i,
                                                                       MbCartPoint3D &p)
    : _underlying(_underlying), PromiseWorker(d), i(i), p(p){};
...
ControlData3D_TotalCount_AsyncWorker::ControlData3D_TotalCount_AsyncWorker(MbControlData3D *_underlying,
                                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ControlData3D_ShareCount_AsyncWorker::ControlData3D_ShareCount_AsyncWorker(MbControlData3D *_underlying,
                                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ControlData3D_ResetIndex_AsyncWorker::ControlData3D_ResetIndex_AsyncWorker(MbControlData3D *_underlying,
                                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
