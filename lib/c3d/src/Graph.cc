...
(
    ...
    Napi::Value Graph::GetLoopsCount_async(const Napi::CallbackInfo& info) {
        ...
        Graph_GetLoopsCount_AsyncWorker* asyncWorker = new Graph_GetLoopsCount_AsyncWorker(
...
if (!(info[0].IsNull() || info[0].IsUndefined())) {
    ...
    for (size_t i = 0; i < curveList_.Length(); i++) {
        ...
        Graph_GetUsedCurves_AsyncWorker* asyncWorker = new Graph_GetUsedCurves_AsyncWorker(
_underlying,            deferred
,
                                *curveList                        );
        asyncWorker->Queue();
    ...
    Graph_GetLoopsCount_AsyncWorker::Graph_GetLoopsCount_AsyncWorker(
MpGraph * _underlying,        Napi::Promise::Deferred const &d
    ...
    Graph_GetUsedCurves_AsyncWorker::Graph_GetUsedCurves_AsyncWorker(
MpGraph * _underlying,        Napi::Promise::Deferred const &d
,
