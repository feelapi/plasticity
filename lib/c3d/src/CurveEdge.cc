...
Napi::Value CurveEdge::EdgeNormal(const Napi::CallbackInfo &info)
{
    ...
    bool _result = _underlying->EdgeNormal(t, *p
...
Napi::Value CurveEdge::EdgeNormal_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_EdgeNormal_AsyncWorker *asyncWorker = new CurveEdge_EdgeNormal_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEdge::GetIntersectionCurve_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetIntersectionCurve_AsyncWorker *asyncWorker =
        new CurveEdge_GetIntersectionCurve_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::GetFacePlus_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetFacePlus_AsyncWorker *asyncWorker = new CurveEdge_GetFacePlus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::GetFaceMinus_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetFaceMinus_AsyncWorker *asyncWorker = new CurveEdge_GetFaceMinus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
Napi::Value CurveEdge::IsSplit(const Napi::CallbackInfo &info)
{
    ...
    bool _result = _underlying->IsSplit(info.Length() == 0 || info[0].IsNull() ? false : strict
...
Napi::Value CurveEdge::IsSplit_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_IsSplit_AsyncWorker *asyncWorker = new CurveEdge_IsSplit_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEdge::GetSpaceCurve_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetSpaceCurve_AsyncWorker *asyncWorker = new CurveEdge_GetSpaceCurve_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::MakeCurve_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_MakeCurve_AsyncWorker *asyncWorker = new CurveEdge_MakeCurve_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::IsSmooth_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_IsSmooth_AsyncWorker *asyncWorker = new CurveEdge_IsSmooth_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::IsSeam_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_IsSeam_AsyncWorker *asyncWorker = new CurveEdge_IsSeam_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::IsPole_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_IsPole_AsyncWorker *asyncWorker = new CurveEdge_IsPole_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
Napi::Value CurveEdge::FaceNormal(const Napi::CallbackInfo &info)
{
    ...
    bool _result = _underlying->FaceNormal(t, *n, plus
...
Napi::Value CurveEdge::FaceNormal_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_FaceNormal_AsyncWorker *asyncWorker = new CurveEdge_FaceNormal_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEdge::VertexNormal(const Napi::CallbackInfo &info)
{
    ...
    bool _result = _underlying->VertexNormal(begin, *normal
...
Napi::Value CurveEdge::VertexNormal_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_VertexNormal_AsyncWorker *asyncWorker = new CurveEdge_VertexNormal_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEdge::GetProlongEdges(const Napi::CallbackInfo &info)
{
    ...
    bool _result = _underlying->GetProlongEdges(*edges
...
Napi::Value CurveEdge::GetProlongEdges_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetProlongEdges_AsyncWorker *asyncWorker =
        new CurveEdge_GetProlongEdges_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
Napi::Value CurveEdge::FindOrientedEdge(const Napi::CallbackInfo &info)
{
    ...
    bool success = _underlying->FindOrientedEdge(orient, face, findLoop, index
...
Napi::Value CurveEdge::FindOrientedEdge_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_FindOrientedEdge_AsyncWorker *asyncWorker =
        new CurveEdge_FindOrientedEdge_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEdge::FindOrientedEdgePlus(const Napi::CallbackInfo &info)
{
    ...
    bool success = _underlying->FindOrientedEdgePlus(loopIndex, findLoop, index
...
Napi::Value CurveEdge::FindOrientedEdgePlus_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_FindOrientedEdgePlus_AsyncWorker *asyncWorker =
        new CurveEdge_FindOrientedEdgePlus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
Napi::Value CurveEdge::FindOrientedEdgeMinus(const Napi::CallbackInfo &info)
{
    ...
    bool success = _underlying->FindOrientedEdgeMinus(loopIndex, findLoop, index
...
Napi::Value CurveEdge::FindOrientedEdgeMinus_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_FindOrientedEdgeMinus_AsyncWorker *asyncWorker =
        new CurveEdge_FindOrientedEdgeMinus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::Point_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_Point_AsyncWorker *asyncWorker = new CurveEdge_Point_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEdge::GetBegPoint_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetBegPoint_AsyncWorker *asyncWorker = new CurveEdge_GetBegPoint_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::GetEndPoint_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetEndPoint_AsyncWorker *asyncWorker = new CurveEdge_GetEndPoint_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
Napi::Value CurveEdge::PointProjection(const Napi::CallbackInfo &info)
{
    ...
    double _result = _underlying->PointProjection(p
...
Napi::Value CurveEdge::PointProjection_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_PointProjection_AsyncWorker *asyncWorker =
        new CurveEdge_PointProjection_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEdge::Reverse_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_Reverse_AsyncWorker *asyncWorker = new CurveEdge_Reverse_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::Tangent_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_Tangent_AsyncWorker *asyncWorker = new CurveEdge_Tangent_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEdge::GetBegTangent_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetBegTangent_AsyncWorker *asyncWorker = new CurveEdge_GetBegTangent_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::GetEndTangent_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetEndTangent_AsyncWorker *asyncWorker = new CurveEdge_GetEndTangent_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_IsA_AsyncWorker *asyncWorker = new CurveEdge_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::GetName_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetName_AsyncWorker *asyncWorker = new CurveEdge_GetName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetMainName_AsyncWorker *asyncWorker = new CurveEdge_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::GetFirstName_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetFirstName_AsyncWorker *asyncWorker = new CurveEdge_GetFirstName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::GetNameHash_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetNameHash_AsyncWorker *asyncWorker = new CurveEdge_GetNameHash_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::AddYourGabaritTo_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_AddYourGabaritTo_AsyncWorker *asyncWorker =
        new CurveEdge_AddYourGabaritTo_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEdge::CalculateMesh_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_CalculateMesh_AsyncWorker *asyncWorker = new CurveEdge_CalculateMesh_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEdge::GetOwnChanged_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetOwnChanged_AsyncWorker *asyncWorker = new CurveEdge_GetOwnChanged_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetUseCount_AsyncWorker *asyncWorker = new CurveEdge_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_AddRef_AsyncWorker *asyncWorker = new CurveEdge_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::SetStyle_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_SetStyle_AsyncWorker *asyncWorker = new CurveEdge_SetStyle_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEdge::GetStyle_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetStyle_AsyncWorker *asyncWorker = new CurveEdge_GetStyle_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::SetColor_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_SetColor_AsyncWorker *asyncWorker = new CurveEdge_SetColor_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveEdge::GetColor_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_GetColor_AsyncWorker *asyncWorker = new CurveEdge_GetColor_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveEdge::AttributesConvert_async(const Napi::CallbackInfo &info)
{
    ...
    CurveEdge_AttributesConvert_AsyncWorker *asyncWorker =
        new CurveEdge_AttributesConvert_AsyncWorker(_underlying, deferred,
...
CurveEdge_EdgeNormal_AsyncWorker::CurveEdge_EdgeNormal_AsyncWorker(MbCurveEdge *_underlying,
...
CurveEdge_GetIntersectionCurve_AsyncWorker::CurveEdge_GetIntersectionCurve_AsyncWorker(MbCurveEdge *_underlying,
...
void CurveEdge_GetIntersectionCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
CurveEdge_GetFacePlus_AsyncWorker::CurveEdge_GetFacePlus_AsyncWorker(MbCurveEdge *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_GetFaceMinus_AsyncWorker::CurveEdge_GetFaceMinus_AsyncWorker(MbCurveEdge *_underlying,
                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_IsSplit_AsyncWorker::CurveEdge_IsSplit_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d,
                                                             bool strict)
    : _underlying(_underlying), PromiseWorker(d), strict(strict){};

void CurveEdge_IsSplit_AsyncWorker::Execute()
{
    EnterParallelRegion();

    bool _result = _underlying->IsSplit(strict);
...
CurveEdge_GetSpaceCurve_AsyncWorker::CurveEdge_GetSpaceCurve_AsyncWorker(MbCurveEdge *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_MakeCurve_AsyncWorker::CurveEdge_MakeCurve_AsyncWorker(MbCurveEdge *_underlying,
                                                                 Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_IsSmooth_AsyncWorker::CurveEdge_IsSmooth_AsyncWorker(MbCurveEdge *_underlying,
                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_IsSeam_AsyncWorker::CurveEdge_IsSeam_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_IsPole_AsyncWorker::CurveEdge_IsPole_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_FaceNormal_AsyncWorker::CurveEdge_FaceNormal_AsyncWorker(MbCurveEdge *_underlying,
                                                                   Napi::Promise::Deferred const &d, double t,
                                                                   bool plus)
    : _underlying(_underlying), PromiseWorker(d), t(t), plus(plus){};
...
CurveEdge_VertexNormal_AsyncWorker::CurveEdge_VertexNormal_AsyncWorker(MbCurveEdge *_underlying,
                                                                       Napi::Promise::Deferred const &d, bool begin)
    : _underlying(_underlying), PromiseWorker(d), begin(begin){};
...
CurveEdge_GetProlongEdges_AsyncWorker::CurveEdge_GetProlongEdges_AsyncWorker(MbCurveEdge *_underlying,
                                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_FindOrientedEdge_AsyncWorker::CurveEdge_FindOrientedEdge_AsyncWorker(MbCurveEdge *_underlying,
                                                                               Napi::Promise::Deferred const &d,
                                                                               bool orient)
    : _underlying(_underlying), PromiseWorker(d), orient(orient){};
...
CurveEdge_FindOrientedEdgePlus_AsyncWorker::CurveEdge_FindOrientedEdgePlus_AsyncWorker(MbCurveEdge *_underlying,
                                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void CurveEdge_FindOrientedEdgePlus_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                        Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void CurveEdge_FindOrientedEdgeMinus_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                         Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
CurveEdge_Point_AsyncWorker::CurveEdge_Point_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d,
                                                         double t)
    : _underlying(_underlying), PromiseWorker(d), t(t){};
...
CurveEdge_GetBegPoint_AsyncWorker::CurveEdge_GetBegPoint_AsyncWorker(MbCurveEdge *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_GetEndPoint_AsyncWorker::CurveEdge_GetEndPoint_AsyncWorker(MbCurveEdge *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_PointProjection_AsyncWorker::CurveEdge_PointProjection_AsyncWorker(MbCurveEdge *_underlying,
                                                                             Napi::Promise::Deferred const &d,
...
CurveEdge_Reverse_AsyncWorker::CurveEdge_Reverse_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_Tangent_AsyncWorker::CurveEdge_Tangent_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d,
                                                             double t)
    : _underlying(_underlying), PromiseWorker(d), t(t){};
...
CurveEdge_GetBegTangent_AsyncWorker::CurveEdge_GetBegTangent_AsyncWorker(MbCurveEdge *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_GetEndTangent_AsyncWorker::CurveEdge_GetEndTangent_AsyncWorker(MbCurveEdge *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_IsA_AsyncWorker::CurveEdge_IsA_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_GetName_AsyncWorker::CurveEdge_GetName_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_GetMainName_AsyncWorker::CurveEdge_GetMainName_AsyncWorker(MbCurveEdge *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_GetFirstName_AsyncWorker::CurveEdge_GetFirstName_AsyncWorker(MbCurveEdge *_underlying,
                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_GetNameHash_AsyncWorker::CurveEdge_GetNameHash_AsyncWorker(MbCurveEdge *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_AddYourGabaritTo_AsyncWorker::CurveEdge_AddYourGabaritTo_AsyncWorker(MbCurveEdge *_underlying,
                                                                               Napi::Promise::Deferred const &d,
                                                                               MbCube &cube)
...
CurveEdge_CalculateMesh_AsyncWorker::CurveEdge_CalculateMesh_AsyncWorker(MbCurveEdge *_underlying,
                                                                         Napi::Promise::Deferred const &d,
...
CurveEdge_GetOwnChanged_AsyncWorker::CurveEdge_GetOwnChanged_AsyncWorker(MbCurveEdge *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_GetUseCount_AsyncWorker::CurveEdge_GetUseCount_AsyncWorker(MbCurveEdge *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_AddRef_AsyncWorker::CurveEdge_AddRef_AsyncWorker(MbCurveEdge *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_SetStyle_AsyncWorker::CurveEdge_SetStyle_AsyncWorker(MbCurveEdge *_underlying,
...
CurveEdge_GetStyle_AsyncWorker::CurveEdge_GetStyle_AsyncWorker(MbCurveEdge *_underlying,
                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_SetColor_AsyncWorker::CurveEdge_SetColor_AsyncWorker(MbCurveEdge *_underlying,
...
CurveEdge_GetColor_AsyncWorker::CurveEdge_GetColor_AsyncWorker(MbCurveEdge *_underlying,
                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
CurveEdge_AttributesConvert_AsyncWorker::CurveEdge_AttributesConvert_AsyncWorker(MbCurveEdge *_underlying,
                                                                                 Napi::Promise::Deferred const &d,
                                                                                 MbGrid &other)
