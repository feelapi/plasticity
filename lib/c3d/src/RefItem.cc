...
Napi::Value RefItem::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    RefItem_GetUseCount_AsyncWorker *asyncWorker = new RefItem_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value RefItem::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    RefItem_AddRef_AsyncWorker *asyncWorker = new RefItem_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
RefItem_GetUseCount_AsyncWorker::RefItem_GetUseCount_AsyncWorker(MbRefItem *_underlying,
...
RefItem_AddRef_AsyncWorker::RefItem_AddRef_AsyncWorker(MbRefItem *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
