...
Napi::Object MeshGrid::Init(Napi::Env env, Napi::Object exports) {
 ...
 bool  intersected = ::LineGridIntersect
(
        grid
,        line
,        *crossPoint
,        tRes
    ...
    Napi::Value MeshGrid::LineGridIntersect_async(const Napi::CallbackInfo& info) {
        ...
        MeshGrid_LineGridIntersect_AsyncWorker* asyncWorker = new MeshGrid_LineGridIntersect_AsyncWorker(
            deferred
,
    ...
    MeshGrid_LineGridIntersect_AsyncWorker::MeshGrid_LineGridIntersect_AsyncWorker(
