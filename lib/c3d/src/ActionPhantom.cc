...
Napi::Value ActionPhantom::SmoothPhantom(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result = ::SmoothPhantom(solid, edges, params, *result
...
Napi::Value ActionPhantom::SmoothPhantom_async(const Napi::CallbackInfo &info)
{
    ...
    ActionPhantom_SmoothPhantom_AsyncWorker *asyncWorker = new ActionPhantom_SmoothPhantom_AsyncWorker(deferred,
...
Napi::Value ActionPhantom::SmoothSequence(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result = ::SmoothSequence(solid, edges, params, createSurfaces, *sequences, *result
...
Napi::Value ActionPhantom::SmoothSequence_async(const Napi::CallbackInfo &info)
{
    ...
    ActionPhantom_SmoothSequence_AsyncWorker *asyncWorker =
        new ActionPhantom_SmoothSequence_AsyncWorker(deferred,
...
ActionPhantom_SmoothPhantom_AsyncWorker::ActionPhantom_SmoothPhantom_AsyncWorker(Napi::Promise::Deferred const &d,
                                                                                 MbSolid &solid,
                                                                                 SArray<MbEdgeFunction> &edges,
                                                                                 const SmoothValues &params)
    : PromiseWorker(d), solid(solid), edges(edges), params(params){};
...
ActionPhantom_SmoothSequence_AsyncWorker::ActionPhantom_SmoothSequence_AsyncWorker(Napi::Promise::Deferred const &d,
                                                                                   const MbSolid &solid,
                                                                                   RPArray<MbCurveEdge> &edges,
                                                                                   const SmoothValues &params,
                                                                                   bool createSurfaces)
    : PromiseWorker(d), solid(solid), edges(edges), params(params), createSurfaces(createSurfaces){};
