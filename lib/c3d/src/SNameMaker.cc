...
(
    ...
    Napi::Value SNameMaker::Add_async(const Napi::CallbackInfo& info) {
        ...
        SNameMaker_Add_AsyncWorker* asyncWorker = new SNameMaker_Add_AsyncWorker(
...
(
    ...
    Napi::Value SNameMaker::IsChild_async(const Napi::CallbackInfo& info) {
        ...
        SNameMaker_IsChild_AsyncWorker* asyncWorker = new SNameMaker_IsChild_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value SNameMaker::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        SNameMaker_GetMainName_AsyncWorker* asyncWorker = new SNameMaker_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SNameMaker::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        SNameMaker_GetUseCount_AsyncWorker* asyncWorker = new SNameMaker_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value SNameMaker::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        SNameMaker_AddRef_AsyncWorker* asyncWorker = new SNameMaker_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
SNameMaker::~SNameMaker() {
    ...
    SNameMaker_Add_AsyncWorker::SNameMaker_Add_AsyncWorker(
...
{};
    ...
    SNameMaker_IsChild_AsyncWorker::SNameMaker_IsChild_AsyncWorker(
MbSNameMaker * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    SNameMaker_GetMainName_AsyncWorker::SNameMaker_GetMainName_AsyncWorker(
MbSNameMaker * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SNameMaker_GetUseCount_AsyncWorker::SNameMaker_GetUseCount_AsyncWorker(
MbSNameMaker * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    SNameMaker_AddRef_AsyncWorker::SNameMaker_AddRef_AsyncWorker(
MbSNameMaker * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
