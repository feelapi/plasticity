...
FormNote::FormNote(const Napi::CallbackInfo &info) : Napi::ObjectWrap<FormNote>(info)
{
    ...
    if (info.Length() == 1 && info[0].IsString() && info[0].ToString().Utf8Value() == "__skip_js_init__")
        return;
    if (info.Length() == 5 && ((info[0].IsBoolean())) && ((info[1].IsBoolean())) && ((info[2].IsBoolean())) &&
        ((info[3].IsBoolean())) && ((info[4].IsBoolean()))
...
Napi::Value FormNote::Wire_async(const Napi::CallbackInfo &info)
{
    ...
    FormNote_Wire_AsyncWorker *asyncWorker = new FormNote_Wire_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value FormNote::Grid_async(const Napi::CallbackInfo &info)
{
    ...
    FormNote_Grid_AsyncWorker *asyncWorker = new FormNote_Grid_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value FormNote::Seam_async(const Napi::CallbackInfo &info)
{
    ...
    FormNote_Seam_AsyncWorker *asyncWorker = new FormNote_Seam_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value FormNote::Quad_async(const Napi::CallbackInfo &info)
{
    ...
    FormNote_Quad_AsyncWorker *asyncWorker = new FormNote_Quad_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value FormNote::Fair_async(const Napi::CallbackInfo &info)
{
    ...
    FormNote_Fair_AsyncWorker *asyncWorker = new FormNote_Fair_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
FormNote_Wire_AsyncWorker::FormNote_Wire_AsyncWorker(MbFormNote *_underlying, Napi::Promise::Deferred const &d)
...
FormNote_Grid_AsyncWorker::FormNote_Grid_AsyncWorker(MbFormNote *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
FormNote_Seam_AsyncWorker::FormNote_Seam_AsyncWorker(MbFormNote *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
FormNote_Quad_AsyncWorker::FormNote_Quad_AsyncWorker(MbFormNote *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
FormNote_Fair_AsyncWorker::FormNote_Fair_AsyncWorker(MbFormNote *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
