...
Napi::Value ContourWithBreaks::InitClosed_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_InitClosed_AsyncWorker *asyncWorker =
        new ContourWithBreaks_InitClosed_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::CheckClosed(const Napi::CallbackInfo &info)
{
    ...
    _underlying->CheckClosed(closedEps
...
Napi::Value ContourWithBreaks::CheckClosed_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_CheckClosed_AsyncWorker *asyncWorker =
        new ContourWithBreaks_CheckClosed_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::GetArea(const Napi::CallbackInfo &info)
{
    ...
    double _result = _underlying->GetArea(info.Length() == 0 || info[0].IsNull() ? 1 : sag
...
Napi::Value ContourWithBreaks::GetArea_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_GetArea_AsyncWorker *asyncWorker =
        new ContourWithBreaks_GetArea_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::GetSegmentsCount_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_GetSegmentsCount_AsyncWorker *asyncWorker =
        new ContourWithBreaks_GetSegmentsCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
Napi::Value ContourWithBreaks::GetSegment(const Napi::CallbackInfo &info)
{
    ...
    const MbCurve *_result = _underlying->GetSegment(i
...
Napi::Value ContourWithBreaks::GetSegment_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_GetSegment_AsyncWorker *asyncWorker =
        new ContourWithBreaks_GetSegment_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::AddCurveWithRuledCheck(const Napi::CallbackInfo &info)
{
    ...
    bool _result = _underlying->AddCurveWithRuledCheck(
        newCur, absEps, info.Length() == 2 || info[2].IsNull() ? false : toEndOnly,
...
Napi::Value ContourWithBreaks::AddCurveWithRuledCheck_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_AddCurveWithRuledCheck_AsyncWorker *asyncWorker =
        new ContourWithBreaks_AddCurveWithRuledCheck_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::GetCornerParams(const Napi::CallbackInfo &info)
{
    ...
    _underlying->GetCornerParams(*params
...
Napi::Value ContourWithBreaks::GetCornerParams_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_GetCornerParams_AsyncWorker *asyncWorker =
        new ContourWithBreaks_GetCornerParams_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ContourWithBreaks::Inverse_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_Inverse_AsyncWorker *asyncWorker =
        new ContourWithBreaks_Inverse_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::Trimmed_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_Trimmed_AsyncWorker *asyncWorker =
        new ContourWithBreaks_Trimmed_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::IsStraight_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_IsStraight_AsyncWorker *asyncWorker =
        new ContourWithBreaks_IsStraight_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::IsClosed_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_IsClosed_AsyncWorker *asyncWorker =
        new ContourWithBreaks_IsClosed_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ContourWithBreaks::IsBounded_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_IsBounded_AsyncWorker *asyncWorker =
        new ContourWithBreaks_IsBounded_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ContourWithBreaks::GetTMax_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_GetTMax_AsyncWorker *asyncWorker =
        new ContourWithBreaks_GetTMax_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ContourWithBreaks::GetTMin_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_GetTMin_AsyncWorker *asyncWorker =
        new ContourWithBreaks_GetTMin_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ContourWithBreaks::GetPeriod_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_GetPeriod_AsyncWorker *asyncWorker =
        new ContourWithBreaks_GetPeriod_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ContourWithBreaks::GetWeightCentre_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_GetWeightCentre_AsyncWorker *asyncWorker =
        new ContourWithBreaks_GetWeightCentre_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ContourWithBreaks::GetLimitPoint_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_GetLimitPoint_AsyncWorker *asyncWorker =
        new ContourWithBreaks_GetLimitPoint_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::PointOn_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_PointOn_AsyncWorker *asyncWorker =
        new ContourWithBreaks_PointOn_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::_PointOn_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks__PointOn_AsyncWorker *asyncWorker =
        new ContourWithBreaks__PointOn_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::Explore_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_Explore_AsyncWorker *asyncWorker =
        new ContourWithBreaks_Explore_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::FirstDer_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_FirstDer_AsyncWorker *asyncWorker =
        new ContourWithBreaks_FirstDer_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::_FirstDer_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks__FirstDer_AsyncWorker *asyncWorker =
        new ContourWithBreaks__FirstDer_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::SecondDer_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_SecondDer_AsyncWorker *asyncWorker =
        new ContourWithBreaks_SecondDer_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::_SecondDer_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks__SecondDer_AsyncWorker *asyncWorker =
        new ContourWithBreaks__SecondDer_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::Tangent_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_Tangent_AsyncWorker *asyncWorker =
        new ContourWithBreaks_Tangent_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::_Tangent_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks__Tangent_AsyncWorker *asyncWorker =
        new ContourWithBreaks__Tangent_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::Normal_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_Normal_AsyncWorker *asyncWorker = new ContourWithBreaks_Normal_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::_Normal_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks__Normal_AsyncWorker *asyncWorker =
        new ContourWithBreaks__Normal_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::PointRelative_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_PointRelative_AsyncWorker *asyncWorker =
        new ContourWithBreaks_PointRelative_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::PointLocation_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_PointLocation_AsyncWorker *asyncWorker =
        new ContourWithBreaks_PointLocation_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_IsA_AsyncWorker *asyncWorker = new ContourWithBreaks_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ContourWithBreaks::Type_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_Type_AsyncWorker *asyncWorker = new ContourWithBreaks_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ContourWithBreaks::Family_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_Family_AsyncWorker *asyncWorker = new ContourWithBreaks_Family_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ContourWithBreaks::Move_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_Move_AsyncWorker *asyncWorker = new ContourWithBreaks_Move_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::Transform_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_Transform_AsyncWorker *asyncWorker =
        new ContourWithBreaks_Transform_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::Duplicate_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_Duplicate_AsyncWorker *asyncWorker =
        new ContourWithBreaks_Duplicate_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::AddYourGabaritTo_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_AddYourGabaritTo_AsyncWorker *asyncWorker =
        new ContourWithBreaks_AddYourGabaritTo_AsyncWorker(_underlying, deferred,
...
Napi::Value ContourWithBreaks::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_GetUseCount_AsyncWorker *asyncWorker =
        new ContourWithBreaks_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ContourWithBreaks::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    ContourWithBreaks_AddRef_AsyncWorker *asyncWorker = new ContourWithBreaks_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
ContourWithBreaks_InitClosed_AsyncWorker::ContourWithBreaks_InitClosed_AsyncWorker(MbContourWithBreaks *_underlying,
...
ContourWithBreaks_CheckClosed_AsyncWorker::ContourWithBreaks_CheckClosed_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                                     Napi::Promise::Deferred const &d,
                                                                                     double closedEps)
    : _underlying(_underlying), PromiseWorker(d), closedEps(closedEps){};
...
void ContourWithBreaks_CheckClosed_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
ContourWithBreaks_GetArea_AsyncWorker::ContourWithBreaks_GetArea_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                             Napi::Promise::Deferred const &d,
                                                                             double sag)
    : _underlying(_underlying), PromiseWorker(d), sag(sag){};

void ContourWithBreaks_GetArea_AsyncWorker::Execute()
{
    EnterParallelRegion();

    double _result = _underlying->GetArea(sag);
...
void ContourWithBreaks_GetSegmentsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                            Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ContourWithBreaks_GetSegment_AsyncWorker::ContourWithBreaks_GetSegment_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                                   Napi::Promise::Deferred const &d,
                                                                                   size_t i)
...
ContourWithBreaks_AddCurveWithRuledCheck_AsyncWorker::ContourWithBreaks_AddCurveWithRuledCheck_AsyncWorker(
    MbContourWithBreaks *_underlying, Napi::Promise::Deferred const &d, MbCurve &newCur, double absEps, bool toEndOnly,
    bool checkSame, VERSION version)
    : _underlying(_underlying), PromiseWorker(d), newCur(newCur), absEps(absEps), toEndOnly(toEndOnly),
...
void ContourWithBreaks_AddCurveWithRuledCheck_AsyncWorker::Execute()
{
    ...
    bool _result = _underlying->AddCurveWithRuledCheck(newCur, absEps, toEndOnly, checkSame, version);
...
void ContourWithBreaks_AddCurveWithRuledCheck_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                                  Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void ContourWithBreaks_GetCornerParams_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                           Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ContourWithBreaks_Inverse_AsyncWorker::ContourWithBreaks_Inverse_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                             Napi::Promise::Deferred const &d,
                                                                             MbRegTransform *iReg)
...
ContourWithBreaks_Trimmed_AsyncWorker::ContourWithBreaks_Trimmed_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                             Napi::Promise::Deferred const &d,
...
ContourWithBreaks_IsStraight_AsyncWorker::ContourWithBreaks_IsStraight_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                                   Napi::Promise::Deferred const &d,
                                                                                   bool ignoreParams)
...
ContourWithBreaks_IsClosed_AsyncWorker::ContourWithBreaks_IsClosed_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ContourWithBreaks_IsBounded_AsyncWorker::ContourWithBreaks_IsBounded_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                                 Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ContourWithBreaks_GetTMax_AsyncWorker::ContourWithBreaks_GetTMax_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ContourWithBreaks_GetTMin_AsyncWorker::ContourWithBreaks_GetTMin_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ContourWithBreaks_GetPeriod_AsyncWorker::ContourWithBreaks_GetPeriod_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                                 Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void ContourWithBreaks_GetWeightCentre_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                           Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ContourWithBreaks_GetLimitPoint_AsyncWorker::ContourWithBreaks_GetLimitPoint_AsyncWorker(
    MbContourWithBreaks *_underlying, Napi::Promise::Deferred const &d, ptrdiff_t number)
...
void ContourWithBreaks_GetLimitPoint_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                         Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ContourWithBreaks_PointOn_AsyncWorker::ContourWithBreaks_PointOn_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                             Napi::Promise::Deferred const &d,
                                                                             double &t)
...
ContourWithBreaks__PointOn_AsyncWorker::ContourWithBreaks__PointOn_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                               Napi::Promise::Deferred const &d,
                                                                               double &t)
    : _underlying(_underlying), PromiseWorker(d), t(t){};
...
ContourWithBreaks_Explore_AsyncWorker::ContourWithBreaks_Explore_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                             Napi::Promise::Deferred const &d,
                                                                             double &t, bool ext)
...
ContourWithBreaks_FirstDer_AsyncWorker::ContourWithBreaks_FirstDer_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                               Napi::Promise::Deferred const &d,
                                                                               double &t)
    : _underlying(_underlying), PromiseWorker(d), t(t){};
...
ContourWithBreaks__FirstDer_AsyncWorker::ContourWithBreaks__FirstDer_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                                 Napi::Promise::Deferred const &d,
                                                                                 double &t)
    : _underlying(_underlying), PromiseWorker(d), t(t){};
...
ContourWithBreaks_SecondDer_AsyncWorker::ContourWithBreaks_SecondDer_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                                 Napi::Promise::Deferred const &d,
                                                                                 double &t)
    : _underlying(_underlying), PromiseWorker(d), t(t){};
...
ContourWithBreaks__SecondDer_AsyncWorker::ContourWithBreaks__SecondDer_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                                   Napi::Promise::Deferred const &d,
                                                                                   double &t)
    : _underlying(_underlying), PromiseWorker(d), t(t){};
...
ContourWithBreaks_Tangent_AsyncWorker::ContourWithBreaks_Tangent_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                             Napi::Promise::Deferred const &d,
                                                                             double &t)
    : _underlying(_underlying), PromiseWorker(d), t(t){};
...
ContourWithBreaks__Tangent_AsyncWorker::ContourWithBreaks__Tangent_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                               Napi::Promise::Deferred const &d,
                                                                               double &t)
    : _underlying(_underlying), PromiseWorker(d), t(t){};
...
ContourWithBreaks_Normal_AsyncWorker::ContourWithBreaks_Normal_AsyncWorker(MbContourWithBreaks *_underlying,
...
ContourWithBreaks__Normal_AsyncWorker::ContourWithBreaks__Normal_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                             Napi::Promise::Deferred const &d,
                                                                             double &t)
    : _underlying(_underlying), PromiseWorker(d), t(t){};
...
ContourWithBreaks_PointRelative_AsyncWorker::ContourWithBreaks_PointRelative_AsyncWorker(
    MbContourWithBreaks *_underlying, Napi::Promise::Deferred const &d, const MbCartPoint &pnt, double eps)
...
void ContourWithBreaks_PointRelative_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                         Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void ContourWithBreaks_PointLocation_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                         Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ContourWithBreaks_IsA_AsyncWorker::ContourWithBreaks_IsA_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ContourWithBreaks_Type_AsyncWorker::ContourWithBreaks_Type_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ContourWithBreaks_Family_AsyncWorker::ContourWithBreaks_Family_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ContourWithBreaks_Move_AsyncWorker::ContourWithBreaks_Move_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                       Napi::Promise::Deferred const &d,
...
ContourWithBreaks_Transform_AsyncWorker::ContourWithBreaks_Transform_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                                 Napi::Promise::Deferred const &d,
                                                                                 const MbMatrix &matr,
                                                                                 MbRegTransform *iReg,
...
ContourWithBreaks_Duplicate_AsyncWorker::ContourWithBreaks_Duplicate_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                                 Napi::Promise::Deferred const &d,
                                                                                 MbRegDuplicate *dup)
...
ContourWithBreaks_AddYourGabaritTo_AsyncWorker::ContourWithBreaks_AddYourGabaritTo_AsyncWorker(
    MbContourWithBreaks *_underlying, Napi::Promise::Deferred const &d, MbRect &rect)
...
void ContourWithBreaks_AddYourGabaritTo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                            Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ContourWithBreaks_GetUseCount_AsyncWorker::ContourWithBreaks_GetUseCount_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void ContourWithBreaks_GetUseCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                       Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ContourWithBreaks_AddRef_AsyncWorker::ContourWithBreaks_AddRef_AsyncWorker(MbContourWithBreaks *_underlying,
                                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
