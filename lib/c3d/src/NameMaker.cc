...
Napi::Value NameMaker::IsChild_async(const Napi::CallbackInfo &info)
{
    ...
    NameMaker_IsChild_AsyncWorker *asyncWorker = new NameMaker_IsChild_AsyncWorker(_underlying, deferred,
...
Napi::Value NameMaker::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    NameMaker_GetMainName_AsyncWorker *asyncWorker = new NameMaker_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value NameMaker::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    NameMaker_GetUseCount_AsyncWorker *asyncWorker = new NameMaker_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value NameMaker::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    NameMaker_AddRef_AsyncWorker *asyncWorker = new NameMaker_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
NameMaker_IsChild_AsyncWorker::NameMaker_IsChild_AsyncWorker(MbNameMaker *_underlying, Napi::Promise::Deferred const &d,
...
NameMaker_GetMainName_AsyncWorker::NameMaker_GetMainName_AsyncWorker(MbNameMaker *_underlying,
...
NameMaker_GetUseCount_AsyncWorker::NameMaker_GetUseCount_AsyncWorker(MbNameMaker *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
NameMaker_AddRef_AsyncWorker::NameMaker_AddRef_AsyncWorker(MbNameMaker *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
