...
Napi::Value ActionSurfaceCurve::CreateContourFillets(const Napi::CallbackInfo &info)
{
    ...
    if (info.Length() == 0 || !((info[0].IsObject() && info[0].ToObject().InstanceOf(Contour3D::GetConstructor(env)))))
    {
    ...
    MbResultType _result = ::CreateContourFillets(contour, radiuses, result, type
...
Napi::Value ActionSurfaceCurve::CreateContourFillets_async(const Napi::CallbackInfo &info)
{
    ...
    ActionSurfaceCurve_CreateContourFillets_AsyncWorker *asyncWorker =
        new ActionSurfaceCurve_CreateContourFillets_AsyncWorker(deferred,
...
Napi::Value ActionSurfaceCurve::OffsetPlaneCurve(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result = ::OffsetPlaneCurve(curve, dist, result
...
Napi::Value ActionSurfaceCurve::OffsetPlaneCurve_async(const Napi::CallbackInfo &info)
{
    ...
    ActionSurfaceCurve_OffsetPlaneCurve_AsyncWorker *asyncWorker =
        new ActionSurfaceCurve_OffsetPlaneCurve_AsyncWorker(deferred,
...
Napi::Value ActionSurfaceCurve::OffsetSurfaceCurve(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result = ::OffsetCurve(curve, params, result
...
Napi::Value ActionSurfaceCurve::OffsetSurfaceCurve_async(const Napi::CallbackInfo &info)
{
    ...
    ActionSurfaceCurve_OffsetSurfaceCurve_AsyncWorker *asyncWorker =
        new ActionSurfaceCurve_OffsetSurfaceCurve_AsyncWorker(deferred,
...
Napi::Value ActionSurfaceCurve::OffsetCurve(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result = ::OffsetCurve(initCurve, params, result
...
Napi::Value ActionSurfaceCurve::OffsetCurve_async(const Napi::CallbackInfo &info)
{
    ...
    ActionSurfaceCurve_OffsetCurve_AsyncWorker *asyncWorker = new ActionSurfaceCurve_OffsetCurve_AsyncWorker(deferred,
...
Napi::Value ActionSurfaceCurve::FilletCurve(const Napi::CallbackInfo &info)
{
    ...
    if (info.Length() == 2 || !((info[2].IsObject() && info[2].ToObject().InstanceOf(Curve3D::GetConstructor(env)))))
    {
    ...
    MbResultType _result =
        ::FilletCurve(curve1, t1, w1, curve2, t2, w2, radius, sense, unchanged, type, names, surface, result
...
Napi::Value ActionSurfaceCurve::FilletCurve_async(const Napi::CallbackInfo &info)
{
    ...
    ActionSurfaceCurve_FilletCurve_AsyncWorker *asyncWorker = new ActionSurfaceCurve_FilletCurve_AsyncWorker(deferred,
...
Napi::Value ActionSurfaceCurve::BridgeCurve(const Napi::CallbackInfo &info)
{
    ...
    if (info.Length() == 3 || !((info[3].IsObject() && info[3].ToObject().InstanceOf(Curve3D::GetConstructor(env)))))
    {
        Napi::Error::New(env, "Curve3D curve2 is required.").ThrowAsJavaScriptException();
        return env.Undefined();
    }
    ...
    MbResultType _result = ::BridgeCurve(curve1, t1, sense1, curve2, t2, sense2, names, result
...
Napi::Value ActionSurfaceCurve::BridgeCurve_async(const Napi::CallbackInfo &info)
{
    ...
    ActionSurfaceCurve_BridgeCurve_AsyncWorker *asyncWorker = new ActionSurfaceCurve_BridgeCurve_AsyncWorker(deferred,
...
Napi::Value ActionSurfaceCurve::ConnectingSpline(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result =
        ::ConnectingSpline(curve1, t1, mating1, curve2, t2, mating2, tension1, tension2, names, result
...
Napi::Value ActionSurfaceCurve::ConnectingSpline_async(const Napi::CallbackInfo &info)
{
    ...
    ActionSurfaceCurve_ConnectingSpline_AsyncWorker *asyncWorker =
        new ActionSurfaceCurve_ConnectingSpline_AsyncWorker(deferred,
...
Napi::Value ActionSurfaceCurve::CurveProjection(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result =
        ::CurveProjection(surface, curve, direction, createExact, truncateByBounds, *result,
...
Napi::Value ActionSurfaceCurve::CurveProjection_async(const Napi::CallbackInfo &info)
{
    ...
    ActionSurfaceCurve_CurveProjection_AsyncWorker *asyncWorker =
        new ActionSurfaceCurve_CurveProjection_AsyncWorker(deferred,
...
ActionSurfaceCurve_CreateContourFillets_AsyncWorker::ActionSurfaceCurve_CreateContourFillets_AsyncWorker(
    Napi::Promise::Deferred const &d, const MbContour3D &contour, SArray<double> &radiuses,
    const MbeConnectingType type)
    : PromiseWorker(d), contour(contour), radiuses(radiuses), type(type){};
...
void ActionSurfaceCurve_CreateContourFillets_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
ActionSurfaceCurve_OffsetPlaneCurve_AsyncWorker::ActionSurfaceCurve_OffsetPlaneCurve_AsyncWorker(
    Napi::Promise::Deferred const &d, const MbCurve3D &curve, double dist)
    : PromiseWorker(d), curve(curve), dist(dist){};
...
void ActionSurfaceCurve_OffsetPlaneCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                             Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ActionSurfaceCurve_OffsetSurfaceCurve_AsyncWorker::ActionSurfaceCurve_OffsetSurfaceCurve_AsyncWorker(
    Napi::Promise::Deferred const &d, const MbCurve3D &curve, const MbSurfaceOffsetCurveParams &params)
    : PromiseWorker(d), curve(curve), params(params){};
...
void ActionSurfaceCurve_OffsetSurfaceCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                               Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ActionSurfaceCurve_OffsetCurve_AsyncWorker::ActionSurfaceCurve_OffsetCurve_AsyncWorker(
    Napi::Promise::Deferred const &d, const MbCurve3D &initCurve, const MbSpatialOffsetCurveParams &params)
    : PromiseWorker(d), initCurve(initCurve), params(params){};
...
void ActionSurfaceCurve_OffsetCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                        Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ActionSurfaceCurve_FilletCurve_AsyncWorker::ActionSurfaceCurve_FilletCurve_AsyncWorker(
    Napi::Promise::Deferred const &d, const MbCurve3D &curve1, double &t1, const MbCurve3D &curve2, double &t2,
    double &radius, bool sense, const MbeConnectingType type, const MbSNameMaker &names)
    : PromiseWorker(d), curve1(curve1), t1(t1), curve2(curve2), t2(t2), radius(radius), sense(sense), type(type),
      names(names){};
...
void ActionSurfaceCurve_FilletCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                        Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ActionSurfaceCurve_BridgeCurve_AsyncWorker::ActionSurfaceCurve_BridgeCurve_AsyncWorker(
    Napi::Promise::Deferred const &d, const MbCurve3D &curve1, double t1, bool sense1, const MbCurve3D &curve2,
    double t2, bool sense2, const MbSNameMaker &names)
    : PromiseWorker(d), curve1(curve1), t1(t1), sense1(sense1), curve2(curve2), t2(t2), sense2(sense2), names(names){};
...
void ActionSurfaceCurve_BridgeCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                        Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ActionSurfaceCurve_ConnectingSpline_AsyncWorker::ActionSurfaceCurve_ConnectingSpline_AsyncWorker(
    Napi::Promise::Deferred const &d, const MbCurve3D &curve1, double t1, MbeMatingType mating1,
    const MbCurve3D &curve2, double t2, MbeMatingType mating2, double tension1, double tension2,
    const MbSNameMaker &names)
    : PromiseWorker(d), curve1(curve1), t1(t1), mating1(mating1), curve2(curve2), t2(t2), mating2(mating2),
      tension1(tension1), tension2(tension2), names(names){};
...
void ActionSurfaceCurve_ConnectingSpline_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                             Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ActionSurfaceCurve_CurveProjection_AsyncWorker::ActionSurfaceCurve_CurveProjection_AsyncWorker(
    Napi::Promise::Deferred const &d, const MbSurface &surface, const MbCurve3D &curve, MbVector3D *direction,
    bool createExact, bool truncateByBounds, VERSION version)
    : PromiseWorker(d), surface(surface), curve(curve), direction(direction), createExact(createExact),
      truncateByBounds(truncateByBounds), version(version){};
...
void ActionSurfaceCurve_CurveProjection_AsyncWorker::Execute()
{
    ...
    MbResultType _result =
        ::CurveProjection(surface, curve, direction, createExact, truncateByBounds, *result, version);
...
void ActionSurfaceCurve_CurveProjection_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                            Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
