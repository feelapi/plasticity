...
Napi::Object ThinShellCreator::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "ThinShellCreator", {
...
(
    ...
    Napi::Value ThinShellCreator::IsA_async(const Napi::CallbackInfo& info) {
        ...
        ThinShellCreator_IsA_AsyncWorker* asyncWorker = new ThinShellCreator_IsA_AsyncWorker(
...
(
    ...
    Napi::Value ThinShellCreator::Type_async(const Napi::CallbackInfo& info) {
        ...
        ThinShellCreator_Type_AsyncWorker* asyncWorker = new ThinShellCreator_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ThinShellCreator::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        ThinShellCreator_GetBasisPoints_AsyncWorker* asyncWorker = new ThinShellCreator_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ThinShellCreator::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        ThinShellCreator_SetBasisPoints_AsyncWorker* asyncWorker = new ThinShellCreator_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ThinShellCreator::GetBasisItems_async(const Napi::CallbackInfo& info) {
        ...
        ThinShellCreator_GetBasisItems_AsyncWorker* asyncWorker = new ThinShellCreator_GetBasisItems_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ThinShellCreator::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        ThinShellCreator_GetCreatorsCount_AsyncWorker* asyncWorker = new ThinShellCreator_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ThinShellCreator::GetYourNameMaker_async(const Napi::CallbackInfo& info) {
        ...
        ThinShellCreator_GetYourNameMaker_AsyncWorker* asyncWorker = new ThinShellCreator_GetYourNameMaker_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ThinShellCreator::GetStatus_async(const Napi::CallbackInfo& info) {
        ...
        ThinShellCreator_GetStatus_AsyncWorker* asyncWorker = new ThinShellCreator_GetStatus_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ThinShellCreator::SetStatus_async(const Napi::CallbackInfo& info) {
        ...
        ThinShellCreator_SetStatus_AsyncWorker* asyncWorker = new ThinShellCreator_SetStatus_AsyncWorker(
_underlying,            deferred
,
...
,        items
    ...
    Napi::Value ThinShellCreator::CreateShell_async(const Napi::CallbackInfo& info) {
        ...
        ThinShellCreator_CreateShell_AsyncWorker* asyncWorker = new ThinShellCreator_CreateShell_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ThinShellCreator::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        ThinShellCreator_GetMainName_AsyncWorker* asyncWorker = new ThinShellCreator_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ThinShellCreator::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        ThinShellCreator_GetUseCount_AsyncWorker* asyncWorker = new ThinShellCreator_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ThinShellCreator::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        ThinShellCreator_AddRef_AsyncWorker* asyncWorker = new ThinShellCreator_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
ThinShellCreator::~ThinShellCreator() {
    ...
    ThinShellCreator_IsA_AsyncWorker::ThinShellCreator_IsA_AsyncWorker(
MbThinShellCreator * _underlying,        Napi::Promise::Deferred const &d
    ...
    ThinShellCreator_Type_AsyncWorker::ThinShellCreator_Type_AsyncWorker(
MbThinShellCreator * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
...
MbThinShellCreator * _underlying,        Napi::Promise::Deferred const &d
    ...
    void ThinShellCreator_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void ThinShellCreator_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ThinShellCreator_GetBasisItems_AsyncWorker::ThinShellCreator_GetBasisItems_AsyncWorker(
MbThinShellCreator * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void ThinShellCreator_GetBasisItems_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void ThinShellCreator_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbThinShellCreator * _underlying,        Napi::Promise::Deferred const &d
    ...
    void ThinShellCreator_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ThinShellCreator_GetStatus_AsyncWorker::ThinShellCreator_GetStatus_AsyncWorker(
MbThinShellCreator * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ThinShellCreator_SetStatus_AsyncWorker::ThinShellCreator_SetStatus_AsyncWorker(
MbThinShellCreator * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeProcessState  l    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    ThinShellCreator_CreateShell_AsyncWorker::ThinShellCreator_CreateShell_AsyncWorker(
MbThinShellCreator * _underlying,        Napi::Promise::Deferred const &d
,
                         MbFaceShell * shell,
...
,                        items
    ...
    ThinShellCreator_GetMainName_AsyncWorker::ThinShellCreator_GetMainName_AsyncWorker(
MbThinShellCreator * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ThinShellCreator_GetUseCount_AsyncWorker::ThinShellCreator_GetUseCount_AsyncWorker(
MbThinShellCreator * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ThinShellCreator_AddRef_AsyncWorker::ThinShellCreator_AddRef_AsyncWorker(
MbThinShellCreator * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
