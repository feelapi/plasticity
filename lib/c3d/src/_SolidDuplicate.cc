...
Napi::Value _SolidDuplicate::GetCopy_async(const Napi::CallbackInfo &info)
{
    ...
    _SolidDuplicate_GetCopy_AsyncWorker *asyncWorker = new _SolidDuplicate_GetCopy_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
_SolidDuplicate_GetCopy_AsyncWorker::_SolidDuplicate_GetCopy_AsyncWorker(SolidDuplicate *_underlying,
