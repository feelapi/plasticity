...
if (!(info[1].IsNull() || info[1].IsUndefined())) {
    ...
    for (size_t i = 0; i < points_.Length(); i++) {
        ...
        ActionCurve3D_Arc_AsyncWorker* asyncWorker = new ActionCurve3D_Arc_AsyncWorker(
            deferred
,
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionCurve3D::Segment_async(const Napi::CallbackInfo& info) {
        ...
        ActionCurve3D_Segment_AsyncWorker* asyncWorker = new ActionCurve3D_Segment_AsyncWorker(
            deferred
,
...
if (!(info[0].IsNull() || info[0].IsUndefined())) {
    ...
    for (size_t i = 0; i < points_.Length(); i++) {
        ...
        ActionCurve3D_SplineCurve_AsyncWorker* asyncWorker = new ActionCurve3D_SplineCurve_AsyncWorker(
            deferred
,
                                *points                ,
 ...
 MbResultType  _result = ::CreateContour
(
        curve
,        result
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionCurve3D::CreateContour_async(const Napi::CallbackInfo& info) {
        ...
        ActionCurve3D_CreateContour_AsyncWorker* asyncWorker = new ActionCurve3D_CreateContour_AsyncWorker(
            deferred
,
 ...
 MbResultType  _result = ::AddCurveToContour
(
        curve
,        contour
,        toEnd
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionCurve3D::AddCurveToContour_async(const Napi::CallbackInfo& info) {
        ...
        ActionCurve3D_AddCurveToContour_AsyncWorker* asyncWorker = new ActionCurve3D_AddCurveToContour_AsyncWorker(
            deferred
,
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionCurve3D::RegularPolygon_async(const Napi::CallbackInfo& info) {
        ...
        ActionCurve3D_RegularPolygon_AsyncWorker* asyncWorker = new ActionCurve3D_RegularPolygon_AsyncWorker(
            deferred
,
 ...
 MbResultType  _result = ::SpiralCurve
(
        point0
,        point1
,        point2
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionCurve3D::SpiralCurve_async(const Napi::CallbackInfo& info) {
        ...
        ActionCurve3D_SpiralCurve_AsyncWorker* asyncWorker = new ActionCurve3D_SpiralCurve_AsyncWorker(
            deferred
,
...
,        metricEps
,        *result
,        info.Length() == 2 || info[2].IsNull() ? false : onlySmoothConnected
...
if (!(info[0].IsNull() || info[0].IsUndefined())) {
    ...
    for (size_t i = 0; i < curves_.Length(); i++) {
        ...
        ActionCurve3D_CreateContours_AsyncWorker* asyncWorker = new ActionCurve3D_CreateContours_AsyncWorker(
            deferred
,
                                *curves                ,
 ...
 MbResultType  _result = ::PlaneCurve
(
        place
,        curve
,        result
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionCurve3D::PlaneCurve_async(const Napi::CallbackInfo& info) {
        ...
        ActionCurve3D_PlaneCurve_AsyncWorker* asyncWorker = new ActionCurve3D_PlaneCurve_AsyncWorker(
            deferred
,
 ...
 MbCurve3D * _result = ::DuplicateCurve
(
        curve
,        info.Length() == 1 || info[1].IsNull() ? Math::DefaultMathVersion() : version
    ...
    Napi::Value ActionCurve3D::DuplicateCurve_async(const Napi::CallbackInfo& info) {
        ...
        ActionCurve3D_DuplicateCurve_AsyncWorker* asyncWorker = new ActionCurve3D_DuplicateCurve_AsyncWorker(
            deferred
,
...
if (_result == rt_Success) {
    ...
    Napi::Value ActionCurve3D::NurbsCopy_async(const Napi::CallbackInfo& info) {
        ...
        ActionCurve3D_NurbsCopy_AsyncWorker* asyncWorker = new ActionCurve3D_NurbsCopy_AsyncWorker(
            deferred
,
    ...
    ActionCurve3D_Arc_AsyncWorker::ActionCurve3D_Arc_AsyncWorker(
...
,                        result
    ...
    ActionCurve3D_Segment_AsyncWorker::ActionCurve3D_Segment_AsyncWorker(
        Napi::Promise::Deferred const &d
,
...
,                        result
    ...
    ActionCurve3D_SplineCurve_AsyncWorker::ActionCurve3D_SplineCurve_AsyncWorker(
        Napi::Promise::Deferred const &d
,
                        const SArray<MbCartPoint3D> & points,
                         bool  closed,
...
,                        result
    ...
    ActionCurve3D_CreateContour_AsyncWorker::ActionCurve3D_CreateContour_AsyncWorker(
        Napi::Promise::Deferred const &d
,
                         MbCurve3D & curve    )
        :PromiseWorker(d),
...
,                        toEnd
    ...
    void ActionCurve3D_AddCurveToContour_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ActionCurve3D_RegularPolygon_AsyncWorker::ActionCurve3D_RegularPolygon_AsyncWorker(
        Napi::Promise::Deferred const &d
,
                        const MbCartPoint3D & centre,
...
,                        result
    ...
    ActionCurve3D_CreateContours_AsyncWorker::ActionCurve3D_CreateContours_AsyncWorker(
        Napi::Promise::Deferred const &d
,
                         RPArray<MbCurve3D> & curves,
                         double  metricEps,
...
,
                        metricEps(metricEps)
,
                        onlySmoothConnected(onlySmoothConnected)
,
                        version(version)
{};
...
,                        version
    ...
    ActionCurve3D_PlaneCurve_AsyncWorker::ActionCurve3D_PlaneCurve_AsyncWorker(
        Napi::Promise::Deferred const &d
,
...
,                        result
    ...
    ActionCurve3D_DuplicateCurve_AsyncWorker::ActionCurve3D_DuplicateCurve_AsyncWorker(
        Napi::Promise::Deferred const &d
,
...
,                        version
    ...
    ActionCurve3D_NurbsCopy_AsyncWorker::ActionCurve3D_NurbsCopy_AsyncWorker(
        Napi::Promise::Deferred const &d
,
                        const MbCurve3D & curve    )
        :PromiseWorker(d),
