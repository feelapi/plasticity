...
Napi::Value ChamferSolid::GetParameters(const Napi::CallbackInfo &info)
{
    ...
    _underlying->GetParameters(*params
...
Napi::Value ChamferSolid::GetParameters_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_GetParameters_AsyncWorker *asyncWorker =
        new ChamferSolid_GetParameters_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value ChamferSolid::SetParameters(const Napi::CallbackInfo &info)
{
    ...
    _underlying->SetParameters(params
...
Napi::Value ChamferSolid::SetParameters_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_SetParameters_AsyncWorker *asyncWorker =
        new ChamferSolid_SetParameters_AsyncWorker(_underlying, deferred,
...
Napi::Value ChamferSolid::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_IsA_AsyncWorker *asyncWorker = new ChamferSolid_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ChamferSolid::Type_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_Type_AsyncWorker *asyncWorker = new ChamferSolid_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ChamferSolid::GetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_GetBasisPoints_AsyncWorker *asyncWorker =
        new ChamferSolid_GetBasisPoints_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ChamferSolid::SetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_SetBasisPoints_AsyncWorker *asyncWorker =
        new ChamferSolid_SetBasisPoints_AsyncWorker(_underlying, deferred,
...
Napi::Value ChamferSolid::GetBasisItems_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_GetBasisItems_AsyncWorker *asyncWorker =
        new ChamferSolid_GetBasisItems_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ChamferSolid::GetCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_GetCreatorsCount_AsyncWorker *asyncWorker =
        new ChamferSolid_GetCreatorsCount_AsyncWorker(_underlying, deferred,
...
Napi::Value ChamferSolid::GetYourNameMaker_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_GetYourNameMaker_AsyncWorker *asyncWorker =
        new ChamferSolid_GetYourNameMaker_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ChamferSolid::GetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_GetStatus_AsyncWorker *asyncWorker = new ChamferSolid_GetStatus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ChamferSolid::SetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_SetStatus_AsyncWorker *asyncWorker = new ChamferSolid_SetStatus_AsyncWorker(_underlying, deferred,
...
Napi::Value ChamferSolid::CreateShell_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_CreateShell_AsyncWorker *asyncWorker = new ChamferSolid_CreateShell_AsyncWorker(_underlying, deferred,
...
Napi::Value ChamferSolid::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_GetMainName_AsyncWorker *asyncWorker = new ChamferSolid_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ChamferSolid::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_GetUseCount_AsyncWorker *asyncWorker = new ChamferSolid_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ChamferSolid::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    ChamferSolid_AddRef_AsyncWorker *asyncWorker = new ChamferSolid_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
ChamferSolid_GetParameters_AsyncWorker::ChamferSolid_GetParameters_AsyncWorker(MbChamferSolid *_underlying,
...
ChamferSolid_SetParameters_AsyncWorker::ChamferSolid_SetParameters_AsyncWorker(MbChamferSolid *_underlying,
                                                                               Napi::Promise::Deferred const &d,
                                                                               const SmoothValues &params)
    : _underlying(_underlying), PromiseWorker(d), params(params){};
...
ChamferSolid_IsA_AsyncWorker::ChamferSolid_IsA_AsyncWorker(MbChamferSolid *_underlying,
                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ChamferSolid_Type_AsyncWorker::ChamferSolid_Type_AsyncWorker(MbChamferSolid *_underlying,
                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ChamferSolid_GetBasisPoints_AsyncWorker::ChamferSolid_GetBasisPoints_AsyncWorker(MbChamferSolid *_underlying,
                                                                                 Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ChamferSolid_SetBasisPoints_AsyncWorker::ChamferSolid_SetBasisPoints_AsyncWorker(MbChamferSolid *_underlying,
                                                                                 Napi::Promise::Deferred const &d,
...
ChamferSolid_GetBasisItems_AsyncWorker::ChamferSolid_GetBasisItems_AsyncWorker(MbChamferSolid *_underlying,
                                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ChamferSolid_GetCreatorsCount_AsyncWorker::ChamferSolid_GetCreatorsCount_AsyncWorker(MbChamferSolid *_underlying,
                                                                                     Napi::Promise::Deferred const &d,
                                                                                     MbeCreatorType ct)
...
void ChamferSolid_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
ChamferSolid_GetYourNameMaker_AsyncWorker::ChamferSolid_GetYourNameMaker_AsyncWorker(MbChamferSolid *_underlying,
                                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void ChamferSolid_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                       Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
ChamferSolid_GetStatus_AsyncWorker::ChamferSolid_GetStatus_AsyncWorker(MbChamferSolid *_underlying,
                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ChamferSolid_SetStatus_AsyncWorker::ChamferSolid_SetStatus_AsyncWorker(MbChamferSolid *_underlying,
                                                                       Napi::Promise::Deferred const &d,
                                                                       MbeProcessState l)
...
ChamferSolid_CreateShell_AsyncWorker::ChamferSolid_CreateShell_AsyncWorker(MbChamferSolid *_underlying,
                                                                           Napi::Promise::Deferred const &d,
...
ChamferSolid_GetMainName_AsyncWorker::ChamferSolid_GetMainName_AsyncWorker(MbChamferSolid *_underlying,
                                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ChamferSolid_GetUseCount_AsyncWorker::ChamferSolid_GetUseCount_AsyncWorker(MbChamferSolid *_underlying,
                                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ChamferSolid_AddRef_AsyncWorker::ChamferSolid_AddRef_AsyncWorker(MbChamferSolid *_underlying,
                                                                 Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
