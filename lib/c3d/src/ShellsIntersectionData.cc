...
ShellsIntersectionData::ShellsIntersectionData(const Napi::CallbackInfo &info)
    : Napi::ObjectWrap<ShellsIntersectionData>(info)
{
...
Napi::Value ShellsIntersectionData::IsSolid_async(const Napi::CallbackInfo &info)
{
    ...
    ShellsIntersectionData_IsSolid_AsyncWorker *asyncWorker =
        new ShellsIntersectionData_IsSolid_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value ShellsIntersectionData::IsSurface_async(const Napi::CallbackInfo &info)
{
    ...
    ShellsIntersectionData_IsSurface_AsyncWorker *asyncWorker =
        new ShellsIntersectionData_IsSurface_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
void ShellsIntersectionData_IsSolid_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
void ShellsIntersectionData_IsSurface_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                          Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
