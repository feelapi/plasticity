...
Napi::Function CartPoint3D::GetConstructor(Napi::Env env) {
 ...
 MbCartPoint3D & _result = _underlying->Move
(
        to
    ...
    Napi::Value CartPoint3D::Move_async(const Napi::CallbackInfo& info) {
        ...
        CartPoint3D_Move_AsyncWorker* asyncWorker = new CartPoint3D_Move_AsyncWorker(
...
void CartPoint3D::SetValue_z(const Napi::CallbackInfo &info, const Napi::Value &value) {
    ...
    CartPoint3D_Move_AsyncWorker::CartPoint3D_Move_AsyncWorker(
MbCartPoint3D * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & to    )
