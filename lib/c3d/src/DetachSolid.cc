...
Napi::Value DetachSolid::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    DetachSolid_IsA_AsyncWorker *asyncWorker = new DetachSolid_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value DetachSolid::Type_async(const Napi::CallbackInfo &info)
{
    ...
    DetachSolid_Type_AsyncWorker *asyncWorker = new DetachSolid_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value DetachSolid::GetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    DetachSolid_GetBasisPoints_AsyncWorker *asyncWorker =
        new DetachSolid_GetBasisPoints_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value DetachSolid::SetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    DetachSolid_SetBasisPoints_AsyncWorker *asyncWorker =
        new DetachSolid_SetBasisPoints_AsyncWorker(_underlying, deferred,
...
Napi::Value DetachSolid::GetBasisItems_async(const Napi::CallbackInfo &info)
{
    ...
    DetachSolid_GetBasisItems_AsyncWorker *asyncWorker =
        new DetachSolid_GetBasisItems_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value DetachSolid::GetCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    DetachSolid_GetCreatorsCount_AsyncWorker *asyncWorker =
        new DetachSolid_GetCreatorsCount_AsyncWorker(_underlying, deferred,
...
Napi::Value DetachSolid::GetYourNameMaker_async(const Napi::CallbackInfo &info)
{
    ...
    DetachSolid_GetYourNameMaker_AsyncWorker *asyncWorker =
        new DetachSolid_GetYourNameMaker_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value DetachSolid::GetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    DetachSolid_GetStatus_AsyncWorker *asyncWorker = new DetachSolid_GetStatus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value DetachSolid::SetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    DetachSolid_SetStatus_AsyncWorker *asyncWorker = new DetachSolid_SetStatus_AsyncWorker(_underlying, deferred,
...
Napi::Value DetachSolid::CreateShell_async(const Napi::CallbackInfo &info)
{
    ...
    DetachSolid_CreateShell_AsyncWorker *asyncWorker = new DetachSolid_CreateShell_AsyncWorker(_underlying, deferred,
...
Napi::Value DetachSolid::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    DetachSolid_GetMainName_AsyncWorker *asyncWorker = new DetachSolid_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value DetachSolid::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    DetachSolid_GetUseCount_AsyncWorker *asyncWorker = new DetachSolid_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value DetachSolid::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    DetachSolid_AddRef_AsyncWorker *asyncWorker = new DetachSolid_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
DetachSolid_IsA_AsyncWorker::DetachSolid_IsA_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d)
...
DetachSolid_Type_AsyncWorker::DetachSolid_Type_AsyncWorker(MbDetachSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
DetachSolid_GetBasisPoints_AsyncWorker::DetachSolid_GetBasisPoints_AsyncWorker(MbDetachSolid *_underlying,
...
DetachSolid_SetBasisPoints_AsyncWorker::DetachSolid_SetBasisPoints_AsyncWorker(MbDetachSolid *_underlying,
                                                                               Napi::Promise::Deferred const &d,
...
DetachSolid_GetBasisItems_AsyncWorker::DetachSolid_GetBasisItems_AsyncWorker(MbDetachSolid *_underlying,
                                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
DetachSolid_GetCreatorsCount_AsyncWorker::DetachSolid_GetCreatorsCount_AsyncWorker(MbDetachSolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d,
                                                                                   MbeCreatorType ct)
...
DetachSolid_GetYourNameMaker_AsyncWorker::DetachSolid_GetYourNameMaker_AsyncWorker(MbDetachSolid *_underlying,
                                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
DetachSolid_GetStatus_AsyncWorker::DetachSolid_GetStatus_AsyncWorker(MbDetachSolid *_underlying,
                                                                     Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
DetachSolid_SetStatus_AsyncWorker::DetachSolid_SetStatus_AsyncWorker(MbDetachSolid *_underlying,
                                                                     Napi::Promise::Deferred const &d,
                                                                     MbeProcessState l)
...
DetachSolid_CreateShell_AsyncWorker::DetachSolid_CreateShell_AsyncWorker(MbDetachSolid *_underlying,
                                                                         Napi::Promise::Deferred const &d,
...
DetachSolid_GetMainName_AsyncWorker::DetachSolid_GetMainName_AsyncWorker(MbDetachSolid *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
DetachSolid_GetUseCount_AsyncWorker::DetachSolid_GetUseCount_AsyncWorker(MbDetachSolid *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
DetachSolid_AddRef_AsyncWorker::DetachSolid_AddRef_AsyncWorker(MbDetachSolid *_underlying,
                                                               Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
