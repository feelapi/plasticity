...
,        close
    ...
    Napi::Value CurveUtil::AreaSign_async(const Napi::CallbackInfo& info) {
        ...
        CurveUtil_AreaSign_AsyncWorker* asyncWorker = new CurveUtil_AreaSign_AsyncWorker(
            deferred
,
    ...
    CurveUtil_AreaSign_AsyncWorker::CurveUtil_AreaSign_AsyncWorker(
