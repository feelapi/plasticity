...
Napi::Object TopologyItem::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "TopologyItem", {
...
(
    ...
    Napi::Value TopologyItem::IsA_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_IsA_AsyncWorker* asyncWorker = new TopologyItem_IsA_AsyncWorker(
...
(
    ...
    Napi::Value TopologyItem::GetName_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_GetName_AsyncWorker* asyncWorker = new TopologyItem_GetName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TopologyItem::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_GetMainName_AsyncWorker* asyncWorker = new TopologyItem_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TopologyItem::GetFirstName_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_GetFirstName_AsyncWorker* asyncWorker = new TopologyItem_GetFirstName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TopologyItem::GetNameHash_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_GetNameHash_AsyncWorker* asyncWorker = new TopologyItem_GetNameHash_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TopologyItem::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_AddYourGabaritTo_AsyncWorker* asyncWorker = new TopologyItem_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
,        *mesh
    ...
    Napi::Value TopologyItem::CalculateMesh_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_CalculateMesh_AsyncWorker* asyncWorker = new TopologyItem_CalculateMesh_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value TopologyItem::GetOwnChanged_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_GetOwnChanged_AsyncWorker* asyncWorker = new TopologyItem_GetOwnChanged_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TopologyItem::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_GetUseCount_AsyncWorker* asyncWorker = new TopologyItem_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TopologyItem::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_AddRef_AsyncWorker* asyncWorker = new TopologyItem_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TopologyItem::SetStyle_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_SetStyle_AsyncWorker* asyncWorker = new TopologyItem_SetStyle_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value TopologyItem::GetStyle_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_GetStyle_AsyncWorker* asyncWorker = new TopologyItem_GetStyle_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TopologyItem::SetColor_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_SetColor_AsyncWorker* asyncWorker = new TopologyItem_SetColor_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value TopologyItem::GetColor_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_GetColor_AsyncWorker* asyncWorker = new TopologyItem_GetColor_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value TopologyItem::AttributesConvert_async(const Napi::CallbackInfo& info) {
        ...
        TopologyItem_AttributesConvert_AsyncWorker* asyncWorker = new TopologyItem_AttributesConvert_AsyncWorker(
_underlying,            deferred
,
...
TopologyItem::~TopologyItem() {
    ...
    TopologyItem_IsA_AsyncWorker::TopologyItem_IsA_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
    ...
    TopologyItem_GetName_AsyncWorker::TopologyItem_GetName_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    TopologyItem_GetMainName_AsyncWorker::TopologyItem_GetMainName_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    TopologyItem_GetFirstName_AsyncWorker::TopologyItem_GetFirstName_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    TopologyItem_GetNameHash_AsyncWorker::TopologyItem_GetNameHash_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    TopologyItem_AddYourGabaritTo_AsyncWorker::TopologyItem_AddYourGabaritTo_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
,
                         MbCube & cube    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    void TopologyItem_AddYourGabaritTo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    TopologyItem_CalculateMesh_AsyncWorker::TopologyItem_CalculateMesh_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        *mesh
    ...
    TopologyItem_GetOwnChanged_AsyncWorker::TopologyItem_GetOwnChanged_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    TopologyItem_GetUseCount_AsyncWorker::TopologyItem_GetUseCount_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    TopologyItem_AddRef_AsyncWorker::TopologyItem_AddRef_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    TopologyItem_SetStyle_AsyncWorker::TopologyItem_SetStyle_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
,
                         int  s    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    TopologyItem_GetStyle_AsyncWorker::TopologyItem_GetStyle_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    TopologyItem_SetColor_AsyncWorker::TopologyItem_SetColor_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
,
                         uint32  c    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    TopologyItem_GetColor_AsyncWorker::TopologyItem_GetColor_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    TopologyItem_AttributesConvert_AsyncWorker::TopologyItem_AttributesConvert_AsyncWorker(
MbTopologyItem * _underlying,        Napi::Promise::Deferred const &d
,
                         MbGrid & other    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    void TopologyItem_AttributesConvert_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
