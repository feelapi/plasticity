...
Napi::Value Action::IsSolidsIntersectionFast(const Napi::CallbackInfo &info)
{
    ...
    if (info.Length() == 1 || !((info[1].IsObject() && info[1].ToObject().InstanceOf(Solid::GetConstructor(env)))))
    {
    ...
    bool _result = ::IsSolidsIntersection(solid1, solid2, names
...
Napi::Value Action::IsSolidsIntersectionFast_async(const Napi::CallbackInfo &info)
{
    ...
    Action_IsSolidsIntersectionFast_AsyncWorker *asyncWorker = new Action_IsSolidsIntersectionFast_AsyncWorker(deferred,
...
Napi::Value Action::IsSolidsIntersection(const Napi::CallbackInfo &info)
{
    ...
    if (info.Length() == 1 || !((info[1].IsObject() && info[1].ToObject().InstanceOf(Matrix3D::GetConstructor(env)))))
    {
    ...
    if (info.Length() == 3 || !((info[3].IsObject() && info[3].ToObject().InstanceOf(Matrix3D::GetConstructor(env)))))
    {
    ...
    bool isIntersection = ::IsSolidsIntersection(solid1, matr1, solid2, matr2, checkTangent, getIntersectionSolids,
                                                 checkTouchPoints, *intData
...
Napi::Value Action::IsSolidsIntersection_async(const Napi::CallbackInfo &info)
{
    ...
    Action_IsSolidsIntersection_AsyncWorker *asyncWorker =
        new Action_IsSolidsIntersection_AsyncWorker(deferred,
...
Napi::Value Action::MinimumSolidsDistance(const Napi::CallbackInfo &info)
{
    ...
    if (info.Length() == 4 || !((info[4].IsObject() && info[4].ToObject().InstanceOf(Matrix3D::GetConstructor(env)))))
    {
        Napi::Error::New(env, "Matrix3D matr2 is required.").ThrowAsJavaScriptException();
        return env.Undefined();
    }
    ...
    bool hasDistance = ::MinimumSolidsDistance(solid1, matr1, isMultipleUseSolid1, solid2, matr2, isMultipleUseSolid2,
                                               lowerLimitDistance, tillFirstLowerLimit, *shellsDistanceData
...
Napi::Value Action::MinimumSolidsDistance_async(const Napi::CallbackInfo &info)
{
    ...
    Action_MinimumSolidsDistance_AsyncWorker *asyncWorker =
        new Action_MinimumSolidsDistance_AsyncWorker(deferred,
...
Napi::Value Action::FindFilletFaces(const Napi::CallbackInfo &info)
{
    ...
    ::FindFilletFaces(faces, accuracy, *filletFaces
...
Napi::Value Action::FindFilletFaces_async(const Napi::CallbackInfo &info)
{
    ...
    Action_FindFilletFaces_AsyncWorker *asyncWorker = new Action_FindFilletFaces_AsyncWorker(deferred, *faces,
...
Napi::Value Action::GetDistanceToCube(const Napi::CallbackInfo &info)
{
    ...
    if (info.Length() == 1 || !((info[1].IsObject() && info[1].ToObject().InstanceOf(FaceShell::GetConstructor(env)))))
    {
    ...
    bool isFound = ::GetDistanceToCube(pl, shell, dPlus, dMinus, info.Length() == 2 || info[2].IsNull() ? true : findMax
...
Napi::Value Action::GetDistanceToCube_async(const Napi::CallbackInfo &info)
{
    ...
    Action_GetDistanceToCube_AsyncWorker *asyncWorker = new Action_GetDistanceToCube_AsyncWorker(deferred,
...
Action_IsSolidsIntersectionFast_AsyncWorker::Action_IsSolidsIntersectionFast_AsyncWorker(
    Napi::Promise::Deferred const &d, const MbSolid &solid1, const MbSolid &solid2, const MbSNameMaker &names)
    : PromiseWorker(d), solid1(solid1), solid2(solid2), names(names){};
...
void Action_IsSolidsIntersectionFast_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
Action_IsSolidsIntersection_AsyncWorker::Action_IsSolidsIntersection_AsyncWorker(
    Napi::Promise::Deferred const &d, const MbSolid &solid1, const MbMatrix3D &matr1, const MbSolid &solid2,
    const MbMatrix3D &matr2, bool checkTangent, bool getIntersectionSolids, bool checkTouchPoints)
    : PromiseWorker(d), solid1(solid1), matr1(matr1), solid2(solid2), matr2(matr2), checkTangent(checkTangent),
      getIntersectionSolids(getIntersectionSolids), checkTouchPoints(checkTouchPoints){};
...
Action_MinimumSolidsDistance_AsyncWorker::Action_MinimumSolidsDistance_AsyncWorker(
    Napi::Promise::Deferred const &d, const MbSolid &solid1, const MbMatrix3D &matr1, bool isMultipleUseSolid1,
    const MbSolid &solid2, const MbMatrix3D &matr2, bool isMultipleUseSolid2, double lowerLimitDistance,
    bool tillFirstLowerLimit)
    : PromiseWorker(d), solid1(solid1), matr1(matr1), isMultipleUseSolid1(isMultipleUseSolid1), solid2(solid2),
      matr2(matr2), isMultipleUseSolid2(isMultipleUseSolid2), lowerLimitDistance(lowerLimitDistance),
...
Action_FindFilletFaces_AsyncWorker::Action_FindFilletFaces_AsyncWorker(Napi::Promise::Deferred const &d,
                                                                       const RPArray<MbFace> &faces, double accuracy)
    : PromiseWorker(d), faces(faces), accuracy(accuracy){};
...
Action_GetDistanceToCube_AsyncWorker::Action_GetDistanceToCube_AsyncWorker(Napi::Promise::Deferred const &d,
                                                                           const MbPlacement3D &pl,
                                                                           const MbFaceShell *shell, bool findMax)
    : PromiseWorker(d), pl(pl), shell(shell), findMax(findMax){};
...
void Action_GetDistanceToCube_AsyncWorker::Execute()
{
    ...
    bool isFound = ::GetDistanceToCube(pl, shell, dPlus, dMinus, findMax);
