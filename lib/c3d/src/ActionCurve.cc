...
Napi::Value ActionCurve::Arc(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result = ::Arc(center, points, curveClosed, angle, a, b, result
...
Napi::Value ActionCurve::Arc_async(const Napi::CallbackInfo &info)
{
    ...
    ActionCurve_Arc_AsyncWorker *asyncWorker = new ActionCurve_Arc_AsyncWorker(deferred,
...
Napi::Value ActionCurve::SplineCurve_async(const Napi::CallbackInfo &info)
{
    ...
    ActionCurve_SplineCurve_AsyncWorker *asyncWorker = new ActionCurve_SplineCurve_AsyncWorker(deferred, *points,
...
Napi::Value ActionCurve::OffsetContour(const Napi::CallbackInfo &info)
{
    ...
    MbContour *_result = ::OffsetContour(cntr, rad, xEpsilon, yEpsilon, modifySegments,
...
Napi::Value ActionCurve::OffsetContour_async(const Napi::CallbackInfo &info)
{
    ...
    ActionCurve_OffsetContour_AsyncWorker *asyncWorker = new ActionCurve_OffsetContour_AsyncWorker(deferred,
...
Napi::Value ActionCurve::SurfaceBoundContour(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result = ::SurfaceBoundContour(
        surface, spaceCurve, info.Length() == 2 || info[2].IsNull() ? Math::DefaultMathVersion() : version, result
...
Napi::Value ActionCurve::SurfaceBoundContour_async(const Napi::CallbackInfo &info)
{
    ...
    ActionCurve_SurfaceBoundContour_AsyncWorker *asyncWorker =
        new ActionCurve_SurfaceBoundContour_AsyncWorker(deferred,
...
Napi::Value ActionCurve::Line(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result = ::Line(point1, point2, result
...
Napi::Value ActionCurve::Line_async(const Napi::CallbackInfo &info)
{
    ...
    ActionCurve_Line_AsyncWorker *asyncWorker = new ActionCurve_Line_AsyncWorker(deferred,
...
Napi::Value ActionCurve::Segment_async(const Napi::CallbackInfo &info)
{
    ...
    ActionCurve_Segment_AsyncWorker *asyncWorker = new ActionCurve_Segment_AsyncWorker(deferred,
...
Napi::Value ActionCurve::RegularPolygon(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result = ::RegularPolygon(centre, point, vertexCount, describe, result
...
Napi::Value ActionCurve::RegularPolygon_async(const Napi::CallbackInfo &info)
{
    ...
    ActionCurve_RegularPolygon_AsyncWorker *asyncWorker = new ActionCurve_RegularPolygon_AsyncWorker(deferred,
...
Napi::Value ActionCurve::NurbsCopy_async(const Napi::CallbackInfo &info)
{
    ...
    ActionCurve_NurbsCopy_AsyncWorker *asyncWorker = new ActionCurve_NurbsCopy_AsyncWorker(deferred,
...
Napi::Value ActionCurve::DuplicateCurve_async(const Napi::CallbackInfo &info)
{
    ...
    ActionCurve_DuplicateCurve_AsyncWorker *asyncWorker = new ActionCurve_DuplicateCurve_AsyncWorker(deferred,
...
ActionCurve_Arc_AsyncWorker::ActionCurve_Arc_AsyncWorker(Napi::Promise::Deferred const &d, const MbCartPoint &center,
                                                         const SArray<MbCartPoint> &points, bool curveClosed,
                                                         double angle, double &a, double &b)
    : PromiseWorker(d), center(center), points(points), curveClosed(curveClosed), angle(angle), a(a), b(b){};
...
ActionCurve_SplineCurve_AsyncWorker::ActionCurve_SplineCurve_AsyncWorker(Napi::Promise::Deferred const &d,
                                                                         const SArray<MbCartPoint> &points, bool closed,
...
ActionCurve_OffsetContour_AsyncWorker::ActionCurve_OffsetContour_AsyncWorker(Napi::Promise::Deferred const &d,
                                                                             const MbContour &cntr, double rad,
                                                                             double xEpsilon, double yEpsilon,
                                                                             bool modifySegments, VERSION version)
    : PromiseWorker(d), cntr(cntr), rad(rad), xEpsilon(xEpsilon), yEpsilon(yEpsilon), modifySegments(modifySegments),
      version(version){};
...
void ActionCurve_OffsetContour_AsyncWorker::Execute()
{
    ...
    MbContour *_result = ::OffsetContour(cntr, rad, xEpsilon, yEpsilon, modifySegments, version);
...
ActionCurve_SurfaceBoundContour_AsyncWorker::ActionCurve_SurfaceBoundContour_AsyncWorker(
    Napi::Promise::Deferred const &d, const MbSurface &surface, const MbCurve3D &spaceCurve, VERSION version)
    : PromiseWorker(d), surface(surface), spaceCurve(spaceCurve), version(version){};
...
void ActionCurve_SurfaceBoundContour_AsyncWorker::Execute()
{
    ...
    MbResultType _result = ::SurfaceBoundContour(surface, spaceCurve, version, result);
...
void ActionCurve_SurfaceBoundContour_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
ActionCurve_Line_AsyncWorker::ActionCurve_Line_AsyncWorker(Napi::Promise::Deferred const &d, const MbCartPoint &point1,
...
ActionCurve_Segment_AsyncWorker::ActionCurve_Segment_AsyncWorker(Napi::Promise::Deferred const &d,
                                                                 const MbCartPoint &point1, const MbCartPoint &point2)
    : PromiseWorker(d), point1(point1), point2(point2){};
...
ActionCurve_RegularPolygon_AsyncWorker::ActionCurve_RegularPolygon_AsyncWorker(Napi::Promise::Deferred const &d,
                                                                               const MbCartPoint &centre,
                                                                               const MbCartPoint &point,
                                                                               size_t vertexCount, bool describe)
    : PromiseWorker(d), centre(centre), point(point), vertexCount(vertexCount), describe(describe){};
...
ActionCurve_NurbsCopy_AsyncWorker::ActionCurve_NurbsCopy_AsyncWorker(Napi::Promise::Deferred const &d,
                                                                     const MbCurve &curve)
...
ActionCurve_DuplicateCurve_AsyncWorker::ActionCurve_DuplicateCurve_AsyncWorker(Napi::Promise::Deferred const &d,
                                                                               const MbCurve &curve, VERSION version)
...
void ActionCurve_DuplicateCurve_AsyncWorker::Execute()
{
    ...
    MbCurve *_result = ::DuplicateCurve(curve, version);
