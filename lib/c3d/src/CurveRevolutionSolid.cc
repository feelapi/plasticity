...
{
    Napi::Function func =
        DefineClass(env, "CurveRevolutionSolid",
                    {
...
CurveRevolutionSolid::CurveRevolutionSolid(const Napi::CallbackInfo &info)
    : Napi::ObjectWrap<CurveRevolutionSolid>(info)
{
...
Napi::Value CurveRevolutionSolid::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    CurveRevolutionSolid_IsA_AsyncWorker *asyncWorker = new CurveRevolutionSolid_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value CurveRevolutionSolid::Type_async(const Napi::CallbackInfo &info)
{
    ...
    CurveRevolutionSolid_Type_AsyncWorker *asyncWorker =
        new CurveRevolutionSolid_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveRevolutionSolid::GetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    CurveRevolutionSolid_GetBasisPoints_AsyncWorker *asyncWorker =
        new CurveRevolutionSolid_GetBasisPoints_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveRevolutionSolid::SetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    CurveRevolutionSolid_SetBasisPoints_AsyncWorker *asyncWorker =
        new CurveRevolutionSolid_SetBasisPoints_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveRevolutionSolid::GetBasisItems_async(const Napi::CallbackInfo &info)
{
    ...
    CurveRevolutionSolid_GetBasisItems_AsyncWorker *asyncWorker =
        new CurveRevolutionSolid_GetBasisItems_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveRevolutionSolid::GetCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    CurveRevolutionSolid_GetCreatorsCount_AsyncWorker *asyncWorker =
        new CurveRevolutionSolid_GetCreatorsCount_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveRevolutionSolid::GetYourNameMaker_async(const Napi::CallbackInfo &info)
{
    ...
    CurveRevolutionSolid_GetYourNameMaker_AsyncWorker *asyncWorker =
        new CurveRevolutionSolid_GetYourNameMaker_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveRevolutionSolid::GetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    CurveRevolutionSolid_GetStatus_AsyncWorker *asyncWorker =
        new CurveRevolutionSolid_GetStatus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveRevolutionSolid::SetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    CurveRevolutionSolid_SetStatus_AsyncWorker *asyncWorker =
        new CurveRevolutionSolid_SetStatus_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveRevolutionSolid::CreateShell_async(const Napi::CallbackInfo &info)
{
    ...
    CurveRevolutionSolid_CreateShell_AsyncWorker *asyncWorker =
        new CurveRevolutionSolid_CreateShell_AsyncWorker(_underlying, deferred,
...
Napi::Value CurveRevolutionSolid::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    CurveRevolutionSolid_GetMainName_AsyncWorker *asyncWorker =
        new CurveRevolutionSolid_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveRevolutionSolid::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    CurveRevolutionSolid_GetUseCount_AsyncWorker *asyncWorker =
        new CurveRevolutionSolid_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value CurveRevolutionSolid::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    CurveRevolutionSolid_AddRef_AsyncWorker *asyncWorker =
        new CurveRevolutionSolid_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
CurveRevolutionSolid_IsA_AsyncWorker::CurveRevolutionSolid_IsA_AsyncWorker(MbCurveRevolutionSolid *_underlying,
...
CurveRevolutionSolid_Type_AsyncWorker::CurveRevolutionSolid_Type_AsyncWorker(MbCurveRevolutionSolid *_underlying,
                                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
void CurveRevolutionSolid_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
CurveRevolutionSolid_SetBasisPoints_AsyncWorker::CurveRevolutionSolid_SetBasisPoints_AsyncWorker(
    MbCurveRevolutionSolid *_underlying, Napi::Promise::Deferred const &d, const MbControlData3D &cd)
...
void CurveRevolutionSolid_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                             Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void CurveRevolutionSolid_GetBasisItems_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                            Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
CurveRevolutionSolid_GetCreatorsCount_AsyncWorker::CurveRevolutionSolid_GetCreatorsCount_AsyncWorker(
    MbCurveRevolutionSolid *_underlying, Napi::Promise::Deferred const &d, MbeCreatorType ct)
...
void CurveRevolutionSolid_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                               Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void CurveRevolutionSolid_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                               Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void CurveRevolutionSolid_GetStatus_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                        Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
CurveRevolutionSolid_SetStatus_AsyncWorker::CurveRevolutionSolid_SetStatus_AsyncWorker(
    MbCurveRevolutionSolid *_underlying, Napi::Promise::Deferred const &d, MbeProcessState l)
...
void CurveRevolutionSolid_SetStatus_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                        Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
CurveRevolutionSolid_CreateShell_AsyncWorker::CurveRevolutionSolid_CreateShell_AsyncWorker(
    MbCurveRevolutionSolid *_underlying, Napi::Promise::Deferred const &d, MbFaceShell *shell, MbeCopyMode sameShell)
...
void CurveRevolutionSolid_CreateShell_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                          Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void CurveRevolutionSolid_GetMainName_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                          Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
void CurveRevolutionSolid_GetUseCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                          Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
CurveRevolutionSolid_AddRef_AsyncWorker::CurveRevolutionSolid_AddRef_AsyncWorker(MbCurveRevolutionSolid *_underlying,
                                                                                 Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
