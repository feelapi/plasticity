...
(
    ...
    Napi::Value OrientedEdge::GetCurveEdge_async(const Napi::CallbackInfo& info) {
        ...
        OrientedEdge_GetCurveEdge_AsyncWorker* asyncWorker = new OrientedEdge_GetCurveEdge_AsyncWorker(
_underlying,            deferred
    ...
    OrientedEdge_GetCurveEdge_AsyncWorker::OrientedEdge_GetCurveEdge_AsyncWorker(
MbOrientedEdge * _underlying,        Napi::Promise::Deferred const &d
    )
