...
(
    ...
    Napi::Value TopItem::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        TopItem_GetUseCount_AsyncWorker* asyncWorker = new TopItem_GetUseCount_AsyncWorker(
...
(
    ...
    Napi::Value TopItem::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        TopItem_AddRef_AsyncWorker* asyncWorker = new TopItem_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
TopItem::~TopItem() {
    ...
    TopItem_GetUseCount_AsyncWorker::TopItem_GetUseCount_AsyncWorker(
MbTopItem * _underlying,        Napi::Promise::Deferred const &d
    )
    ...
    TopItem_AddRef_AsyncWorker::TopItem_AddRef_AsyncWorker(
MbTopItem * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
