...
Napi::Value Writer::WriteItems(const Napi::CallbackInfo &info)
{
    ...
    size_t size = ::WriteItems(model, memory
    ...
    _to = Napi::Buffer<char>::New(env, (char *)memory, size,
                                  [](Napi::Env, char *finalizeData) { delete[] finalizeData; });
...
Napi::Value Writer::WriteItems_async(const Napi::CallbackInfo &info)
{
    ...
    Writer_WriteItems_AsyncWorker *asyncWorker = new Writer_WriteItems_AsyncWorker(deferred,
...
Napi::Value Writer::ReadItems_async(const Napi::CallbackInfo &info)
{
    ...
    Writer_ReadItems_AsyncWorker *asyncWorker = new Writer_ReadItems_AsyncWorker(deferred,
...
Writer_WriteItems_AsyncWorker::Writer_WriteItems_AsyncWorker(Napi::Promise::Deferred const &d, const MbModel &model)
    : PromiseWorker(d), model(model){};
...
Writer_ReadItems_AsyncWorker::Writer_ReadItems_AsyncWorker(Napi::Promise::Deferred const &d, const void *memory)
    : PromiseWorker(d), memory(memory){};
