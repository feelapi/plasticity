...
(
    ...
    Napi::Value Creator::IsA_async(const Napi::CallbackInfo& info) {
        ...
        Creator_IsA_AsyncWorker* asyncWorker = new Creator_IsA_AsyncWorker(
...
(
    ...
    Napi::Value Creator::Type_async(const Napi::CallbackInfo& info) {
        ...
        Creator_Type_AsyncWorker* asyncWorker = new Creator_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Creator::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        Creator_GetBasisPoints_AsyncWorker* asyncWorker = new Creator_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Creator::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        Creator_SetBasisPoints_AsyncWorker* asyncWorker = new Creator_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Creator::GetBasisItems_async(const Napi::CallbackInfo& info) {
        ...
        Creator_GetBasisItems_AsyncWorker* asyncWorker = new Creator_GetBasisItems_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Creator::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        Creator_GetCreatorsCount_AsyncWorker* asyncWorker = new Creator_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Creator::GetYourNameMaker_async(const Napi::CallbackInfo& info) {
        ...
        Creator_GetYourNameMaker_AsyncWorker* asyncWorker = new Creator_GetYourNameMaker_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Creator::GetStatus_async(const Napi::CallbackInfo& info) {
        ...
        Creator_GetStatus_AsyncWorker* asyncWorker = new Creator_GetStatus_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Creator::SetStatus_async(const Napi::CallbackInfo& info) {
        ...
        Creator_SetStatus_AsyncWorker* asyncWorker = new Creator_SetStatus_AsyncWorker(
_underlying,            deferred
,
...
,        items
    ...
    Napi::Value Creator::CreateShell_async(const Napi::CallbackInfo& info) {
        ...
        Creator_CreateShell_AsyncWorker* asyncWorker = new Creator_CreateShell_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value Creator::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        Creator_GetMainName_AsyncWorker* asyncWorker = new Creator_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Creator::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        Creator_GetUseCount_AsyncWorker* asyncWorker = new Creator_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Creator::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        Creator_AddRef_AsyncWorker* asyncWorker = new Creator_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
Creator::~Creator() {
    ...
    Creator_IsA_AsyncWorker::Creator_IsA_AsyncWorker(
MbCreator * _underlying,        Napi::Promise::Deferred const &d
    )
    ...
    Creator_Type_AsyncWorker::Creator_Type_AsyncWorker(
MbCreator * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Creator_GetBasisPoints_AsyncWorker::Creator_GetBasisPoints_AsyncWorker(
MbCreator * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Creator_SetBasisPoints_AsyncWorker::Creator_SetBasisPoints_AsyncWorker(
MbCreator * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    Creator_GetBasisItems_AsyncWorker::Creator_GetBasisItems_AsyncWorker(
MbCreator * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Creator_GetCreatorsCount_AsyncWorker::Creator_GetCreatorsCount_AsyncWorker(
MbCreator * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeCreatorType  ct    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Creator_GetYourNameMaker_AsyncWorker::Creator_GetYourNameMaker_AsyncWorker(
MbCreator * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Creator_GetStatus_AsyncWorker::Creator_GetStatus_AsyncWorker(
MbCreator * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Creator_SetStatus_AsyncWorker::Creator_SetStatus_AsyncWorker(
MbCreator * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeProcessState  l    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    Creator_CreateShell_AsyncWorker::Creator_CreateShell_AsyncWorker(
MbCreator * _underlying,        Napi::Promise::Deferred const &d
,
                         MbFaceShell * shell,
...
,                        items
    ...
    Creator_GetMainName_AsyncWorker::Creator_GetMainName_AsyncWorker(
MbCreator * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Creator_GetUseCount_AsyncWorker::Creator_GetUseCount_AsyncWorker(
MbCreator * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Creator_AddRef_AsyncWorker::Creator_AddRef_AsyncWorker(
MbCreator * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
