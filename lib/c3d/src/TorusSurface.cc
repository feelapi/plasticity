...
Napi::Value TorusSurface::GetMajorRadius_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetMajorRadius_AsyncWorker *asyncWorker =
        new TorusSurface_GetMajorRadius_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value TorusSurface::GetMinorRadius_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetMinorRadius_AsyncWorker *asyncWorker =
        new TorusSurface_GetMinorRadius_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::GetSurface_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetSurface_AsyncWorker *asyncWorker = new TorusSurface_GetSurface_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::GetUEpsilon_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetUEpsilon_AsyncWorker *asyncWorker = new TorusSurface_GetUEpsilon_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::GetVEpsilon_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetVEpsilon_AsyncWorker *asyncWorker = new TorusSurface_GetVEpsilon_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::GetUMid_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetUMid_AsyncWorker *asyncWorker = new TorusSurface_GetUMid_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::GetVMid_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetVMid_AsyncWorker *asyncWorker = new TorusSurface_GetVMid_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::GetUMin_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetUMin_AsyncWorker *asyncWorker = new TorusSurface_GetUMin_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::GetUMax_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetUMax_AsyncWorker *asyncWorker = new TorusSurface_GetUMax_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::GetVMin_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetVMin_AsyncWorker *asyncWorker = new TorusSurface_GetVMin_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::GetVMax_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetVMax_AsyncWorker *asyncWorker = new TorusSurface_GetVMax_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::GetUParamToUnit_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetUParamToUnit_AsyncWorker *asyncWorker =
        new TorusSurface_GetUParamToUnit_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::GetVParamToUnit_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetVParamToUnit_AsyncWorker *asyncWorker =
        new TorusSurface_GetVParamToUnit_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::GetRadius_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetRadius_AsyncWorker *asyncWorker = new TorusSurface_GetRadius_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::Normal_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_Normal_AsyncWorker *asyncWorker = new TorusSurface_Normal_AsyncWorker(_underlying, deferred,
...
Napi::Value TorusSurface::NearDirectPointProjection_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_NearDirectPointProjection_AsyncWorker *asyncWorker =
        new TorusSurface_NearDirectPointProjection_AsyncWorker(_underlying, deferred,
...
Napi::Value TorusSurface::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_IsA_AsyncWorker *asyncWorker = new TorusSurface_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::Type_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_Type_AsyncWorker *asyncWorker = new TorusSurface_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::Family_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_Family_AsyncWorker *asyncWorker = new TorusSurface_Family_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::Transform_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_Transform_AsyncWorker *asyncWorker = new TorusSurface_Transform_AsyncWorker(_underlying, deferred,
...
Napi::Value TorusSurface::Move_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_Move_AsyncWorker *asyncWorker = new TorusSurface_Move_AsyncWorker(_underlying, deferred,
...
Napi::Value TorusSurface::Rotate_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_Rotate_AsyncWorker *asyncWorker = new TorusSurface_Rotate_AsyncWorker(_underlying, deferred,
...
Napi::Value TorusSurface::Refresh_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_Refresh_AsyncWorker *asyncWorker = new TorusSurface_Refresh_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::Duplicate_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_Duplicate_AsyncWorker *asyncWorker = new TorusSurface_Duplicate_AsyncWorker(_underlying, deferred,
...
Napi::Value TorusSurface::AddYourGabaritTo_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_AddYourGabaritTo_AsyncWorker *asyncWorker =
        new TorusSurface_AddYourGabaritTo_AsyncWorker(_underlying, deferred,
...
Napi::Value TorusSurface::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_GetUseCount_AsyncWorker *asyncWorker = new TorusSurface_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value TorusSurface::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    TorusSurface_AddRef_AsyncWorker *asyncWorker = new TorusSurface_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
TorusSurface_GetMajorRadius_AsyncWorker::TorusSurface_GetMajorRadius_AsyncWorker(MbTorusSurface *_underlying,
...
TorusSurface_GetMinorRadius_AsyncWorker::TorusSurface_GetMinorRadius_AsyncWorker(MbTorusSurface *_underlying,
                                                                                 Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_GetSurface_AsyncWorker::TorusSurface_GetSurface_AsyncWorker(MbTorusSurface *_underlying,
                                                                         Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_GetUEpsilon_AsyncWorker::TorusSurface_GetUEpsilon_AsyncWorker(MbTorusSurface *_underlying,
                                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_GetVEpsilon_AsyncWorker::TorusSurface_GetVEpsilon_AsyncWorker(MbTorusSurface *_underlying,
                                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_GetUMid_AsyncWorker::TorusSurface_GetUMid_AsyncWorker(MbTorusSurface *_underlying,
                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_GetVMid_AsyncWorker::TorusSurface_GetVMid_AsyncWorker(MbTorusSurface *_underlying,
                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_GetUMin_AsyncWorker::TorusSurface_GetUMin_AsyncWorker(MbTorusSurface *_underlying,
                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_GetUMax_AsyncWorker::TorusSurface_GetUMax_AsyncWorker(MbTorusSurface *_underlying,
                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_GetVMin_AsyncWorker::TorusSurface_GetVMin_AsyncWorker(MbTorusSurface *_underlying,
                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_GetVMax_AsyncWorker::TorusSurface_GetVMax_AsyncWorker(MbTorusSurface *_underlying,
                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_GetUParamToUnit_AsyncWorker::TorusSurface_GetUParamToUnit_AsyncWorker(MbTorusSurface *_underlying,
                                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_GetVParamToUnit_AsyncWorker::TorusSurface_GetVParamToUnit_AsyncWorker(MbTorusSurface *_underlying,
                                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_GetRadius_AsyncWorker::TorusSurface_GetRadius_AsyncWorker(MbTorusSurface *_underlying,
                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_Normal_AsyncWorker::TorusSurface_Normal_AsyncWorker(MbTorusSurface *_underlying,
                                                                 Napi::Promise::Deferred const &d, double &u, double &v)
...
TorusSurface_NearDirectPointProjection_AsyncWorker::TorusSurface_NearDirectPointProjection_AsyncWorker(
    MbTorusSurface *_underlying, Napi::Promise::Deferred const &d, const MbCartPoint3D &pnt, const MbVector3D &vect,
...
void TorusSurface_NearDirectPointProjection_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
TorusSurface_IsA_AsyncWorker::TorusSurface_IsA_AsyncWorker(MbTorusSurface *_underlying,
                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_Type_AsyncWorker::TorusSurface_Type_AsyncWorker(MbTorusSurface *_underlying,
                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_Family_AsyncWorker::TorusSurface_Family_AsyncWorker(MbTorusSurface *_underlying,
                                                                 Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_Transform_AsyncWorker::TorusSurface_Transform_AsyncWorker(MbTorusSurface *_underlying,
                                                                       Napi::Promise::Deferred const &d,
...
TorusSurface_Move_AsyncWorker::TorusSurface_Move_AsyncWorker(MbTorusSurface *_underlying,
...
TorusSurface_Rotate_AsyncWorker::TorusSurface_Rotate_AsyncWorker(MbTorusSurface *_underlying,
...
TorusSurface_Refresh_AsyncWorker::TorusSurface_Refresh_AsyncWorker(MbTorusSurface *_underlying,
                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_Duplicate_AsyncWorker::TorusSurface_Duplicate_AsyncWorker(MbTorusSurface *_underlying,
                                                                       Napi::Promise::Deferred const &d,
                                                                       MbRegDuplicate *iReg)
...
TorusSurface_AddYourGabaritTo_AsyncWorker::TorusSurface_AddYourGabaritTo_AsyncWorker(MbTorusSurface *_underlying,
                                                                                     Napi::Promise::Deferred const &d,
                                                                                     MbCube &cube)
...
void TorusSurface_AddYourGabaritTo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                       Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
...
TorusSurface_GetUseCount_AsyncWorker::TorusSurface_GetUseCount_AsyncWorker(MbTorusSurface *_underlying,
                                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
TorusSurface_AddRef_AsyncWorker::TorusSurface_AddRef_AsyncWorker(MbTorusSurface *_underlying,
                                                                 Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
