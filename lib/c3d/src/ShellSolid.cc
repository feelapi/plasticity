...
Napi::Value ShellSolid::IsA_async(const Napi::CallbackInfo &info)
{
    ...
    ShellSolid_IsA_AsyncWorker *asyncWorker = new ShellSolid_IsA_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value ShellSolid::Type_async(const Napi::CallbackInfo &info)
{
    ...
    ShellSolid_Type_AsyncWorker *asyncWorker = new ShellSolid_Type_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ShellSolid::GetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    ShellSolid_GetBasisPoints_AsyncWorker *asyncWorker =
        new ShellSolid_GetBasisPoints_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ShellSolid::SetBasisPoints_async(const Napi::CallbackInfo &info)
{
    ...
    ShellSolid_SetBasisPoints_AsyncWorker *asyncWorker =
        new ShellSolid_SetBasisPoints_AsyncWorker(_underlying, deferred,
...
Napi::Value ShellSolid::GetBasisItems_async(const Napi::CallbackInfo &info)
{
    ...
    ShellSolid_GetBasisItems_AsyncWorker *asyncWorker = new ShellSolid_GetBasisItems_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ShellSolid::GetCreatorsCount_async(const Napi::CallbackInfo &info)
{
    ...
    ShellSolid_GetCreatorsCount_AsyncWorker *asyncWorker =
        new ShellSolid_GetCreatorsCount_AsyncWorker(_underlying, deferred,
...
Napi::Value ShellSolid::GetYourNameMaker_async(const Napi::CallbackInfo &info)
{
    ...
    ShellSolid_GetYourNameMaker_AsyncWorker *asyncWorker =
        new ShellSolid_GetYourNameMaker_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ShellSolid::GetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    ShellSolid_GetStatus_AsyncWorker *asyncWorker = new ShellSolid_GetStatus_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ShellSolid::SetStatus_async(const Napi::CallbackInfo &info)
{
    ...
    ShellSolid_SetStatus_AsyncWorker *asyncWorker = new ShellSolid_SetStatus_AsyncWorker(_underlying, deferred,
...
Napi::Value ShellSolid::CreateShell_async(const Napi::CallbackInfo &info)
{
    ...
    ShellSolid_CreateShell_AsyncWorker *asyncWorker = new ShellSolid_CreateShell_AsyncWorker(_underlying, deferred,
...
Napi::Value ShellSolid::GetMainName_async(const Napi::CallbackInfo &info)
{
    ...
    ShellSolid_GetMainName_AsyncWorker *asyncWorker = new ShellSolid_GetMainName_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ShellSolid::GetUseCount_async(const Napi::CallbackInfo &info)
{
    ...
    ShellSolid_GetUseCount_AsyncWorker *asyncWorker = new ShellSolid_GetUseCount_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
Napi::Value ShellSolid::AddRef_async(const Napi::CallbackInfo &info)
{
    ...
    ShellSolid_AddRef_AsyncWorker *asyncWorker = new ShellSolid_AddRef_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
    return deferred.Promise();
}
...
ShellSolid_IsA_AsyncWorker::ShellSolid_IsA_AsyncWorker(MbShellSolid *_underlying, Napi::Promise::Deferred const &d)
...
ShellSolid_Type_AsyncWorker::ShellSolid_Type_AsyncWorker(MbShellSolid *_underlying, Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ShellSolid_GetBasisPoints_AsyncWorker::ShellSolid_GetBasisPoints_AsyncWorker(MbShellSolid *_underlying,
...
ShellSolid_SetBasisPoints_AsyncWorker::ShellSolid_SetBasisPoints_AsyncWorker(MbShellSolid *_underlying,
                                                                             Napi::Promise::Deferred const &d,
...
ShellSolid_GetBasisItems_AsyncWorker::ShellSolid_GetBasisItems_AsyncWorker(MbShellSolid *_underlying,
                                                                           Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ShellSolid_GetCreatorsCount_AsyncWorker::ShellSolid_GetCreatorsCount_AsyncWorker(MbShellSolid *_underlying,
                                                                                 Napi::Promise::Deferred const &d,
                                                                                 MbeCreatorType ct)
...
ShellSolid_GetYourNameMaker_AsyncWorker::ShellSolid_GetYourNameMaker_AsyncWorker(MbShellSolid *_underlying,
                                                                                 Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ShellSolid_GetStatus_AsyncWorker::ShellSolid_GetStatus_AsyncWorker(MbShellSolid *_underlying,
                                                                   Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ShellSolid_SetStatus_AsyncWorker::ShellSolid_SetStatus_AsyncWorker(MbShellSolid *_underlying,
...
ShellSolid_CreateShell_AsyncWorker::ShellSolid_CreateShell_AsyncWorker(MbShellSolid *_underlying,
                                                                       Napi::Promise::Deferred const &d,
...
ShellSolid_GetMainName_AsyncWorker::ShellSolid_GetMainName_AsyncWorker(MbShellSolid *_underlying,
                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ShellSolid_GetUseCount_AsyncWorker::ShellSolid_GetUseCount_AsyncWorker(MbShellSolid *_underlying,
                                                                       Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
...
ShellSolid_AddRef_AsyncWorker::ShellSolid_AddRef_AsyncWorker(MbShellSolid *_underlying,
                                                             Napi::Promise::Deferred const &d)
    : _underlying(_underlying), PromiseWorker(d){};
