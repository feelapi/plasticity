...
Napi::Value ActionSurface::ElementarySurface(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result = ::ElementarySurface(point0, point1, point2, surfaceType, result
...
Napi::Value ActionSurface::ElementarySurface_async(const Napi::CallbackInfo &info)
{
    ...
    ActionSurface_ElementarySurface_AsyncWorker *asyncWorker =
        new ActionSurface_ElementarySurface_AsyncWorker(deferred,
...
Napi::Value ActionSurface::ExtrusionSurface(const Napi::CallbackInfo &info)
{
    ...
    MbResultType _result = ::ExtrusionSurface(curve, direction, simplify, result
...
Napi::Value ActionSurface::ExtrusionSurface_async(const Napi::CallbackInfo &info)
{
    ...
    ActionSurface_ExtrusionSurface_AsyncWorker *asyncWorker = new ActionSurface_ExtrusionSurface_AsyncWorker(deferred,
...
ActionSurface_ElementarySurface_AsyncWorker::ActionSurface_ElementarySurface_AsyncWorker(
    ...
    const MbCartPoint3D &point2, MbeSpaceType surfaceType)
    : PromiseWorker(d), point0(point0), point1(point1), point2(point2), surfaceType(surfaceType){};
...
void ActionSurface_ElementarySurface_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
ActionSurface_ExtrusionSurface_AsyncWorker::ActionSurface_ExtrusionSurface_AsyncWorker(Napi::Promise::Deferred const &d,
                                                                                       const MbCurve3D &curve,
                                                                                       const MbVector3D &direction,
                                                                                       bool simplify)
    : PromiseWorker(d), curve(curve), direction(direction), simplify(simplify){};
...
void ActionSurface_ExtrusionSurface_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                        Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
