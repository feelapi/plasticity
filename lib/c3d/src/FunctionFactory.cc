...
Napi::Object FunctionFactory::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "FunctionFactory", {
...
Napi::Function FunctionFactory::GetConstructor(Napi::Env env) {
 ...
 MbFunction * _result = _underlying->CreateAnalyticalFunction
(
        data
,        argument
,        tmin
,        tmax
    ...
    Napi::Value FunctionFactory::CreateAnalyticalFunction_async(const Napi::CallbackInfo& info) {
        ...
        FunctionFactory_CreateAnalyticalFunction_AsyncWorker* asyncWorker = new FunctionFactory_CreateAnalyticalFunction_AsyncWorker(
...
MbFunctionFactory * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        tmax
    ...
    void FunctionFactory_CreateAnalyticalFunction_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
