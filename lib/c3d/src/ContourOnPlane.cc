...
Napi::Object ContourOnPlane::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "ContourOnPlane", {
...
ContourOnPlane::ContourOnPlane(const Napi::CallbackInfo& info) : Napi::ObjectWrap<ContourOnPlane>(info) {
    ...
    if (info.Length() == 1 && info[0].IsString() && info[0].ToString().Utf8Value() == "__skip_js_init__") return;
        if (info.Length() == 3&&                ((
                info[0].IsObject() &&
                    info[0].ToObject().InstanceOf(Plane::GetConstructor(env))
        )   
)
 &&         ((
                info[1].IsObject() &&
...
(
    ...
    Napi::Value ContourOnPlane::GetPlacement_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetPlacement_AsyncWorker* asyncWorker = new ContourOnPlane_GetPlacement_AsyncWorker(
...
(
    ...
    Napi::Value ContourOnPlane::GetContour_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetContour_AsyncWorker* asyncWorker = new ContourOnPlane_GetContour_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::GetSurface_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetSurface_AsyncWorker* asyncWorker = new ContourOnPlane_GetSurface_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::GetSegment_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetSegment_AsyncWorker* asyncWorker = new ContourOnPlane_GetSegment_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnPlane::GetSegmentsCount_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetSegmentsCount_AsyncWorker* asyncWorker = new ContourOnPlane_GetSegmentsCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
if (_result) {
    ...
    Napi::Value ContourOnPlane::GetPlaneCurve_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetPlaneCurve_AsyncWorker* asyncWorker = new ContourOnPlane_GetPlaneCurve_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnPlane::IsPlanar_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_IsPlanar_AsyncWorker* asyncWorker = new ContourOnPlane_IsPlanar_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnPlane::IsClosed_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_IsClosed_AsyncWorker* asyncWorker = new ContourOnPlane_IsClosed_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::IsTouch_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_IsTouch_AsyncWorker* asyncWorker = new ContourOnPlane_IsTouch_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::GetTMax_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetTMax_AsyncWorker* asyncWorker = new ContourOnPlane_GetTMax_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::GetTMin_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetTMin_AsyncWorker* asyncWorker = new ContourOnPlane_GetTMin_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::GetPeriod_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetPeriod_AsyncWorker* asyncWorker = new ContourOnPlane_GetPeriod_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::IsPeriodic_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_IsPeriodic_AsyncWorker* asyncWorker = new ContourOnPlane_IsPeriodic_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::IsStraight_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_IsStraight_AsyncWorker* asyncWorker = new ContourOnPlane_IsStraight_AsyncWorker(
_underlying,            deferred
,
...
,        sense
    ...
    Napi::Value ContourOnPlane::Trimmed_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_Trimmed_AsyncWorker* asyncWorker = new ContourOnPlane_Trimmed_AsyncWorker(
_underlying,            deferred
,
...
,        *n
    ...
    Napi::Value ContourOnPlane::Normal_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_Normal_AsyncWorker* asyncWorker = new ContourOnPlane_Normal_AsyncWorker(
_underlying,            deferred
,
...
,        *tan
    ...
    Napi::Value ContourOnPlane::Tangent_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_Tangent_AsyncWorker* asyncWorker = new ContourOnPlane_Tangent_AsyncWorker(
_underlying,            deferred
,
...
,        *b
    ...
    Napi::Value ContourOnPlane::BNormal_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_BNormal_AsyncWorker* asyncWorker = new ContourOnPlane_BNormal_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnPlane::GetCentre_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetCentre_AsyncWorker* asyncWorker = new ContourOnPlane_GetCentre_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        *point
    ...
    Napi::Value ContourOnPlane::GetLimitPoint_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetLimitPoint_AsyncWorker* asyncWorker = new ContourOnPlane_GetLimitPoint_AsyncWorker(
_underlying,            deferred
,
...
,        *p
    ...
    Napi::Value ContourOnPlane::PointOn_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_PointOn_AsyncWorker* asyncWorker = new ContourOnPlane_PointOn_AsyncWorker(
_underlying,            deferred
,
...
,        *p
    ...
    Napi::Value ContourOnPlane::_PointOn_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane__PointOn_AsyncWorker* asyncWorker = new ContourOnPlane__PointOn_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : tRange
    ...
    Napi::Value ContourOnPlane::NearPointProjection_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_NearPointProjection_AsyncWorker* asyncWorker = new ContourOnPlane_NearPointProjection_AsyncWorker(
_underlying,            deferred
,
...
if (_result) {
    ...
    Napi::Value ContourOnPlane::GetSurfaceCurve_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetSurfaceCurve_AsyncWorker* asyncWorker = new ContourOnPlane_GetSurfaceCurve_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnPlane::GetWeightCentre_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetWeightCentre_AsyncWorker* asyncWorker = new ContourOnPlane_GetWeightCentre_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::GetBasisCurve_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetBasisCurve_AsyncWorker* asyncWorker = new ContourOnPlane_GetBasisCurve_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetBasisPoints_AsyncWorker* asyncWorker = new ContourOnPlane_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_SetBasisPoints_AsyncWorker* asyncWorker = new ContourOnPlane_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnPlane::Inverse_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_Inverse_AsyncWorker* asyncWorker = new ContourOnPlane_Inverse_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? Math::DefaultMathVersion() : version
    ...
    Napi::Value ContourOnPlane::GetProjection_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetProjection_AsyncWorker* asyncWorker = new ContourOnPlane_GetProjection_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnPlane::GetCircleAxis_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetCircleAxis_AsyncWorker* asyncWorker = new ContourOnPlane_GetCircleAxis_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::IsA_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_IsA_AsyncWorker* asyncWorker = new ContourOnPlane_IsA_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::Type_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_Type_AsyncWorker* asyncWorker = new ContourOnPlane_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::Family_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_Family_AsyncWorker* asyncWorker = new ContourOnPlane_Family_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value ContourOnPlane::Transform_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_Transform_AsyncWorker* asyncWorker = new ContourOnPlane_Transform_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 1 || info[1].IsNull() ? NULL : iReg
    ...
    Napi::Value ContourOnPlane::Move_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_Move_AsyncWorker* asyncWorker = new ContourOnPlane_Move_AsyncWorker(
_underlying,            deferred
,
...
,        info.Length() == 2 || info[2].IsNull() ? NULL : iReg
    ...
    Napi::Value ContourOnPlane::Rotate_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_Rotate_AsyncWorker* asyncWorker = new ContourOnPlane_Rotate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnPlane::Refresh_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_Refresh_AsyncWorker* asyncWorker = new ContourOnPlane_Refresh_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::Duplicate_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_Duplicate_AsyncWorker* asyncWorker = new ContourOnPlane_Duplicate_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnPlane::AddYourGabaritTo_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_AddYourGabaritTo_AsyncWorker* asyncWorker = new ContourOnPlane_AddYourGabaritTo_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value ContourOnPlane::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_GetUseCount_AsyncWorker* asyncWorker = new ContourOnPlane_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value ContourOnPlane::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        ContourOnPlane_AddRef_AsyncWorker* asyncWorker = new ContourOnPlane_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
ContourOnPlane::~ContourOnPlane() {
    ...
    ContourOnPlane_GetPlacement_AsyncWorker::ContourOnPlane_GetPlacement_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    ...
    ContourOnPlane_GetContour_AsyncWorker::ContourOnPlane_GetContour_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_GetSurface_AsyncWorker::ContourOnPlane_GetSurface_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_GetSegment_AsyncWorker::ContourOnPlane_GetSegment_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                         size_t  index    )
        :_underlying(_underlying),PromiseWorker(d),
...
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    ...
    void ContourOnPlane_GetSegmentsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnPlane_GetPlaneCurve_AsyncWorker::ContourOnPlane_GetPlaneCurve_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  saveParams,
                         PlanarCheckParams  params    )
...
,                        params
    ...
    ContourOnPlane_IsPlanar_AsyncWorker::ContourOnPlane_IsPlanar_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                         double  accuracy    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    ContourOnPlane_IsClosed_AsyncWorker::ContourOnPlane_IsClosed_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_IsTouch_AsyncWorker::ContourOnPlane_IsTouch_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_GetTMax_AsyncWorker::ContourOnPlane_GetTMax_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_GetTMin_AsyncWorker::ContourOnPlane_GetTMin_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_GetPeriod_AsyncWorker::ContourOnPlane_GetPeriod_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_IsPeriodic_AsyncWorker::ContourOnPlane_IsPeriodic_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_IsStraight_AsyncWorker::ContourOnPlane_IsStraight_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                         bool  ignoreParams    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    ContourOnPlane_Trimmed_AsyncWorker::ContourOnPlane_Trimmed_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                         double  t1,
                         double  t2,
...
,                        sense
    ...
    ContourOnPlane_Normal_AsyncWorker::ContourOnPlane_Normal_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *n
    ...
    ContourOnPlane_Tangent_AsyncWorker::ContourOnPlane_Tangent_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *tan
    ...
    ContourOnPlane_BNormal_AsyncWorker::ContourOnPlane_BNormal_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *b
    ...
    ContourOnPlane_GetCentre_AsyncWorker::ContourOnPlane_GetCentre_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_GetLimitPoint_AsyncWorker::ContourOnPlane_GetLimitPoint_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                         ptrdiff_t  number    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *point
    ...
    ContourOnPlane_PointOn_AsyncWorker::ContourOnPlane_PointOn_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        *p
    ...
    ContourOnPlane__PointOn_AsyncWorker::ContourOnPlane__PointOn_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                         double & t    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        tRange
    ...
    void ContourOnPlane_NearPointProjection_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnPlane_GetSurfaceCurve_AsyncWorker::ContourOnPlane_GetSurfaceCurve_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                         VERSION  version    )
        :_underlying(_underlying),PromiseWorker(d),
...
,                        version
    ...
    void ContourOnPlane_GetSurfaceCurve_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnPlane_GetWeightCentre_AsyncWorker::ContourOnPlane_GetWeightCentre_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void ContourOnPlane_GetWeightCentre_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnPlane_GetBasisCurve_AsyncWorker::ContourOnPlane_GetBasisCurve_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_GetBasisPoints_AsyncWorker::ContourOnPlane_GetBasisPoints_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void ContourOnPlane_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnPlane_SetBasisPoints_AsyncWorker::ContourOnPlane_SetBasisPoints_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    void ContourOnPlane_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnPlane_Inverse_AsyncWorker::ContourOnPlane_Inverse_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_GetProjection_AsyncWorker::ContourOnPlane_GetProjection_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        version
    ...
    ContourOnPlane_GetCircleAxis_AsyncWorker::ContourOnPlane_GetCircleAxis_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_IsA_AsyncWorker::ContourOnPlane_IsA_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_Type_AsyncWorker::ContourOnPlane_Type_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_Family_AsyncWorker::ContourOnPlane_Family_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_Transform_AsyncWorker::ContourOnPlane_Transform_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
...
,                        iReg
    ...
    ContourOnPlane_Move_AsyncWorker::ContourOnPlane_Move_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbVector3D & v,
                         MbRegTransform * iReg    )
...
,                        iReg
    ...
    ContourOnPlane_Rotate_AsyncWorker::ContourOnPlane_Rotate_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                        const MbAxis3D & axis,
                         double  angle,
...
,                        iReg
    ...
    ContourOnPlane_Refresh_AsyncWorker::ContourOnPlane_Refresh_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_Duplicate_AsyncWorker::ContourOnPlane_Duplicate_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
,
                         MbRegDuplicate * iReg    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    void ContourOnPlane_AddYourGabaritTo_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    ContourOnPlane_GetUseCount_AsyncWorker::ContourOnPlane_GetUseCount_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    ContourOnPlane_AddRef_AsyncWorker::ContourOnPlane_AddRef_AsyncWorker(
MbContourOnPlane * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
