...
(
    ...
    Napi::Value Rect::GetTop_async(const Napi::CallbackInfo& info) {
        ...
        Rect_GetTop_AsyncWorker* asyncWorker = new Rect_GetTop_AsyncWorker(
...
(
    ...
    Napi::Value Rect::GetBottom_async(const Napi::CallbackInfo& info) {
        ...
        Rect_GetBottom_AsyncWorker* asyncWorker = new Rect_GetBottom_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Rect::GetLeft_async(const Napi::CallbackInfo& info) {
        ...
        Rect_GetLeft_AsyncWorker* asyncWorker = new Rect_GetLeft_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value Rect::GetRight_async(const Napi::CallbackInfo& info) {
        ...
        Rect_GetRight_AsyncWorker* asyncWorker = new Rect_GetRight_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
    ...
    Rect_GetTop_AsyncWorker::Rect_GetTop_AsyncWorker(
MbRect * _underlying,        Napi::Promise::Deferred const &d
    ...
    Rect_GetBottom_AsyncWorker::Rect_GetBottom_AsyncWorker(
MbRect * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Rect_GetLeft_AsyncWorker::Rect_GetLeft_AsyncWorker(
MbRect * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    Rect_GetRight_AsyncWorker::Rect_GetRight_AsyncWorker(
MbRect * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
