...
Napi::Object _SweptValuesAndSides::Init(const Napi::Env env, Napi::Object exports)
{
    Napi::Function func = DefineClass(
        env, "SweptValuesAndSides",
        {
            ...
            InstanceAccessor<&_SweptValuesAndSides::GetValue_thickness1, &_SweptValuesAndSides::SetValue_thickness1>(
                "thickness1"),
            InstanceAccessor<&_SweptValuesAndSides::GetValue_thickness2, &_SweptValuesAndSides::SetValue_thickness2>(
                "thickness2"),
            InstanceAccessor<&_SweptValuesAndSides::GetValue_shellClosed, &_SweptValuesAndSides::SetValue_shellClosed>(
                "shellClosed"),
        });
...
_SweptValuesAndSides::_SweptValuesAndSides(const Napi::CallbackInfo &info)
    : Napi::ObjectWrap<_SweptValuesAndSides>(info)
{
...
Napi::Value _SweptValuesAndSides::CheckSelfInt_async(const Napi::CallbackInfo &info)
{
    ...
    _SweptValuesAndSides_CheckSelfInt_AsyncWorker *asyncWorker =
        new _SweptValuesAndSides_CheckSelfInt_AsyncWorker(_underlying, deferred);
    asyncWorker->Queue();
...
Napi::Value _SweptValuesAndSides::SetCheckSelfInt_async(const Napi::CallbackInfo &info)
{
    ...
    _SweptValuesAndSides_SetCheckSelfInt_AsyncWorker *asyncWorker =
        new _SweptValuesAndSides_SetCheckSelfInt_AsyncWorker(_underlying, deferred,
...
void _SweptValuesAndSides_CheckSelfInt_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
...
_SweptValuesAndSides_SetCheckSelfInt_AsyncWorker::_SweptValuesAndSides_SetCheckSelfInt_AsyncWorker(
    SweptValuesAndSides _underlying, Napi::Promise::Deferred const &d, bool c)
...
void _SweptValuesAndSides_SetCheckSelfInt_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred,
                                                              Napi::Error const &error)
{
    Napi::Env env = deferred.Env();
    error.Value().Set("code", Napi::Number::New(env, this->resultType));
