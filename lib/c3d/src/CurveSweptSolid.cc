...
Napi::Object CurveSweptSolid::Init(const Napi::Env env, Napi::Object exports) {
    Napi::Function func = DefineClass(env, "CurveSweptSolid", {
...
(
    ...
    Napi::Value CurveSweptSolid::IsA_async(const Napi::CallbackInfo& info) {
        ...
        CurveSweptSolid_IsA_AsyncWorker* asyncWorker = new CurveSweptSolid_IsA_AsyncWorker(
...
(
    ...
    Napi::Value CurveSweptSolid::Type_async(const Napi::CallbackInfo& info) {
        ...
        CurveSweptSolid_Type_AsyncWorker* asyncWorker = new CurveSweptSolid_Type_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CurveSweptSolid::GetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        CurveSweptSolid_GetBasisPoints_AsyncWorker* asyncWorker = new CurveSweptSolid_GetBasisPoints_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CurveSweptSolid::SetBasisPoints_async(const Napi::CallbackInfo& info) {
        ...
        CurveSweptSolid_SetBasisPoints_AsyncWorker* asyncWorker = new CurveSweptSolid_SetBasisPoints_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CurveSweptSolid::GetBasisItems_async(const Napi::CallbackInfo& info) {
        ...
        CurveSweptSolid_GetBasisItems_AsyncWorker* asyncWorker = new CurveSweptSolid_GetBasisItems_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CurveSweptSolid::GetCreatorsCount_async(const Napi::CallbackInfo& info) {
        ...
        CurveSweptSolid_GetCreatorsCount_AsyncWorker* asyncWorker = new CurveSweptSolid_GetCreatorsCount_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CurveSweptSolid::GetYourNameMaker_async(const Napi::CallbackInfo& info) {
        ...
        CurveSweptSolid_GetYourNameMaker_AsyncWorker* asyncWorker = new CurveSweptSolid_GetYourNameMaker_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CurveSweptSolid::GetStatus_async(const Napi::CallbackInfo& info) {
        ...
        CurveSweptSolid_GetStatus_AsyncWorker* asyncWorker = new CurveSweptSolid_GetStatus_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CurveSweptSolid::SetStatus_async(const Napi::CallbackInfo& info) {
        ...
        CurveSweptSolid_SetStatus_AsyncWorker* asyncWorker = new CurveSweptSolid_SetStatus_AsyncWorker(
_underlying,            deferred
,
...
,        items
    ...
    Napi::Value CurveSweptSolid::CreateShell_async(const Napi::CallbackInfo& info) {
        ...
        CurveSweptSolid_CreateShell_AsyncWorker* asyncWorker = new CurveSweptSolid_CreateShell_AsyncWorker(
_underlying,            deferred
,
...
(
    ...
    Napi::Value CurveSweptSolid::GetMainName_async(const Napi::CallbackInfo& info) {
        ...
        CurveSweptSolid_GetMainName_AsyncWorker* asyncWorker = new CurveSweptSolid_GetMainName_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CurveSweptSolid::GetUseCount_async(const Napi::CallbackInfo& info) {
        ...
        CurveSweptSolid_GetUseCount_AsyncWorker* asyncWorker = new CurveSweptSolid_GetUseCount_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
(
    ...
    Napi::Value CurveSweptSolid::AddRef_async(const Napi::CallbackInfo& info) {
        ...
        CurveSweptSolid_AddRef_AsyncWorker* asyncWorker = new CurveSweptSolid_AddRef_AsyncWorker(
_underlying,            deferred
        );
        asyncWorker->Queue();
        return deferred.Promise();
...
CurveSweptSolid::~CurveSweptSolid() {
    ...
    CurveSweptSolid_IsA_AsyncWorker::CurveSweptSolid_IsA_AsyncWorker(
MbCurveSweptSolid * _underlying,        Napi::Promise::Deferred const &d
    ...
    CurveSweptSolid_Type_AsyncWorker::CurveSweptSolid_Type_AsyncWorker(
MbCurveSweptSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CurveSweptSolid_GetBasisPoints_AsyncWorker::CurveSweptSolid_GetBasisPoints_AsyncWorker(
MbCurveSweptSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void CurveSweptSolid_GetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    CurveSweptSolid_SetBasisPoints_AsyncWorker::CurveSweptSolid_SetBasisPoints_AsyncWorker(
MbCurveSweptSolid * _underlying,        Napi::Promise::Deferred const &d
,
...
{};
    ...
    void CurveSweptSolid_SetBasisPoints_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    CurveSweptSolid_GetBasisItems_AsyncWorker::CurveSweptSolid_GetBasisItems_AsyncWorker(
MbCurveSweptSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    void CurveSweptSolid_GetBasisItems_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
{};
    ...
    void CurveSweptSolid_GetCreatorsCount_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
...
MbCurveSweptSolid * _underlying,        Napi::Promise::Deferred const &d
    ...
    void CurveSweptSolid_GetYourNameMaker_AsyncWorker::Reject(Napi::Promise::Deferred const &deferred, Napi::Error const & error) {
        Napi::Env env = deferred.Env();
        error.Value().Set("code", Napi::Number::New(env, this->resultType));
        error.Value()["isC3dError"] = true;
        deferred.Reject(error.Value());
    }
    CurveSweptSolid_GetStatus_AsyncWorker::CurveSweptSolid_GetStatus_AsyncWorker(
MbCurveSweptSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CurveSweptSolid_SetStatus_AsyncWorker::CurveSweptSolid_SetStatus_AsyncWorker(
MbCurveSweptSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbeProcessState  l    )
        :_underlying(_underlying),PromiseWorker(d),
...
{};
    ...
    CurveSweptSolid_CreateShell_AsyncWorker::CurveSweptSolid_CreateShell_AsyncWorker(
MbCurveSweptSolid * _underlying,        Napi::Promise::Deferred const &d
,
                         MbFaceShell * shell,
...
,                        items
    ...
    CurveSweptSolid_GetMainName_AsyncWorker::CurveSweptSolid_GetMainName_AsyncWorker(
MbCurveSweptSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CurveSweptSolid_GetUseCount_AsyncWorker::CurveSweptSolid_GetUseCount_AsyncWorker(
MbCurveSweptSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
    ...
    CurveSweptSolid_AddRef_AsyncWorker::CurveSweptSolid_AddRef_AsyncWorker(
MbCurveSweptSolid * _underlying,        Napi::Promise::Deferred const &d
    )
        :_underlying(_underlying),PromiseWorker(d){};
